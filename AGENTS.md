...
- **常用命令**：
  ...
  ```
- **当前 Research 进度（2026-07-06）**：registry `411` projects；candidate total `357`，pending new candidates `158`；depth upgrade queue `14`，全部为 `needs-upgrade`；下一批新增候选从 `USDa / USDA`、`Tradable NA Rent Financing Platform SSTN`、`Spiko US T-Bills Money Market Fund` 开始；下一批旧文升级从 `golem-glm...`、`kaito-kaito...`、`livepeer-lpt...` 开始。
