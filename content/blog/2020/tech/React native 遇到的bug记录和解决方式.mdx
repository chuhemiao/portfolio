...
summary: "+ 首先确保自己开启了端口 `adb reverse tcp:8081 tcp:8081` ,然后运行`sudo npx react-native run-android` 然后出现错误： `Failure [INSTALL_FAILED_USER_RESTRICTED: Install cance"
category: "tech"
slug: "react-native-bug"
---
