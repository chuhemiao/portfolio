...
summary: "Go get 出现超时问题：“golang unrecognized import path \"golang.org/x/net   unrecognized import path \"golang.org/x/sys\"  Unknown SSL protocol error in connecti"
category: "tech"
---
