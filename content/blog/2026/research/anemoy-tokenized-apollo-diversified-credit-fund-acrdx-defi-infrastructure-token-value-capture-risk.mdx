...
| Latest TVL sample | $1.63B |
| TVL sample change | 5.84% |
| Primary source posture | Surf + CoinGecko + CMC discovery + official/project links |

Base case: Anemoy Tokenized Apollo Diversified Credit Fund remains a selective watchlist asset until token value capture is cleaner. Bull case: protocol usage and token mechanics converge, turning ACRDX into a security, collateral, or fee-routing asset with real demand. Bear case: the protocol remains useful but token holders absorb dilution, thin liquidity, governance optionality, or regulatory/technical tail risk.

## Project Overview

Seeded 2026-07-06 from Surf market-ranking; rank 431, market cap $50,972,403, 24h volume $0. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.

Surf's project profile maps Anemoy Tokenized Apollo Diversified Credit Fund to the following high-level surface:
...
The strongest reason to add the report is not that Anemoy Tokenized Apollo Diversified Credit Fund is obviously cheap. It is that the project is large or specific enough to track in the Research Map, and the current candidate backlog indicates it had not yet been covered locally.
...
The market intelligence layer has three parts: DeFi usage, market liquidity, and attention. For Anemoy Tokenized Apollo Diversified Credit Fund, the DeFi-oriented backlog note is the first signal: Seeded 2026-07-06 from Surf market-ranking; rank 431, market cap $50,972,403, 24h volume $0. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.. Surf/CG data then adds market cap not disclosed, FDV not disclosed, 24h volume not disclosed, and price not disclosed.

| Traction metric | Value | Interpretation |
|---|---|---|
| Latest TVL sample | $1.63B | Useful only if sustained without aggressive incentives |
| TVL sample points | 90 | More points improve trend confidence |
| TVL sample change | 5.84% | Positive trend supports usage; negative trend requires explanation |
...
| Accrual channel | Strength for Anemoy Tokenized Apollo Diversified Credit Fund | Evidence needed |
|---|---|---|
...
| Staking / security | Depends on whether ACRDX is bonded or slashable | Staking contracts, validator docs, reward schedule |
...
The third frame is source triangulation. Surf project-detail gives an aggregated project view, CoinGecko provides a market-data and community-data surface, CoinMarketCap discovery is used to cross-check symbol identity, and DefiLlama style TVL notes provide a protocol-usage lens. For Anemoy Tokenized Apollo Diversified Credit Fund, the candidate backlog records Seeded 2026-07-06 from Surf market-ranking; rank 431, market cap $50,972,403, 24h volume $0. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.. Surf identifies chains as not disclosed, exchanges as not disclosed, and tags as not disclosed. If these labels diverge from official documentation, official documentation wins. If CMC, CG, and Surf disagree on supply or market cap, this memo treats the supply field as unresolved until a token contract, official tokenomics page, and exchange-circulating methodology can be reconciled.
...
Anemoy Tokenized Apollo Diversified Credit Fund competes in the DeFi infrastructure bucket, where category peers vary by exact design. The memo uses functional competitors rather than only ticker competitors:
...
Weighted conclusion: Anemoy Tokenized Apollo Diversified Credit Fund is important enough to track, but not clean enough to rank as a high-conviction token until economic capture is clearer.

## Bull / Base / Bear

| Scenario | Probability | Thesis | Monitoring signal |
|---|---:|---|---|
| Bull | 25% | Anemoy Tokenized Apollo Diversified Credit Fund compounds usage, liquidity improves, and ACRDX gains measurable value capture through staking, fees, collateral, or governance-controlled economics. | TVL up, fees visible, volume deepens, supply overhang falls |
...
The strongest bearish critique is simple: this could be a useful protocol with an average token. If ACRDX does not capture fees or security demand, the market will eventually value it as governance optionality plus liquidity beta. The second critique is data inconsistency. CG, CMC, Surf, and official docs can disagree on circulating supply, FDV, and market cap. The third critique is reflexive TVL: deposits can leave quickly when incentives, yields, or narratives change.
...
|---|---|---|---|
| TVL | $1.63B | Weekly | >20% drawdown or sustained growth |
...
1. Re-run Surf project-detail and project-defi-metrics if Anemoy Tokenized Apollo Diversified Credit Fund announces a major integration, listing, tokenomics change, exploit, or governance proposal.
...
| Peer comparison | Monthly | Anemoy Tokenized Apollo Diversified Credit Fund gains share with better economics | Peers grow faster with cleaner capture |

## Evidence Ledger

| # | Source | Link | Why it matters |
|---:|---|---|---|
| 1 | CoinGecko search | [link](https://www.coingecko.com/en/search?query=Anemoy%20Tokenized%20Apollo%20Diversified%20Credit%20Fund) | Identity, market, social, contract, or discovery cross-check |
| 2 | CoinMarketCap discovery | [link](https://coinmarketcap.com/search/?q=Anemoy%20Tokenized%20Apollo%20Diversified%20Credit%20Fund) | Identity, market, social, contract, or discovery cross-check |
| 3 | DefiLlama protocol discovery | [link](https://defillama.com/search?query=Anemoy%20Tokenized%20Apollo%20Diversified%20Credit%20Fund) | Identity, market, social, contract, or discovery cross-check |
| 4 | Token Terminal discovery | [link](https://tokenterminal.com/explorer?search=Anemoy%20Tokenized%20Apollo%20Diversified%20Credit%20Fund) | Identity, market, social, contract, or discovery cross-check |
| 5 | Messari discovery | [link](https://messari.io/search?q=Anemoy%20Tokenized%20Apollo%20Diversified%20Credit%20Fund) | Identity, market, social, contract, or discovery cross-check |
| 6 | Anemoy Tokenized Apollo Diversified Credit Fund ACRDX / VEF | [link](https://www.coingecko.com/en/coins/anemoy-tokenized-apollo-diversified-credit-fund/vef) | Identity, market, social, contract, or discovery cross-check |
| 7 | Anemoy Tokenized Apollo Diversified Credit Fund Price (ACRDX) | [link](https://www.coinbase.com/price/anemoy-tokenized-apollo-diversified-credit-fund) | Identity, market, social, contract, or discovery cross-check |
| 8 | Anemoy Tokenized Apollo Diversified Credit Fund / ACRDX - RWA.xyz | [link](https://app.rwa.xyz/assets/ACRDX) | Identity, market, social, contract, or discovery cross-check |
| 9 | Anemoy Tokenized Apollo Diversified Credit Fund Price History | [link](https://www.coingecko.com/en/coins/anemoy-tokenized-apollo-diversified-credit-fund/historical_data) | Identity, market, social, contract, or discovery cross-check |
| 10 | Grove Deploys $50M to ACRDX Launched with Centrifuge and Plume | [link](https://centrifuge.io/blog/acrdx-launch-on-centrifuge) | Identity, market, social, contract, or discovery cross-check |
| 11 | Google project search | [link](https://www.google.com/search?q=Anemoy%20Tokenized%20Apollo%20Diversified%20Credit%20Fund%20ACRDX%20crypto) | Identity, market, social, contract, or discovery cross-check |
| 12 | Google tokenomics search | [link](https://www.google.com/search?q=Anemoy%20Tokenized%20Apollo%20Diversified%20Credit%20Fund%20ACRDX%20tokenomics) | Identity, market, social, contract, or discovery cross-check |
| 13 | Google docs search | [link](https://www.google.com/search?q=Anemoy%20Tokenized%20Apollo%20Diversified%20Credit%20Fund%20docs) | Identity, market, social, contract, or discovery cross-check |
| 14 | Google governance search | [link](https://www.google.com/search?q=Anemoy%20Tokenized%20Apollo%20Diversified%20Credit%20Fund%20governance%20proposal) | Identity, market, social, contract, or discovery cross-check |
| 15 | Google audit search | [link](https://www.google.com/search?q=Anemoy%20Tokenized%20Apollo%20Diversified%20Credit%20Fund%20audit%20report) | Identity, market, social, contract, or discovery cross-check |
| 16 | CoinMarketCap what-is guess | [link](https://coinmarketcap.com/cmc-ai/anemoy-tokenized-apollo-diversified-credit-fund/what-is/) | Identity, market, social, contract, or discovery cross-check |
| 17 | CoinMarketCap price analysis guess | [link](https://coinmarketcap.com/cmc-ai/anemoy-tokenized-apollo-diversified-credit-fund/price-analysis/) | Identity, market, social, contract, or discovery cross-check |
| 18 | CoinMarketCap currency guess | [link](https://coinmarketcap.com/currencies/anemoy-tokenized-apollo-diversified-credit-fund/) | Identity, market, social, contract, or discovery cross-check |
| 19 | Dune discovery | [link](https://dune.com/browse/dashboards?q=Anemoy%20Tokenized%20Apollo%20Diversified%20Credit%20Fund) | Identity, market, social, contract, or discovery cross-check |
| 20 | Dune token query | [link](https://dune.com/browse/queries?q=Anemoy%20Tokenized%20Apollo%20Diversified%20Credit%20Fund) | Identity, market, social, contract, or discovery cross-check |
| 21 | DeFiLlama fees discovery | [link](https://defillama.com/fees?chain=All&search=Anemoy%20Tokenized%20Apollo%20Diversified%20Credit%20Fund) | Identity, market, social, contract, or discovery cross-check |
| 22 | DeFiLlama yield discovery | [link](https://defillama.com/yields?token=ACRDX) | Identity, market, social, contract, or discovery cross-check |
| 23 | TokenUnlocks search | [link](https://token.unlocks.app/?search=Anemoy%20Tokenized%20Apollo%20Diversified%20Credit%20Fund) | Identity, market, social, contract, or discovery cross-check |
| 24 | CryptoRank search | [link](https://cryptorank.io/price/anemoy-tokenized-apollo-diversified-credit-fund) | Identity, market, social, contract, or discovery cross-check |
| 25 | RootData search | [link](https://www.rootdata.com/search?kw=Anemoy%20Tokenized%20Apollo%20Diversified%20Credit%20Fund) | Identity, market, social, contract, or discovery cross-check |
| 26 | CoinDesk search | [link](https://www.coindesk.com/search?s=Anemoy%20Tokenized%20Apollo%20Diversified%20Credit%20Fund) | Identity, market, social, contract, or discovery cross-check |
| 27 | The Block search | [link](https://www.theblock.co/search?query=Anemoy%20Tokenized%20Apollo%20Diversified%20Credit%20Fund) | Identity, market, social, contract, or discovery cross-check |
| 28 | GitHub search | [link](https://github.com/search?q=Anemoy%20Tokenized%20Apollo%20Diversified%20Credit%20Fund&type=repositories) | Identity, market, social, contract, or discovery cross-check |
| 29 | Etherscan token search | [link](https://etherscan.io/search?f=0&q=ACRDX) | Identity, market, social, contract, or discovery cross-check |
| 30 | BscScan token search | [link](https://bscscan.com/search?f=0&q=ACRDX) | Identity, market, social, contract, or discovery cross-check |
| 31 | Arbiscan token search | [link](https://arbiscan.io/search?f=0&q=ACRDX) | Identity, market, social, contract, or discovery cross-check |
| 32 | BaseScan token search | [link](https://basescan.org/search?f=0&q=ACRDX) | Identity, market, social, contract, or discovery cross-check |
| 33 | RWA.xyz search | [link](https://app.rwa.xyz/search?query=Anemoy%20Tokenized%20Apollo%20Diversified%20Credit%20Fund) | Identity, market, social, contract, or discovery cross-check |

Additional direct source list:

- [CoinGecko search](https://www.coingecko.com/en/search?query=Anemoy%20Tokenized%20Apollo%20Diversified%20Credit%20Fund)
- [CoinMarketCap discovery](https://coinmarketcap.com/search/?q=Anemoy%20Tokenized%20Apollo%20Diversified%20Credit%20Fund)
- [DefiLlama protocol discovery](https://defillama.com/search?query=Anemoy%20Tokenized%20Apollo%20Diversified%20Credit%20Fund)
- [Token Terminal discovery](https://tokenterminal.com/explorer?search=Anemoy%20Tokenized%20Apollo%20Diversified%20Credit%20Fund)
- [Messari discovery](https://messari.io/search?q=Anemoy%20Tokenized%20Apollo%20Diversified%20Credit%20Fund)
- [Anemoy Tokenized Apollo Diversified Credit Fund ACRDX / VEF](https://www.coingecko.com/en/coins/anemoy-tokenized-apollo-diversified-credit-fund/vef)
- [Anemoy Tokenized Apollo Diversified Credit Fund Price (ACRDX)](https://www.coinbase.com/price/anemoy-tokenized-apollo-diversified-credit-fund)
- [Anemoy Tokenized Apollo Diversified Credit Fund | ACRDX - RWA.xyz](https://app.rwa.xyz/assets/ACRDX)
- [Anemoy Tokenized Apollo Diversified Credit Fund Price History](https://www.coingecko.com/en/coins/anemoy-tokenized-apollo-diversified-credit-fund/historical_data)
- [Grove Deploys $50M to ACRDX Launched with Centrifuge and Plume](https://centrifuge.io/blog/acrdx-launch-on-centrifuge)
- [Google project search](https://www.google.com/search?q=Anemoy%20Tokenized%20Apollo%20Diversified%20Credit%20Fund%20ACRDX%20crypto)
- [Google tokenomics search](https://www.google.com/search?q=Anemoy%20Tokenized%20Apollo%20Diversified%20Credit%20Fund%20ACRDX%20tokenomics)
- [Google docs search](https://www.google.com/search?q=Anemoy%20Tokenized%20Apollo%20Diversified%20Credit%20Fund%20docs)
- [Google governance search](https://www.google.com/search?q=Anemoy%20Tokenized%20Apollo%20Diversified%20Credit%20Fund%20governance%20proposal)
- [Google audit search](https://www.google.com/search?q=Anemoy%20Tokenized%20Apollo%20Diversified%20Credit%20Fund%20audit%20report)
- [CoinMarketCap what-is guess](https://coinmarketcap.com/cmc-ai/anemoy-tokenized-apollo-diversified-credit-fund/what-is/)
- [CoinMarketCap price analysis guess](https://coinmarketcap.com/cmc-ai/anemoy-tokenized-apollo-diversified-credit-fund/price-analysis/)
- [CoinMarketCap currency guess](https://coinmarketcap.com/currencies/anemoy-tokenized-apollo-diversified-credit-fund/)
- [Dune discovery](https://dune.com/browse/dashboards?q=Anemoy%20Tokenized%20Apollo%20Diversified%20Credit%20Fund)
- [Dune token query](https://dune.com/browse/queries?q=Anemoy%20Tokenized%20Apollo%20Diversified%20Credit%20Fund)
- [DeFiLlama fees discovery](https://defillama.com/fees?chain=All&search=Anemoy%20Tokenized%20Apollo%20Diversified%20Credit%20Fund)
- [DeFiLlama yield discovery](https://defillama.com/yields?token=ACRDX)
- [TokenUnlocks search](https://token.unlocks.app/?search=Anemoy%20Tokenized%20Apollo%20Diversified%20Credit%20Fund)
- [CryptoRank search](https://cryptorank.io/price/anemoy-tokenized-apollo-diversified-credit-fund)
