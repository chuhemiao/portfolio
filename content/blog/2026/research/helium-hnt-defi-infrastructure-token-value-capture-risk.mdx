...
| FDV | $43.72M |
| 24h volume | $2.77M |
| Circulating supply | 182.06M |
| Total supply | 182.06M |
| 7d price change | -9.29% |
| 30d price change | -50.81% |
...
Base case: Helium remains a selective watchlist asset until token value capture is cleaner. Bull case: protocol usage and token mechanics converge, turning HNT into a security, collateral, or fee-routing asset with real demand. Bear case: the protocol remains useful but token holders absorb dilution, thin liquidity, governance optionality, or regulatory/technical tail risk.

## Project Overview

Helium is a decentralized wireless (DePIN) network where individuals run Hotspots to provide IoT and mobile coverage and earn HNT tokens as incentives. It offers developer documentation, a wallet, and services (Helium Mobile/Plus) enabling decentralized LoRaWAN and consumer mobile connectivity.

Surf's project profile maps Helium to the following high-level surface:

| Area | Evidence |
|---|---|
| Website | [https://www.helium.com/](https://www.helium.com/) |
| X handle | [@helium](https://x.com/helium) |
| X followers | 224.31K |
| Tags | DePIN (Physical Infra) |
| Chains | Solana |
| Exchanges | BINANCE, COINBASE, BITHUMB, BYBIT, BITGET |
| TGE status | post |
...
| Liquidity | $2.77M 24h volume | Deeper CEX/DEX books and less fragmented contract liquidity |
| Supply quality | 182.06M circulating vs 182.06M total | Official unlock schedule and reconciled circulating methodology |
| Downside containment | Watchlist only | Transparent treasury, audits, risk controls, and stress-test history |

The strongest reason to add the report is not that Helium is obviously cheap. It is that the project is large or specific enough to track in the Research Map, and the current candidate backlog indicates it had not yet been covered locally.
...
|---|---|---|---|
| solana | HNT | hntyVP6YFm1Hg25TN9WGLqM12b8TQmcknKrdu1oxWux | [explorer](https://solscan.io/token/hntyVP6YFm1Hg25TN9WGLqM12b8TQmcknKrdu1oxWux) |
| solana | MOBILE | mb1eu7TzEc71KxDpsmsKoucSSuuoGLv1drys1oP2jh6 | [explorer](https://solscan.io/token/mb1eu7TzEc71KxDpsmsKoucSSuuoGLv1drys1oP2jh6) |
| solana | IOT | iotEVVZLEywoTn1QdwNPddxPWszn3zFhEot3MfL9fns | [explorer](https://solscan.io/token/iotEVVZLEywoTn1QdwNPddxPWszn3zFhEot3MfL9fns) |
...
The market intelligence layer has three parts: DeFi usage, market liquidity, and attention. For Helium, the DeFi-oriented backlog note is the first signal: Seeded 2026-07-06 from Surf market-ranking; rank 498, market cap $43,204,034, 24h volume $2,569,121. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.. Surf/CG data then adds market cap $43.72M, FDV $43.72M, 24h volume $2.77M, and price $0.2402.
...
| 24h volume | $2.77M | Position sizing and exit liquidity proxy |
| Market cap | $43.72M | Liquid valuation proxy |
| FDV | $43.72M | Dilution-aware valuation proxy |
| FDV / market cap spread | 1.00x | Higher spread means more supply risk |
| X followers | 224.31K | Attention proxy, not adoption proof |
...
| Accrual channel | Strength for Helium | Evidence needed |
|---|---|---|
...
| Staking / security | Depends on whether HNT is bonded or slashable | Staking contracts, validator docs, reward schedule |
...
The fifth frame is reflexivity. Many DeFi and infrastructure assets reprice in waves: first through TVL and listings, then through fee visibility, then through tokenomics cleanup, and finally through real cash-flow or strategic acquisition narratives. Helium currently needs to be monitored through that sequence. The available 90-day TVL series has 0 point(s), latest TVL not disclosed, and approximate change not disclosed. Market-price movement shows 7d -9.29% and 30d -50.81% when Surf or CoinGecko exposed the field. If TVL and price move together, the thesis may be simple beta. If TVL rises while price lags, the thesis becomes value-capture skepticism. If price rises while TVL falls, the thesis becomes momentum without fundamental confirmation.

The conservative conclusion is that Helium's product relevance may be ahead of its token value capture. That is common in this sector. The report should therefore watch for activation events: fee switch, staking redesign, revenue dashboard, cap increases, major integrations, or emissions reductions.
...
|---|---|---|---|
| 2022-02-19 | Series D | $200.00M | Pantera Capital, Multicoin Capital, Andreessen Horowitz (a16z crypto), FTX Ventures, Tiger Global Management, Ribbit Capital, Alumni Ventures, Seven Seven Six |
| 2021-08-10 | Undisclosed | $111.00M | Alameda Research, Multicoin Capital, Andreessen Horowitz (a16z crypto), Ribbit Capital, 10T Fund |
| 2019-06-15 | Series C | $15.00M | Multicoin Capital, Union Square Ventures (USV), Slow Ventures, SV Angel, Khosla Ventures, FirstMark, Digital Garage, GV Google Ventures |
| 2016-04-25 | Series B | $20.00M | Khosla Ventures, FirstMark, GV Google Ventures, Munich Re |
| 2014-12-09 | Series A | $16.00M | Slow Ventures, SV Angel, Khosla Ventures, FirstMark, Digital Garage |
| 2013-11-01 | Seed | $2.80M | Slow Ventures, SV Angel, FirstMark, Digital Garage |

| Team member | Role | Link |
|---|---|---|
| Amir Haleem | Co-Founder, CEO | [X](https://twitter.com/amirhaleem) |
| Shawn Fanning | Co-Founder | [X](https://twitter.com/shawnfanning) |
| Sean Carey | Co-Founder | [X](https://twitter.com/densone) |
| Marc Nijdam | CTO | [X](https://twitter.com/madninja) |
| Frank Mong | COO | [X](https://twitter.com/fmong) |
| Robert Wenig | Advisory Board Member | not disclosed |
| Eric Dresselhuys | Advisory Board Member | [X](https://twitter.com/EricDresselhuys) |
| Ibrahim Ammar | Advisor | not disclosed |
...
Helium competes in the DeFi infrastructure bucket, where category peers vary by exact design. The memo uses functional competitors rather than only ticker competitors:
...
Weighted conclusion: Helium is important enough to track, but not clean enough to rank as a high-conviction token until economic capture is clearer.

## Bull / Base / Bear

| Scenario | Probability | Thesis | Monitoring signal |
|---|---:|---|---|
| Bull | 25% | Helium compounds usage, liquidity improves, and HNT gains measurable value capture through staking, fees, collateral, or governance-controlled economics. | TVL up, fees visible, volume deepens, supply overhang falls |
...
**Confidence: 6.2 / 10.** The score is above neutral because Helium has enough source coverage and category relevance to justify a full report. It is below high conviction because several valuation-critical fields remain unresolved: durable fees, tokenholder capture, precise unlocks, and stress-tested liquidity.
...
The strongest bearish critique is simple: this could be a useful protocol with an average token. If HNT does not capture fees or security demand, the market will eventually value it as governance optionality plus liquidity beta. The second critique is data inconsistency. CG, CMC, Surf, and official docs can disagree on circulating supply, FDV, and market cap. The third critique is reflexive TVL: deposits can leave quickly when incentives, yields, or narratives change.
...
| 24h volume | $2.77M | Weekly | Volume below position-size threshold |
...
1. Re-run Surf project-detail and project-defi-metrics if Helium announces a major integration, listing, tokenomics change, exploit, or governance proposal.
...
This report intentionally separates source availability from source quality. Helium has a visible market footprint, but a visible footprint is not the same as a reconciled investment record. The Research Map standard treats CoinGecko and CoinMarketCap as discovery and market-data surfaces, Surf as an aggregation and refresh layer, DefiLlama style records as a protocol-usage lens, and official docs as the final arbiter for product mechanics. When these sources disagree, the disagreement itself is part of the thesis. A token with unclear supply methodology, mismatched contract labels, stale app docs, or broken dashboard coverage is usually harder to underwrite even when the narrative looks attractive.

For Helium, the first reconciliation job is identity. The token symbol is HNT, the category is DeFi infrastructure, chains are Solana, exchanges are BINANCE, COINBASE, BITHUMB, BYBIT, BITGET, and tags are DePIN (Physical Infra). These fields should be checked against official docs, token contracts, exchange market tabs, and community channels before the report graduates from watchlist to allocation candidate. If HNT trades on multiple chains, each contract should be mapped to a canonical issuer statement. If the same symbol is reused by another asset, exchange tickers and contract addresses must be treated as separate facts rather than as interchangeable labels. This matters because a fuzzy ticker match can make a good memo wrong at the first line.

The second reconciliation job is market data. Market cap is $43.72M, FDV is $43.72M, 24h volume is $2.77M, FDV / market cap is 1.00x, 7d price change is -9.29%, and 30d price change is -50.81%. These numbers need a vendor-drift check. If CMC reports a different circulating supply from CoinGecko or Surf, the memo should prefer the official unlock and circulating-supply definition, then keep the aggregator spread as a risk note. If volume is dominated by one venue, the liquidity score should be lower than the headline volume implies. If FDV is not disclosed or total supply is missing, the base case should assume worse dilution until proven otherwise.
...
|---|---|---|
| Identity | Helium / HNT | Match official docs, CG, CMC, Surf, contracts |
...
| Peer comparison | Monthly | Helium gains share with better economics | Peers grow faster with cleaner capture |

## Evidence Ledger

| # | Source | Link | Why it matters |
|---:|---|---|---|
| 1 | Official website | [link](https://www.helium.com/) | Identity, market, social, contract, or discovery cross-check |
| 2 | CoinGecko search | [link](https://www.coingecko.com/en/search?query=Helium) | Identity, market, social, contract, or discovery cross-check |
| 3 | CoinMarketCap discovery | [link](https://coinmarketcap.com/search/?q=Helium) | Identity, market, social, contract, or discovery cross-check |
| 4 | DefiLlama protocol discovery | [link](https://defillama.com/search?query=Helium) | Identity, market, social, contract, or discovery cross-check |
| 5 | Token Terminal discovery | [link](https://tokenterminal.com/explorer?search=Helium) | Identity, market, social, contract, or discovery cross-check |
| 6 | Messari discovery | [link](https://messari.io/search?q=Helium) | Identity, market, social, contract, or discovery cross-check |
| 7 | X profile | [link](https://x.com/helium) | Identity, market, social, contract, or discovery cross-check |
| 8 | GitHub | [link](https://github.com/helium) | Identity, market, social, contract, or discovery cross-check |
| 9 | Telegram | [link](https://t.me/helium_network) | Identity, market, social, contract, or discovery cross-check |
| 10 | Discord | [link](https://discord.com/invite/helium) | Identity, market, social, contract, or discovery cross-check |
| 11 | Helium Price: HNT/USD Live Price Chart, Market Cap ... | [link](https://www.coingecko.com/en/coins/helium) | Identity, market, social, contract, or discovery cross-check |
| 12 | Helium Mobile Price Chart (MOBILE) | [link](https://www.coingecko.com/en/coins/helium-mobile) | Identity, market, social, contract, or discovery cross-check |
| 13 | The Helium Network Token / Helium Documentation | [link](https://docs.helium.com/tokens/hnt-token/) | Identity, market, social, contract, or discovery cross-check |
| 14 | What Is Helium (HNT)? Features, Tokenomics, and Price ... | [link](https://coinmarketcap.com/academy/article/what-is-helium-hnt-features-tokenomics-and-price-prediction) | Identity, market, social, contract, or discovery cross-check |
| 15 | What is Helium (HNT)? | [link](https://www.coingecko.com/learn/what-is-helium-hnt) | Identity, market, social, contract, or discovery cross-check |
| 16 | solana HNT | [link](https://solscan.io/token/hntyVP6YFm1Hg25TN9WGLqM12b8TQmcknKrdu1oxWux) | Identity, market, social, contract, or discovery cross-check |
| 17 | solana MOBILE | [link](https://solscan.io/token/mb1eu7TzEc71KxDpsmsKoucSSuuoGLv1drys1oP2jh6) | Identity, market, social, contract, or discovery cross-check |
| 18 | solana IOT | [link](https://solscan.io/token/iotEVVZLEywoTn1QdwNPddxPWszn3zFhEot3MfL9fns) | Identity, market, social, contract, or discovery cross-check |
| 19 | Google project search | [link](https://www.google.com/search?q=Helium%20HNT%20crypto) | Identity, market, social, contract, or discovery cross-check |
| 20 | Google tokenomics search | [link](https://www.google.com/search?q=Helium%20HNT%20tokenomics) | Identity, market, social, contract, or discovery cross-check |
| 21 | Google docs search | [link](https://www.google.com/search?q=Helium%20docs) | Identity, market, social, contract, or discovery cross-check |
| 22 | Google governance search | [link](https://www.google.com/search?q=Helium%20governance%20proposal) | Identity, market, social, contract, or discovery cross-check |
| 23 | Google audit search | [link](https://www.google.com/search?q=Helium%20audit%20report) | Identity, market, social, contract, or discovery cross-check |
| 24 | CoinMarketCap what-is guess | [link](https://coinmarketcap.com/cmc-ai/helium/what-is/) | Identity, market, social, contract, or discovery cross-check |
| 25 | CoinMarketCap price analysis guess | [link](https://coinmarketcap.com/cmc-ai/helium/price-analysis/) | Identity, market, social, contract, or discovery cross-check |
| 26 | CoinMarketCap currency guess | [link](https://coinmarketcap.com/currencies/helium/) | Identity, market, social, contract, or discovery cross-check |
| 27 | Dune discovery | [link](https://dune.com/browse/dashboards?q=Helium) | Identity, market, social, contract, or discovery cross-check |
| 28 | Dune token query | [link](https://dune.com/browse/queries?q=Helium) | Identity, market, social, contract, or discovery cross-check |
| 29 | DeFiLlama fees discovery | [link](https://defillama.com/fees?chain=All&search=Helium) | Identity, market, social, contract, or discovery cross-check |
| 30 | DeFiLlama yield discovery | [link](https://defillama.com/yields?token=HNT) | Identity, market, social, contract, or discovery cross-check |
| 31 | TokenUnlocks search | [link](https://token.unlocks.app/?search=Helium) | Identity, market, social, contract, or discovery cross-check |
| 32 | CryptoRank search | [link](https://cryptorank.io/price/helium) | Identity, market, social, contract, or discovery cross-check |
| 33 | RootData search | [link](https://www.rootdata.com/search?kw=Helium) | Identity, market, social, contract, or discovery cross-check |
| 34 | CoinDesk search | [link](https://www.coindesk.com/search?s=Helium) | Identity, market, social, contract, or discovery cross-check |

Additional direct source list:

- [Official website](https://www.helium.com/)
- [CoinGecko search](https://www.coingecko.com/en/search?query=Helium)
- [CoinMarketCap discovery](https://coinmarketcap.com/search/?q=Helium)
- [DefiLlama protocol discovery](https://defillama.com/search?query=Helium)
- [Token Terminal discovery](https://tokenterminal.com/explorer?search=Helium)
- [Messari discovery](https://messari.io/search?q=Helium)
- [X profile](https://x.com/helium)
- [GitHub](https://github.com/helium)
- [Telegram](https://t.me/helium_network)
- [Discord](https://discord.com/invite/helium)
- [Helium Price: HNT/USD Live Price Chart, Market Cap ...](https://www.coingecko.com/en/coins/helium)
- [Helium Mobile Price Chart (MOBILE)](https://www.coingecko.com/en/coins/helium-mobile)
- [The Helium Network Token | Helium Documentation](https://docs.helium.com/tokens/hnt-token/)
- [What Is Helium (HNT)? Features, Tokenomics, and Price ...](https://coinmarketcap.com/academy/article/what-is-helium-hnt-features-tokenomics-and-price-prediction)
- [What is Helium (HNT)?](https://www.coingecko.com/learn/what-is-helium-hnt)
- [solana HNT](https://solscan.io/token/hntyVP6YFm1Hg25TN9WGLqM12b8TQmcknKrdu1oxWux)
- [solana MOBILE](https://solscan.io/token/mb1eu7TzEc71KxDpsmsKoucSSuuoGLv1drys1oP2jh6)
- [solana IOT](https://solscan.io/token/iotEVVZLEywoTn1QdwNPddxPWszn3zFhEot3MfL9fns)
- [Google project search](https://www.google.com/search?q=Helium%20HNT%20crypto)
- [Google tokenomics search](https://www.google.com/search?q=Helium%20HNT%20tokenomics)
- [Google docs search](https://www.google.com/search?q=Helium%20docs)
- [Google governance search](https://www.google.com/search?q=Helium%20governance%20proposal)
- [Google audit search](https://www.google.com/search?q=Helium%20audit%20report)
- [CoinMarketCap what-is guess](https://coinmarketcap.com/cmc-ai/helium/what-is/)
