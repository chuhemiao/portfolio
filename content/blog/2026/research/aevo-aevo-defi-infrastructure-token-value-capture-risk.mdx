---
title: 'Aevo / AEVO: DeFi infrastructure value capture, liquidity, and token risk'
publishedAt: '2026-07-06'
summary: 'Aevo is treated as a DeFi infrastructure watchlist candidate sourced from CoinGecko/CMC discovery and refreshed with Surf, with emphasis on product durability, token value capture, liquidity, supply, and execution risk.'
slug: 'aevo-aevo-defi-infrastructure-token-value-capture-risk'
category: 'research'
---

# Aevo / AEVO: DeFi infrastructure value capture, liquidity, and token risk

## Pre-screen Decision

**Decision: add to Research Map as a full-depth watchlist report, not as an automatic accumulation call.** Aevo appears in the local CoinGecko/CMC-oriented candidate pool through market discovery and was refreshed with Surf on 2026-07-06. The project has enough protocol surface for a real memo: chain exposure is Ethereum; exchange exposure is BINANCE, OKX, BYBIT, BITGET; category tags are Derivatives (Perp/Option), Layer2 & Scaling; current market cap is $17.53M; FDV is $19.12M; and 24h volume is $4.40M. That combination makes it worth researching, but not enough to override the main risks: token value capture may be indirect, liquidity can be fragile, supply methodology may differ across data vendors, and protocol usage can be incentive-sensitive.

The report uses a conservative watchlist standard. A pass means the project deserves monitoring and comparison against peers. It does not mean the token is cheap. A fail would require one of three red flags: no identifiable official/project surface, no meaningful market or DeFi data, or a high-confidence duplicate in the Research Map. Local duplicate checks did not flag Aevo before this file was created, and the existing candidate note says: Seeded 2026-07-06 from Surf market-ranking; rank 890, market cap $17,559,983, 24h volume $4,253,076. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.

## TL;DR / Executive Summary

Aevo is best understood as a **DeFi infrastructure** asset where the product thesis and the token thesis must be separated. The product thesis asks whether users, validators, LPs, borrowers, or asset issuers have a durable reason to use the protocol. The token thesis asks whether AEVO captures that activity through fees, staking, collateral, governance, liquidity routing, protocol-owned assets, or emissions control. The available evidence supports a watchlist entry, especially because it has a visible data footprint across Surf, CoinGecko, CMC discovery, and DeFi-oriented candidate notes. The evidence does not yet support a high-conviction valuation without better fee/revenue, unlock, treasury, and user-retention disclosure.
...
Base case: Aevo remains a selective watchlist asset until token value capture is cleaner. Bull case: protocol usage and token mechanics converge, turning AEVO into a security, collateral, or fee-routing asset with real demand. Bear case: the protocol remains useful but token holders absorb dilution, thin liquidity, governance optionality, or regulatory/technical tail risk.

## Project Overview

Aevo is a decentralized derivatives exchange and the first Derivatives L2, focused on options and perpetuals with an order-book, high-performance matching engine running on a custom EVM rollup to Ethereum. It provides APIs/SDKs for professional traders, staking and incentive programs, and the AEVO token for governance and ecosystem incentives.

Surf's project profile maps Aevo to the following high-level surface:

| Area | Evidence |
|---|---|
| Website | not disclosed |
| X handle | [@aevoxyz](https://x.com/aevoxyz) |
| X followers | 121.99K |
...
| Liquidity | $4.40M 24h volume | Deeper CEX/DEX books and less fragmented contract liquidity |
| Supply quality | 917.16M circulating vs 1.00B total | Official unlock schedule and reconciled circulating methodology |
| Downside containment | Watchlist only | Transparent treasury, audits, risk controls, and stress-test history |

The strongest reason to add the report is not that Aevo is obviously cheap. It is that the project is large or specific enough to track in the Research Map, and the current candidate backlog indicates it had not yet been covered locally.
...
|---|---|---|---|
| ethereum | AEVO | 0xb528edbef013aff855ac3c50b381f253af13b997 | [explorer](https://etherscan.io/token/0xb528edbef013aff855ac3c50b381f253af13b997) |
...
The market intelligence layer has three parts: DeFi usage, market liquidity, and attention. For Aevo, the DeFi-oriented backlog note is the first signal: Seeded 2026-07-06 from Surf market-ranking; rank 890, market cap $17,559,983, 24h volume $4,253,076. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.. Surf/CG data then adds market cap $17.53M, FDV $19.12M, 24h volume $4.40M, and price $0.0191.
...
| 24h volume | $4.40M | Position sizing and exit liquidity proxy |
| Market cap | $17.53M | Liquid valuation proxy |
| FDV | $19.12M | Dilution-aware valuation proxy |
| FDV / market cap spread | 1.09x | Higher spread means more supply risk |
| X followers | 121.99K | Attention proxy, not adoption proof |
...
| Accrual channel | Strength for Aevo | Evidence needed |
|---|---|---|
...
| Staking / security | Depends on whether AEVO is bonded or slashable | Staking contracts, validator docs, reward schedule |
...
The fifth frame is reflexivity. Many DeFi and infrastructure assets reprice in waves: first through TVL and listings, then through fee visibility, then through tokenomics cleanup, and finally through real cash-flow or strategic acquisition narratives. Aevo currently needs to be monitored through that sequence. The available 90-day TVL series has 0 point(s), latest TVL not disclosed, and approximate change not disclosed. Market-price movement shows 7d -1.01% and 30d 0.32% when Surf or CoinGecko exposed the field. If TVL and price move together, the thesis may be simple beta. If TVL rises while price lags, the thesis becomes value-capture skepticism. If price rises while TVL falls, the thesis becomes momentum without fundamental confirmation.

The conservative conclusion is that Aevo's product relevance may be ahead of its token value capture. That is common in this sector. The report should therefore watch for activation events: fee switch, staking redesign, revenue dashboard, cap increases, major integrations, or emissions reductions.
...
|---|---|---|---|
| 2024-05-21 | Undisclosed | not disclosed | YZi Labs (Prev. Binance Labs) |
| 2024-03-14 | Undisclosed | not disclosed | Pantera Capital |

| Team member | Role | Link |
|---|---|---|
| Julian Koh | Co-Founder | [X](https://twitter.com/juliankoh) |
| Ken Chan | Co-Founder | [X](https://twitter.com/kenchangh) |
| Gabriel Ravindran | COO | [X](https://twitter.com/GabrielRav) |
| Karon Pangestu | Head of Growth | [X](https://twitter.com/pangestu_karon) |
| Jeremy Obadia | Head of Derivatives | [X](https://twitter.com/obadje_) |
...
Aevo competes in the DeFi infrastructure bucket, where category peers vary by exact design. The memo uses functional competitors rather than only ticker competitors:
...
The key competitive question is whether Aevo has a reason to exist beyond incentives. If switching costs are low and users are primarily chasing emissions, any valuation premium should be temporary. If the protocol controls a scarce integration point, compliance rail, validator layer, or liquidity venue, it can deserve a persistent watchlist premium.
...
Weighted conclusion: Aevo is important enough to track, but not clean enough to rank as a high-conviction token until economic capture is clearer.

## Bull / Base / Bear

| Scenario | Probability | Thesis | Monitoring signal |
|---|---:|---|---|
| Bull | 25% | Aevo compounds usage, liquidity improves, and AEVO gains measurable value capture through staking, fees, collateral, or governance-controlled economics. | TVL up, fees visible, volume deepens, supply overhang falls |
...
**Confidence: 6.2 / 10.** The score is above neutral because Aevo has enough source coverage and category relevance to justify a full report. It is below high conviction because several valuation-critical fields remain unresolved: durable fees, tokenholder capture, precise unlocks, and stress-tested liquidity.
...
The strongest bearish critique is simple: this could be a useful protocol with an average token. If AEVO does not capture fees or security demand, the market will eventually value it as governance optionality plus liquidity beta. The second critique is data inconsistency. CG, CMC, Surf, and official docs can disagree on circulating supply, FDV, and market cap. The third critique is reflexive TVL: deposits can leave quickly when incentives, yields, or narratives change.
...
| 24h volume | $4.40M | Weekly | Volume below position-size threshold |
...
1. Re-run Surf project-detail and project-defi-metrics if Aevo announces a major integration, listing, tokenomics change, exploit, or governance proposal.
...
|---|---|---|
| Identity | Aevo / AEVO | Match official docs, CG, CMC, Surf, contracts |
...
For Aevo, the current liquidity read is watchlist first. The market cap is $17.53M, FDV is $19.12M, reported 24h volume is $4.40M, and FDV / market cap is 1.09x. These values can support a research card, but they do not automatically support an investment. A cleaner setup would show stable volume across multiple venues, narrow spreads, less reliance on a single pair, and a supply schedule that does not create a near-term wall of unlock pressure.
...
| Peer comparison | Monthly | Aevo gains share with better economics | Peers grow faster with cleaner capture |

## Evidence Ledger

| # | Source | Link | Why it matters |
|---:|---|---|---|
| 1 | CoinGecko search | [link](https://www.coingecko.com/en/search?query=Aevo) | Identity, market, social, contract, or discovery cross-check |
| 2 | CoinMarketCap discovery | [link](https://coinmarketcap.com/search/?q=Aevo) | Identity, market, social, contract, or discovery cross-check |
| 3 | DefiLlama protocol discovery | [link](https://defillama.com/search?query=Aevo) | Identity, market, social, contract, or discovery cross-check |
| 4 | Token Terminal discovery | [link](https://tokenterminal.com/explorer?search=Aevo) | Identity, market, social, contract, or discovery cross-check |
| 5 | Messari discovery | [link](https://messari.io/search?q=Aevo) | Identity, market, social, contract, or discovery cross-check |
| 6 | X profile | [link](https://x.com/aevoxyz) | Identity, market, social, contract, or discovery cross-check |
| 7 | GitHub | [link](https://github.com/aevoxyz) | Identity, market, social, contract, or discovery cross-check |
| 8 | Discord | [link](https://discord.com/invite/aevo) | Identity, market, social, contract, or discovery cross-check |
| 9 | AEVO/USD Live Price Chart, Market Cap & News Today - CoinGecko | [link](https://www.coingecko.com/en/coins/aevo) | Identity, market, social, contract, or discovery cross-check |
| 10 | What Is Aevo (AEVO) And How Does It Work? - CoinMarketCap | [link](https://coinmarketcap.com/cmc-ai/aevo/what-is/) | Identity, market, social, contract, or discovery cross-check |
| 11 | Aevo Statistics: Markets, Trading Volume & Trust Score / CoinGecko | [link](https://www.coingecko.com/en/exchanges/aevo) | Identity, market, social, contract, or discovery cross-check |
| 12 | AEVO to BTC: Aevo Price in Bitcoin - CoinGecko | [link](https://www.coingecko.com/en/coins/aevo/btc) | Identity, market, social, contract, or discovery cross-check |
| 13 | Guide to Improving Aevo Airdrop Eligibility - CoinGecko | [link](https://www.coingecko.com/learn/aevo-airdrop) | Identity, market, social, contract, or discovery cross-check |
| 14 | ethereum AEVO | [link](https://etherscan.io/token/0xb528edbef013aff855ac3c50b381f253af13b997) | Identity, market, social, contract, or discovery cross-check |
| 15 | Google project search | [link](https://www.google.com/search?q=Aevo%20AEVO%20crypto) | Identity, market, social, contract, or discovery cross-check |
| 16 | Google tokenomics search | [link](https://www.google.com/search?q=Aevo%20AEVO%20tokenomics) | Identity, market, social, contract, or discovery cross-check |
| 17 | Google docs search | [link](https://www.google.com/search?q=Aevo%20docs) | Identity, market, social, contract, or discovery cross-check |
| 18 | Google governance search | [link](https://www.google.com/search?q=Aevo%20governance%20proposal) | Identity, market, social, contract, or discovery cross-check |
| 19 | Google audit search | [link](https://www.google.com/search?q=Aevo%20audit%20report) | Identity, market, social, contract, or discovery cross-check |
| 20 | CoinMarketCap price analysis guess | [link](https://coinmarketcap.com/cmc-ai/aevo/price-analysis/) | Identity, market, social, contract, or discovery cross-check |
| 21 | CoinMarketCap currency guess | [link](https://coinmarketcap.com/currencies/aevo/) | Identity, market, social, contract, or discovery cross-check |
| 22 | Dune discovery | [link](https://dune.com/browse/dashboards?q=Aevo) | Identity, market, social, contract, or discovery cross-check |
| 23 | Dune token query | [link](https://dune.com/browse/queries?q=Aevo) | Identity, market, social, contract, or discovery cross-check |
| 24 | DeFiLlama fees discovery | [link](https://defillama.com/fees?chain=All&search=Aevo) | Identity, market, social, contract, or discovery cross-check |
| 25 | DeFiLlama yield discovery | [link](https://defillama.com/yields?token=AEVO) | Identity, market, social, contract, or discovery cross-check |
| 26 | TokenUnlocks search | [link](https://token.unlocks.app/?search=Aevo) | Identity, market, social, contract, or discovery cross-check |
| 27 | CryptoRank search | [link](https://cryptorank.io/price/aevo) | Identity, market, social, contract, or discovery cross-check |
| 28 | RootData search | [link](https://www.rootdata.com/search?kw=Aevo) | Identity, market, social, contract, or discovery cross-check |
| 29 | CoinDesk search | [link](https://www.coindesk.com/search?s=Aevo) | Identity, market, social, contract, or discovery cross-check |
| 30 | The Block search | [link](https://www.theblock.co/search?query=Aevo) | Identity, market, social, contract, or discovery cross-check |
| 31 | GitHub search | [link](https://github.com/search?q=Aevo&type=repositories) | Identity, market, social, contract, or discovery cross-check |
| 32 | Etherscan token search | [link](https://etherscan.io/search?f=0&q=AEVO) | Identity, market, social, contract, or discovery cross-check |
| 33 | BscScan token search | [link](https://bscscan.com/search?f=0&q=AEVO) | Identity, market, social, contract, or discovery cross-check |
| 34 | Arbiscan token search | [link](https://arbiscan.io/search?f=0&q=AEVO) | Identity, market, social, contract, or discovery cross-check |

Additional direct source list:

- [CoinGecko search](https://www.coingecko.com/en/search?query=Aevo)
- [CoinMarketCap discovery](https://coinmarketcap.com/search/?q=Aevo)
- [DefiLlama protocol discovery](https://defillama.com/search?query=Aevo)
- [Token Terminal discovery](https://tokenterminal.com/explorer?search=Aevo)
- [Messari discovery](https://messari.io/search?q=Aevo)
- [X profile](https://x.com/aevoxyz)
- [GitHub](https://github.com/aevoxyz)
- [Discord](https://discord.com/invite/aevo)
- [AEVO/USD Live Price Chart, Market Cap & News Today - CoinGecko](https://www.coingecko.com/en/coins/aevo)
- [What Is Aevo (AEVO) And How Does It Work? - CoinMarketCap](https://coinmarketcap.com/cmc-ai/aevo/what-is/)
- [Aevo Statistics: Markets, Trading Volume & Trust Score | CoinGecko](https://www.coingecko.com/en/exchanges/aevo)
- [AEVO to BTC: Aevo Price in Bitcoin - CoinGecko](https://www.coingecko.com/en/coins/aevo/btc)
- [Guide to Improving Aevo Airdrop Eligibility - CoinGecko](https://www.coingecko.com/learn/aevo-airdrop)
- [ethereum AEVO](https://etherscan.io/token/0xb528edbef013aff855ac3c50b381f253af13b997)
- [Google project search](https://www.google.com/search?q=Aevo%20AEVO%20crypto)
- [Google tokenomics search](https://www.google.com/search?q=Aevo%20AEVO%20tokenomics)
- [Google docs search](https://www.google.com/search?q=Aevo%20docs)
- [Google governance search](https://www.google.com/search?q=Aevo%20governance%20proposal)
- [Google audit search](https://www.google.com/search?q=Aevo%20audit%20report)
- [CoinMarketCap price analysis guess](https://coinmarketcap.com/cmc-ai/aevo/price-analysis/)
- [CoinMarketCap currency guess](https://coinmarketcap.com/currencies/aevo/)
- [Dune discovery](https://dune.com/browse/dashboards?q=Aevo)
- [Dune token query](https://dune.com/browse/queries?q=Aevo)
- [DeFiLlama fees discovery](https://defillama.com/fees?chain=All&search=Aevo)

## Final Investment View

Aevo should be in the Research Map as a **watchlist / selective diligence** asset. The project has enough category relevance and data footprint to merit ongoing coverage, especially because it came from the CG/CMC-oriented candidate workflow and has no high-confidence local duplicate. The current evidence does not yet support a high-conviction allocation thesis. The next level of confidence requires cleaner token economics: fee capture, staking or collateral utility, transparent unlocks, and liquidity that can support realistic position sizing.
