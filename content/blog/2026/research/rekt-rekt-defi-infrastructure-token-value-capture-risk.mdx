---
title: 'Rekt / REKT: DeFi infrastructure value capture, liquidity, and token risk'
publishedAt: '2026-07-06'
summary: 'Rekt is treated as a DeFi infrastructure watchlist candidate sourced from CoinGecko/CMC discovery and refreshed with Surf, with emphasis on product durability, token value capture, liquidity, supply, and execution risk.'
slug: 'rekt-rekt-defi-infrastructure-token-value-capture-risk'
category: 'research'
---

# Rekt / REKT: DeFi infrastructure value capture, liquidity, and token risk

## Pre-screen Decision

**Decision: add to Research Map as a full-depth watchlist report, not as an automatic accumulation call.** Rekt appears in the local CoinGecko/CMC-oriented candidate pool through market discovery and was refreshed with Surf on 2026-07-06. The project has enough protocol surface for a real memo: chain exposure is Abstract, Avalanche, Base, Binance Smart Chain, Ethereum, HyperEVM, Solana; exchange exposure is BINANCE ALPHA; category tags are Meme, NFT Collections; current market cap is $36.07M; FDV is $36.07M; and 24h volume is $664.70K. That combination makes it worth researching, but not enough to override the main risks: token value capture may be indirect, liquidity can be fragile, supply methodology may differ across data vendors, and protocol usage can be incentive-sensitive.

The report uses a conservative watchlist standard. A pass means the project deserves monitoring and comparison against peers. It does not mean the token is cheap. A fail would require one of three red flags: no identifiable official/project surface, no meaningful market or DeFi data, or a high-confidence duplicate in the Research Map. Local duplicate checks did not flag Rekt before this file was created, and the existing candidate note says: Seeded 2026-07-06 from Surf market-ranking; rank 565, market cap $35,565,316, 24h volume $644,642. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.

## TL;DR / Executive Summary

Rekt is best understood as a **DeFi infrastructure** asset where the product thesis and the token thesis must be separated. The product thesis asks whether users, validators, LPs, borrowers, or asset issuers have a durable reason to use the protocol. The token thesis asks whether REKT captures that activity through fees, staking, collateral, governance, liquidity routing, protocol-owned assets, or emissions control. The available evidence supports a watchlist entry, especially because it has a visible data footprint across Surf, CoinGecko, CMC discovery, and DeFi-oriented candidate notes. The evidence does not yet support a high-conviction valuation without better fee/revenue, unlock, treasury, and user-retention disclosure.
...
| Chains | Abstract, Avalanche, Base, Binance Smart Chain, Ethereum, HyperEVM, Solana |
| Exchanges | BINANCE ALPHA |
| Price | $0.0000 |
| Market cap | $36.07M |
| FDV | $36.07M |
| 24h volume | $664.70K |
| Circulating supply | 420690.00B |
| Total supply | 420690.00B |
...
Base case: Rekt remains a selective watchlist asset until token value capture is cleaner. Bull case: protocol usage and token mechanics converge, turning REKT into a security, collateral, or fee-routing asset with real demand. Bear case: the protocol remains useful but token holders absorb dilution, thin liquidity, governance optionality, or regulatory/technical tail risk.

## Project Overview

Rekt (REKT) is a meme-brand token that powers the Rekt Brands ecosystem — including Rekt Drinks, the Rektguy NFT collection, art, events, and media — functioning as a community-driven “brand coin.” It is deployed across multiple chains to deliver membership, utility, and access within the project’s consumer-product and NFT-focused verticals.

Surf's project profile maps Rekt to the following high-level surface:

| Area | Evidence |
|---|---|
| Website | [https://www.rektcoin.com/](https://www.rektcoin.com/) |
| X handle | [@RektCoin](https://x.com/RektCoin) |
| X followers | 47.22K |
...
| Liquidity | $664.70K 24h volume | Deeper CEX/DEX books and less fragmented contract liquidity |
| Supply quality | 420690.00B circulating vs 420690.00B total | Official unlock schedule and reconciled circulating methodology |
| Downside containment | Watchlist only | Transparent treasury, audits, risk controls, and stress-test history |

The strongest reason to add the report is not that Rekt is obviously cheap. It is that the project is large or specific enough to track in the Research Map, and the current candidate backlog indicates it had not yet been covered locally.
...
| Settlement layer | Chains and contracts that hold user value | Abstract, Avalanche, Base, Binance Smart Chain, Ethereum, HyperEVM, Solana |
...
|---|---|---|---|
| base | REKT | 0xb3e3c89b8d9c88b1fe96856e382959ee6291ebba | [explorer](https://basescan.org/token/0xb3e3c89b8d9c88b1fe96856e382959ee6291ebba) |
| solana | REKT | vQoYWru2pbUdcVkUrRH74ktQDJgVjRcDvsoDbUzM5n9 | [explorer](https://solscan.io/token/vQoYWru2pbUdcVkUrRH74ktQDJgVjRcDvsoDbUzM5n9) |
| Abstract | REKT | 0xd63b0e99303d51713f947195bf37188a943255a1 | not mapped |
| ethereum | REKT | 0xdd3b11ef34cd511a2da159034a05fcb94d806686 | [explorer](https://etherscan.io/token/0xdd3b11ef34cd511a2da159034a05fcb94d806686) |
| HyperEVM | REKT | 0xc12e26ab94d1e62f18373cf25e43afa7b2af1cdc | not mapped |
| avalanche | REKT | 0x0f875ae3eb1fc8a3289657676fc2a288585982a5 | [explorer](https://snowtrace.io/token/0x0f875ae3eb1fc8a3289657676fc2a288585982a5) |
| bsc | REKT | 0x20482b0b4d9d8f60d3ab432b92f4c4b901a0d10c | [explorer](https://bscscan.com/token/0x20482b0b4d9d8f60d3ab432b92f4c4b901a0d10c) |
...
The market intelligence layer has three parts: DeFi usage, market liquidity, and attention. For Rekt, the DeFi-oriented backlog note is the first signal: Seeded 2026-07-06 from Surf market-ranking; rank 565, market cap $35,565,316, 24h volume $644,642. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.. Surf/CG data then adds market cap $36.07M, FDV $36.07M, 24h volume $664.70K, and price $0.0000.
...
| 24h volume | $664.70K | Position sizing and exit liquidity proxy |
| Market cap | $36.07M | Liquid valuation proxy |
| FDV | $36.07M | Dilution-aware valuation proxy |
| FDV / market cap spread | 1.00x | Higher spread means more supply risk |
| X followers | 47.22K | Attention proxy, not adoption proof |
...
| Accrual channel | Strength for Rekt | Evidence needed |
|---|---|---|
...
| Staking / security | Depends on whether REKT is bonded or slashable | Staking contracts, validator docs, reward schedule |
...
The fifth frame is reflexivity. Many DeFi and infrastructure assets reprice in waves: first through TVL and listings, then through fee visibility, then through tokenomics cleanup, and finally through real cash-flow or strategic acquisition narratives. Rekt currently needs to be monitored through that sequence. The available 90-day TVL series has 0 point(s), latest TVL not disclosed, and approximate change not disclosed. Market-price movement shows 7d 19.27% and 30d 1.72% when Surf or CoinGecko exposed the field. If TVL and price move together, the thesis may be simple beta. If TVL rises while price lags, the thesis becomes value-capture skepticism. If price rises while TVL falls, the thesis becomes momentum without fundamental confirmation.

The conservative conclusion is that Rekt's product relevance may be ahead of its token value capture. That is common in this sector. The report should therefore watch for activation events: fee switch, staking redesign, revenue dashboard, cap increases, major integrations, or emissions reductions.
...
|---|---|---|---|
| 2024-11-21 | Ieo | $100.00K | not disclosed |
...
Rekt competes in the DeFi infrastructure bucket, where category peers vary by exact design. The memo uses functional competitors rather than only ticker competitors:
...
The key competitive question is whether Rekt has a reason to exist beyond incentives. If switching costs are low and users are primarily chasing emissions, any valuation premium should be temporary. If the protocol controls a scarce integration point, compliance rail, validator layer, or liquidity venue, it can deserve a persistent watchlist premium.
...
Weighted conclusion: Rekt is important enough to track, but not clean enough to rank as a high-conviction token until economic capture is clearer.

## Bull / Base / Bear

| Scenario | Probability | Thesis | Monitoring signal |
|---|---:|---|---|
| Bull | 25% | Rekt compounds usage, liquidity improves, and REKT gains measurable value capture through staking, fees, collateral, or governance-controlled economics. | TVL up, fees visible, volume deepens, supply overhang falls |
...
**Confidence: 6.2 / 10.** The score is above neutral because Rekt has enough source coverage and category relevance to justify a full report. It is below high conviction because several valuation-critical fields remain unresolved: durable fees, tokenholder capture, precise unlocks, and stress-tested liquidity.
...
The strongest bearish critique is simple: this could be a useful protocol with an average token. If REKT does not capture fees or security demand, the market will eventually value it as governance optionality plus liquidity beta. The second critique is data inconsistency. CG, CMC, Surf, and official docs can disagree on circulating supply, FDV, and market cap. The third critique is reflexive TVL: deposits can leave quickly when incentives, yields, or narratives change.
...
| 24h volume | $664.70K | Weekly | Volume below position-size threshold |
...
1. Re-run Surf project-detail and project-defi-metrics if Rekt announces a major integration, listing, tokenomics change, exploit, or governance proposal.
...
This report intentionally separates source availability from source quality. Rekt has a visible market footprint, but a visible footprint is not the same as a reconciled investment record. The Research Map standard treats CoinGecko and CoinMarketCap as discovery and market-data surfaces, Surf as an aggregation and refresh layer, DefiLlama style records as a protocol-usage lens, and official docs as the final arbiter for product mechanics. When these sources disagree, the disagreement itself is part of the thesis. A token with unclear supply methodology, mismatched contract labels, stale app docs, or broken dashboard coverage is usually harder to underwrite even when the narrative looks attractive.

For Rekt, the first reconciliation job is identity. The token symbol is REKT, the category is DeFi infrastructure, chains are Abstract, Avalanche, Base, Binance Smart Chain, Ethereum, HyperEVM, Solana, exchanges are BINANCE ALPHA, and tags are Meme, NFT Collections. These fields should be checked against official docs, token contracts, exchange market tabs, and community channels before the report graduates from watchlist to allocation candidate. If REKT trades on multiple chains, each contract should be mapped to a canonical issuer statement. If the same symbol is reused by another asset, exchange tickers and contract addresses must be treated as separate facts rather than as interchangeable labels. This matters because a fuzzy ticker match can make a good memo wrong at the first line.

The second reconciliation job is market data. Market cap is $36.07M, FDV is $36.07M, 24h volume is $664.70K, FDV / market cap is 1.00x, 7d price change is 19.27%, and 30d price change is 1.72%. These numbers need a vendor-drift check. If CMC reports a different circulating supply from CoinGecko or Surf, the memo should prefer the official unlock and circulating-supply definition, then keep the aggregator spread as a risk note. If volume is dominated by one venue, the liquidity score should be lower than the headline volume implies. If FDV is not disclosed or total supply is missing, the base case should assume worse dilution until proven otherwise.
...
|---|---|---|
| Identity | Rekt / REKT | Match official docs, CG, CMC, Surf, contracts |
| Category | DeFi infrastructure | Confirm product mechanics and revenue model |
| Chains | Abstract, Avalanche, Base, Binance Smart Chain, Ethereum, HyperEVM, Solana | Confirm canonical deployments and bridge assumptions |
| Exchanges | BINANCE ALPHA | Check live order books and inactive pairs |
| Market cap | $36.07M | Compare Surf, CG, CMC, exchange pages |
| FDV | $36.07M | Reconcile total supply and unlock schedule |
| Volume | $664.70K | Check exchange concentration and wash-trading risk |
| TVL | not disclosed | Confirm TVL meaning, source, and double-counting risk |

## Primary-source Diligence Work Plan

The next diligence pass should start from primary sources, not from the token chart. The first document to find is an official docs or whitepaper page that explains what Rekt does and where users interact with it. The second is tokenomics: allocation, emissions, unlocks, utility, fee routing, treasury policy, and governance rights. The third is security material: audits, bug bounty scope, incident post-mortems, admin-key disclosures, or upgrade timelocks. The fourth is usage evidence: live app metrics, dashboards, contract balances, fee dashboards, validator counts, loan books, LP depth, or stablecoin collateral reports. Without those four documents, any price target is mostly narrative.

For Rekt, the primary-source pass should answer a narrow sequence of questions. What user action creates protocol value? Who pays? Who receives the fee or spread? Does REKT sit inside that flow, or does it only vote on parameters? Can users exit without trusting a multisig, bridge, centralized custodian, or opaque off-chain book? What part of the system can be paused or upgraded? Which parameters would cause losses if changed incorrectly? If the project is young, which metrics prove organic adoption rather than incentives? If the project is mature, which metrics prove durability rather than slow decline?
...
For Rekt, the current liquidity read is watchlist first. The market cap is $36.07M, FDV is $36.07M, reported 24h volume is $664.70K, and FDV / market cap is 1.00x. These values can support a research card, but they do not automatically support an investment. A cleaner setup would show stable volume across multiple venues, narrow spreads, less reliance on a single pair, and a supply schedule that does not create a near-term wall of unlock pressure.
...
| Peer comparison | Monthly | Rekt gains share with better economics | Peers grow faster with cleaner capture |

## Evidence Ledger

| # | Source | Link | Why it matters |
|---:|---|---|---|
| 1 | Official website | [link](https://www.rektcoin.com/) | Identity, market, social, contract, or discovery cross-check |
| 2 | CoinGecko search | [link](https://www.coingecko.com/en/search?query=Rekt) | Identity, market, social, contract, or discovery cross-check |
| 3 | CoinMarketCap discovery | [link](https://coinmarketcap.com/search/?q=Rekt) | Identity, market, social, contract, or discovery cross-check |
| 4 | DefiLlama protocol discovery | [link](https://defillama.com/search?query=Rekt) | Identity, market, social, contract, or discovery cross-check |
| 5 | Token Terminal discovery | [link](https://tokenterminal.com/explorer?search=Rekt) | Identity, market, social, contract, or discovery cross-check |
| 6 | Messari discovery | [link](https://messari.io/search?q=Rekt) | Identity, market, social, contract, or discovery cross-check |
| 7 | X profile | [link](https://x.com/RektCoin) | Identity, market, social, contract, or discovery cross-check |
| 8 | Telegram | [link](https://t.me/rektbrands) | Identity, market, social, contract, or discovery cross-check |
| 9 | Discord | [link](https://discord.gg/rektguynft) | Identity, market, social, contract, or discovery cross-check |
| 10 | REKT/USD Live Price Chart, Market Cap & News Today - CoinGecko | [link](https://www.coingecko.com/en/coins/rekt-2) | Identity, market, social, contract, or discovery cross-check |
| 11 | REKT/USD Live Price Chart, Market Cap & News Today - CoinGecko | [link](https://www.coingecko.com/en/coins/rekt-arb) | Identity, market, social, contract, or discovery cross-check |
| 12 | REKT/USD Live Price Chart, Market Cap & News Today - CoinGecko | [link](https://www.coingecko.com/en/coins/rektcoin) | Identity, market, social, contract, or discovery cross-check |
| 13 | REKT (rekt.game) to USD Chart - CoinMarketCap | [link](https://coinmarketcap.com/currencies/rektcoin-new/) | Identity, market, social, contract, or discovery cross-check |
| 14 | REKT to ETH: $REKT Price in Ether / CoinGecko | [link](https://www.coingecko.com/en/coins/rektcoin/eth) | Identity, market, social, contract, or discovery cross-check |
| 15 | base REKT | [link](https://basescan.org/token/0xb3e3c89b8d9c88b1fe96856e382959ee6291ebba) | Identity, market, social, contract, or discovery cross-check |
| 16 | solana REKT | [link](https://solscan.io/token/vQoYWru2pbUdcVkUrRH74ktQDJgVjRcDvsoDbUzM5n9) | Identity, market, social, contract, or discovery cross-check |
| 17 | ethereum REKT | [link](https://etherscan.io/token/0xdd3b11ef34cd511a2da159034a05fcb94d806686) | Identity, market, social, contract, or discovery cross-check |
| 18 | avalanche REKT | [link](https://snowtrace.io/token/0x0f875ae3eb1fc8a3289657676fc2a288585982a5) | Identity, market, social, contract, or discovery cross-check |
| 19 | bsc REKT | [link](https://bscscan.com/token/0x20482b0b4d9d8f60d3ab432b92f4c4b901a0d10c) | Identity, market, social, contract, or discovery cross-check |
| 20 | Google project search | [link](https://www.google.com/search?q=Rekt%20REKT%20crypto) | Identity, market, social, contract, or discovery cross-check |
| 21 | Google tokenomics search | [link](https://www.google.com/search?q=Rekt%20REKT%20tokenomics) | Identity, market, social, contract, or discovery cross-check |
| 22 | Google docs search | [link](https://www.google.com/search?q=Rekt%20docs) | Identity, market, social, contract, or discovery cross-check |
| 23 | Google governance search | [link](https://www.google.com/search?q=Rekt%20governance%20proposal) | Identity, market, social, contract, or discovery cross-check |
| 24 | Google audit search | [link](https://www.google.com/search?q=Rekt%20audit%20report) | Identity, market, social, contract, or discovery cross-check |
| 25 | CoinMarketCap what-is guess | [link](https://coinmarketcap.com/cmc-ai/rekt/what-is/) | Identity, market, social, contract, or discovery cross-check |
| 26 | CoinMarketCap price analysis guess | [link](https://coinmarketcap.com/cmc-ai/rekt/price-analysis/) | Identity, market, social, contract, or discovery cross-check |
| 27 | CoinMarketCap currency guess | [link](https://coinmarketcap.com/currencies/rekt/) | Identity, market, social, contract, or discovery cross-check |
| 28 | Dune discovery | [link](https://dune.com/browse/dashboards?q=Rekt) | Identity, market, social, contract, or discovery cross-check |
| 29 | Dune token query | [link](https://dune.com/browse/queries?q=Rekt) | Identity, market, social, contract, or discovery cross-check |
| 30 | DeFiLlama fees discovery | [link](https://defillama.com/fees?chain=All&search=Rekt) | Identity, market, social, contract, or discovery cross-check |
| 31 | DeFiLlama yield discovery | [link](https://defillama.com/yields?token=REKT) | Identity, market, social, contract, or discovery cross-check |
| 32 | TokenUnlocks search | [link](https://token.unlocks.app/?search=Rekt) | Identity, market, social, contract, or discovery cross-check |
| 33 | CryptoRank search | [link](https://cryptorank.io/price/rekt) | Identity, market, social, contract, or discovery cross-check |
| 34 | RootData search | [link](https://www.rootdata.com/search?kw=Rekt) | Identity, market, social, contract, or discovery cross-check |

Additional direct source list:

- [Official website](https://www.rektcoin.com/)
- [CoinGecko search](https://www.coingecko.com/en/search?query=Rekt)
- [CoinMarketCap discovery](https://coinmarketcap.com/search/?q=Rekt)
- [DefiLlama protocol discovery](https://defillama.com/search?query=Rekt)
- [Token Terminal discovery](https://tokenterminal.com/explorer?search=Rekt)
- [Messari discovery](https://messari.io/search?q=Rekt)
- [X profile](https://x.com/RektCoin)
- [Telegram](https://t.me/rektbrands)
- [Discord](https://discord.gg/rektguynft)
- [REKT/USD Live Price Chart, Market Cap & News Today - CoinGecko](https://www.coingecko.com/en/coins/rekt-2)
- [REKT/USD Live Price Chart, Market Cap & News Today - CoinGecko](https://www.coingecko.com/en/coins/rekt-arb)
- [REKT/USD Live Price Chart, Market Cap & News Today - CoinGecko](https://www.coingecko.com/en/coins/rektcoin)
- [REKT (rekt.game) to USD Chart - CoinMarketCap](https://coinmarketcap.com/currencies/rektcoin-new/)
- [REKT to ETH: $REKT Price in Ether | CoinGecko](https://www.coingecko.com/en/coins/rektcoin/eth)
- [base REKT](https://basescan.org/token/0xb3e3c89b8d9c88b1fe96856e382959ee6291ebba)
- [solana REKT](https://solscan.io/token/vQoYWru2pbUdcVkUrRH74ktQDJgVjRcDvsoDbUzM5n9)
- [ethereum REKT](https://etherscan.io/token/0xdd3b11ef34cd511a2da159034a05fcb94d806686)
- [avalanche REKT](https://snowtrace.io/token/0x0f875ae3eb1fc8a3289657676fc2a288585982a5)
- [bsc REKT](https://bscscan.com/token/0x20482b0b4d9d8f60d3ab432b92f4c4b901a0d10c)
- [Google project search](https://www.google.com/search?q=Rekt%20REKT%20crypto)
- [Google tokenomics search](https://www.google.com/search?q=Rekt%20REKT%20tokenomics)
- [Google docs search](https://www.google.com/search?q=Rekt%20docs)
- [Google governance search](https://www.google.com/search?q=Rekt%20governance%20proposal)
- [Google audit search](https://www.google.com/search?q=Rekt%20audit%20report)

## Final Investment View

Rekt should be in the Research Map as a **watchlist / selective diligence** asset. The project has enough category relevance and data footprint to merit ongoing coverage, especially because it came from the CG/CMC-oriented candidate workflow and has no high-confidence local duplicate. The current evidence does not yet support a high-conviction allocation thesis. The next level of confidence requires cleaner token economics: fee capture, staking or collateral utility, transparent unlocks, and liquidity that can support realistic position sizing.
