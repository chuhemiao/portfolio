---
title: 'WAX / WAXP: DeFi infrastructure value capture, liquidity, and token risk'
publishedAt: '2026-07-06'
summary: 'WAX is treated as a DeFi infrastructure watchlist candidate sourced from CoinGecko/CMC discovery and refreshed with Surf, with emphasis on product durability, token value capture, liquidity, supply, and execution risk.'
slug: 'wax-waxp-defi-infrastructure-token-value-capture-risk'
category: 'research'
---

# WAX / WAXP: DeFi infrastructure value capture, liquidity, and token risk

## Pre-screen Decision

**Decision: add to Research Map as a full-depth watchlist report, not as an automatic accumulation call.** WAX appears in the local CoinGecko/CMC-oriented candidate pool through market discovery and was refreshed with Surf on 2026-07-06. The project has enough protocol surface for a real memo: chain exposure is Ethereum, WAX; exchange exposure is BINANCE, UPBIT, OKX, BITHUMB, BYBIT, BITGET; category tags are Gaming Infra, Layer1; current market cap is $19.65M; FDV is $19.65M; and 24h volume is $1.04M. That combination makes it worth researching, but not enough to override the main risks: token value capture may be indirect, liquidity can be fragile, supply methodology may differ across data vendors, and protocol usage can be incentive-sensitive.

The report uses a conservative watchlist standard. A pass means the project deserves monitoring and comparison against peers. It does not mean the token is cheap. A fail would require one of three red flags: no identifiable official/project surface, no meaningful market or DeFi data, or a high-confidence duplicate in the Research Map. Local duplicate checks did not flag WAX before this file was created, and the existing candidate note says: Seeded 2026-07-06 from Surf market-ranking; rank 833, market cap $19,811,482, 24h volume $818,816. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.

## TL;DR / Executive Summary

WAX is best understood as a **DeFi infrastructure** asset where the product thesis and the token thesis must be separated. The product thesis asks whether users, validators, LPs, borrowers, or asset issuers have a durable reason to use the protocol. The token thesis asks whether WAXP captures that activity through fees, staking, collateral, governance, liquidity routing, protocol-owned assets, or emissions control. The available evidence supports a watchlist entry, especially because it has a visible data footprint across Surf, CoinGecko, CMC discovery, and DeFi-oriented candidate notes. The evidence does not yet support a high-conviction valuation without better fee/revenue, unlock, treasury, and user-retention disclosure.
...
Base case: WAX remains a selective watchlist asset until token value capture is cleaner. Bull case: protocol usage and token mechanics converge, turning WAXP into a security, collateral, or fee-routing asset with real demand. Bear case: the protocol remains useful but token holders absorb dilution, thin liquidity, governance optionality, or regulatory/technical tail risk.

## Project Overview

WAX is a purpose-built, carbon-neutral blockchain and protocol focused on NFTs, gaming, and virtual-asset marketplaces, offering tools like WAX Cloud Wallet, bridges, and developer SDKs. Its native token WAXP powers transactions, staking and governance on a high-throughput DPoS network optimized for e-commerce and game economies.

Surf's project profile maps WAX to the following high-level surface:

| Area | Evidence |
|---|---|
| Website | [https://on.wax.io/wax-io/](https://on.wax.io/wax-io/) |
| X handle | [@WAX_io](https://x.com/WAX_io) |
| X followers | 269.02K |
...
| Liquidity | $1.04M 24h volume | Deeper CEX/DEX books and less fragmented contract liquidity |
| Supply quality | 4.64B circulating vs 4.64B total | Official unlock schedule and reconciled circulating methodology |
| Downside containment | Watchlist only | Transparent treasury, audits, risk controls, and stress-test history |

The strongest reason to add the report is not that WAX is obviously cheap. It is that the project is large or specific enough to track in the Research Map, and the current candidate backlog indicates it had not yet been covered locally.
...
| Settlement layer | Chains and contracts that hold user value | Ethereum, WAX |
...
|---|---|---|---|
| WAX | WAXP | WAX-wax-eosio.token | not mapped |
| ethereum | WAXP | 0x2a79324c19ef2b89ea98b23bc669b7e7c9f8a517 | [explorer](https://etherscan.io/token/0x2a79324c19ef2b89ea98b23bc669b7e7c9f8a517) |
| ethereum | WAXE | 0x7a2bc711e19ba6aff6ce8246c546e8c4b4944dfd | [explorer](https://etherscan.io/token/0x7a2bc711e19ba6aff6ce8246c546e8c4b4944dfd) |
...
The market intelligence layer has three parts: DeFi usage, market liquidity, and attention. For WAX, the DeFi-oriented backlog note is the first signal: Seeded 2026-07-06 from Surf market-ranking; rank 833, market cap $19,811,482, 24h volume $818,816. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.. Surf/CG data then adds market cap $19.65M, FDV $19.65M, 24h volume $1.04M, and price $0.0042.
...
| 24h volume | $1.04M | Position sizing and exit liquidity proxy |
| Market cap | $19.65M | Liquid valuation proxy |
| FDV | $19.65M | Dilution-aware valuation proxy |
| FDV / market cap spread | 1.00x | Higher spread means more supply risk |
| X followers | 269.02K | Attention proxy, not adoption proof |
...
| Accrual channel | Strength for WAX | Evidence needed |
|---|---|---|
...
| Staking / security | Depends on whether WAXP is bonded or slashable | Staking contracts, validator docs, reward schedule |
...
The fifth frame is reflexivity. Many DeFi and infrastructure assets reprice in waves: first through TVL and listings, then through fee visibility, then through tokenomics cleanup, and finally through real cash-flow or strategic acquisition narratives. WAX currently needs to be monitored through that sequence. The available 90-day TVL series has 0 point(s), latest TVL not disclosed, and approximate change not disclosed. Market-price movement shows 7d 3.40% and 30d -11.25% when Surf or CoinGecko exposed the field. If TVL and price move together, the thesis may be simple beta. If TVL rises while price lags, the thesis becomes value-capture skepticism. If price rises while TVL falls, the thesis becomes momentum without fundamental confirmation.

The conservative conclusion is that WAX's product relevance may be ahead of its token value capture. That is common in this sector. The report should therefore watch for activation events: fee switch, staking redesign, revenue dashboard, cap increases, major integrations, or emissions reductions.
...
|---|---|---|---|
| 2022-06-02 | Undisclosed | $10.00M | OKX Ventures |
| 2017-11-15 | Ico | $9.60M | not disclosed |

| Team member | Role | Link |
|---|---|---|
| William E. Quigley | Co-Founder, CEO | [X](https://twitter.com/WilliamEQuigley) |
| Jonathan Yantis | Co-Founder, COO | not disclosed |
| John Brechisci | Co-Founder, Lead Designer | not disclosed |
...
WAX competes in the DeFi infrastructure bucket, where category peers vary by exact design. The memo uses functional competitors rather than only ticker competitors:
...
The key competitive question is whether WAX has a reason to exist beyond incentives. If switching costs are low and users are primarily chasing emissions, any valuation premium should be temporary. If the protocol controls a scarce integration point, compliance rail, validator layer, or liquidity venue, it can deserve a persistent watchlist premium.
...
Weighted conclusion: WAX is important enough to track, but not clean enough to rank as a high-conviction token until economic capture is clearer.

## Bull / Base / Bear

| Scenario | Probability | Thesis | Monitoring signal |
|---|---:|---|---|
| Bull | 25% | WAX compounds usage, liquidity improves, and WAXP gains measurable value capture through staking, fees, collateral, or governance-controlled economics. | TVL up, fees visible, volume deepens, supply overhang falls |
...
**Confidence: 6.2 / 10.** The score is above neutral because WAX has enough source coverage and category relevance to justify a full report. It is below high conviction because several valuation-critical fields remain unresolved: durable fees, tokenholder capture, precise unlocks, and stress-tested liquidity.
...
The strongest bearish critique is simple: this could be a useful protocol with an average token. If WAXP does not capture fees or security demand, the market will eventually value it as governance optionality plus liquidity beta. The second critique is data inconsistency. CG, CMC, Surf, and official docs can disagree on circulating supply, FDV, and market cap. The third critique is reflexive TVL: deposits can leave quickly when incentives, yields, or narratives change.
...
| 24h volume | $1.04M | Weekly | Volume below position-size threshold |
...
1. Re-run Surf project-detail and project-defi-metrics if WAX announces a major integration, listing, tokenomics change, exploit, or governance proposal.
...
This report intentionally separates source availability from source quality. WAX has a visible market footprint, but a visible footprint is not the same as a reconciled investment record. The Research Map standard treats CoinGecko and CoinMarketCap as discovery and market-data surfaces, Surf as an aggregation and refresh layer, DefiLlama style records as a protocol-usage lens, and official docs as the final arbiter for product mechanics. When these sources disagree, the disagreement itself is part of the thesis. A token with unclear supply methodology, mismatched contract labels, stale app docs, or broken dashboard coverage is usually harder to underwrite even when the narrative looks attractive.

For WAX, the first reconciliation job is identity. The token symbol is WAXP, the category is DeFi infrastructure, chains are Ethereum, WAX, exchanges are BINANCE, UPBIT, OKX, BITHUMB, BYBIT, BITGET, and tags are Gaming Infra, Layer1. These fields should be checked against official docs, token contracts, exchange market tabs, and community channels before the report graduates from watchlist to allocation candidate. If WAXP trades on multiple chains, each contract should be mapped to a canonical issuer statement. If the same symbol is reused by another asset, exchange tickers and contract addresses must be treated as separate facts rather than as interchangeable labels. This matters because a fuzzy ticker match can make a good memo wrong at the first line.

The second reconciliation job is market data. Market cap is $19.65M, FDV is $19.65M, 24h volume is $1.04M, FDV / market cap is 1.00x, 7d price change is 3.40%, and 30d price change is -11.25%. These numbers need a vendor-drift check. If CMC reports a different circulating supply from CoinGecko or Surf, the memo should prefer the official unlock and circulating-supply definition, then keep the aggregator spread as a risk note. If volume is dominated by one venue, the liquidity score should be lower than the headline volume implies. If FDV is not disclosed or total supply is missing, the base case should assume worse dilution until proven otherwise.
...
For WAX, the current liquidity read is watchlist first. The market cap is $19.65M, FDV is $19.65M, reported 24h volume is $1.04M, and FDV / market cap is 1.00x. These values can support a research card, but they do not automatically support an investment. A cleaner setup would show stable volume across multiple venues, narrow spreads, less reliance on a single pair, and a supply schedule that does not create a near-term wall of unlock pressure.
...
| Peer comparison | Monthly | WAX gains share with better economics | Peers grow faster with cleaner capture |

## Evidence Ledger

| # | Source | Link | Why it matters |
|---:|---|---|---|
| 1 | Official website | [link](https://on.wax.io/wax-io/) | Identity, market, social, contract, or discovery cross-check |
| 2 | CoinGecko search | [link](https://www.coingecko.com/en/search?query=WAX) | Identity, market, social, contract, or discovery cross-check |
| 3 | CoinMarketCap discovery | [link](https://coinmarketcap.com/search/?q=WAX) | Identity, market, social, contract, or discovery cross-check |
| 4 | DefiLlama protocol discovery | [link](https://defillama.com/search?query=WAX) | Identity, market, social, contract, or discovery cross-check |
| 5 | Token Terminal discovery | [link](https://tokenterminal.com/explorer?search=WAX) | Identity, market, social, contract, or discovery cross-check |
| 6 | Messari discovery | [link](https://messari.io/search?q=WAX) | Identity, market, social, contract, or discovery cross-check |
| 7 | X profile | [link](https://x.com/WAX_io) | Identity, market, social, contract, or discovery cross-check |
| 8 | GitHub | [link](https://github.com/waxio) | Identity, market, social, contract, or discovery cross-check |
| 9 | Telegram | [link](https://t.me/wax_io) | Identity, market, social, contract, or discovery cross-check |
| 10 | WAXP/USD Live Price Chart, Market Cap & News Today | [link](https://www.coingecko.com/en/coins/wax) | Identity, market, social, contract, or discovery cross-check |
| 11 | WAX price today, WAXP to USD live ... | [link](https://coinmarketcap.com/currencies/wax/) | Identity, market, social, contract, or discovery cross-check |
| 12 | Top Wax Ecosystem Coins by Market Cap | [link](https://www.coingecko.com/en/categories/wax-ecosystem) | Identity, market, social, contract, or discovery cross-check |
| 13 | WAX Price History: Download WAXP Historical Data | [link](https://www.coingecko.com/en/coins/wax/historical_data) | Identity, market, social, contract, or discovery cross-check |
| 14 | WAX (WAXP) Price Prediction For 2026 & Beyond | [link](https://coinmarketcap.com/cmc-ai/wax/price-prediction/) | Identity, market, social, contract, or discovery cross-check |
| 15 | ethereum WAXP | [link](https://etherscan.io/token/0x2a79324c19ef2b89ea98b23bc669b7e7c9f8a517) | Identity, market, social, contract, or discovery cross-check |
| 16 | ethereum WAXE | [link](https://etherscan.io/token/0x7a2bc711e19ba6aff6ce8246c546e8c4b4944dfd) | Identity, market, social, contract, or discovery cross-check |
| 17 | Google project search | [link](https://www.google.com/search?q=WAX%20WAXP%20crypto) | Identity, market, social, contract, or discovery cross-check |
| 18 | Google tokenomics search | [link](https://www.google.com/search?q=WAX%20WAXP%20tokenomics) | Identity, market, social, contract, or discovery cross-check |
| 19 | Google docs search | [link](https://www.google.com/search?q=WAX%20docs) | Identity, market, social, contract, or discovery cross-check |
| 20 | Google governance search | [link](https://www.google.com/search?q=WAX%20governance%20proposal) | Identity, market, social, contract, or discovery cross-check |
| 21 | Google audit search | [link](https://www.google.com/search?q=WAX%20audit%20report) | Identity, market, social, contract, or discovery cross-check |
| 22 | CoinMarketCap what-is guess | [link](https://coinmarketcap.com/cmc-ai/wax/what-is/) | Identity, market, social, contract, or discovery cross-check |
| 23 | CoinMarketCap price analysis guess | [link](https://coinmarketcap.com/cmc-ai/wax/price-analysis/) | Identity, market, social, contract, or discovery cross-check |
| 24 | Dune discovery | [link](https://dune.com/browse/dashboards?q=WAX) | Identity, market, social, contract, or discovery cross-check |
| 25 | Dune token query | [link](https://dune.com/browse/queries?q=WAX) | Identity, market, social, contract, or discovery cross-check |
| 26 | DeFiLlama fees discovery | [link](https://defillama.com/fees?chain=All&search=WAX) | Identity, market, social, contract, or discovery cross-check |
| 27 | DeFiLlama yield discovery | [link](https://defillama.com/yields?token=WAXP) | Identity, market, social, contract, or discovery cross-check |
| 28 | TokenUnlocks search | [link](https://token.unlocks.app/?search=WAX) | Identity, market, social, contract, or discovery cross-check |
| 29 | CryptoRank search | [link](https://cryptorank.io/price/wax) | Identity, market, social, contract, or discovery cross-check |
| 30 | RootData search | [link](https://www.rootdata.com/search?kw=WAX) | Identity, market, social, contract, or discovery cross-check |
| 31 | CoinDesk search | [link](https://www.coindesk.com/search?s=WAX) | Identity, market, social, contract, or discovery cross-check |
| 32 | The Block search | [link](https://www.theblock.co/search?query=WAX) | Identity, market, social, contract, or discovery cross-check |
| 33 | GitHub search | [link](https://github.com/search?q=WAX&type=repositories) | Identity, market, social, contract, or discovery cross-check |
| 34 | Etherscan token search | [link](https://etherscan.io/search?f=0&q=WAXP) | Identity, market, social, contract, or discovery cross-check |

Additional direct source list:

- [Official website](https://on.wax.io/wax-io/)
- [CoinGecko search](https://www.coingecko.com/en/search?query=WAX)
- [CoinMarketCap discovery](https://coinmarketcap.com/search/?q=WAX)
- [DefiLlama protocol discovery](https://defillama.com/search?query=WAX)
- [Token Terminal discovery](https://tokenterminal.com/explorer?search=WAX)
- [Messari discovery](https://messari.io/search?q=WAX)
- [X profile](https://x.com/WAX_io)
- [GitHub](https://github.com/waxio)
- [Telegram](https://t.me/wax_io)
- [WAXP/USD Live Price Chart, Market Cap & News Today](https://www.coingecko.com/en/coins/wax)
- [WAX price today, WAXP to USD live ...](https://coinmarketcap.com/currencies/wax/)
- [Top Wax Ecosystem Coins by Market Cap](https://www.coingecko.com/en/categories/wax-ecosystem)
- [WAX Price History: Download WAXP Historical Data](https://www.coingecko.com/en/coins/wax/historical_data)
- [WAX (WAXP) Price Prediction For 2026 & Beyond](https://coinmarketcap.com/cmc-ai/wax/price-prediction/)
- [ethereum WAXP](https://etherscan.io/token/0x2a79324c19ef2b89ea98b23bc669b7e7c9f8a517)
- [ethereum WAXE](https://etherscan.io/token/0x7a2bc711e19ba6aff6ce8246c546e8c4b4944dfd)
- [Google project search](https://www.google.com/search?q=WAX%20WAXP%20crypto)
- [Google tokenomics search](https://www.google.com/search?q=WAX%20WAXP%20tokenomics)
- [Google docs search](https://www.google.com/search?q=WAX%20docs)
- [Google governance search](https://www.google.com/search?q=WAX%20governance%20proposal)
- [Google audit search](https://www.google.com/search?q=WAX%20audit%20report)
- [CoinMarketCap what-is guess](https://coinmarketcap.com/cmc-ai/wax/what-is/)
- [CoinMarketCap price analysis guess](https://coinmarketcap.com/cmc-ai/wax/price-analysis/)
- [Dune discovery](https://dune.com/browse/dashboards?q=WAX)

## Final Investment View

WAX should be in the Research Map as a **watchlist / selective diligence** asset. The project has enough category relevance and data footprint to merit ongoing coverage, especially because it came from the CG/CMC-oriented candidate workflow and has no high-confidence local duplicate. The current evidence does not yet support a high-conviction allocation thesis. The next level of confidence requires cleaner token economics: fee capture, staking or collateral utility, transparent unlocks, and liquidity that can support realistic position sizing.
