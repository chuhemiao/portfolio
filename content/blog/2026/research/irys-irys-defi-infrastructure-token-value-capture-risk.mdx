...
| Exchanges | UPBIT, COINBASE, OKX, BITHUMB, BINANCE ALPHA, BITGET |
| Price | $0.0150 |
| Market cap | $29.97M |
| FDV | $149.86M |
| 24h volume | $3.37M |
...
Base case: Irys remains a selective watchlist asset until token value capture is cleaner. Bull case: protocol usage and token mechanics converge, turning IRYS into a security, collateral, or fee-routing asset with real demand. Bear case: the protocol remains useful but token holders absorb dilution, thin liquidity, governance optionality, or regulatory/technical tail risk.

## Project Overview

Irys (formerly Bundlr) is a Layer-1 programmable datachain combining low-cost permanent on-chain storage, verifiable compute, and an EVM-compatible execution layer so stored data can carry embedded instructions and interact across applications. It targets AI, NFT, and data-intensive use cases and provides developer tools, an SDK, explorer, and a live testnet/faucet.

Surf's project profile maps Irys to the following high-level surface:

| Area | Evidence |
|---|---|
| Website | [https://irys.xyz/](https://irys.xyz/) |
| X handle | [@irys_xyz](https://x.com/irys_xyz) |
| X followers | 276.70K |
| Tags | Layer1, Storage & Compute |
| Chains | Binance Smart Chain, Ethereum |
| Exchanges | UPBIT, COINBASE, OKX, BITHUMB, BINANCE ALPHA, BITGET |
| TGE status | post |
| CoinGecko ID | not disclosed |

The main product question is whether Irys is a standalone protocol with defensible demand or a token wrapper riding a larger ecosystem wave. For DeFi infrastructure projects, the strongest evidence is usually not the token chart. It is repeated usage across cycles, measurable TVL or volume, sticky integrations, credible counterparties, and a token design that matters even after incentive budgets normalize.

## Research Question / Investment Relevance

The core research question is: **does Irys convert protocol relevance into tokenholder relevance?** This is the gap that breaks many DeFi, infrastructure, and RWA tokens. A protocol can have meaningful TVL, a strong founder story, integrations, and real users while the token remains a weak claim on that value. Conversely, a token can appreciate because of listings or narrative momentum while the underlying protocol economics are not yet strong enough to justify the move.
...
| Liquidity | $3.37M 24h volume | Deeper CEX/DEX books and less fragmented contract liquidity |
| Supply quality | 2.00B circulating vs 10.00B total | Official unlock schedule and reconciled circulating methodology |
| Downside containment | Watchlist only | Transparent treasury, audits, risk controls, and stress-test history |

The strongest reason to add the report is not that Irys is obviously cheap. It is that the project is large or specific enough to track in the Research Map, and the current candidate backlog indicates it had not yet been covered locally.
...
|---|---|---|---|
| ethereum | IRYS | 0x50f41f589afaca2ef41fdf590fe7b90cd26dee64 | [explorer](https://etherscan.io/token/0x50f41f589afaca2ef41fdf590fe7b90cd26dee64) |
| bsc | IRYS | 0x91152b4ef635403efbae860edd0f8c321d7c035d | [explorer](https://bscscan.com/token/0x91152b4ef635403efbae860edd0f8c321d7c035d) |
...
The market intelligence layer has three parts: DeFi usage, market liquidity, and attention. For Irys, the DeFi-oriented backlog note is the first signal: Seeded 2026-07-06 from Surf market-ranking; rank 648, market cap $29,461,670, 24h volume $3,259,256. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.. Surf/CG data then adds market cap $29.97M, FDV $149.86M, 24h volume $3.37M, and price $0.0150.
...
| 24h volume | $3.37M | Position sizing and exit liquidity proxy |
| Market cap | $29.97M | Liquid valuation proxy |
| FDV | $149.86M | Dilution-aware valuation proxy |
| FDV / market cap spread | 5.00x | Higher spread means more supply risk |
| X followers | 276.70K | Attention proxy, not adoption proof |
...
| Accrual channel | Strength for Irys | Evidence needed |
|---|---|---|
...
| Staking / security | Depends on whether IRYS is bonded or slashable | Staking contracts, validator docs, reward schedule |
...
The fifth frame is reflexivity. Many DeFi and infrastructure assets reprice in waves: first through TVL and listings, then through fee visibility, then through tokenomics cleanup, and finally through real cash-flow or strategic acquisition narratives. Irys currently needs to be monitored through that sequence. The available 90-day TVL series has 0 point(s), latest TVL not disclosed, and approximate change not disclosed. Market-price movement shows 7d 2.24% and 30d -16.44% when Surf or CoinGecko exposed the field. If TVL and price move together, the thesis may be simple beta. If TVL rises while price lags, the thesis becomes value-capture skepticism. If price rises while TVL falls, the thesis becomes momentum without fundamental confirmation.

The conservative conclusion is that Irys's product relevance may be ahead of its token value capture. That is common in this sector. The report should therefore watch for activation events: fee switch, staking redesign, revenue dashboard, cap increases, major integrations, or emissions reductions.
...
|---|---|---|---|
| 2025-08-21 | Series A | $10.00M | CoinFund, Hypersphere Ventures, WAGMI Ventures, Breed VC, echo, Tykhe Ventures, Varrock |
| 2024-06-12 | Strategic | $3.70M | Framework Ventures, Lemniscap, Hypersphere Ventures, Permanent Ventures, Primitive Ventures |
| 2022-05-04 | Seed | $5.20M | Framework Ventures, Hypersphere Ventures, Permanent Ventures, Race Capital, OpenSea, Double Down, KYVE, Sriram Krishnan |

| Team member | Role | Link |
|---|---|---|
| Josh Benaron | Founder, CEO | [X](https://x.com/josh_benaron) |
| Gus Lobo | CMO | [X](https://x.com/misterwestwolf) |
| Tiffany Lai | VP, Partnerships, VP, Ecosystem | [X](https://x.com/tiffanylai_) |
| Jake | VP, Strategy, VP, Operations | [X](https://x.com/lew_xyz) |
...
Irys competes in the DeFi infrastructure bucket, where category peers vary by exact design. The memo uses functional competitors rather than only ticker competitors:
...
The key competitive question is whether Irys has a reason to exist beyond incentives. If switching costs are low and users are primarily chasing emissions, any valuation premium should be temporary. If the protocol controls a scarce integration point, compliance rail, validator layer, or liquidity venue, it can deserve a persistent watchlist premium.
...
Weighted conclusion: Irys is important enough to track, but not clean enough to rank as a high-conviction token until economic capture is clearer.

## Bull / Base / Bear

| Scenario | Probability | Thesis | Monitoring signal |
|---|---:|---|---|
| Bull | 25% | Irys compounds usage, liquidity improves, and IRYS gains measurable value capture through staking, fees, collateral, or governance-controlled economics. | TVL up, fees visible, volume deepens, supply overhang falls |
...
**Confidence: 6.2 / 10.** The score is above neutral because Irys has enough source coverage and category relevance to justify a full report. It is below high conviction because several valuation-critical fields remain unresolved: durable fees, tokenholder capture, precise unlocks, and stress-tested liquidity.
...
The strongest bearish critique is simple: this could be a useful protocol with an average token. If IRYS does not capture fees or security demand, the market will eventually value it as governance optionality plus liquidity beta. The second critique is data inconsistency. CG, CMC, Surf, and official docs can disagree on circulating supply, FDV, and market cap. The third critique is reflexive TVL: deposits can leave quickly when incentives, yields, or narratives change.
...
| 24h volume | $3.37M | Weekly | Volume below position-size threshold |
...
1. Re-run Surf project-detail and project-defi-metrics if Irys announces a major integration, listing, tokenomics change, exploit, or governance proposal.
...
This report intentionally separates source availability from source quality. Irys has a visible market footprint, but a visible footprint is not the same as a reconciled investment record. The Research Map standard treats CoinGecko and CoinMarketCap as discovery and market-data surfaces, Surf as an aggregation and refresh layer, DefiLlama style records as a protocol-usage lens, and official docs as the final arbiter for product mechanics. When these sources disagree, the disagreement itself is part of the thesis. A token with unclear supply methodology, mismatched contract labels, stale app docs, or broken dashboard coverage is usually harder to underwrite even when the narrative looks attractive.

For Irys, the first reconciliation job is identity. The token symbol is IRYS, the category is DeFi infrastructure, chains are Binance Smart Chain, Ethereum, exchanges are UPBIT, COINBASE, OKX, BITHUMB, BINANCE ALPHA, BITGET, and tags are Layer1, Storage & Compute. These fields should be checked against official docs, token contracts, exchange market tabs, and community channels before the report graduates from watchlist to allocation candidate. If IRYS trades on multiple chains, each contract should be mapped to a canonical issuer statement. If the same symbol is reused by another asset, exchange tickers and contract addresses must be treated as separate facts rather than as interchangeable labels. This matters because a fuzzy ticker match can make a good memo wrong at the first line.

The second reconciliation job is market data. Market cap is $29.97M, FDV is $149.86M, 24h volume is $3.37M, FDV / market cap is 5.00x, 7d price change is 2.24%, and 30d price change is -16.44%. These numbers need a vendor-drift check. If CMC reports a different circulating supply from CoinGecko or Surf, the memo should prefer the official unlock and circulating-supply definition, then keep the aggregator spread as a risk note. If volume is dominated by one venue, the liquidity score should be lower than the headline volume implies. If FDV is not disclosed or total supply is missing, the base case should assume worse dilution until proven otherwise.
...
|---|---|---|
| Identity | Irys / IRYS | Match official docs, CG, CMC, Surf, contracts |
...
| Exchanges | UPBIT, COINBASE, OKX, BITHUMB, BINANCE ALPHA, BITGET | Check live order books and inactive pairs |
| Market cap | $29.97M | Compare Surf, CG, CMC, exchange pages |
| FDV | $149.86M | Reconcile total supply and unlock schedule |
| Volume | $3.37M | Check exchange concentration and wash-trading risk |
| TVL | not disclosed | Confirm TVL meaning, source, and double-counting risk |

## Primary-source Diligence Work Plan

The next diligence pass should start from primary sources, not from the token chart. The first document to find is an official docs or whitepaper page that explains what Irys does and where users interact with it. The second is tokenomics: allocation, emissions, unlocks, utility, fee routing, treasury policy, and governance rights. The third is security material: audits, bug bounty scope, incident post-mortems, admin-key disclosures, or upgrade timelocks. The fourth is usage evidence: live app metrics, dashboards, contract balances, fee dashboards, validator counts, loan books, LP depth, or stablecoin collateral reports. Without those four documents, any price target is mostly narrative.

For Irys, the primary-source pass should answer a narrow sequence of questions. What user action creates protocol value? Who pays? Who receives the fee or spread? Does IRYS sit inside that flow, or does it only vote on parameters? Can users exit without trusting a multisig, bridge, centralized custodian, or opaque off-chain book? What part of the system can be paused or upgraded? Which parameters would cause losses if changed incorrectly? If the project is young, which metrics prove organic adoption rather than incentives? If the project is mature, which metrics prove durability rather than slow decline?
...
For Irys, the current liquidity read is watchlist first. The market cap is $29.97M, FDV is $149.86M, reported 24h volume is $3.37M, and FDV / market cap is 5.00x. These values can support a research card, but they do not automatically support an investment. A cleaner setup would show stable volume across multiple venues, narrow spreads, less reliance on a single pair, and a supply schedule that does not create a near-term wall of unlock pressure.
...
| Peer comparison | Monthly | Irys gains share with better economics | Peers grow faster with cleaner capture |

## Evidence Ledger

| # | Source | Link | Why it matters |
|---:|---|---|---|
| 1 | Official website | [link](https://irys.xyz/) | Identity, market, social, contract, or discovery cross-check |
| 2 | CoinGecko search | [link](https://www.coingecko.com/en/search?query=Irys) | Identity, market, social, contract, or discovery cross-check |
| 3 | CoinMarketCap discovery | [link](https://coinmarketcap.com/search/?q=Irys) | Identity, market, social, contract, or discovery cross-check |
| 4 | DefiLlama protocol discovery | [link](https://defillama.com/search?query=Irys) | Identity, market, social, contract, or discovery cross-check |
| 5 | Token Terminal discovery | [link](https://tokenterminal.com/explorer?search=Irys) | Identity, market, social, contract, or discovery cross-check |
| 6 | Messari discovery | [link](https://messari.io/search?q=Irys) | Identity, market, social, contract, or discovery cross-check |
| 7 | X profile | [link](https://x.com/irys_xyz) | Identity, market, social, contract, or discovery cross-check |
| 8 | GitHub | [link](https://github.com/Irys-xyz) | Identity, market, social, contract, or discovery cross-check |
| 9 | Discord | [link](https://discord.com/invite/irys) | Identity, market, social, contract, or discovery cross-check |
| 10 | IRYS/USD Live Price Chart, Market Cap & News Today | [link](https://www.coingecko.com/en/coins/irys) | Identity, market, social, contract, or discovery cross-check |
| 11 | What Is Irys (IRYS) And How Does It Work? | [link](https://coinmarketcap.com/cmc-ai/irys/what-is/) | Identity, market, social, contract, or discovery cross-check |
| 12 | What Is Irys and How To Interact With The Irys Testnet | [link](https://www.coingecko.com/learn/what-is-irys-crypto) | Identity, market, social, contract, or discovery cross-check |
| 13 | Irys (IRYS) Price Prediction For 2026 & Beyond | [link](https://coinmarketcap.com/cmc-ai/irys/price-prediction/) | Identity, market, social, contract, or discovery cross-check |
| 14 | IRYS to BTC: Irys Price in Bitcoin | [link](https://www.coingecko.com/en/coins/irys/btc) | Identity, market, social, contract, or discovery cross-check |
| 15 | ethereum IRYS | [link](https://etherscan.io/token/0x50f41f589afaca2ef41fdf590fe7b90cd26dee64) | Identity, market, social, contract, or discovery cross-check |
| 16 | bsc IRYS | [link](https://bscscan.com/token/0x91152b4ef635403efbae860edd0f8c321d7c035d) | Identity, market, social, contract, or discovery cross-check |
| 17 | Google project search | [link](https://www.google.com/search?q=Irys%20IRYS%20crypto) | Identity, market, social, contract, or discovery cross-check |
| 18 | Google tokenomics search | [link](https://www.google.com/search?q=Irys%20IRYS%20tokenomics) | Identity, market, social, contract, or discovery cross-check |
| 19 | Google docs search | [link](https://www.google.com/search?q=Irys%20docs) | Identity, market, social, contract, or discovery cross-check |
| 20 | Google governance search | [link](https://www.google.com/search?q=Irys%20governance%20proposal) | Identity, market, social, contract, or discovery cross-check |
| 21 | Google audit search | [link](https://www.google.com/search?q=Irys%20audit%20report) | Identity, market, social, contract, or discovery cross-check |
| 22 | CoinMarketCap price analysis guess | [link](https://coinmarketcap.com/cmc-ai/irys/price-analysis/) | Identity, market, social, contract, or discovery cross-check |
| 23 | CoinMarketCap currency guess | [link](https://coinmarketcap.com/currencies/irys/) | Identity, market, social, contract, or discovery cross-check |
| 24 | Dune discovery | [link](https://dune.com/browse/dashboards?q=Irys) | Identity, market, social, contract, or discovery cross-check |
| 25 | Dune token query | [link](https://dune.com/browse/queries?q=Irys) | Identity, market, social, contract, or discovery cross-check |
| 26 | DeFiLlama fees discovery | [link](https://defillama.com/fees?chain=All&search=Irys) | Identity, market, social, contract, or discovery cross-check |
| 27 | DeFiLlama yield discovery | [link](https://defillama.com/yields?token=IRYS) | Identity, market, social, contract, or discovery cross-check |
| 28 | TokenUnlocks search | [link](https://token.unlocks.app/?search=Irys) | Identity, market, social, contract, or discovery cross-check |
| 29 | CryptoRank search | [link](https://cryptorank.io/price/irys) | Identity, market, social, contract, or discovery cross-check |
| 30 | RootData search | [link](https://www.rootdata.com/search?kw=Irys) | Identity, market, social, contract, or discovery cross-check |
| 31 | CoinDesk search | [link](https://www.coindesk.com/search?s=Irys) | Identity, market, social, contract, or discovery cross-check |
| 32 | The Block search | [link](https://www.theblock.co/search?query=Irys) | Identity, market, social, contract, or discovery cross-check |
| 33 | GitHub search | [link](https://github.com/search?q=Irys&type=repositories) | Identity, market, social, contract, or discovery cross-check |
| 34 | Etherscan token search | [link](https://etherscan.io/search?f=0&q=IRYS) | Identity, market, social, contract, or discovery cross-check |

Additional direct source list:

- [Official website](https://irys.xyz/)
- [CoinGecko search](https://www.coingecko.com/en/search?query=Irys)
- [CoinMarketCap discovery](https://coinmarketcap.com/search/?q=Irys)
- [DefiLlama protocol discovery](https://defillama.com/search?query=Irys)
- [Token Terminal discovery](https://tokenterminal.com/explorer?search=Irys)
- [Messari discovery](https://messari.io/search?q=Irys)
- [X profile](https://x.com/irys_xyz)
- [GitHub](https://github.com/Irys-xyz)
- [Discord](https://discord.com/invite/irys)
- [IRYS/USD Live Price Chart, Market Cap & News Today](https://www.coingecko.com/en/coins/irys)
- [What Is Irys (IRYS) And How Does It Work?](https://coinmarketcap.com/cmc-ai/irys/what-is/)
- [What Is Irys and How To Interact With The Irys Testnet](https://www.coingecko.com/learn/what-is-irys-crypto)
- [Irys (IRYS) Price Prediction For 2026 & Beyond](https://coinmarketcap.com/cmc-ai/irys/price-prediction/)
- [IRYS to BTC: Irys Price in Bitcoin](https://www.coingecko.com/en/coins/irys/btc)
- [ethereum IRYS](https://etherscan.io/token/0x50f41f589afaca2ef41fdf590fe7b90cd26dee64)
- [bsc IRYS](https://bscscan.com/token/0x91152b4ef635403efbae860edd0f8c321d7c035d)
- [Google project search](https://www.google.com/search?q=Irys%20IRYS%20crypto)
- [Google tokenomics search](https://www.google.com/search?q=Irys%20IRYS%20tokenomics)
- [Google docs search](https://www.google.com/search?q=Irys%20docs)
- [Google governance search](https://www.google.com/search?q=Irys%20governance%20proposal)
- [Google audit search](https://www.google.com/search?q=Irys%20audit%20report)
- [CoinMarketCap price analysis guess](https://coinmarketcap.com/cmc-ai/irys/price-analysis/)
- [CoinMarketCap currency guess](https://coinmarketcap.com/currencies/irys/)
- [Dune discovery](https://dune.com/browse/dashboards?q=Irys)
