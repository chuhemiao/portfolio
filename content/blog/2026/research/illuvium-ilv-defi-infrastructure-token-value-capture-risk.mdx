---
title: 'Illuvium / ILV: DeFi infrastructure value capture, liquidity, and token risk'
publishedAt: '2026-07-06'
summary: 'Illuvium is treated as a DeFi infrastructure watchlist candidate sourced from CoinGecko/CMC discovery and refreshed with Surf, with emphasis on product durability, token value capture, liquidity, supply, and execution risk.'
slug: 'illuvium-ilv-defi-infrastructure-token-value-capture-risk'
category: 'research'
---

# Illuvium / ILV: DeFi infrastructure value capture, liquidity, and token risk

## Pre-screen Decision

**Decision: add to Research Map as a full-depth watchlist report, not as an automatic accumulation call.** Illuvium appears in the local CoinGecko/CMC-oriented candidate pool through market discovery and was refreshed with Surf on 2026-07-06. The project has enough protocol surface for a real memo: chain exposure is Energi, Ethereum; exchange exposure is BINANCE, COINBASE, OKX, BITHUMB, BITGET; category tags are GameFi, NFT Collections; current market cap is $27.42M; FDV is $31.76M; and 24h volume is $3.41M. That combination makes it worth researching, but not enough to override the main risks: token value capture may be indirect, liquidity can be fragile, supply methodology may differ across data vendors, and protocol usage can be incentive-sensitive.

The report uses a conservative watchlist standard. A pass means the project deserves monitoring and comparison against peers. It does not mean the token is cheap. A fail would require one of three red flags: no identifiable official/project surface, no meaningful market or DeFi data, or a high-confidence duplicate in the Research Map. Local duplicate checks did not flag Illuvium before this file was created, and the existing candidate note says: Seeded 2026-07-06 from Surf market-ranking; rank 694, market cap $26,743,383, 24h volume $3,243,515. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.

## TL;DR / Executive Summary

Illuvium is best understood as a **DeFi infrastructure** asset where the product thesis and the token thesis must be separated. The product thesis asks whether users, validators, LPs, borrowers, or asset issuers have a durable reason to use the protocol. The token thesis asks whether ILV captures that activity through fees, staking, collateral, governance, liquidity routing, protocol-owned assets, or emissions control. The available evidence supports a watchlist entry, especially because it has a visible data footprint across Surf, CoinGecko, CMC discovery, and DeFi-oriented candidate notes. The evidence does not yet support a high-conviction valuation without better fee/revenue, unlock, treasury, and user-retention disclosure.
...
Base case: Illuvium remains a selective watchlist asset until token value capture is cleaner. Bull case: protocol usage and token mechanics converge, turning ILV into a security, collateral, or fee-routing asset with real demand. Bear case: the protocol remains useful but token holders absorb dilution, thin liquidity, governance optionality, or regulatory/technical tail risk.

## Project Overview

Illuvium is a blockchain game studio building an open-world RPG and NFT auto-battler on Ethereum/Immutable X where players collect, upgrade, battle, and trade NFT creatures called Illuvials. The ecosystem includes the ILV governance token, staking, an NFT marketplace (Illuvidex), and interoperable game modules such as Overworld, Arena, and Beyond.

Surf's project profile maps Illuvium to the following high-level surface:

| Area | Evidence |
|---|---|
| Website | [https://illuvium.io](https://illuvium.io) |
| X handle | [@illuviumio](https://x.com/illuviumio) |
| X followers | 389.08K |
...
| Supply quality | 8.29M circulating vs 9.60M total | Official unlock schedule and reconciled circulating methodology |
| Downside containment | Watchlist only | Transparent treasury, audits, risk controls, and stress-test history |

The strongest reason to add the report is not that Illuvium is obviously cheap. It is that the project is large or specific enough to track in the Research Map, and the current candidate backlog indicates it had not yet been covered locally.

## Architecture / Mechanism

Illuvium's architecture should be evaluated through the job it performs. For a DeFi infrastructure project, architecture is not merely code shape. It includes the contracts, governance process, integration path, oracle and risk dependencies, bridge or staking assumptions, collateral policies, and the way users enter and exit positions.
...
|---|---|---|---|
| Energi | ILV | 0xa4ecf6d10b8d61d4a022821a6ff8b9536a47c70d | not mapped |
| ethereum | ILV | 0x767fe9edc9e0df98e07454847909b5e959d7ca0e | [explorer](https://etherscan.io/token/0x767fe9edc9e0df98e07454847909b5e959d7ca0e) |
...
The market intelligence layer has three parts: DeFi usage, market liquidity, and attention. For Illuvium, the DeFi-oriented backlog note is the first signal: Seeded 2026-07-06 from Surf market-ranking; rank 694, market cap $26,743,383, 24h volume $3,243,515. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.. Surf/CG data then adds market cap $27.42M, FDV $31.76M, 24h volume $3.41M, and price $3.3100.
...
| Market cap | $27.42M | Liquid valuation proxy |
| FDV | $31.76M | Dilution-aware valuation proxy |
| FDV / market cap spread | 1.16x | Higher spread means more supply risk |
| X followers | 389.08K | Attention proxy, not adoption proof |
...
| Accrual channel | Strength for Illuvium | Evidence needed |
|---|---|---|
...
| Staking / security | Depends on whether ILV is bonded or slashable | Staking contracts, validator docs, reward schedule |
...
The fifth frame is reflexivity. Many DeFi and infrastructure assets reprice in waves: first through TVL and listings, then through fee visibility, then through tokenomics cleanup, and finally through real cash-flow or strategic acquisition narratives. Illuvium currently needs to be monitored through that sequence. The available 90-day TVL series has 0 point(s), latest TVL not disclosed, and approximate change not disclosed. Market-price movement shows 7d 14.68% and 30d 0.24% when Surf or CoinGecko exposed the field. If TVL and price move together, the thesis may be simple beta. If TVL rises while price lags, the thesis becomes value-capture skepticism. If price rises while TVL falls, the thesis becomes momentum without fundamental confirmation.

The conservative conclusion is that Illuvium's product relevance may be ahead of its token value capture. That is common in this sector. The report should therefore watch for activation events: fee switch, staking redesign, revenue dashboard, cap increases, major integrations, or emissions reductions.
...
|---|---|---|---|
| 2024-03-27 | Series A | $12.00M | Arrington Capital, Animoca Brands, Yield Guild Games (YGG), The Spartan Group, P2 Ventures (Polygon Ventures), King River Capital, Arca, 32-Bit Ventures |
| 2023-05-31 | Undisclosed | $10.00M | Framework Ventures |
| 2021-03-30 | Ido | not disclosed | not disclosed |
| 2021-03-12 | Seed | $4.50M | LD Capital, Moonwhale Ventures, Yield Guild Games (YGG), Framework Ventures, Delphi Ventures, Bitscale Capital, IOSG Ventures, Blocksync Ventures |
| not disclosed | Seed | $5.00M | not disclosed |
| not disclosed | Pre-Seed | $500.00K | not disclosed |

| Team member | Role | Link |
|---|---|---|
| Kieran Warwick | Co-Founder | [X](https://twitter.com/KieranWarwick) |
| Aaron Warwick | Co-Founder | [X](https://twitter.com/aaron_warwick) |
| Grant Warwick | Co-Founder | not disclosed |
| Stuart Blackler | CTO | not disclosed |
| Danny Wilson | CFO | not disclosed |
| John Avery | Advisor | not disclosed |
| Victoria Wells | CLO | [X](https://twitter.com/Radvocato) |
...
Illuvium competes in the DeFi infrastructure bucket, where category peers vary by exact design. The memo uses functional competitors rather than only ticker competitors:
...
The key competitive question is whether Illuvium has a reason to exist beyond incentives. If switching costs are low and users are primarily chasing emissions, any valuation premium should be temporary. If the protocol controls a scarce integration point, compliance rail, validator layer, or liquidity venue, it can deserve a persistent watchlist premium.
...
Weighted conclusion: Illuvium is important enough to track, but not clean enough to rank as a high-conviction token until economic capture is clearer.

## Bull / Base / Bear

| Scenario | Probability | Thesis | Monitoring signal |
|---|---:|---|---|
| Bull | 25% | Illuvium compounds usage, liquidity improves, and ILV gains measurable value capture through staking, fees, collateral, or governance-controlled economics. | TVL up, fees visible, volume deepens, supply overhang falls |
...
The strongest bearish critique is simple: this could be a useful protocol with an average token. If ILV does not capture fees or security demand, the market will eventually value it as governance optionality plus liquidity beta. The second critique is data inconsistency. CG, CMC, Surf, and official docs can disagree on circulating supply, FDV, and market cap. The third critique is reflexive TVL: deposits can leave quickly when incentives, yields, or narratives change.
...
1. Re-run Surf project-detail and project-defi-metrics if Illuvium announces a major integration, listing, tokenomics change, exploit, or governance proposal.
...
This report intentionally separates source availability from source quality. Illuvium has a visible market footprint, but a visible footprint is not the same as a reconciled investment record. The Research Map standard treats CoinGecko and CoinMarketCap as discovery and market-data surfaces, Surf as an aggregation and refresh layer, DefiLlama style records as a protocol-usage lens, and official docs as the final arbiter for product mechanics. When these sources disagree, the disagreement itself is part of the thesis. A token with unclear supply methodology, mismatched contract labels, stale app docs, or broken dashboard coverage is usually harder to underwrite even when the narrative looks attractive.

For Illuvium, the first reconciliation job is identity. The token symbol is ILV, the category is DeFi infrastructure, chains are Energi, Ethereum, exchanges are BINANCE, COINBASE, OKX, BITHUMB, BITGET, and tags are GameFi, NFT Collections. These fields should be checked against official docs, token contracts, exchange market tabs, and community channels before the report graduates from watchlist to allocation candidate. If ILV trades on multiple chains, each contract should be mapped to a canonical issuer statement. If the same symbol is reused by another asset, exchange tickers and contract addresses must be treated as separate facts rather than as interchangeable labels. This matters because a fuzzy ticker match can make a good memo wrong at the first line.

The second reconciliation job is market data. Market cap is $27.42M, FDV is $31.76M, 24h volume is $3.41M, FDV / market cap is 1.16x, 7d price change is 14.68%, and 30d price change is 0.24%. These numbers need a vendor-drift check. If CMC reports a different circulating supply from CoinGecko or Surf, the memo should prefer the official unlock and circulating-supply definition, then keep the aggregator spread as a risk note. If volume is dominated by one venue, the liquidity score should be lower than the headline volume implies. If FDV is not disclosed or total supply is missing, the base case should assume worse dilution until proven otherwise.
...
|---|---|---|
| Identity | Illuvium / ILV | Match official docs, CG, CMC, Surf, contracts |
...
| Market cap | $27.42M | Compare Surf, CG, CMC, exchange pages |
| FDV | $31.76M | Reconcile total supply and unlock schedule |
...
For Illuvium, the current liquidity read is watchlist first. The market cap is $27.42M, FDV is $31.76M, reported 24h volume is $3.41M, and FDV / market cap is 1.16x. These values can support a research card, but they do not automatically support an investment. A cleaner setup would show stable volume across multiple venues, narrow spreads, less reliance on a single pair, and a supply schedule that does not create a near-term wall of unlock pressure.
...
| Peer comparison | Monthly | Illuvium gains share with better economics | Peers grow faster with cleaner capture |

## Evidence Ledger

| # | Source | Link | Why it matters |
|---:|---|---|---|
| 1 | Official website | [link](https://illuvium.io) | Identity, market, social, contract, or discovery cross-check |
| 2 | CoinGecko search | [link](https://www.coingecko.com/en/search?query=Illuvium) | Identity, market, social, contract, or discovery cross-check |
| 3 | CoinMarketCap discovery | [link](https://coinmarketcap.com/search/?q=Illuvium) | Identity, market, social, contract, or discovery cross-check |
| 4 | DefiLlama protocol discovery | [link](https://defillama.com/search?query=Illuvium) | Identity, market, social, contract, or discovery cross-check |
| 5 | Token Terminal discovery | [link](https://tokenterminal.com/explorer?search=Illuvium) | Identity, market, social, contract, or discovery cross-check |
| 6 | Messari discovery | [link](https://messari.io/search?q=Illuvium) | Identity, market, social, contract, or discovery cross-check |
| 7 | X profile | [link](https://x.com/illuviumio) | Identity, market, social, contract, or discovery cross-check |
| 8 | Telegram | [link](https://t.me/illuvium) | Identity, market, social, contract, or discovery cross-check |
| 9 | Discord | [link](https://discord.gg/illuvium) | Identity, market, social, contract, or discovery cross-check |
| 10 | Illuvium Price: ILV/USD Live Price Chart, Market Cap & News Today | [link](https://www.coingecko.com/en/coins/illuvium) | Identity, market, social, contract, or discovery cross-check |
| 11 | ILV to BTC: Illuvium Price in Bitcoin - CoinGecko | [link](https://www.coingecko.com/en/coins/illuvium/btc) | Identity, market, social, contract, or discovery cross-check |
| 12 | What Is Illuvium (ILV) And How Does It Work? - CoinMarketCap | [link](https://coinmarketcap.com/cmc-ai/illuvium/what-is/) | Identity, market, social, contract, or discovery cross-check |
| 13 | Illuvium NFT Floor Price Chart - CoinGecko | [link](https://www.coingecko.com/en/nft/illuvium) | Identity, market, social, contract, or discovery cross-check |
| 14 | Illuvium (ILV) / Tokenomics & Vesting Schedule - Token Unlocks | [link](https://tokenomist.ai/illuvium) | Identity, market, social, contract, or discovery cross-check |
| 15 | ethereum ILV | [link](https://etherscan.io/token/0x767fe9edc9e0df98e07454847909b5e959d7ca0e) | Identity, market, social, contract, or discovery cross-check |
| 16 | Google project search | [link](https://www.google.com/search?q=Illuvium%20ILV%20crypto) | Identity, market, social, contract, or discovery cross-check |
| 17 | Google tokenomics search | [link](https://www.google.com/search?q=Illuvium%20ILV%20tokenomics) | Identity, market, social, contract, or discovery cross-check |
| 18 | Google docs search | [link](https://www.google.com/search?q=Illuvium%20docs) | Identity, market, social, contract, or discovery cross-check |
| 19 | Google governance search | [link](https://www.google.com/search?q=Illuvium%20governance%20proposal) | Identity, market, social, contract, or discovery cross-check |
| 20 | Google audit search | [link](https://www.google.com/search?q=Illuvium%20audit%20report) | Identity, market, social, contract, or discovery cross-check |
| 21 | CoinMarketCap price analysis guess | [link](https://coinmarketcap.com/cmc-ai/illuvium/price-analysis/) | Identity, market, social, contract, or discovery cross-check |
| 22 | CoinMarketCap currency guess | [link](https://coinmarketcap.com/currencies/illuvium/) | Identity, market, social, contract, or discovery cross-check |
| 23 | Dune discovery | [link](https://dune.com/browse/dashboards?q=Illuvium) | Identity, market, social, contract, or discovery cross-check |
| 24 | Dune token query | [link](https://dune.com/browse/queries?q=Illuvium) | Identity, market, social, contract, or discovery cross-check |
| 25 | DeFiLlama fees discovery | [link](https://defillama.com/fees?chain=All&search=Illuvium) | Identity, market, social, contract, or discovery cross-check |
| 26 | DeFiLlama yield discovery | [link](https://defillama.com/yields?token=ILV) | Identity, market, social, contract, or discovery cross-check |
| 27 | TokenUnlocks search | [link](https://token.unlocks.app/?search=Illuvium) | Identity, market, social, contract, or discovery cross-check |
| 28 | CryptoRank search | [link](https://cryptorank.io/price/illuvium) | Identity, market, social, contract, or discovery cross-check |
| 29 | RootData search | [link](https://www.rootdata.com/search?kw=Illuvium) | Identity, market, social, contract, or discovery cross-check |
| 30 | CoinDesk search | [link](https://www.coindesk.com/search?s=Illuvium) | Identity, market, social, contract, or discovery cross-check |
| 31 | The Block search | [link](https://www.theblock.co/search?query=Illuvium) | Identity, market, social, contract, or discovery cross-check |
| 32 | GitHub search | [link](https://github.com/search?q=Illuvium&type=repositories) | Identity, market, social, contract, or discovery cross-check |
| 33 | Etherscan token search | [link](https://etherscan.io/search?f=0&q=ILV) | Identity, market, social, contract, or discovery cross-check |
| 34 | BscScan token search | [link](https://bscscan.com/search?f=0&q=ILV) | Identity, market, social, contract, or discovery cross-check |

Additional direct source list:

- [Official website](https://illuvium.io)
- [CoinGecko search](https://www.coingecko.com/en/search?query=Illuvium)
- [CoinMarketCap discovery](https://coinmarketcap.com/search/?q=Illuvium)
- [DefiLlama protocol discovery](https://defillama.com/search?query=Illuvium)
- [Token Terminal discovery](https://tokenterminal.com/explorer?search=Illuvium)
- [Messari discovery](https://messari.io/search?q=Illuvium)
- [X profile](https://x.com/illuviumio)
- [Telegram](https://t.me/illuvium)
- [Discord](https://discord.gg/illuvium)
- [Illuvium Price: ILV/USD Live Price Chart, Market Cap & News Today](https://www.coingecko.com/en/coins/illuvium)
- [ILV to BTC: Illuvium Price in Bitcoin - CoinGecko](https://www.coingecko.com/en/coins/illuvium/btc)
- [What Is Illuvium (ILV) And How Does It Work? - CoinMarketCap](https://coinmarketcap.com/cmc-ai/illuvium/what-is/)
- [Illuvium NFT Floor Price Chart - CoinGecko](https://www.coingecko.com/en/nft/illuvium)
- [Illuvium (ILV) | Tokenomics & Vesting Schedule - Token Unlocks](https://tokenomist.ai/illuvium)
- [ethereum ILV](https://etherscan.io/token/0x767fe9edc9e0df98e07454847909b5e959d7ca0e)
- [Google project search](https://www.google.com/search?q=Illuvium%20ILV%20crypto)
- [Google tokenomics search](https://www.google.com/search?q=Illuvium%20ILV%20tokenomics)
- [Google docs search](https://www.google.com/search?q=Illuvium%20docs)
- [Google governance search](https://www.google.com/search?q=Illuvium%20governance%20proposal)
- [Google audit search](https://www.google.com/search?q=Illuvium%20audit%20report)
- [CoinMarketCap price analysis guess](https://coinmarketcap.com/cmc-ai/illuvium/price-analysis/)
- [CoinMarketCap currency guess](https://coinmarketcap.com/currencies/illuvium/)
- [Dune discovery](https://dune.com/browse/dashboards?q=Illuvium)
- [Dune token query](https://dune.com/browse/queries?q=Illuvium)

## Final Investment View

Illuvium should be in the Research Map as a **watchlist / selective diligence** asset. The project has enough category relevance and data footprint to merit ongoing coverage, especially because it came from the CG/CMC-oriented candidate workflow and has no high-confidence local duplicate. The current evidence does not yet support a high-conviction allocation thesis. The next level of confidence requires cleaner token economics: fee capture, staking or collateral utility, transparent unlocks, and liquidity that can support realistic position sizing.
