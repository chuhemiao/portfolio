---
title: 'Prom / PROM: privacy infrastructure value capture, liquidity, and token risk'
publishedAt: '2026-07-06'
summary: 'Prom is treated as a privacy infrastructure watchlist candidate sourced from CoinGecko/CMC discovery and refreshed with Surf, with emphasis on product durability, token value capture, liquidity, supply, and execution risk.'
slug: 'prom-prom-privacy-infrastructure-token-value-capture-risk'
category: 'research'
---

# Prom / PROM: privacy infrastructure value capture, liquidity, and token risk

## Pre-screen Decision

**Decision: add to Research Map as a full-depth watchlist report, not as an automatic accumulation call.** Prom appears in the local CoinGecko/CMC-oriented candidate pool through market discovery and was refreshed with Surf on 2026-07-06. The project has enough protocol surface for a real memo: chain exposure is Binance Smart Chain, Ethereum; exchange exposure is BINANCE, UPBIT, BITGET; category tags are Layer2 & Scaling, Modular & DA, Privacy & ZK; current market cap is $20.68M; FDV is $21.82M; and 24h volume is $484.47K. That combination makes it worth researching, but not enough to override the main risks: token value capture may be indirect, liquidity can be fragile, supply methodology may differ across data vendors, and protocol usage can be incentive-sensitive.

The report uses a conservative watchlist standard. A pass means the project deserves monitoring and comparison against peers. It does not mean the token is cheap. A fail would require one of three red flags: no identifiable official/project surface, no meaningful market or DeFi data, or a high-confidence duplicate in the Research Map. Local duplicate checks did not flag Prom before this file was created, and the existing candidate note says: Seeded 2026-07-06 from Surf market-ranking; rank 818, market cap $20,607,113, 24h volume $439,153. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.

## TL;DR / Executive Summary

Prom is best understood as a **privacy infrastructure** asset where the product thesis and the token thesis must be separated. The product thesis asks whether users, validators, LPs, borrowers, or asset issuers have a durable reason to use the protocol. The token thesis asks whether PROM captures that activity through fees, staking, collateral, governance, liquidity routing, protocol-owned assets, or emissions control. The available evidence supports a watchlist entry, especially because it has a visible data footprint across Surf, CoinGecko, CMC discovery, and DeFi-oriented candidate notes. The evidence does not yet support a high-conviction valuation without better fee/revenue, unlock, treasury, and user-retention disclosure.
...
| Exchanges | BINANCE, UPBIT, BITGET |
| Price | $1.1300 |
| Market cap | $20.68M |
| FDV | $21.82M |
| 24h volume | $484.47K |
| Circulating supply | 18.25M |
| Total supply | 19.25M |
...
Base case: Prom remains a selective watchlist asset until token value capture is cleaner. Bull case: protocol usage and token mechanics converge, turning PROM into a security, collateral, or fee-routing asset with real demand. Bear case: the protocol remains useful but token holders absorb dilution, thin liquidity, governance optionality, or regulatory/technical tail risk.

## Project Overview

Prom is a modular ZK‑EVM Layer‑2 blockchain built on the Polygon CDK that uses zero‑knowledge proofs to deliver high‑throughput, low‑cost, interoperable infrastructure for dApps, DeFi and NFTs. PROM is the native token for transaction fees, on‑chain governance, validator incentives and ecosystem access.

Surf's project profile maps Prom to the following high-level surface:

| Area | Evidence |
|---|---|
| Website | [https://prom.io/](https://prom.io/) |
| X handle | [@prom_io](https://x.com/prom_io) |
| X followers | 102.76K |
...
| Liquidity | $484.47K 24h volume | Deeper CEX/DEX books and less fragmented contract liquidity |
| Supply quality | 18.25M circulating vs 19.25M total | Official unlock schedule and reconciled circulating methodology |
| Downside containment | Watchlist only | Transparent treasury, audits, risk controls, and stress-test history |

The strongest reason to add the report is not that Prom is obviously cheap. It is that the project is large or specific enough to track in the Research Map, and the current candidate backlog indicates it had not yet been covered locally.
...
|---|---|---|---|
| ethereum | PROM | 0xfc82bb4ba86045af6f327323a46e80412b91b27d | [explorer](https://etherscan.io/token/0xfc82bb4ba86045af6f327323a46e80412b91b27d) |
| bsc | PROM | 0xaf53d56ff99f1322515e54fdde93ff8b3b7dafd5 | [explorer](https://bscscan.com/token/0xaf53d56ff99f1322515e54fdde93ff8b3b7dafd5) |
...
The market intelligence layer has three parts: DeFi usage, market liquidity, and attention. For Prom, the DeFi-oriented backlog note is the first signal: Seeded 2026-07-06 from Surf market-ranking; rank 818, market cap $20,607,113, 24h volume $439,153. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.. Surf/CG data then adds market cap $20.68M, FDV $21.82M, 24h volume $484.47K, and price $1.1300.
...
| 24h volume | $484.47K | Position sizing and exit liquidity proxy |
| Market cap | $20.68M | Liquid valuation proxy |
| FDV | $21.82M | Dilution-aware valuation proxy |
| FDV / market cap spread | 1.05x | Higher spread means more supply risk |
| X followers | 102.76K | Attention proxy, not adoption proof |
...
| Accrual channel | Strength for Prom | Evidence needed |
|---|---|---|
...
| Staking / security | Depends on whether PROM is bonded or slashable | Staking contracts, validator docs, reward schedule |
...
The fifth frame is reflexivity. Many DeFi and infrastructure assets reprice in waves: first through TVL and listings, then through fee visibility, then through tokenomics cleanup, and finally through real cash-flow or strategic acquisition narratives. Prom currently needs to be monitored through that sequence. The available 90-day TVL series has 0 point(s), latest TVL not disclosed, and approximate change not disclosed. Market-price movement shows 7d 0.71% and 30d 15.32% when Surf or CoinGecko exposed the field. If TVL and price move together, the thesis may be simple beta. If TVL rises while price lags, the thesis becomes value-capture skepticism. If price rises while TVL falls, the thesis becomes momentum without fundamental confirmation.

The conservative conclusion is that Prom's product relevance may be ahead of its token value capture. That is common in this sector. The report should therefore watch for activation events: fee switch, staking redesign, revenue dashboard, cap increases, major integrations, or emissions reductions.
...
|---|---|---|---|
| 2024-02-21 | Undisclosed | not disclosed | DWF Labs |
| 2019-02-01 | Ico | $850.00K | not disclosed |
| 2019-01-01 | Private/Pre-Sale | $4.00M | not disclosed |
...
Prom competes in the privacy infrastructure bucket, where category peers vary by exact design. The memo uses functional competitors rather than only ticker competitors:
...
The key competitive question is whether Prom has a reason to exist beyond incentives. If switching costs are low and users are primarily chasing emissions, any valuation premium should be temporary. If the protocol controls a scarce integration point, compliance rail, validator layer, or liquidity venue, it can deserve a persistent watchlist premium.
...
Weighted conclusion: Prom is important enough to track, but not clean enough to rank as a high-conviction token until economic capture is clearer.

## Bull / Base / Bear

| Scenario | Probability | Thesis | Monitoring signal |
|---|---:|---|---|
| Bull | 25% | Prom compounds usage, liquidity improves, and PROM gains measurable value capture through staking, fees, collateral, or governance-controlled economics. | TVL up, fees visible, volume deepens, supply overhang falls |
...
**Confidence: 6.2 / 10.** The score is above neutral because Prom has enough source coverage and category relevance to justify a full report. It is below high conviction because several valuation-critical fields remain unresolved: durable fees, tokenholder capture, precise unlocks, and stress-tested liquidity.
...
The strongest bearish critique is simple: this could be a useful protocol with an average token. If PROM does not capture fees or security demand, the market will eventually value it as governance optionality plus liquidity beta. The second critique is data inconsistency. CG, CMC, Surf, and official docs can disagree on circulating supply, FDV, and market cap. The third critique is reflexive TVL: deposits can leave quickly when incentives, yields, or narratives change.
...
| 24h volume | $484.47K | Weekly | Volume below position-size threshold |
...
1. Re-run Surf project-detail and project-defi-metrics if Prom announces a major integration, listing, tokenomics change, exploit, or governance proposal.
...
This report intentionally separates source availability from source quality. Prom has a visible market footprint, but a visible footprint is not the same as a reconciled investment record. The Research Map standard treats CoinGecko and CoinMarketCap as discovery and market-data surfaces, Surf as an aggregation and refresh layer, DefiLlama style records as a protocol-usage lens, and official docs as the final arbiter for product mechanics. When these sources disagree, the disagreement itself is part of the thesis. A token with unclear supply methodology, mismatched contract labels, stale app docs, or broken dashboard coverage is usually harder to underwrite even when the narrative looks attractive.

For Prom, the first reconciliation job is identity. The token symbol is PROM, the category is privacy infrastructure, chains are Binance Smart Chain, Ethereum, exchanges are BINANCE, UPBIT, BITGET, and tags are Layer2 & Scaling, Modular & DA, Privacy & ZK. These fields should be checked against official docs, token contracts, exchange market tabs, and community channels before the report graduates from watchlist to allocation candidate. If PROM trades on multiple chains, each contract should be mapped to a canonical issuer statement. If the same symbol is reused by another asset, exchange tickers and contract addresses must be treated as separate facts rather than as interchangeable labels. This matters because a fuzzy ticker match can make a good memo wrong at the first line.

The second reconciliation job is market data. Market cap is $20.68M, FDV is $21.82M, 24h volume is $484.47K, FDV / market cap is 1.05x, 7d price change is 0.71%, and 30d price change is 15.32%. These numbers need a vendor-drift check. If CMC reports a different circulating supply from CoinGecko or Surf, the memo should prefer the official unlock and circulating-supply definition, then keep the aggregator spread as a risk note. If volume is dominated by one venue, the liquidity score should be lower than the headline volume implies. If FDV is not disclosed or total supply is missing, the base case should assume worse dilution until proven otherwise.
...
|---|---|---|
| Identity | Prom / PROM | Match official docs, CG, CMC, Surf, contracts |
...
| Peer comparison | Monthly | Prom gains share with better economics | Peers grow faster with cleaner capture |

## Evidence Ledger

| # | Source | Link | Why it matters |
|---:|---|---|---|
| 1 | Official website | [link](https://prom.io/) | Identity, market, social, contract, or discovery cross-check |
| 2 | CoinGecko search | [link](https://www.coingecko.com/en/search?query=Prom) | Identity, market, social, contract, or discovery cross-check |
| 3 | CoinMarketCap discovery | [link](https://coinmarketcap.com/search/?q=Prom) | Identity, market, social, contract, or discovery cross-check |
| 4 | DefiLlama protocol discovery | [link](https://defillama.com/search?query=Prom) | Identity, market, social, contract, or discovery cross-check |
| 5 | Token Terminal discovery | [link](https://tokenterminal.com/explorer?search=Prom) | Identity, market, social, contract, or discovery cross-check |
| 6 | Messari discovery | [link](https://messari.io/search?q=Prom) | Identity, market, social, contract, or discovery cross-check |
| 7 | X profile | [link](https://x.com/prom_io) | Identity, market, social, contract, or discovery cross-check |
| 8 | Telegram | [link](https://t.me/prom_io) | Identity, market, social, contract, or discovery cross-check |
| 9 | PROM/USD Live Price Chart, Market Cap & News Today - CoinGecko | [link](https://www.coingecko.com/en/coins/prom) | Identity, market, social, contract, or discovery cross-check |
| 10 | Prom price today, PROM to USD live price, marketcap and chart | [link](https://coinmarketcap.com/currencies/prom/) | Identity, market, social, contract, or discovery cross-check |
...
| 12 | Prom Price History: Download PROM Historical Data / CoinGecko | [link](https://www.coingecko.com/en/coins/prom/historical_data) | Identity, market, social, contract, or discovery cross-check |
| 13 | What Is Prom (PROM) And How Does It Work? - CoinMarketCap | [link](https://coinmarketcap.com/cmc-ai/prom/what-is/) | Identity, market, social, contract, or discovery cross-check |
| 14 | ethereum PROM | [link](https://etherscan.io/token/0xfc82bb4ba86045af6f327323a46e80412b91b27d) | Identity, market, social, contract, or discovery cross-check |
| 15 | bsc PROM | [link](https://bscscan.com/token/0xaf53d56ff99f1322515e54fdde93ff8b3b7dafd5) | Identity, market, social, contract, or discovery cross-check |
| 16 | Google project search | [link](https://www.google.com/search?q=Prom%20PROM%20crypto) | Identity, market, social, contract, or discovery cross-check |
| 17 | Google tokenomics search | [link](https://www.google.com/search?q=Prom%20PROM%20tokenomics) | Identity, market, social, contract, or discovery cross-check |
| 18 | Google docs search | [link](https://www.google.com/search?q=Prom%20docs) | Identity, market, social, contract, or discovery cross-check |
| 19 | Google governance search | [link](https://www.google.com/search?q=Prom%20governance%20proposal) | Identity, market, social, contract, or discovery cross-check |
| 20 | Google audit search | [link](https://www.google.com/search?q=Prom%20audit%20report) | Identity, market, social, contract, or discovery cross-check |
| 21 | CoinMarketCap price analysis guess | [link](https://coinmarketcap.com/cmc-ai/prom/price-analysis/) | Identity, market, social, contract, or discovery cross-check |
| 22 | Dune discovery | [link](https://dune.com/browse/dashboards?q=Prom) | Identity, market, social, contract, or discovery cross-check |
| 23 | Dune token query | [link](https://dune.com/browse/queries?q=Prom) | Identity, market, social, contract, or discovery cross-check |
| 24 | DeFiLlama fees discovery | [link](https://defillama.com/fees?chain=All&search=Prom) | Identity, market, social, contract, or discovery cross-check |
| 25 | DeFiLlama yield discovery | [link](https://defillama.com/yields?token=PROM) | Identity, market, social, contract, or discovery cross-check |
| 26 | TokenUnlocks search | [link](https://token.unlocks.app/?search=Prom) | Identity, market, social, contract, or discovery cross-check |
| 27 | CryptoRank search | [link](https://cryptorank.io/price/prom) | Identity, market, social, contract, or discovery cross-check |
| 28 | RootData search | [link](https://www.rootdata.com/search?kw=Prom) | Identity, market, social, contract, or discovery cross-check |
| 29 | CoinDesk search | [link](https://www.coindesk.com/search?s=Prom) | Identity, market, social, contract, or discovery cross-check |
| 30 | The Block search | [link](https://www.theblock.co/search?query=Prom) | Identity, market, social, contract, or discovery cross-check |
| 31 | GitHub search | [link](https://github.com/search?q=Prom&type=repositories) | Identity, market, social, contract, or discovery cross-check |
| 32 | Etherscan token search | [link](https://etherscan.io/search?f=0&q=PROM) | Identity, market, social, contract, or discovery cross-check |
| 33 | BscScan token search | [link](https://bscscan.com/search?f=0&q=PROM) | Identity, market, social, contract, or discovery cross-check |
| 34 | Arbiscan token search | [link](https://arbiscan.io/search?f=0&q=PROM) | Identity, market, social, contract, or discovery cross-check |

Additional direct source list:

- [Official website](https://prom.io/)
- [CoinGecko search](https://www.coingecko.com/en/search?query=Prom)
- [CoinMarketCap discovery](https://coinmarketcap.com/search/?q=Prom)
- [DefiLlama protocol discovery](https://defillama.com/search?query=Prom)
- [Token Terminal discovery](https://tokenterminal.com/explorer?search=Prom)
- [Messari discovery](https://messari.io/search?q=Prom)
- [X profile](https://x.com/prom_io)
- [Telegram](https://t.me/prom_io)
- [PROM/USD Live Price Chart, Market Cap & News Today - CoinGecko](https://www.coingecko.com/en/coins/prom)
- [Prom price today, PROM to USD live price, marketcap and chart](https://coinmarketcap.com/currencies/prom/)
- [CoinGecko: Cryptocurrency Prices, Charts, and Crypto Market Cap](https://www.coingecko.com/)
- [Prom Price History: Download PROM Historical Data | CoinGecko](https://www.coingecko.com/en/coins/prom/historical_data)
- [What Is Prom (PROM) And How Does It Work? - CoinMarketCap](https://coinmarketcap.com/cmc-ai/prom/what-is/)
- [ethereum PROM](https://etherscan.io/token/0xfc82bb4ba86045af6f327323a46e80412b91b27d)
- [bsc PROM](https://bscscan.com/token/0xaf53d56ff99f1322515e54fdde93ff8b3b7dafd5)
- [Google project search](https://www.google.com/search?q=Prom%20PROM%20crypto)
- [Google tokenomics search](https://www.google.com/search?q=Prom%20PROM%20tokenomics)
- [Google docs search](https://www.google.com/search?q=Prom%20docs)
- [Google governance search](https://www.google.com/search?q=Prom%20governance%20proposal)
- [Google audit search](https://www.google.com/search?q=Prom%20audit%20report)
- [CoinMarketCap price analysis guess](https://coinmarketcap.com/cmc-ai/prom/price-analysis/)
- [Dune discovery](https://dune.com/browse/dashboards?q=Prom)
- [Dune token query](https://dune.com/browse/queries?q=Prom)
- [DeFiLlama fees discovery](https://defillama.com/fees?chain=All&search=Prom)

## Final Investment View

Prom should be in the Research Map as a **watchlist / selective diligence** asset. The project has enough category relevance and data footprint to merit ongoing coverage, especially because it came from the CG/CMC-oriented candidate workflow and has no high-confidence local duplicate. The current evidence does not yet support a high-conviction allocation thesis. The next level of confidence requires cleaner token economics: fee capture, staking or collateral utility, transparent unlocks, and liquidity that can support realistic position sizing.
