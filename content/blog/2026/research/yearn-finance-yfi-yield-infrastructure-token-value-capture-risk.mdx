---
title: 'yearn.finance / YFI: yield infrastructure value capture, liquidity, and token risk'
publishedAt: '2026-07-06'
summary: 'yearn.finance is treated as a yield infrastructure watchlist candidate sourced from CoinGecko/CMC discovery and refreshed with Surf, with emphasis on product durability, token value capture, liquidity, supply, and execution risk.'
slug: 'yearn-finance-yfi-yield-infrastructure-token-value-capture-risk'
category: 'research'
---

# yearn.finance / YFI: yield infrastructure value capture, liquidity, and token risk

## Pre-screen Decision

**Decision: add to Research Map as a full-depth watchlist report, not as an automatic accumulation call.** yearn.finance appears in the local CoinGecko/CMC-oriented candidate pool through market discovery and was refreshed with Surf on 2026-07-06. The project has enough protocol surface for a real memo: chain exposure is Arbitrum One, Avalanche, Base, Energi, Ethereum, Fantom, HECO Chain, Harmony Shard 0, Katana, Near Protocol, Optimistic Ethereum, Polygon Pos, SORA, Xdai; exchange exposure is BITHUMB; category tags are Yield & Asset Mgmt; current market cap is $85.25M; FDV is $87.27M; and 24h volume is $26.19M. That combination makes it worth researching, but not enough to override the main risks: token value capture may be indirect, liquidity can be fragile, supply methodology may differ across data vendors, and protocol usage can be incentive-sensitive.

The report uses a conservative watchlist standard. A pass means the project deserves monitoring and comparison against peers. It does not mean the token is cheap. A fail would require one of three red flags: no identifiable official/project surface, no meaningful market or DeFi data, or a high-confidence duplicate in the Research Map. Local duplicate checks did not flag yearn.finance before this file was created, and the existing candidate note says: Seeded 2026-06-28 from Surf market-ranking; rank 382, market cap $58,784,636, 24h volume $3,868,222. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.

## TL;DR / Executive Summary

yearn.finance is best understood as a **yield infrastructure** asset where the product thesis and the token thesis must be separated. The product thesis asks whether users, validators, LPs, borrowers, or asset issuers have a durable reason to use the protocol. The token thesis asks whether YFI captures that activity through fees, staking, collateral, governance, liquidity routing, protocol-owned assets, or emissions control. The available evidence supports a watchlist entry, especially because it has a visible data footprint across Surf, CoinGecko, CMC discovery, and DeFi-oriented candidate notes. The evidence does not yet support a high-conviction valuation without better fee/revenue, unlock, treasury, and user-retention disclosure.
...
| Chains | Arbitrum One, Avalanche, Base, Energi, Ethereum, Fantom, HECO Chain, Harmony Shard 0, Katana, Near Protocol, Optimistic Ethereum, Polygon Pos, SORA, Xdai |
| Exchanges | BITHUMB |
| Price | $2.38K |
| Market cap | $85.25M |
| FDV | $87.27M |
| 24h volume | $26.19M |
| Circulating supply | 35.82K |
| Total supply | 36.67K |
| 7d price change | 45.52% |
| 30d price change | 34.50% |
...
Base case: yearn.finance remains a selective watchlist asset until token value capture is cleaner. Bull case: protocol usage and token mechanics converge, turning YFI into a security, collateral, or fee-routing asset with real demand. Bear case: the protocol remains useful but token holders absorb dilution, thin liquidity, governance optionality, or regulatory/technical tail risk.

## Project Overview

Yearn.fi is a decentralized finance yield aggregator that automatically allocates and optimizes deposits across lending and AMM protocols via Vaults, Earn, and Iron Bank, using automated strategies and auto-compounding. Its governance token YFI enables community-driven governance of the protocol.

Surf's project profile maps yearn.finance to the following high-level surface:

| Area | Evidence |
|---|---|
| Website | [https://yearn.finance](https://yearn.finance) |
| X handle | [@yearnfi](https://x.com/yearnfi) |
| X followers | 208.95K |
...
| Liquidity | $26.19M 24h volume | Deeper CEX/DEX books and less fragmented contract liquidity |
| Supply quality | 35.82K circulating vs 36.67K total | Official unlock schedule and reconciled circulating methodology |
| Downside containment | Watchlist only | Transparent treasury, audits, risk controls, and stress-test history |

The strongest reason to add the report is not that yearn.finance is obviously cheap. It is that the project is large or specific enough to track in the Research Map, and the current candidate backlog indicates it had not yet been covered locally.
...
| Settlement layer | Chains and contracts that hold user value | Arbitrum One, Avalanche, Base, Energi, Ethereum, Fantom, HECO Chain, Harmony Shard 0, Katana, Near Protocol, Optimistic Ethereum, Polygon Pos, SORA, Xdai |
...
|---|---|---|---|
| fantom | YFI | 0x29b0da86e484e1c0029b56e817912d778ac0ec69 | not mapped |
| base | YFI | 0x9eaf8c1e34f05a589eda6bafdf391cf6ad3cb239 | [explorer](https://basescan.org/token/0x9eaf8c1e34f05a589eda6bafdf391cf6ad3cb239) |
| SORA | YFI | 0x002676c3edea5b08bc0f9b6809a91aa313b7da35e28b190222e9dc032bf1e662 | not mapped |
| Xdai | YFI | 0xbf65bfcb5da067446cee6a706ba3fe2fb1a9fdfd | not mapped |
| Energi | YFI | 0x2726dd5efb3a209a54c512e9562a2045b8f45dbc | not mapped |
| ethereum | YFI | 0x0bc529c00c6401aef6d220be8c6ea1667f6ad93e | [explorer](https://etherscan.io/token/0x0bc529c00c6401aef6d220be8c6ea1667f6ad93e) |
| avalanche | YFI | 0x9eaac1b23d935365bd7b542fe22ceee2922f52dc | [explorer](https://snowtrace.io/token/0x9eaac1b23d935365bd7b542fe22ceee2922f52dc) |
| HECO Chain | YFI | 0xb4f019beac758abbee2f906033aaa2f0f6dacb35 | not mapped |
...
The market intelligence layer has three parts: DeFi usage, market liquidity, and attention. For yearn.finance, the DeFi-oriented backlog note is the first signal: Seeded 2026-06-28 from Surf market-ranking; rank 382, market cap $58,784,636, 24h volume $3,868,222. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.. Surf/CG data then adds market cap $85.25M, FDV $87.27M, 24h volume $26.19M, and price $2.38K.
...
| 24h volume | $26.19M | Position sizing and exit liquidity proxy |
| Market cap | $85.25M | Liquid valuation proxy |
| FDV | $87.27M | Dilution-aware valuation proxy |
| FDV / market cap spread | 1.02x | Higher spread means more supply risk |
| X followers | 208.95K | Attention proxy, not adoption proof |
...
| Accrual channel | Strength for yearn.finance | Evidence needed |
|---|---|---|
...
| Staking / security | Depends on whether YFI is bonded or slashable | Staking contracts, validator docs, reward schedule |
...
The first analytical frame is utility durability. yearn.finance should not be treated as investable only because it appears in CoinGecko or CoinMarketCap discovery. The useful question is whether the protocol controls a repeatable workflow: validators needing distributed operation, lenders needing collateralized liquidity, LPs needing routing, tokenized assets needing compliance rails, or depositors needing yield. In this memo the base assumption is that yearn.finance belongs to the yield infrastructure bucket. That means the token, if any, has to be judged by how directly it captures fees, security demand, collateral demand, risk-management demand, governance power, or distribution access. A high TVL number without fee conversion is weaker than a modest TVL base with sticky users, clear revenue, and controllable emissions.

The second frame is liquidity quality. Current tracked market data points to market cap $85.25M, FDV $87.27M, 24h volume $26.19M, price $2.38K, circulating supply 35.82K, and total supply 36.67K. These numbers are not a buy signal by themselves. They are a risk surface. When FDV materially exceeds market cap, the memo discounts upside because later unlocks can absorb demand. When volume is low relative to market cap, the memo discounts tradability because position sizing becomes difficult. When price performance is strong but project usage is flat, the memo treats the move as narrative beta rather than fundamental repricing. When usage is durable but price is weak, the memo treats the asset as a watchlist candidate rather than an immediate long.

The third frame is source triangulation. Surf project-detail gives an aggregated project view, CoinGecko provides a market-data and community-data surface, CoinMarketCap discovery is used to cross-check symbol identity, and DefiLlama style TVL notes provide a protocol-usage lens. For yearn.finance, the candidate backlog records Seeded 2026-06-28 from Surf market-ranking; rank 382, market cap $58,784,636, 24h volume $3,868,222. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.. Surf identifies chains as Arbitrum One, Avalanche, Base, Energi, Ethereum, Fantom, HECO Chain, Harmony Shard 0, Katana, Near Protocol, Optimistic Ethereum, Polygon Pos, SORA, Xdai, exchanges as BITHUMB, and tags as Yield & Asset Mgmt. If these labels diverge from official documentation, official documentation wins. If CMC, CG, and Surf disagree on supply or market cap, this memo treats the supply field as unresolved until a token contract, official tokenomics page, and exchange-circulating methodology can be reconciled.
...
The fifth frame is reflexivity. Many DeFi and infrastructure assets reprice in waves: first through TVL and listings, then through fee visibility, then through tokenomics cleanup, and finally through real cash-flow or strategic acquisition narratives. yearn.finance currently needs to be monitored through that sequence. The available 90-day TVL series has 0 point(s), latest TVL not disclosed, and approximate change not disclosed. Market-price movement shows 7d 45.52% and 30d 34.50% when Surf or CoinGecko exposed the field. If TVL and price move together, the thesis may be simple beta. If TVL rises while price lags, the thesis becomes value-capture skepticism. If price rises while TVL falls, the thesis becomes momentum without fundamental confirmation.

The conservative conclusion is that yearn.finance's product relevance may be ahead of its token value capture. That is common in this sector. The report should therefore watch for activation events: fee switch, staking redesign, revenue dashboard, cap increases, major integrations, or emissions reductions.
...
|---|---|---|
| Andre Cronje | Founder | [X](https://twitter.com/andrecronjetech) |
| Daniele Trovato | Co-Founder | not disclosed |
...
yearn.finance competes in the yield infrastructure bucket, where category peers vary by exact design. The memo uses functional competitors rather than only ticker competitors:
...
The key competitive question is whether yearn.finance has a reason to exist beyond incentives. If switching costs are low and users are primarily chasing emissions, any valuation premium should be temporary. If the protocol controls a scarce integration point, compliance rail, validator layer, or liquidity venue, it can deserve a persistent watchlist premium.
...
Weighted conclusion: yearn.finance is important enough to track, but not clean enough to rank as a high-conviction token until economic capture is clearer.

## Bull / Base / Bear

| Scenario | Probability | Thesis | Monitoring signal |
|---|---:|---|---|
| Bull | 25% | yearn.finance compounds usage, liquidity improves, and YFI gains measurable value capture through staking, fees, collateral, or governance-controlled economics. | TVL up, fees visible, volume deepens, supply overhang falls |
...
The strongest bearish critique is simple: this could be a useful protocol with an average token. If YFI does not capture fees or security demand, the market will eventually value it as governance optionality plus liquidity beta. The second critique is data inconsistency. CG, CMC, Surf, and official docs can disagree on circulating supply, FDV, and market cap. The third critique is reflexive TVL: deposits can leave quickly when incentives, yields, or narratives change.
...
| 24h volume | $26.19M | Weekly | Volume below position-size threshold |
...
1. Re-run Surf project-detail and project-defi-metrics if yearn.finance announces a major integration, listing, tokenomics change, exploit, or governance proposal.
...
This report intentionally separates source availability from source quality. yearn.finance has a visible market footprint, but a visible footprint is not the same as a reconciled investment record. The Research Map standard treats CoinGecko and CoinMarketCap as discovery and market-data surfaces, Surf as an aggregation and refresh layer, DefiLlama style records as a protocol-usage lens, and official docs as the final arbiter for product mechanics. When these sources disagree, the disagreement itself is part of the thesis. A token with unclear supply methodology, mismatched contract labels, stale app docs, or broken dashboard coverage is usually harder to underwrite even when the narrative looks attractive.

For yearn.finance, the first reconciliation job is identity. The token symbol is YFI, the category is yield infrastructure, chains are Arbitrum One, Avalanche, Base, Energi, Ethereum, Fantom, HECO Chain, Harmony Shard 0, Katana, Near Protocol, Optimistic Ethereum, Polygon Pos, SORA, Xdai, exchanges are BITHUMB, and tags are Yield & Asset Mgmt. These fields should be checked against official docs, token contracts, exchange market tabs, and community channels before the report graduates from watchlist to allocation candidate. If YFI trades on multiple chains, each contract should be mapped to a canonical issuer statement. If the same symbol is reused by another asset, exchange tickers and contract addresses must be treated as separate facts rather than as interchangeable labels. This matters because a fuzzy ticker match can make a good memo wrong at the first line.

The second reconciliation job is market data. Market cap is $85.25M, FDV is $87.27M, 24h volume is $26.19M, FDV / market cap is 1.02x, 7d price change is 45.52%, and 30d price change is 34.50%. These numbers need a vendor-drift check. If CMC reports a different circulating supply from CoinGecko or Surf, the memo should prefer the official unlock and circulating-supply definition, then keep the aggregator spread as a risk note. If volume is dominated by one venue, the liquidity score should be lower than the headline volume implies. If FDV is not disclosed or total supply is missing, the base case should assume worse dilution until proven otherwise.
...
|---|---|---|
| Identity | yearn.finance / YFI | Match official docs, CG, CMC, Surf, contracts |
| Category | yield infrastructure | Confirm product mechanics and revenue model |
| Chains | Arbitrum One, Avalanche, Base, Energi, Ethereum, Fantom, HECO Chain, Harmony Shard 0, Katana, Near Protocol, Optimistic Ethereum, Polygon Pos, SORA, Xdai | Confirm canonical deployments and bridge assumptions |
| Exchanges | BITHUMB | Check live order books and inactive pairs |
| Market cap | $85.25M | Compare Surf, CG, CMC, exchange pages |
| FDV | $87.27M | Reconcile total supply and unlock schedule |
| Volume | $26.19M | Check exchange concentration and wash-trading risk |
| TVL | not disclosed | Confirm TVL meaning, source, and double-counting risk |

## Primary-source Diligence Work Plan

The next diligence pass should start from primary sources, not from the token chart. The first document to find is an official docs or whitepaper page that explains what yearn.finance does and where users interact with it. The second is tokenomics: allocation, emissions, unlocks, utility, fee routing, treasury policy, and governance rights. The third is security material: audits, bug bounty scope, incident post-mortems, admin-key disclosures, or upgrade timelocks. The fourth is usage evidence: live app metrics, dashboards, contract balances, fee dashboards, validator counts, loan books, LP depth, or stablecoin collateral reports. Without those four documents, any price target is mostly narrative.

For yearn.finance, the primary-source pass should answer a narrow sequence of questions. What user action creates protocol value? Who pays? Who receives the fee or spread? Does YFI sit inside that flow, or does it only vote on parameters? Can users exit without trusting a multisig, bridge, centralized custodian, or opaque off-chain book? What part of the system can be paused or upgraded? Which parameters would cause losses if changed incorrectly? If the project is young, which metrics prove organic adoption rather than incentives? If the project is mature, which metrics prove durability rather than slow decline?
...
For yearn.finance, the current liquidity read is watchlist first. The market cap is $85.25M, FDV is $87.27M, reported 24h volume is $26.19M, and FDV / market cap is 1.02x. These values can support a research card, but they do not automatically support an investment. A cleaner setup would show stable volume across multiple venues, narrow spreads, less reliance on a single pair, and a supply schedule that does not create a near-term wall of unlock pressure.
...
The failure-mode view is deliberately harsher than the base case. yearn.finance can fail for reasons that do not show up in a simple market-data table. Smart contracts can be exploited. Oracles can misprice collateral. Bridges can be paused. Staking systems can experience slashing or validator concentration. RWA systems can face issuer, custodian, or redemption risk. Stablecoin systems can lose pegs. Privacy systems can face sanctions, delistings, or legal restrictions. DEXs and yield systems can lose users when incentives rotate. A full-depth memo should make these risks visible before they become headlines.

For yearn.finance, the live monitoring stack should include contract events, TVL, volume, governance, documentation changes, social announcements, security disclosures, and exchange-market quality. A single metric is not enough. TVL may stay high while liquidity thins. Volume may rise because of volatility rather than adoption. Social attention may rise around controversy rather than progress. Governance may pass proposals that improve short-term price but add long-term risk. The strongest monitoring dashboard combines on-chain state, off-chain disclosure, and market quality.

Incident response matters because crypto risks are discontinuous. A protocol can look normal until a bridge halt, oracle issue, admin pause, market-maker withdrawal, regulatory action, or treasury sale changes the entire thesis. The Research Map should therefore attach explicit downgrade triggers. If yearn.finance suffers a material exploit, downgrade until a post-mortem, reimbursement plan, and contract patch are published. If supply expands faster than disclosed, downgrade tokenomics confidence. If the main app loses integrations or TVL without explanation, downgrade product durability. If market depth collapses while price holds, downgrade liquidity quality.
...
| Peer comparison | Monthly | yearn.finance gains share with better economics | Peers grow faster with cleaner capture |

## Evidence Ledger

| # | Source | Link | Why it matters |
|---:|---|---|---|
| 1 | Official website | [link](https://yearn.finance) | Identity, market, social, contract, or discovery cross-check |
| 2 | CoinGecko search | [link](https://www.coingecko.com/en/search?query=yearn.finance) | Identity, market, social, contract, or discovery cross-check |
| 3 | CoinMarketCap discovery | [link](https://coinmarketcap.com/search/?q=yearn.finance) | Identity, market, social, contract, or discovery cross-check |
| 4 | DefiLlama protocol discovery | [link](https://defillama.com/search?query=yearn.finance) | Identity, market, social, contract, or discovery cross-check |
| 5 | Token Terminal discovery | [link](https://tokenterminal.com/explorer?search=yearn.finance) | Identity, market, social, contract, or discovery cross-check |
| 6 | Messari discovery | [link](https://messari.io/search?q=yearn.finance) | Identity, market, social, contract, or discovery cross-check |
| 7 | X profile | [link](https://x.com/yearnfi) | Identity, market, social, contract, or discovery cross-check |
| 8 | GitHub | [link](https://github.com/iearn-finance) | Identity, market, social, contract, or discovery cross-check |
| 9 | Telegram | [link](https://t.me/iearnfinance) | Identity, market, social, contract, or discovery cross-check |
| 10 | yearn.finance Price Chart (YFI) - CoinGecko | [link](https://www.coingecko.com/en/coins/yearn-finance) | Identity, market, social, contract, or discovery cross-check |
| 11 | Top Yearn Ecosystem Coins by Market Cap - CoinGecko | [link](https://www.coingecko.com/en/categories/yearn-yfi-partnerships-mergers) | Identity, market, social, contract, or discovery cross-check |
| 12 | What Is Yearn (YFI) And How Does It Work? - CoinMarketCap | [link](https://coinmarketcap.com/cmc-ai/yearn-finance/what-is/) | Identity, market, social, contract, or discovery cross-check |
| 13 | Yearn Finance Launches YFI Buyback Program: Markets Wrap | [link](https://blockworks.com/news/yearn-finance-launches-yfi-buyback-program-markets-wrap) | Identity, market, social, contract, or discovery cross-check |
| 14 | YFI to BTC: yearn.finance Price in Bitcoin / CoinGecko | [link](https://www.coingecko.com/en/coins/yearn-finance/btc) | Identity, market, social, contract, or discovery cross-check |
| 15 | base YFI | [link](https://basescan.org/token/0x9eaf8c1e34f05a589eda6bafdf391cf6ad3cb239) | Identity, market, social, contract, or discovery cross-check |
| 16 | ethereum YFI | [link](https://etherscan.io/token/0x0bc529c00c6401aef6d220be8c6ea1667f6ad93e) | Identity, market, social, contract, or discovery cross-check |
| 17 | avalanche YFI | [link](https://snowtrace.io/token/0x9eaac1b23d935365bd7b542fe22ceee2922f52dc) | Identity, market, social, contract, or discovery cross-check |
| 18 | polygon YFI | [link](https://polygonscan.com/token/0xda537104d6a5edd53c6fbba9a898708e465260b6) | Identity, market, social, contract, or discovery cross-check |
| 19 | arbitrum YFI | [link](https://arbiscan.io/token/0x82e3a8f066a6989666b031d916c43672085b1582) | Identity, market, social, contract, or discovery cross-check |
| 20 | Google project search | [link](https://www.google.com/search?q=yearn.finance%20YFI%20crypto) | Identity, market, social, contract, or discovery cross-check |
| 21 | Google tokenomics search | [link](https://www.google.com/search?q=yearn.finance%20YFI%20tokenomics) | Identity, market, social, contract, or discovery cross-check |
| 22 | Google docs search | [link](https://www.google.com/search?q=yearn.finance%20docs) | Identity, market, social, contract, or discovery cross-check |
| 23 | Google governance search | [link](https://www.google.com/search?q=yearn.finance%20governance%20proposal) | Identity, market, social, contract, or discovery cross-check |
| 24 | Google audit search | [link](https://www.google.com/search?q=yearn.finance%20audit%20report) | Identity, market, social, contract, or discovery cross-check |
| 25 | CoinMarketCap price analysis guess | [link](https://coinmarketcap.com/cmc-ai/yearn-finance/price-analysis/) | Identity, market, social, contract, or discovery cross-check |
| 26 | CoinMarketCap currency guess | [link](https://coinmarketcap.com/currencies/yearn-finance/) | Identity, market, social, contract, or discovery cross-check |
| 27 | Dune discovery | [link](https://dune.com/browse/dashboards?q=yearn.finance) | Identity, market, social, contract, or discovery cross-check |
| 28 | Dune token query | [link](https://dune.com/browse/queries?q=yearn.finance) | Identity, market, social, contract, or discovery cross-check |
| 29 | DeFiLlama fees discovery | [link](https://defillama.com/fees?chain=All&search=yearn.finance) | Identity, market, social, contract, or discovery cross-check |
| 30 | DeFiLlama yield discovery | [link](https://defillama.com/yields?token=YFI) | Identity, market, social, contract, or discovery cross-check |
| 31 | TokenUnlocks search | [link](https://token.unlocks.app/?search=yearn.finance) | Identity, market, social, contract, or discovery cross-check |
| 32 | CryptoRank search | [link](https://cryptorank.io/price/yearn-finance) | Identity, market, social, contract, or discovery cross-check |
| 33 | RootData search | [link](https://www.rootdata.com/search?kw=yearn.finance) | Identity, market, social, contract, or discovery cross-check |
| 34 | CoinDesk search | [link](https://www.coindesk.com/search?s=yearn.finance) | Identity, market, social, contract, or discovery cross-check |

Additional direct source list:

- [Official website](https://yearn.finance)
- [CoinGecko search](https://www.coingecko.com/en/search?query=yearn.finance)
- [CoinMarketCap discovery](https://coinmarketcap.com/search/?q=yearn.finance)
- [DefiLlama protocol discovery](https://defillama.com/search?query=yearn.finance)
- [Token Terminal discovery](https://tokenterminal.com/explorer?search=yearn.finance)
- [Messari discovery](https://messari.io/search?q=yearn.finance)
- [X profile](https://x.com/yearnfi)
- [GitHub](https://github.com/iearn-finance)
- [Telegram](https://t.me/iearnfinance)
- [yearn.finance Price Chart (YFI) - CoinGecko](https://www.coingecko.com/en/coins/yearn-finance)
- [Top Yearn Ecosystem Coins by Market Cap - CoinGecko](https://www.coingecko.com/en/categories/yearn-yfi-partnerships-mergers)
- [What Is Yearn (YFI) And How Does It Work? - CoinMarketCap](https://coinmarketcap.com/cmc-ai/yearn-finance/what-is/)
- [Yearn Finance Launches YFI Buyback Program: Markets Wrap](https://blockworks.com/news/yearn-finance-launches-yfi-buyback-program-markets-wrap)
- [YFI to BTC: yearn.finance Price in Bitcoin | CoinGecko](https://www.coingecko.com/en/coins/yearn-finance/btc)
- [base YFI](https://basescan.org/token/0x9eaf8c1e34f05a589eda6bafdf391cf6ad3cb239)
- [ethereum YFI](https://etherscan.io/token/0x0bc529c00c6401aef6d220be8c6ea1667f6ad93e)
- [avalanche YFI](https://snowtrace.io/token/0x9eaac1b23d935365bd7b542fe22ceee2922f52dc)
- [polygon YFI](https://polygonscan.com/token/0xda537104d6a5edd53c6fbba9a898708e465260b6)
- [arbitrum YFI](https://arbiscan.io/token/0x82e3a8f066a6989666b031d916c43672085b1582)
- [Google project search](https://www.google.com/search?q=yearn.finance%20YFI%20crypto)
- [Google tokenomics search](https://www.google.com/search?q=yearn.finance%20YFI%20tokenomics)
- [Google docs search](https://www.google.com/search?q=yearn.finance%20docs)
- [Google governance search](https://www.google.com/search?q=yearn.finance%20governance%20proposal)
- [Google audit search](https://www.google.com/search?q=yearn.finance%20audit%20report)
