---
title: 'Sai / SAI: stablecoin / credit infrastructure value capture, liquidity, and token risk'
publishedAt: '2026-07-06'
summary: 'Sai is treated as a stablecoin / credit infrastructure watchlist candidate sourced from CoinGecko/CMC discovery and refreshed with Surf, with emphasis on product durability, token value capture, liquidity, supply, and execution risk.'
slug: 'sai-sai-stablecoin-credit-infrastructure-token-value-capture-risk'
category: 'research'
---

# Sai / SAI: stablecoin / credit infrastructure value capture, liquidity, and token risk

## Pre-screen Decision

**Decision: add to Research Map as a full-depth watchlist report, not as an automatic accumulation call.** Sai appears in the local CoinGecko/CMC-oriented candidate pool through market discovery and was refreshed with Surf on 2026-07-06. The project has enough protocol surface for a real memo: chain exposure is Arbitrum Nova, Arbitrum One, Avalanche, Energi, Ethereum, Kaia, Optimistic Ethereum, Polygon Pos, SORA; exchange exposure is not disclosed; category tags are DAO, Lending & Borrowing, Stablecoins; current market cap is $24.99M; FDV is $24.99M; and 24h volume is $8.0500. That combination makes it worth researching, but not enough to override the main risks: token value capture may be indirect, liquidity can be fragile, supply methodology may differ across data vendors, and protocol usage can be incentive-sensitive.

The report uses a conservative watchlist standard. A pass means the project deserves monitoring and comparison against peers. It does not mean the token is cheap. A fail would require one of three red flags: no identifiable official/project surface, no meaningful market or DeFi data, or a high-confidence duplicate in the Research Map. Local duplicate checks did not flag Sai before this file was created, and the existing candidate note says: Seeded 2026-07-06 from Surf market-ranking; rank 731, market cap $24,536,806, 24h volume $8. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.

## TL;DR / Executive Summary

Sai is best understood as a **stablecoin / credit infrastructure** asset where the product thesis and the token thesis must be separated. The product thesis asks whether users, validators, LPs, borrowers, or asset issuers have a durable reason to use the protocol. The token thesis asks whether SAI captures that activity through fees, staking, collateral, governance, liquidity routing, protocol-owned assets, or emissions control. The available evidence supports a watchlist entry, especially because it has a visible data footprint across Surf, CoinGecko, CMC discovery, and DeFi-oriented candidate notes. The evidence does not yet support a high-conviction valuation without better fee/revenue, unlock, treasury, and user-retention disclosure.
...
| Chains | Arbitrum Nova, Arbitrum One, Avalanche, Energi, Ethereum, Kaia, Optimistic Ethereum, Polygon Pos, SORA |
...
| Latest TVL sample | $15.02B |
| TVL sample change | 7.62% |
| Primary source posture | Surf + CoinGecko + CMC discovery + official/project links |

Base case: Sai remains a selective watchlist asset until token value capture is cleaner. Bull case: protocol usage and token mechanics converge, turning SAI into a security, collateral, or fee-routing asset with real demand. Bear case: the protocol remains useful but token holders absorb dilution, thin liquidity, governance optionality, or regulatory/technical tail risk.

## Project Overview

Sky Protocol, formerly MakerDAO, enables generation of the USDS stablecoin through collateralized positions. Governed by SKY token holders, it offers yield via sUSDS and supports autonomous Sky Stars for ecosystem innovation.

Surf's project profile maps Sai to the following high-level surface:
...
| Liquidity | $8.0500 24h volume | Deeper CEX/DEX books and less fragmented contract liquidity |
| Supply quality | 2.66M circulating vs 2.66M total | Official unlock schedule and reconciled circulating methodology |
| Downside containment | Watchlist only | Transparent treasury, audits, risk controls, and stress-test history |

The strongest reason to add the report is not that Sai is obviously cheap. It is that the project is large or specific enough to track in the Research Map, and the current candidate backlog indicates it had not yet been covered locally.
...
| Settlement layer | Chains and contracts that hold user value | Arbitrum Nova, Arbitrum One, Avalanche, Energi, Ethereum, Kaia, Optimistic Ethereum, Polygon Pos, SORA |
...
|---|---|---|---|
| ethereum | SAI | 0x89d24a6b4ccb1b6faa2625fe562bdd9a23260359 | [explorer](https://etherscan.io/token/0x89d24a6b4ccb1b6faa2625fe562bdd9a23260359) |
| Arbitrum Nova | DAI | 0xda10009cbd5d07dd0cecc66161fc93d7c9000da1 | [explorer](https://arbiscan.io/token/0xda10009cbd5d07dd0cecc66161fc93d7c9000da1) |
| ethereum | MKR | 0x9f8f72aa9304c8b593d555f12ef6589cc3a579a2 | [explorer](https://etherscan.io/token/0x9f8f72aa9304c8b593d555f12ef6589cc3a579a2) |
| SORA | MKR | 0x00ec184ef0b4bd955db05eea5a8489ae72888ab6e63682a15beca1cd39344c8f | not mapped |
| Energi | MKR | 0x050317d93f29d1ba5ff3eac3b8157fd4e345588d | not mapped |
| avalanche | MKR | 0x88128fd4b259552a9a1d457f435a6527aab72d42 | [explorer](https://snowtrace.io/token/0x88128fd4b259552a9a1d457f435a6527aab72d42) |
| polygon | MKR | 0x6f7c932e7684666c9fd1d44527765433e01ff61d | [explorer](https://polygonscan.com/token/0x6f7c932e7684666c9fd1d44527765433e01ff61d) |
| arbitrum | DAI | 0xda10009cbd5d07dd0cecc66161fc93d7c9000da1 | [explorer](https://arbiscan.io/token/0xda10009cbd5d07dd0cecc66161fc93d7c9000da1) |
...
The market intelligence layer has three parts: DeFi usage, market liquidity, and attention. For Sai, the DeFi-oriented backlog note is the first signal: Seeded 2026-07-06 from Surf market-ranking; rank 731, market cap $24,536,806, 24h volume $8. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.. Surf/CG data then adds market cap $24.99M, FDV $24.99M, 24h volume $8.0500, and price $9.4100.

| Traction metric | Value | Interpretation |
|---|---|---|
| Latest TVL sample | $15.02B | Useful only if sustained without aggressive incentives |
| TVL sample points | 90 | More points improve trend confidence |
| TVL sample change | 7.62% | Positive trend supports usage; negative trend requires explanation |
| 24h volume | $8.0500 | Position sizing and exit liquidity proxy |
| Market cap | $24.99M | Liquid valuation proxy |
| FDV | $24.99M | Dilution-aware valuation proxy |
...
| Accrual channel | Strength for Sai | Evidence needed |
|---|---|---|
...
| Staking / security | Depends on whether SAI is bonded or slashable | Staking contracts, validator docs, reward schedule |
...
The fifth frame is reflexivity. Many DeFi and infrastructure assets reprice in waves: first through TVL and listings, then through fee visibility, then through tokenomics cleanup, and finally through real cash-flow or strategic acquisition narratives. Sai currently needs to be monitored through that sequence. The available 90-day TVL series has 90 point(s), latest TVL $15.02B, and approximate change 7.62%. Market-price movement shows 7d 13.15% and 30d 13.95% when Surf or CoinGecko exposed the field. If TVL and price move together, the thesis may be simple beta. If TVL rises while price lags, the thesis becomes value-capture skepticism. If price rises while TVL falls, the thesis becomes momentum without fundamental confirmation.

The conservative conclusion is that Sai's product relevance may be ahead of its token value capture. That is common in this sector. The report should therefore watch for activation events: fee switch, staking redesign, revenue dashboard, cap increases, major integrations, or emissions reductions.
...
|---|---|---|---|
| 2019-12-19 | Strategic | $27.50M | Paradigm, Dragonfly |
| 2018-09-24 | Undisclosed | $15.00M | Andreessen Horowitz (a16z crypto) |
| 2017-12-15 | Seed | $12.00M | Fenbushi Capital, Polychain Capital, Andreessen Horowitz (a16z crypto), 1confirmation, FBG Capital, Wyre Capital, Walden Bridge Capital, Scanate |

| Team member | Role | Link |
|---|---|---|
| Rune Christensen | Founder | [X](https://twitter.com/RuneKek) |
...
Sai competes in the stablecoin / credit infrastructure bucket, where category peers vary by exact design. The memo uses functional competitors rather than only ticker competitors:
...
Weighted conclusion: Sai is important enough to track, but not clean enough to rank as a high-conviction token until economic capture is clearer.

## Bull / Base / Bear

| Scenario | Probability | Thesis | Monitoring signal |
|---|---:|---|---|
| Bull | 25% | Sai compounds usage, liquidity improves, and SAI gains measurable value capture through staking, fees, collateral, or governance-controlled economics. | TVL up, fees visible, volume deepens, supply overhang falls |
...
**Confidence: 6.2 / 10.** The score is above neutral because Sai has enough source coverage and category relevance to justify a full report. It is below high conviction because several valuation-critical fields remain unresolved: durable fees, tokenholder capture, precise unlocks, and stress-tested liquidity.
...
The strongest bearish critique is simple: this could be a useful protocol with an average token. If SAI does not capture fees or security demand, the market will eventually value it as governance optionality plus liquidity beta. The second critique is data inconsistency. CG, CMC, Surf, and official docs can disagree on circulating supply, FDV, and market cap. The third critique is reflexive TVL: deposits can leave quickly when incentives, yields, or narratives change.
...
|---|---|---|---|
| TVL | $15.02B | Weekly | >20% drawdown or sustained growth |
| 24h volume | $8.0500 | Weekly | Volume below position-size threshold |
...
1. Re-run Surf project-detail and project-defi-metrics if Sai announces a major integration, listing, tokenomics change, exploit, or governance proposal.
...
For Sai, the current liquidity read is watchlist first. The market cap is $24.99M, FDV is $24.99M, reported 24h volume is $8.0500, and FDV / market cap is 1.00x. These values can support a research card, but they do not automatically support an investment. A cleaner setup would show stable volume across multiple venues, narrow spreads, less reliance on a single pair, and a supply schedule that does not create a near-term wall of unlock pressure.
...
| Peer comparison | Monthly | Sai gains share with better economics | Peers grow faster with cleaner capture |

## Evidence Ledger

| # | Source | Link | Why it matters |
|---:|---|---|---|
| 1 | Official website | [link](https://sky.money) | Identity, market, social, contract, or discovery cross-check |
| 2 | CoinGecko search | [link](https://www.coingecko.com/en/search?query=Sai) | Identity, market, social, contract, or discovery cross-check |
| 3 | CoinMarketCap discovery | [link](https://coinmarketcap.com/search/?q=Sai) | Identity, market, social, contract, or discovery cross-check |
| 4 | DefiLlama protocol discovery | [link](https://defillama.com/search?query=Sai) | Identity, market, social, contract, or discovery cross-check |
| 5 | Token Terminal discovery | [link](https://tokenterminal.com/explorer?search=Sai) | Identity, market, social, contract, or discovery cross-check |
| 6 | Messari discovery | [link](https://messari.io/search?q=Sai) | Identity, market, social, contract, or discovery cross-check |
| 7 | Telegram | [link](https://t.me/makerdaoofficial) | Identity, market, social, contract, or discovery cross-check |
...
| 9 | SAI/USD Live Price Chart, Market Cap & News Today - CoinGecko | [link](https://www.coingecko.com/en/coins/sai) | Identity, market, social, contract, or discovery cross-check |
| 10 | Sharpe AI Price Chart (SAI) - CoinGecko | [link](https://www.coingecko.com/en/coins/sharpe-ai) | Identity, market, social, contract, or discovery cross-check |
| 11 | Crypto Data API: Most Comprehensive & Reliable ... - CoinGecko | [link](https://www.coingecko.com/en/api) | Identity, market, social, contract, or discovery cross-check |
| 12 | Sharpe AI price SAI #2938 - CoinMarketCap | [link](https://coinmarketcap.com/currencies/sharpe-ai/) | Identity, market, social, contract, or discovery cross-check |
| 13 | ethereum SAI | [link](https://etherscan.io/token/0x89d24a6b4ccb1b6faa2625fe562bdd9a23260359) | Identity, market, social, contract, or discovery cross-check |
| 14 | Arbitrum Nova DAI | [link](https://arbiscan.io/token/0xda10009cbd5d07dd0cecc66161fc93d7c9000da1) | Identity, market, social, contract, or discovery cross-check |
| 15 | ethereum MKR | [link](https://etherscan.io/token/0x9f8f72aa9304c8b593d555f12ef6589cc3a579a2) | Identity, market, social, contract, or discovery cross-check |
| 16 | avalanche MKR | [link](https://snowtrace.io/token/0x88128fd4b259552a9a1d457f435a6527aab72d42) | Identity, market, social, contract, or discovery cross-check |
| 17 | polygon MKR | [link](https://polygonscan.com/token/0x6f7c932e7684666c9fd1d44527765433e01ff61d) | Identity, market, social, contract, or discovery cross-check |
| 18 | optimism DAI | [link](https://optimistic.etherscan.io/token/0xda10009cbd5d07dd0cecc66161fc93d7c9000da1) | Identity, market, social, contract, or discovery cross-check |
| 19 | ethereum DAI | [link](https://etherscan.io/token/0x6b175474e89094c44da98b954eedeac495271d0f) | Identity, market, social, contract, or discovery cross-check |
| 20 | Google project search | [link](https://www.google.com/search?q=Sai%20SAI%20crypto) | Identity, market, social, contract, or discovery cross-check |
| 21 | Google tokenomics search | [link](https://www.google.com/search?q=Sai%20SAI%20tokenomics) | Identity, market, social, contract, or discovery cross-check |
| 22 | Google docs search | [link](https://www.google.com/search?q=Sai%20docs) | Identity, market, social, contract, or discovery cross-check |
| 23 | Google governance search | [link](https://www.google.com/search?q=Sai%20governance%20proposal) | Identity, market, social, contract, or discovery cross-check |
| 24 | Google audit search | [link](https://www.google.com/search?q=Sai%20audit%20report) | Identity, market, social, contract, or discovery cross-check |
| 25 | CoinMarketCap what-is guess | [link](https://coinmarketcap.com/cmc-ai/sai/what-is/) | Identity, market, social, contract, or discovery cross-check |
| 26 | CoinMarketCap price analysis guess | [link](https://coinmarketcap.com/cmc-ai/sai/price-analysis/) | Identity, market, social, contract, or discovery cross-check |
| 27 | CoinMarketCap currency guess | [link](https://coinmarketcap.com/currencies/sai/) | Identity, market, social, contract, or discovery cross-check |
| 28 | Dune discovery | [link](https://dune.com/browse/dashboards?q=Sai) | Identity, market, social, contract, or discovery cross-check |
| 29 | Dune token query | [link](https://dune.com/browse/queries?q=Sai) | Identity, market, social, contract, or discovery cross-check |
| 30 | DeFiLlama fees discovery | [link](https://defillama.com/fees?chain=All&search=Sai) | Identity, market, social, contract, or discovery cross-check |
| 31 | DeFiLlama yield discovery | [link](https://defillama.com/yields?token=SAI) | Identity, market, social, contract, or discovery cross-check |
| 32 | TokenUnlocks search | [link](https://token.unlocks.app/?search=Sai) | Identity, market, social, contract, or discovery cross-check |
| 33 | CryptoRank search | [link](https://cryptorank.io/price/sai) | Identity, market, social, contract, or discovery cross-check |
| 34 | RootData search | [link](https://www.rootdata.com/search?kw=Sai) | Identity, market, social, contract, or discovery cross-check |

Additional direct source list:

- [Official website](https://sky.money)
- [CoinGecko search](https://www.coingecko.com/en/search?query=Sai)
- [CoinMarketCap discovery](https://coinmarketcap.com/search/?q=Sai)
- [DefiLlama protocol discovery](https://defillama.com/search?query=Sai)
- [Token Terminal discovery](https://tokenterminal.com/explorer?search=Sai)
- [Messari discovery](https://messari.io/search?q=Sai)
- [Telegram](https://t.me/makerdaoofficial)
- [CoinGecko: Cryptocurrency Prices, Charts, and Crypto Market Cap](https://www.coingecko.com/)
- [SAI/USD Live Price Chart, Market Cap & News Today - CoinGecko](https://www.coingecko.com/en/coins/sai)
- [Sharpe AI Price Chart (SAI) - CoinGecko](https://www.coingecko.com/en/coins/sharpe-ai)
- [Crypto Data API: Most Comprehensive & Reliable ... - CoinGecko](https://www.coingecko.com/en/api)
- [Sharpe AI price SAI #2938 - CoinMarketCap](https://coinmarketcap.com/currencies/sharpe-ai/)
- [ethereum SAI](https://etherscan.io/token/0x89d24a6b4ccb1b6faa2625fe562bdd9a23260359)
- [Arbitrum Nova DAI](https://arbiscan.io/token/0xda10009cbd5d07dd0cecc66161fc93d7c9000da1)
- [ethereum MKR](https://etherscan.io/token/0x9f8f72aa9304c8b593d555f12ef6589cc3a579a2)
- [avalanche MKR](https://snowtrace.io/token/0x88128fd4b259552a9a1d457f435a6527aab72d42)
- [polygon MKR](https://polygonscan.com/token/0x6f7c932e7684666c9fd1d44527765433e01ff61d)
- [optimism DAI](https://optimistic.etherscan.io/token/0xda10009cbd5d07dd0cecc66161fc93d7c9000da1)
- [ethereum DAI](https://etherscan.io/token/0x6b175474e89094c44da98b954eedeac495271d0f)
- [Google project search](https://www.google.com/search?q=Sai%20SAI%20crypto)
- [Google tokenomics search](https://www.google.com/search?q=Sai%20SAI%20tokenomics)
- [Google docs search](https://www.google.com/search?q=Sai%20docs)
- [Google governance search](https://www.google.com/search?q=Sai%20governance%20proposal)
- [Google audit search](https://www.google.com/search?q=Sai%20audit%20report)

## Final Investment View

Sai should be in the Research Map as a **watchlist / selective diligence** asset. The project has enough category relevance and data footprint to merit ongoing coverage, especially because it came from the CG/CMC-oriented candidate workflow and has no high-confidence local duplicate. The current evidence does not yet support a high-conviction allocation thesis. The next level of confidence requires cleaner token economics: fee capture, staking or collateral utility, transparent unlocks, and liquidity that can support realistic position sizing.
