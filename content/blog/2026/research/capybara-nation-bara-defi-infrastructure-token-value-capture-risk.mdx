...
| FDV | $12.63M |
| 24h volume | $8.09K |
| Circulating supply | 100000.00B |
| Total supply | 100000.00B |
...
Base case: Capybara Nation remains a selective watchlist asset until token value capture is cleaner. Bull case: protocol usage and token mechanics converge, turning BARA into a security, collateral, or fee-routing asset with real demand. Bear case: the protocol remains useful but token holders absorb dilution, thin liquidity, governance optionality, or regulatory/technical tail risk.

## Project Overview

Capybara Nation is a GameFi project on Cronos related to Capybaras. It's a tap-to-earn game on Telegram.

Surf's project profile maps Capybara Nation to the following high-level surface:

| Area | Evidence |
|---|---|
| Website | [https://capybaranation.xyz/](https://capybaranation.xyz/) |
| X handle | [@capy_nation](https://x.com/capy_nation) |
| X followers | 136.18K |
| Tags | not disclosed |
| Chains | Cronos |
| Exchanges | not disclosed |
...
| Liquidity | $8.09K 24h volume | Deeper CEX/DEX books and less fragmented contract liquidity |
| Supply quality | 100000.00B circulating vs 100000.00B total | Official unlock schedule and reconciled circulating methodology |
| Downside containment | Watchlist only | Transparent treasury, audits, risk controls, and stress-test history |

The strongest reason to add the report is not that Capybara Nation is obviously cheap. It is that the project is large or specific enough to track in the Research Map, and the current candidate backlog indicates it had not yet been covered locally.
...
| Settlement layer | Chains and contracts that hold user value | Cronos |
...
|---|---|---|---|
| Cronos | BARA | 0xf24409d155965ca87c45ad5bc084ad8ad3be4f39 | not mapped |
...
The market intelligence layer has three parts: DeFi usage, market liquidity, and attention. For Capybara Nation, the DeFi-oriented backlog note is the first signal: Seeded 2026-07-06 from Surf market-ranking; rank 1033, market cap $12,914,069, 24h volume $5,768. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.. Surf/CG data then adds market cap $12.63M, FDV $12.63M, 24h volume $8.09K, and price $0.0000.
...
| 24h volume | $8.09K | Position sizing and exit liquidity proxy |
| Market cap | $12.63M | Liquid valuation proxy |
| FDV | $12.63M | Dilution-aware valuation proxy |
| FDV / market cap spread | 1.00x | Higher spread means more supply risk |
| X followers | 136.18K | Attention proxy, not adoption proof |
...
| Accrual channel | Strength for Capybara Nation | Evidence needed |
|---|---|---|
...
| Staking / security | Depends on whether BARA is bonded or slashable | Staking contracts, validator docs, reward schedule |
...
The fifth frame is reflexivity. Many DeFi and infrastructure assets reprice in waves: first through TVL and listings, then through fee visibility, then through tokenomics cleanup, and finally through real cash-flow or strategic acquisition narratives. Capybara Nation currently needs to be monitored through that sequence. The available 90-day TVL series has 90 point(s), latest TVL $104.63M, and approximate change 34.34%. Market-price movement shows 7d 8.28% and 30d -2.24% when Surf or CoinGecko exposed the field. If TVL and price move together, the thesis may be simple beta. If TVL rises while price lags, the thesis becomes value-capture skepticism. If price rises while TVL falls, the thesis becomes momentum without fundamental confirmation.

The conservative conclusion is that Capybara Nation's product relevance may be ahead of its token value capture. That is common in this sector. The report should therefore watch for activation events: fee switch, staking redesign, revenue dashboard, cap increases, major integrations, or emissions reductions.
...
Capybara Nation competes in the DeFi infrastructure bucket, where category peers vary by exact design. The memo uses functional competitors rather than only ticker competitors:
...
Weighted conclusion: Capybara Nation is important enough to track, but not clean enough to rank as a high-conviction token until economic capture is clearer.

## Bull / Base / Bear

| Scenario | Probability | Thesis | Monitoring signal |
|---|---:|---|---|
| Bull | 25% | Capybara Nation compounds usage, liquidity improves, and BARA gains measurable value capture through staking, fees, collateral, or governance-controlled economics. | TVL up, fees visible, volume deepens, supply overhang falls |
...
The strongest bearish critique is simple: this could be a useful protocol with an average token. If BARA does not capture fees or security demand, the market will eventually value it as governance optionality plus liquidity beta. The second critique is data inconsistency. CG, CMC, Surf, and official docs can disagree on circulating supply, FDV, and market cap. The third critique is reflexive TVL: deposits can leave quickly when incentives, yields, or narratives change.
...
| 24h volume | $8.09K | Weekly | Volume below position-size threshold |
...
1. Re-run Surf project-detail and project-defi-metrics if Capybara Nation announces a major integration, listing, tokenomics change, exploit, or governance proposal.
...
This report intentionally separates source availability from source quality. Capybara Nation has a visible market footprint, but a visible footprint is not the same as a reconciled investment record. The Research Map standard treats CoinGecko and CoinMarketCap as discovery and market-data surfaces, Surf as an aggregation and refresh layer, DefiLlama style records as a protocol-usage lens, and official docs as the final arbiter for product mechanics. When these sources disagree, the disagreement itself is part of the thesis. A token with unclear supply methodology, mismatched contract labels, stale app docs, or broken dashboard coverage is usually harder to underwrite even when the narrative looks attractive.

For Capybara Nation, the first reconciliation job is identity. The token symbol is BARA, the category is DeFi infrastructure, chains are Cronos, exchanges are not disclosed, and tags are not disclosed. These fields should be checked against official docs, token contracts, exchange market tabs, and community channels before the report graduates from watchlist to allocation candidate. If BARA trades on multiple chains, each contract should be mapped to a canonical issuer statement. If the same symbol is reused by another asset, exchange tickers and contract addresses must be treated as separate facts rather than as interchangeable labels. This matters because a fuzzy ticker match can make a good memo wrong at the first line.

The second reconciliation job is market data. Market cap is $12.63M, FDV is $12.63M, 24h volume is $8.09K, FDV / market cap is 1.00x, 7d price change is 8.28%, and 30d price change is -2.24%. These numbers need a vendor-drift check. If CMC reports a different circulating supply from CoinGecko or Surf, the memo should prefer the official unlock and circulating-supply definition, then keep the aggregator spread as a risk note. If volume is dominated by one venue, the liquidity score should be lower than the headline volume implies. If FDV is not disclosed or total supply is missing, the base case should assume worse dilution until proven otherwise.
...
For Capybara Nation, the current liquidity read is watchlist first. The market cap is $12.63M, FDV is $12.63M, reported 24h volume is $8.09K, and FDV / market cap is 1.00x. These values can support a research card, but they do not automatically support an investment. A cleaner setup would show stable volume across multiple venues, narrow spreads, less reliance on a single pair, and a supply schedule that does not create a near-term wall of unlock pressure.
...
| Peer comparison | Monthly | Capybara Nation gains share with better economics | Peers grow faster with cleaner capture |

## Evidence Ledger

| # | Source | Link | Why it matters |
|---:|---|---|---|
| 1 | Official website | [link](https://capybaranation.xyz/) | Identity, market, social, contract, or discovery cross-check |
| 2 | CoinGecko search | [link](https://www.coingecko.com/en/search?query=Capybara%20Nation) | Identity, market, social, contract, or discovery cross-check |
| 3 | CoinMarketCap discovery | [link](https://coinmarketcap.com/search/?q=Capybara%20Nation) | Identity, market, social, contract, or discovery cross-check |
| 4 | DefiLlama protocol discovery | [link](https://defillama.com/search?query=Capybara%20Nation) | Identity, market, social, contract, or discovery cross-check |
| 5 | Token Terminal discovery | [link](https://tokenterminal.com/explorer?search=Capybara%20Nation) | Identity, market, social, contract, or discovery cross-check |
| 6 | Messari discovery | [link](https://messari.io/search?q=Capybara%20Nation) | Identity, market, social, contract, or discovery cross-check |
| 7 | X profile | [link](https://x.com/capy_nation) | Identity, market, social, contract, or discovery cross-check |
| 8 | Telegram | [link](https://t.me/capybaranation) | Identity, market, social, contract, or discovery cross-check |
| 9 | Capybara Nation Price Chart (BARA) - CoinGecko | [link](https://www.coingecko.com/en/coins/capybara-nation) | Identity, market, social, contract, or discovery cross-check |
| 10 | BARA to INR: Capybara Nation Price in Indian Rupee - CoinGecko | [link](https://www.coingecko.com/en/coins/capybara-nation/inr) | Identity, market, social, contract, or discovery cross-check |
| 11 | BARA to NGN: Capybara Nation Price in Nigerian Naira - CoinGecko | [link](https://www.coingecko.com/en/coins/capybara-nation/ngn) | Identity, market, social, contract, or discovery cross-check |
| 12 | Capybara Nation Price (BARA) - Coinbase | [link](https://www.coinbase.com/price/capybara-nation) | Identity, market, social, contract, or discovery cross-check |
| 13 | BARA to PKR: Capybara Nation Price in Pakistani Rupee / CoinGecko | [link](https://www.coingecko.com/en/coins/capybara-nation/pkr) | Identity, market, social, contract, or discovery cross-check |
| 14 | Google project search | [link](https://www.google.com/search?q=Capybara%20Nation%20BARA%20crypto) | Identity, market, social, contract, or discovery cross-check |
| 15 | Google tokenomics search | [link](https://www.google.com/search?q=Capybara%20Nation%20BARA%20tokenomics) | Identity, market, social, contract, or discovery cross-check |
| 16 | Google docs search | [link](https://www.google.com/search?q=Capybara%20Nation%20docs) | Identity, market, social, contract, or discovery cross-check |
| 17 | Google governance search | [link](https://www.google.com/search?q=Capybara%20Nation%20governance%20proposal) | Identity, market, social, contract, or discovery cross-check |
| 18 | Google audit search | [link](https://www.google.com/search?q=Capybara%20Nation%20audit%20report) | Identity, market, social, contract, or discovery cross-check |
| 19 | CoinMarketCap what-is guess | [link](https://coinmarketcap.com/cmc-ai/capybara-nation/what-is/) | Identity, market, social, contract, or discovery cross-check |
| 20 | CoinMarketCap price analysis guess | [link](https://coinmarketcap.com/cmc-ai/capybara-nation/price-analysis/) | Identity, market, social, contract, or discovery cross-check |
| 21 | CoinMarketCap currency guess | [link](https://coinmarketcap.com/currencies/capybara-nation/) | Identity, market, social, contract, or discovery cross-check |
| 22 | Dune discovery | [link](https://dune.com/browse/dashboards?q=Capybara%20Nation) | Identity, market, social, contract, or discovery cross-check |
| 23 | Dune token query | [link](https://dune.com/browse/queries?q=Capybara%20Nation) | Identity, market, social, contract, or discovery cross-check |
| 24 | DeFiLlama fees discovery | [link](https://defillama.com/fees?chain=All&search=Capybara%20Nation) | Identity, market, social, contract, or discovery cross-check |
| 25 | DeFiLlama yield discovery | [link](https://defillama.com/yields?token=BARA) | Identity, market, social, contract, or discovery cross-check |
| 26 | TokenUnlocks search | [link](https://token.unlocks.app/?search=Capybara%20Nation) | Identity, market, social, contract, or discovery cross-check |
| 27 | CryptoRank search | [link](https://cryptorank.io/price/capybara-nation) | Identity, market, social, contract, or discovery cross-check |
| 28 | RootData search | [link](https://www.rootdata.com/search?kw=Capybara%20Nation) | Identity, market, social, contract, or discovery cross-check |
| 29 | CoinDesk search | [link](https://www.coindesk.com/search?s=Capybara%20Nation) | Identity, market, social, contract, or discovery cross-check |
| 30 | The Block search | [link](https://www.theblock.co/search?query=Capybara%20Nation) | Identity, market, social, contract, or discovery cross-check |
| 31 | GitHub search | [link](https://github.com/search?q=Capybara%20Nation&type=repositories) | Identity, market, social, contract, or discovery cross-check |
| 32 | Etherscan token search | [link](https://etherscan.io/search?f=0&q=BARA) | Identity, market, social, contract, or discovery cross-check |
| 33 | BscScan token search | [link](https://bscscan.com/search?f=0&q=BARA) | Identity, market, social, contract, or discovery cross-check |
| 34 | Arbiscan token search | [link](https://arbiscan.io/search?f=0&q=BARA) | Identity, market, social, contract, or discovery cross-check |

Additional direct source list:

- [Official website](https://capybaranation.xyz/)
- [CoinGecko search](https://www.coingecko.com/en/search?query=Capybara%20Nation)
- [CoinMarketCap discovery](https://coinmarketcap.com/search/?q=Capybara%20Nation)
- [DefiLlama protocol discovery](https://defillama.com/search?query=Capybara%20Nation)
- [Token Terminal discovery](https://tokenterminal.com/explorer?search=Capybara%20Nation)
- [Messari discovery](https://messari.io/search?q=Capybara%20Nation)
- [X profile](https://x.com/capy_nation)
- [Telegram](https://t.me/capybaranation)
- [Capybara Nation Price Chart (BARA) - CoinGecko](https://www.coingecko.com/en/coins/capybara-nation)
- [BARA to INR: Capybara Nation Price in Indian Rupee - CoinGecko](https://www.coingecko.com/en/coins/capybara-nation/inr)
- [BARA to NGN: Capybara Nation Price in Nigerian Naira - CoinGecko](https://www.coingecko.com/en/coins/capybara-nation/ngn)
- [Capybara Nation Price (BARA) - Coinbase](https://www.coinbase.com/price/capybara-nation)
- [BARA to PKR: Capybara Nation Price in Pakistani Rupee | CoinGecko](https://www.coingecko.com/en/coins/capybara-nation/pkr)
- [Google project search](https://www.google.com/search?q=Capybara%20Nation%20BARA%20crypto)
- [Google tokenomics search](https://www.google.com/search?q=Capybara%20Nation%20BARA%20tokenomics)
- [Google docs search](https://www.google.com/search?q=Capybara%20Nation%20docs)
- [Google governance search](https://www.google.com/search?q=Capybara%20Nation%20governance%20proposal)
- [Google audit search](https://www.google.com/search?q=Capybara%20Nation%20audit%20report)
- [CoinMarketCap what-is guess](https://coinmarketcap.com/cmc-ai/capybara-nation/what-is/)
- [CoinMarketCap price analysis guess](https://coinmarketcap.com/cmc-ai/capybara-nation/price-analysis/)
- [CoinMarketCap currency guess](https://coinmarketcap.com/currencies/capybara-nation/)
- [Dune discovery](https://dune.com/browse/dashboards?q=Capybara%20Nation)
- [Dune token query](https://dune.com/browse/queries?q=Capybara%20Nation)
- [DeFiLlama fees discovery](https://defillama.com/fees?chain=All&search=Capybara%20Nation)
