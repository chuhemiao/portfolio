---
title: 'Decentrawood / DEOD: DeFi infrastructure value capture, liquidity, and token risk'
publishedAt: '2026-07-06'
summary: 'Decentrawood is treated as a DeFi infrastructure watchlist candidate sourced from CoinGecko/CMC discovery and refreshed with Surf, with emphasis on product durability, token value capture, liquidity, supply, and execution risk.'
slug: 'decentrawood-deod-defi-infrastructure-token-value-capture-risk'
category: 'research'
---

# Decentrawood / DEOD: DeFi infrastructure value capture, liquidity, and token risk

## Pre-screen Decision

**Decision: add to Research Map as a full-depth watchlist report, not as an automatic accumulation call.** Decentrawood appears in the local CoinGecko/CMC-oriented candidate pool through market discovery and was refreshed with Surf on 2026-07-06. The project has enough protocol surface for a real memo: chain exposure is Binance Smart Chain, Polygon Pos, Solana; exchange exposure is not disclosed; category tags are not disclosed; current market cap is $8.57M; FDV is $25.70M; and 24h volume is $307.22K. That combination makes it worth researching, but not enough to override the main risks: token value capture may be indirect, liquidity can be fragile, supply methodology may differ across data vendors, and protocol usage can be incentive-sensitive.

The report uses a conservative watchlist standard. A pass means the project deserves monitoring and comparison against peers. It does not mean the token is cheap. A fail would require one of three red flags: no identifiable official/project surface, no meaningful market or DeFi data, or a high-confidence duplicate in the Research Map. Local duplicate checks did not flag Decentrawood before this file was created, and the existing candidate note says: Seeded 2026-07-06 from Surf market-ranking; rank 1226, market cap $8,963,471, 24h volume $349,361. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.

## TL;DR / Executive Summary

Decentrawood is best understood as a **DeFi infrastructure** asset where the product thesis and the token thesis must be separated. The product thesis asks whether users, validators, LPs, borrowers, or asset issuers have a durable reason to use the protocol. The token thesis asks whether DEOD captures that activity through fees, staking, collateral, governance, liquidity routing, protocol-owned assets, or emissions control. The available evidence supports a watchlist entry, especially because it has a visible data footprint across Surf, CoinGecko, CMC discovery, and DeFi-oriented candidate notes. The evidence does not yet support a high-conviction valuation without better fee/revenue, unlock, treasury, and user-retention disclosure.

| Metric | Current read |
|---|---|
| Project | Decentrawood |
| Token | DEOD |
| Category | DeFi infrastructure |
| Chains | Binance Smart Chain, Polygon Pos, Solana |
| Exchanges | not disclosed |
| Price | $0.0136 |
| Market cap | $8.57M |
| FDV | $25.70M |
| 24h volume | $307.22K |
| Circulating supply | 629.96M |
| Total supply | 1.89B |
| 7d price change | 7.87% |
| 30d price change | 110.50% |
...
Base case: Decentrawood remains a selective watchlist asset until token value capture is cleaner. Bull case: protocol usage and token mechanics converge, turning DEOD into a security, collateral, or fee-routing asset with real demand. Bear case: the protocol remains useful but token holders absorb dilution, thin liquidity, governance optionality, or regulatory/technical tail risk.

## Project Overview

Decentrawood is a decentralized AI platform for entertainment, where users create, own, and earn from content using blockchain and AI. It offers metaverse experiences, gaming like DEODHunt, and music via TuneHub. The DEOD token operates on BNB Chain.

Surf's project profile maps Decentrawood to the following high-level surface:

| Area | Evidence |
|---|---|
| Website | [https://decentrawood.com/](https://decentrawood.com/) |
| X handle | [@decentrawood](https://x.com/decentrawood) |
| X followers | 24.21K |
| Tags | not disclosed |
| Chains | Binance Smart Chain, Polygon Pos, Solana |
| Exchanges | not disclosed |
...
| Liquidity | $307.22K 24h volume | Deeper CEX/DEX books and less fragmented contract liquidity |
| Supply quality | 629.96M circulating vs 1.89B total | Official unlock schedule and reconciled circulating methodology |
| Downside containment | Watchlist only | Transparent treasury, audits, risk controls, and stress-test history |

The strongest reason to add the report is not that Decentrawood is obviously cheap. It is that the project is large or specific enough to track in the Research Map, and the current candidate backlog indicates it had not yet been covered locally.

## Architecture / Mechanism

Decentrawood's architecture should be evaluated through the job it performs. For a DeFi infrastructure project, architecture is not merely code shape. It includes the contracts, governance process, integration path, oracle and risk dependencies, bridge or staking assumptions, collateral policies, and the way users enter and exit positions.
...
| Settlement layer | Chains and contracts that hold user value | Binance Smart Chain, Polygon Pos, Solana |
...
|---|---|---|---|
| bsc | DEOD | 0x3510fbbc13090f991ffa523527113a166161683e | [explorer](https://bscscan.com/token/0x3510fbbc13090f991ffa523527113a166161683e) |
| solana | DEOD | 3YwiEbpSmRKxfji5AvVNobz3xaYakLnLJV9MPZ4F2yWQ | [explorer](https://solscan.io/token/3YwiEbpSmRKxfji5AvVNobz3xaYakLnLJV9MPZ4F2yWQ) |
| polygon | DEOD | 0xe77abb1e75d2913b2076dd16049992ffeaca5235 | [explorer](https://polygonscan.com/token/0xe77abb1e75d2913b2076dd16049992ffeaca5235) |
| bsc | DEOD | 0x7f4b7431a4e1b9f375ef0a94224ea4ef09b4f668 | [explorer](https://bscscan.com/token/0x7f4b7431a4e1b9f375ef0a94224ea4ef09b4f668) |
...
The market intelligence layer has three parts: DeFi usage, market liquidity, and attention. For Decentrawood, the DeFi-oriented backlog note is the first signal: Seeded 2026-07-06 from Surf market-ranking; rank 1226, market cap $8,963,471, 24h volume $349,361. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.. Surf/CG data then adds market cap $8.57M, FDV $25.70M, 24h volume $307.22K, and price $0.0136.
...
| 24h volume | $307.22K | Position sizing and exit liquidity proxy |
| Market cap | $8.57M | Liquid valuation proxy |
| FDV | $25.70M | Dilution-aware valuation proxy |
| FDV / market cap spread | 3.00x | Higher spread means more supply risk |
| X followers | 24.21K | Attention proxy, not adoption proof |
...
| Accrual channel | Strength for Decentrawood | Evidence needed |
|---|---|---|
...
| Staking / security | Depends on whether DEOD is bonded or slashable | Staking contracts, validator docs, reward schedule |
...
The fifth frame is reflexivity. Many DeFi and infrastructure assets reprice in waves: first through TVL and listings, then through fee visibility, then through tokenomics cleanup, and finally through real cash-flow or strategic acquisition narratives. Decentrawood currently needs to be monitored through that sequence. The available 90-day TVL series has 0 point(s), latest TVL not disclosed, and approximate change not disclosed. Market-price movement shows 7d 7.87% and 30d 110.50% when Surf or CoinGecko exposed the field. If TVL and price move together, the thesis may be simple beta. If TVL rises while price lags, the thesis becomes value-capture skepticism. If price rises while TVL falls, the thesis becomes momentum without fundamental confirmation.

The conservative conclusion is that Decentrawood's product relevance may be ahead of its token value capture. That is common in this sector. The report should therefore watch for activation events: fee switch, staking redesign, revenue dashboard, cap increases, major integrations, or emissions reductions.
...
Decentrawood competes in the DeFi infrastructure bucket, where category peers vary by exact design. The memo uses functional competitors rather than only ticker competitors:
...
The key competitive question is whether Decentrawood has a reason to exist beyond incentives. If switching costs are low and users are primarily chasing emissions, any valuation premium should be temporary. If the protocol controls a scarce integration point, compliance rail, validator layer, or liquidity venue, it can deserve a persistent watchlist premium.
...
Weighted conclusion: Decentrawood is important enough to track, but not clean enough to rank as a high-conviction token until economic capture is clearer.

## Bull / Base / Bear

| Scenario | Probability | Thesis | Monitoring signal |
|---|---:|---|---|
| Bull | 25% | Decentrawood compounds usage, liquidity improves, and DEOD gains measurable value capture through staking, fees, collateral, or governance-controlled economics. | TVL up, fees visible, volume deepens, supply overhang falls |
...
The strongest bearish critique is simple: this could be a useful protocol with an average token. If DEOD does not capture fees or security demand, the market will eventually value it as governance optionality plus liquidity beta. The second critique is data inconsistency. CG, CMC, Surf, and official docs can disagree on circulating supply, FDV, and market cap. The third critique is reflexive TVL: deposits can leave quickly when incentives, yields, or narratives change.
...
| 24h volume | $307.22K | Weekly | Volume below position-size threshold |
...
1. Re-run Surf project-detail and project-defi-metrics if Decentrawood announces a major integration, listing, tokenomics change, exploit, or governance proposal.
...
This report intentionally separates source availability from source quality. Decentrawood has a visible market footprint, but a visible footprint is not the same as a reconciled investment record. The Research Map standard treats CoinGecko and CoinMarketCap as discovery and market-data surfaces, Surf as an aggregation and refresh layer, DefiLlama style records as a protocol-usage lens, and official docs as the final arbiter for product mechanics. When these sources disagree, the disagreement itself is part of the thesis. A token with unclear supply methodology, mismatched contract labels, stale app docs, or broken dashboard coverage is usually harder to underwrite even when the narrative looks attractive.

For Decentrawood, the first reconciliation job is identity. The token symbol is DEOD, the category is DeFi infrastructure, chains are Binance Smart Chain, Polygon Pos, Solana, exchanges are not disclosed, and tags are not disclosed. These fields should be checked against official docs, token contracts, exchange market tabs, and community channels before the report graduates from watchlist to allocation candidate. If DEOD trades on multiple chains, each contract should be mapped to a canonical issuer statement. If the same symbol is reused by another asset, exchange tickers and contract addresses must be treated as separate facts rather than as interchangeable labels. This matters because a fuzzy ticker match can make a good memo wrong at the first line.

The second reconciliation job is market data. Market cap is $8.57M, FDV is $25.70M, 24h volume is $307.22K, FDV / market cap is 3.00x, 7d price change is 7.87%, and 30d price change is 110.50%. These numbers need a vendor-drift check. If CMC reports a different circulating supply from CoinGecko or Surf, the memo should prefer the official unlock and circulating-supply definition, then keep the aggregator spread as a risk note. If volume is dominated by one venue, the liquidity score should be lower than the headline volume implies. If FDV is not disclosed or total supply is missing, the base case should assume worse dilution until proven otherwise.
...
For Decentrawood, the current liquidity read is watchlist first. The market cap is $8.57M, FDV is $25.70M, reported 24h volume is $307.22K, and FDV / market cap is 3.00x. These values can support a research card, but they do not automatically support an investment. A cleaner setup would show stable volume across multiple venues, narrow spreads, less reliance on a single pair, and a supply schedule that does not create a near-term wall of unlock pressure.
...
The failure-mode view is deliberately harsher than the base case. Decentrawood can fail for reasons that do not show up in a simple market-data table. Smart contracts can be exploited. Oracles can misprice collateral. Bridges can be paused. Staking systems can experience slashing or validator concentration. RWA systems can face issuer, custodian, or redemption risk. Stablecoin systems can lose pegs. Privacy systems can face sanctions, delistings, or legal restrictions. DEXs and yield systems can lose users when incentives rotate. A full-depth memo should make these risks visible before they become headlines.

For Decentrawood, the live monitoring stack should include contract events, TVL, volume, governance, documentation changes, social announcements, security disclosures, and exchange-market quality. A single metric is not enough. TVL may stay high while liquidity thins. Volume may rise because of volatility rather than adoption. Social attention may rise around controversy rather than progress. Governance may pass proposals that improve short-term price but add long-term risk. The strongest monitoring dashboard combines on-chain state, off-chain disclosure, and market quality.

Incident response matters because crypto risks are discontinuous. A protocol can look normal until a bridge halt, oracle issue, admin pause, market-maker withdrawal, regulatory action, or treasury sale changes the entire thesis. The Research Map should therefore attach explicit downgrade triggers. If Decentrawood suffers a material exploit, downgrade until a post-mortem, reimbursement plan, and contract patch are published. If supply expands faster than disclosed, downgrade tokenomics confidence. If the main app loses integrations or TVL without explanation, downgrade product durability. If market depth collapses while price holds, downgrade liquidity quality.
...
| Peer comparison | Monthly | Decentrawood gains share with better economics | Peers grow faster with cleaner capture |

## Evidence Ledger

| # | Source | Link | Why it matters |
|---:|---|---|---|
| 1 | Official website | [link](https://decentrawood.com/) | Identity, market, social, contract, or discovery cross-check |
| 2 | CoinGecko search | [link](https://www.coingecko.com/en/search?query=Decentrawood) | Identity, market, social, contract, or discovery cross-check |
| 3 | CoinMarketCap discovery | [link](https://coinmarketcap.com/search/?q=Decentrawood) | Identity, market, social, contract, or discovery cross-check |
| 4 | DefiLlama protocol discovery | [link](https://defillama.com/search?query=Decentrawood) | Identity, market, social, contract, or discovery cross-check |
| 5 | Token Terminal discovery | [link](https://tokenterminal.com/explorer?search=Decentrawood) | Identity, market, social, contract, or discovery cross-check |
| 6 | Messari discovery | [link](https://messari.io/search?q=Decentrawood) | Identity, market, social, contract, or discovery cross-check |
| 7 | X profile | [link](https://x.com/decentrawood) | Identity, market, social, contract, or discovery cross-check |
| 8 | Telegram | [link](https://t.me/decentrawood_platform) | Identity, market, social, contract, or discovery cross-check |
| 9 | Decentrawood DEOD Price - CoinGecko | [link](https://www.coingecko.com/en/coins/decentrawood) | Identity, market, social, contract, or discovery cross-check |
| 10 | DEOD to BTC: Decentrawood Price in Bitcoin - CoinGecko | [link](https://www.coingecko.com/en/coins/decentrawood/btc) | Identity, market, social, contract, or discovery cross-check |
...
| 12 | New Deod Tokenomics (v2 – Current Contract) - Decentrawood | [link](https://decentrawood.com/DeodToken) | Identity, market, social, contract, or discovery cross-check |
| 13 | Decentrawood Price History: Download DEOD Historical Data | [link](https://www.coingecko.com/en/coins/decentrawood/historical_data) | Identity, market, social, contract, or discovery cross-check |
| 14 | bsc DEOD | [link](https://bscscan.com/token/0x3510fbbc13090f991ffa523527113a166161683e) | Identity, market, social, contract, or discovery cross-check |
| 15 | solana DEOD | [link](https://solscan.io/token/3YwiEbpSmRKxfji5AvVNobz3xaYakLnLJV9MPZ4F2yWQ) | Identity, market, social, contract, or discovery cross-check |
| 16 | polygon DEOD | [link](https://polygonscan.com/token/0xe77abb1e75d2913b2076dd16049992ffeaca5235) | Identity, market, social, contract, or discovery cross-check |
| 17 | bsc DEOD | [link](https://bscscan.com/token/0x7f4b7431a4e1b9f375ef0a94224ea4ef09b4f668) | Identity, market, social, contract, or discovery cross-check |
| 18 | Google project search | [link](https://www.google.com/search?q=Decentrawood%20DEOD%20crypto) | Identity, market, social, contract, or discovery cross-check |
| 19 | Google tokenomics search | [link](https://www.google.com/search?q=Decentrawood%20DEOD%20tokenomics) | Identity, market, social, contract, or discovery cross-check |
| 20 | Google docs search | [link](https://www.google.com/search?q=Decentrawood%20docs) | Identity, market, social, contract, or discovery cross-check |
| 21 | Google governance search | [link](https://www.google.com/search?q=Decentrawood%20governance%20proposal) | Identity, market, social, contract, or discovery cross-check |
| 22 | Google audit search | [link](https://www.google.com/search?q=Decentrawood%20audit%20report) | Identity, market, social, contract, or discovery cross-check |
| 23 | CoinMarketCap what-is guess | [link](https://coinmarketcap.com/cmc-ai/decentrawood/what-is/) | Identity, market, social, contract, or discovery cross-check |
| 24 | CoinMarketCap price analysis guess | [link](https://coinmarketcap.com/cmc-ai/decentrawood/price-analysis/) | Identity, market, social, contract, or discovery cross-check |
| 25 | CoinMarketCap currency guess | [link](https://coinmarketcap.com/currencies/decentrawood/) | Identity, market, social, contract, or discovery cross-check |
| 26 | Dune discovery | [link](https://dune.com/browse/dashboards?q=Decentrawood) | Identity, market, social, contract, or discovery cross-check |
| 27 | Dune token query | [link](https://dune.com/browse/queries?q=Decentrawood) | Identity, market, social, contract, or discovery cross-check |
| 28 | DeFiLlama fees discovery | [link](https://defillama.com/fees?chain=All&search=Decentrawood) | Identity, market, social, contract, or discovery cross-check |
| 29 | DeFiLlama yield discovery | [link](https://defillama.com/yields?token=DEOD) | Identity, market, social, contract, or discovery cross-check |
| 30 | TokenUnlocks search | [link](https://token.unlocks.app/?search=Decentrawood) | Identity, market, social, contract, or discovery cross-check |
| 31 | CryptoRank search | [link](https://cryptorank.io/price/decentrawood) | Identity, market, social, contract, or discovery cross-check |
| 32 | RootData search | [link](https://www.rootdata.com/search?kw=Decentrawood) | Identity, market, social, contract, or discovery cross-check |
| 33 | CoinDesk search | [link](https://www.coindesk.com/search?s=Decentrawood) | Identity, market, social, contract, or discovery cross-check |
| 34 | The Block search | [link](https://www.theblock.co/search?query=Decentrawood) | Identity, market, social, contract, or discovery cross-check |

Additional direct source list:

- [Official website](https://decentrawood.com/)
- [CoinGecko search](https://www.coingecko.com/en/search?query=Decentrawood)
- [CoinMarketCap discovery](https://coinmarketcap.com/search/?q=Decentrawood)
- [DefiLlama protocol discovery](https://defillama.com/search?query=Decentrawood)
- [Token Terminal discovery](https://tokenterminal.com/explorer?search=Decentrawood)
- [Messari discovery](https://messari.io/search?q=Decentrawood)
- [X profile](https://x.com/decentrawood)
- [Telegram](https://t.me/decentrawood_platform)
- [Decentrawood DEOD Price - CoinGecko](https://www.coingecko.com/en/coins/decentrawood)
- [DEOD to BTC: Decentrawood Price in Bitcoin - CoinGecko](https://www.coingecko.com/en/coins/decentrawood/btc)
- [CoinGecko: Cryptocurrency Prices, Charts, and Crypto Market Cap](https://www.coingecko.com/)
- [New Deod Tokenomics (v2 – Current Contract) - Decentrawood](https://decentrawood.com/DeodToken)
- [Decentrawood Price History: Download DEOD Historical Data](https://www.coingecko.com/en/coins/decentrawood/historical_data)
- [bsc DEOD](https://bscscan.com/token/0x3510fbbc13090f991ffa523527113a166161683e)
- [solana DEOD](https://solscan.io/token/3YwiEbpSmRKxfji5AvVNobz3xaYakLnLJV9MPZ4F2yWQ)
- [polygon DEOD](https://polygonscan.com/token/0xe77abb1e75d2913b2076dd16049992ffeaca5235)
- [bsc DEOD](https://bscscan.com/token/0x7f4b7431a4e1b9f375ef0a94224ea4ef09b4f668)
- [Google project search](https://www.google.com/search?q=Decentrawood%20DEOD%20crypto)
- [Google tokenomics search](https://www.google.com/search?q=Decentrawood%20DEOD%20tokenomics)
- [Google docs search](https://www.google.com/search?q=Decentrawood%20docs)
- [Google governance search](https://www.google.com/search?q=Decentrawood%20governance%20proposal)
- [Google audit search](https://www.google.com/search?q=Decentrawood%20audit%20report)
- [CoinMarketCap what-is guess](https://coinmarketcap.com/cmc-ai/decentrawood/what-is/)
- [CoinMarketCap price analysis guess](https://coinmarketcap.com/cmc-ai/decentrawood/price-analysis/)

## Final Investment View

Decentrawood should be in the Research Map as a **watchlist / selective diligence** asset. The project has enough category relevance and data footprint to merit ongoing coverage, especially because it came from the CG/CMC-oriented candidate workflow and has no high-confidence local duplicate. The current evidence does not yet support a high-conviction allocation thesis. The next level of confidence requires cleaner token economics: fee capture, staking or collateral utility, transparent unlocks, and liquidity that can support realistic position sizing.
