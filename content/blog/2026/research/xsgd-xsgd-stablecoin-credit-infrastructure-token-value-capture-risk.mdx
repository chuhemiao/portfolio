---
title: 'XSGD / XSGD: stablecoin / credit infrastructure value capture, liquidity, and token risk'
publishedAt: '2026-07-06'
summary: 'XSGD is treated as a stablecoin / credit infrastructure watchlist candidate sourced from CoinGecko/CMC discovery and refreshed with Surf, with emphasis on product durability, token value capture, liquidity, supply, and execution risk.'
slug: 'xsgd-xsgd-stablecoin-credit-infrastructure-token-value-capture-risk'
category: 'research'
---

# XSGD / XSGD: stablecoin / credit infrastructure value capture, liquidity, and token risk

## Pre-screen Decision

**Decision: add to Research Map as a full-depth watchlist report, not as an automatic accumulation call.** XSGD appears in the local CoinGecko/CMC-oriented candidate pool through market discovery and was refreshed with Surf on 2026-07-06. The project has enough protocol surface for a real memo: chain exposure is Arbitrum One, Avalanche, Base, Ethereum, Hedera, Polygon Pos, Xrp, Zilliqa; exchange exposure is not disclosed; category tags are Stablecoins, Payments & Gateway; current market cap is $11.69M; FDV is $11.69M; and 24h volume is $534.71K. That combination makes it worth researching, but not enough to override the main risks: token value capture may be indirect, liquidity can be fragile, supply methodology may differ across data vendors, and protocol usage can be incentive-sensitive.

The report uses a conservative watchlist standard. A pass means the project deserves monitoring and comparison against peers. It does not mean the token is cheap. A fail would require one of three red flags: no identifiable official/project surface, no meaningful market or DeFi data, or a high-confidence duplicate in the Research Map. Local duplicate checks did not flag XSGD before this file was created, and the existing candidate note says: Seeded 2026-07-06 from Surf market-ranking; rank 1087, market cap $11,681,236, 24h volume $507,952. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.

## TL;DR / Executive Summary

XSGD is best understood as a **stablecoin / credit infrastructure** asset where the product thesis and the token thesis must be separated. The product thesis asks whether users, validators, LPs, borrowers, or asset issuers have a durable reason to use the protocol. The token thesis asks whether XSGD captures that activity through fees, staking, collateral, governance, liquidity routing, protocol-owned assets, or emissions control. The available evidence supports a watchlist entry, especially because it has a visible data footprint across Surf, CoinGecko, CMC discovery, and DeFi-oriented candidate notes. The evidence does not yet support a high-conviction valuation without better fee/revenue, unlock, treasury, and user-retention disclosure.
...
| Chains | Arbitrum One, Avalanche, Base, Ethereum, Hedera, Polygon Pos, Xrp, Zilliqa |
...
Base case: XSGD remains a selective watchlist asset until token value capture is cleaner. Bull case: protocol usage and token mechanics converge, turning XSGD into a security, collateral, or fee-routing asset with real demand. Bear case: the protocol remains useful but token holders absorb dilution, thin liquidity, governance optionality, or regulatory/technical tail risk.

## Project Overview

XSGD is the fully collateralized Singapore Dollar stablecoin, powered by open-source blockchain protocols. StraitsX enables fast and safe access to digital assets markets and decentralized finance applications through the StraitsX APIs and stablecoins for individuals and businesses. Key features of XSGD: - Regulatory Compliant. Issued by Xfers, a licensed Major Payment Institution under the e-money issuance framework - Fully Backed with Fiat Reserves. Each XSGD is backed by one Singapore dollar that is being held and safeguarded in a Singapore bank - Transparent & Trusted. Each XSGD will always be redeemable on a one-for-one basis with the Singapore Dollar on our platform - Multi-chain XSGD. Take advantage of the speed, scalability, and cost-efficiency offered by Ethereum and Zilliqa.

Surf's project profile maps XSGD to the following high-level surface:

| Area | Evidence |
|---|---|
| Website | [https://www.straitsx.com/sg](https://www.straitsx.com/sg) |
| X handle | [@StraitsX](https://x.com/StraitsX) |
| X followers | 7.26K |
...
| Liquidity | $534.71K 24h volume | Deeper CEX/DEX books and less fragmented contract liquidity |
| Supply quality | 15.11M circulating vs 15.11M total | Official unlock schedule and reconciled circulating methodology |
| Downside containment | Watchlist only | Transparent treasury, audits, risk controls, and stress-test history |

The strongest reason to add the report is not that XSGD is obviously cheap. It is that the project is large or specific enough to track in the Research Map, and the current candidate backlog indicates it had not yet been covered locally.
...
| Settlement layer | Chains and contracts that hold user value | Arbitrum One, Avalanche, Base, Ethereum, Hedera, Polygon Pos, Xrp, Zilliqa |
...
|---|---|---|---|
| Xrp | XSGD | rK67JczCpaYXVtfw3qJVmqwpSfa1bYTptw | not mapped |
| arbitrum | XSGD | 0xe333e7754a2dc1e020a162ecab019254b9dab653 | [explorer](https://arbiscan.io/token/0xe333e7754a2dc1e020a162ecab019254b9dab653) |
| Xrp | XSGD | XSGD.rK67JczCpaYXVtfw3qJVmqwpSfa1bYTptw | not mapped |
| base | XSGD | 0x0a4c9cb2778ab3302996a34befcf9a8bc288c33b | [explorer](https://basescan.org/token/0x0a4c9cb2778ab3302996a34befcf9a8bc288c33b) |
| Zilliqa | XSGD | zil180v66mlw007ltdv8tq5t240y7upwgf7djklmwh | not mapped |
| ethereum | XSGD | 0x70e8de73ce538da2beed35d14187f6959a8eca96 | [explorer](https://etherscan.io/token/0x70e8de73ce538da2beed35d14187f6959a8eca96) |
| avalanche | XSGD | 0xb2f85b7ab3c2b6f62df06de6ae7d09c010a5096e | [explorer](https://snowtrace.io/token/0xb2f85b7ab3c2b6f62df06de6ae7d09c010a5096e) |
| polygon | XSGD | 0xdc3326e71d45186f113a2f448984ca0e8d201995 | [explorer](https://polygonscan.com/token/0xdc3326e71d45186f113a2f448984ca0e8d201995) |
...
The market intelligence layer has three parts: DeFi usage, market liquidity, and attention. For XSGD, the DeFi-oriented backlog note is the first signal: Seeded 2026-07-06 from Surf market-ranking; rank 1087, market cap $11,681,236, 24h volume $507,952. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.. Surf/CG data then adds market cap $11.69M, FDV $11.69M, 24h volume $534.71K, and price $0.7737.
...
| 24h volume | $534.71K | Position sizing and exit liquidity proxy |
| Market cap | $11.69M | Liquid valuation proxy |
| FDV | $11.69M | Dilution-aware valuation proxy |
| FDV / market cap spread | 1.00x | Higher spread means more supply risk |
| X followers | 7.26K | Attention proxy, not adoption proof |
...
| Accrual channel | Strength for XSGD | Evidence needed |
|---|---|---|
...
| Staking / security | Depends on whether XSGD is bonded or slashable | Staking contracts, validator docs, reward schedule |
...
The fifth frame is reflexivity. Many DeFi and infrastructure assets reprice in waves: first through TVL and listings, then through fee visibility, then through tokenomics cleanup, and finally through real cash-flow or strategic acquisition narratives. XSGD currently needs to be monitored through that sequence. The available 90-day TVL series has 0 point(s), latest TVL not disclosed, and approximate change not disclosed. Market-price movement shows 7d 0.33% and 30d 0.09% when Surf or CoinGecko exposed the field. If TVL and price move together, the thesis may be simple beta. If TVL rises while price lags, the thesis becomes value-capture skepticism. If price rises while TVL falls, the thesis becomes momentum without fundamental confirmation.

The conservative conclusion is that XSGD's product relevance may be ahead of its token value capture. That is common in this sector. The report should therefore watch for activation events: fee switch, staking redesign, revenue dashboard, cap increases, major integrations, or emissions reductions.
...
XSGD competes in the stablecoin / credit infrastructure bucket, where category peers vary by exact design. The memo uses functional competitors rather than only ticker competitors:
...
The key competitive question is whether XSGD has a reason to exist beyond incentives. If switching costs are low and users are primarily chasing emissions, any valuation premium should be temporary. If the protocol controls a scarce integration point, compliance rail, validator layer, or liquidity venue, it can deserve a persistent watchlist premium.
...
Weighted conclusion: XSGD is important enough to track, but not clean enough to rank as a high-conviction token until economic capture is clearer.

## Bull / Base / Bear

| Scenario | Probability | Thesis | Monitoring signal |
|---|---:|---|---|
| Bull | 25% | XSGD compounds usage, liquidity improves, and XSGD gains measurable value capture through staking, fees, collateral, or governance-controlled economics. | TVL up, fees visible, volume deepens, supply overhang falls |
...
**Confidence: 6.2 / 10.** The score is above neutral because XSGD has enough source coverage and category relevance to justify a full report. It is below high conviction because several valuation-critical fields remain unresolved: durable fees, tokenholder capture, precise unlocks, and stress-tested liquidity.
...
The strongest bearish critique is simple: this could be a useful protocol with an average token. If XSGD does not capture fees or security demand, the market will eventually value it as governance optionality plus liquidity beta. The second critique is data inconsistency. CG, CMC, Surf, and official docs can disagree on circulating supply, FDV, and market cap. The third critique is reflexive TVL: deposits can leave quickly when incentives, yields, or narratives change.
...
| 24h volume | $534.71K | Weekly | Volume below position-size threshold |
...
1. Re-run Surf project-detail and project-defi-metrics if XSGD announces a major integration, listing, tokenomics change, exploit, or governance proposal.
...
This report intentionally separates source availability from source quality. XSGD has a visible market footprint, but a visible footprint is not the same as a reconciled investment record. The Research Map standard treats CoinGecko and CoinMarketCap as discovery and market-data surfaces, Surf as an aggregation and refresh layer, DefiLlama style records as a protocol-usage lens, and official docs as the final arbiter for product mechanics. When these sources disagree, the disagreement itself is part of the thesis. A token with unclear supply methodology, mismatched contract labels, stale app docs, or broken dashboard coverage is usually harder to underwrite even when the narrative looks attractive.

For XSGD, the first reconciliation job is identity. The token symbol is XSGD, the category is stablecoin / credit infrastructure, chains are Arbitrum One, Avalanche, Base, Ethereum, Hedera, Polygon Pos, Xrp, Zilliqa, exchanges are not disclosed, and tags are Stablecoins, Payments & Gateway. These fields should be checked against official docs, token contracts, exchange market tabs, and community channels before the report graduates from watchlist to allocation candidate. If XSGD trades on multiple chains, each contract should be mapped to a canonical issuer statement. If the same symbol is reused by another asset, exchange tickers and contract addresses must be treated as separate facts rather than as interchangeable labels. This matters because a fuzzy ticker match can make a good memo wrong at the first line.

The second reconciliation job is market data. Market cap is $11.69M, FDV is $11.69M, 24h volume is $534.71K, FDV / market cap is 1.00x, 7d price change is 0.33%, and 30d price change is 0.09%. These numbers need a vendor-drift check. If CMC reports a different circulating supply from CoinGecko or Surf, the memo should prefer the official unlock and circulating-supply definition, then keep the aggregator spread as a risk note. If volume is dominated by one venue, the liquidity score should be lower than the headline volume implies. If FDV is not disclosed or total supply is missing, the base case should assume worse dilution until proven otherwise.
...
|---|---|---|
| Identity | XSGD / XSGD | Match official docs, CG, CMC, Surf, contracts |
| Category | stablecoin / credit infrastructure | Confirm product mechanics and revenue model |
| Chains | Arbitrum One, Avalanche, Base, Ethereum, Hedera, Polygon Pos, Xrp, Zilliqa | Confirm canonical deployments and bridge assumptions |
| Exchanges | not disclosed | Check live order books and inactive pairs |
| Market cap | $11.69M | Compare Surf, CG, CMC, exchange pages |
| FDV | $11.69M | Reconcile total supply and unlock schedule |
| Volume | $534.71K | Check exchange concentration and wash-trading risk |
| TVL | not disclosed | Confirm TVL meaning, source, and double-counting risk |

## Primary-source Diligence Work Plan

The next diligence pass should start from primary sources, not from the token chart. The first document to find is an official docs or whitepaper page that explains what XSGD does and where users interact with it. The second is tokenomics: allocation, emissions, unlocks, utility, fee routing, treasury policy, and governance rights. The third is security material: audits, bug bounty scope, incident post-mortems, admin-key disclosures, or upgrade timelocks. The fourth is usage evidence: live app metrics, dashboards, contract balances, fee dashboards, validator counts, loan books, LP depth, or stablecoin collateral reports. Without those four documents, any price target is mostly narrative.

For XSGD, the primary-source pass should answer a narrow sequence of questions. What user action creates protocol value? Who pays? Who receives the fee or spread? Does XSGD sit inside that flow, or does it only vote on parameters? Can users exit without trusting a multisig, bridge, centralized custodian, or opaque off-chain book? What part of the system can be paused or upgraded? Which parameters would cause losses if changed incorrectly? If the project is young, which metrics prove organic adoption rather than incentives? If the project is mature, which metrics prove durability rather than slow decline?
...
For XSGD, the current liquidity read is watchlist first. The market cap is $11.69M, FDV is $11.69M, reported 24h volume is $534.71K, and FDV / market cap is 1.00x. These values can support a research card, but they do not automatically support an investment. A cleaner setup would show stable volume across multiple venues, narrow spreads, less reliance on a single pair, and a supply schedule that does not create a near-term wall of unlock pressure.
...
| Peer comparison | Monthly | XSGD gains share with better economics | Peers grow faster with cleaner capture |

## Evidence Ledger

| # | Source | Link | Why it matters |
|---:|---|---|---|
| 1 | Official website | [link](https://www.straitsx.com/sg) | Identity, market, social, contract, or discovery cross-check |
| 2 | CoinGecko search | [link](https://www.coingecko.com/en/search?query=XSGD) | Identity, market, social, contract, or discovery cross-check |
| 3 | CoinMarketCap discovery | [link](https://coinmarketcap.com/search/?q=XSGD) | Identity, market, social, contract, or discovery cross-check |
| 4 | DefiLlama protocol discovery | [link](https://defillama.com/search?query=XSGD) | Identity, market, social, contract, or discovery cross-check |
| 5 | Token Terminal discovery | [link](https://tokenterminal.com/explorer?search=XSGD) | Identity, market, social, contract, or discovery cross-check |
| 6 | Messari discovery | [link](https://messari.io/search?q=XSGD) | Identity, market, social, contract, or discovery cross-check |
| 7 | X profile | [link](https://x.com/StraitsX) | Identity, market, social, contract, or discovery cross-check |
| 8 | GitHub | [link](https://github.com/Xfers/StraitsX-tokens) | Identity, market, social, contract, or discovery cross-check |
| 9 | XSGD/USD Live Price Chart, Market Cap & News Today - CoinGecko | [link](https://www.coingecko.com/en/coins/xsgd) | Identity, market, social, contract, or discovery cross-check |
...
| 11 | XSGD to BTC: XSGD Price in Bitcoin - CoinGecko | [link](https://www.coingecko.com/en/coins/xsgd/btc) | Identity, market, social, contract, or discovery cross-check |
| 12 | XSGD Price History: Download XSGD Historical Data - CoinGecko | [link](https://www.coingecko.com/en/coins/xsgd/historical_data) | Identity, market, social, contract, or discovery cross-check |
| 13 | XSGD / Singapore Dollar Stablecoin by StraitsX | [link](https://www.straitsx.com/xsgd) | Identity, market, social, contract, or discovery cross-check |
| 14 | arbitrum XSGD | [link](https://arbiscan.io/token/0xe333e7754a2dc1e020a162ecab019254b9dab653) | Identity, market, social, contract, or discovery cross-check |
| 15 | base XSGD | [link](https://basescan.org/token/0x0a4c9cb2778ab3302996a34befcf9a8bc288c33b) | Identity, market, social, contract, or discovery cross-check |
| 16 | ethereum XSGD | [link](https://etherscan.io/token/0x70e8de73ce538da2beed35d14187f6959a8eca96) | Identity, market, social, contract, or discovery cross-check |
| 17 | avalanche XSGD | [link](https://snowtrace.io/token/0xb2f85b7ab3c2b6f62df06de6ae7d09c010a5096e) | Identity, market, social, contract, or discovery cross-check |
| 18 | polygon XSGD | [link](https://polygonscan.com/token/0xdc3326e71d45186f113a2f448984ca0e8d201995) | Identity, market, social, contract, or discovery cross-check |
| 19 | Google project search | [link](https://www.google.com/search?q=XSGD%20XSGD%20crypto) | Identity, market, social, contract, or discovery cross-check |
| 20 | Google tokenomics search | [link](https://www.google.com/search?q=XSGD%20XSGD%20tokenomics) | Identity, market, social, contract, or discovery cross-check |
| 21 | Google docs search | [link](https://www.google.com/search?q=XSGD%20docs) | Identity, market, social, contract, or discovery cross-check |
| 22 | Google governance search | [link](https://www.google.com/search?q=XSGD%20governance%20proposal) | Identity, market, social, contract, or discovery cross-check |
| 23 | Google audit search | [link](https://www.google.com/search?q=XSGD%20audit%20report) | Identity, market, social, contract, or discovery cross-check |
| 24 | CoinMarketCap what-is guess | [link](https://coinmarketcap.com/cmc-ai/xsgd/what-is/) | Identity, market, social, contract, or discovery cross-check |
| 25 | CoinMarketCap price analysis guess | [link](https://coinmarketcap.com/cmc-ai/xsgd/price-analysis/) | Identity, market, social, contract, or discovery cross-check |
| 26 | CoinMarketCap currency guess | [link](https://coinmarketcap.com/currencies/xsgd/) | Identity, market, social, contract, or discovery cross-check |
| 27 | Dune discovery | [link](https://dune.com/browse/dashboards?q=XSGD) | Identity, market, social, contract, or discovery cross-check |
| 28 | Dune token query | [link](https://dune.com/browse/queries?q=XSGD) | Identity, market, social, contract, or discovery cross-check |
| 29 | DeFiLlama fees discovery | [link](https://defillama.com/fees?chain=All&search=XSGD) | Identity, market, social, contract, or discovery cross-check |
| 30 | DeFiLlama yield discovery | [link](https://defillama.com/yields?token=XSGD) | Identity, market, social, contract, or discovery cross-check |
| 31 | TokenUnlocks search | [link](https://token.unlocks.app/?search=XSGD) | Identity, market, social, contract, or discovery cross-check |
| 32 | CryptoRank search | [link](https://cryptorank.io/price/xsgd) | Identity, market, social, contract, or discovery cross-check |
| 33 | RootData search | [link](https://www.rootdata.com/search?kw=XSGD) | Identity, market, social, contract, or discovery cross-check |
| 34 | CoinDesk search | [link](https://www.coindesk.com/search?s=XSGD) | Identity, market, social, contract, or discovery cross-check |

Additional direct source list:

- [Official website](https://www.straitsx.com/sg)
- [CoinGecko search](https://www.coingecko.com/en/search?query=XSGD)
- [CoinMarketCap discovery](https://coinmarketcap.com/search/?q=XSGD)
- [DefiLlama protocol discovery](https://defillama.com/search?query=XSGD)
- [Token Terminal discovery](https://tokenterminal.com/explorer?search=XSGD)
- [Messari discovery](https://messari.io/search?q=XSGD)
- [X profile](https://x.com/StraitsX)
- [GitHub](https://github.com/Xfers/StraitsX-tokens)
- [XSGD/USD Live Price Chart, Market Cap & News Today - CoinGecko](https://www.coingecko.com/en/coins/xsgd)
- [CoinGecko: Cryptocurrency Prices, Charts, and Crypto Market Cap](https://www.coingecko.com/)
- [XSGD to BTC: XSGD Price in Bitcoin - CoinGecko](https://www.coingecko.com/en/coins/xsgd/btc)
- [XSGD Price History: Download XSGD Historical Data - CoinGecko](https://www.coingecko.com/en/coins/xsgd/historical_data)
- [XSGD | Singapore Dollar Stablecoin by StraitsX](https://www.straitsx.com/xsgd)
- [arbitrum XSGD](https://arbiscan.io/token/0xe333e7754a2dc1e020a162ecab019254b9dab653)
- [base XSGD](https://basescan.org/token/0x0a4c9cb2778ab3302996a34befcf9a8bc288c33b)
- [ethereum XSGD](https://etherscan.io/token/0x70e8de73ce538da2beed35d14187f6959a8eca96)
- [avalanche XSGD](https://snowtrace.io/token/0xb2f85b7ab3c2b6f62df06de6ae7d09c010a5096e)
- [polygon XSGD](https://polygonscan.com/token/0xdc3326e71d45186f113a2f448984ca0e8d201995)
- [Google project search](https://www.google.com/search?q=XSGD%20XSGD%20crypto)
- [Google tokenomics search](https://www.google.com/search?q=XSGD%20XSGD%20tokenomics)
- [Google docs search](https://www.google.com/search?q=XSGD%20docs)
- [Google governance search](https://www.google.com/search?q=XSGD%20governance%20proposal)
- [Google audit search](https://www.google.com/search?q=XSGD%20audit%20report)
- [CoinMarketCap what-is guess](https://coinmarketcap.com/cmc-ai/xsgd/what-is/)

## Final Investment View

XSGD should be in the Research Map as a **watchlist / selective diligence** asset. The project has enough category relevance and data footprint to merit ongoing coverage, especially because it came from the CG/CMC-oriented candidate workflow and has no high-confidence local duplicate. The current evidence does not yet support a high-conviction allocation thesis. The next level of confidence requires cleaner token economics: fee capture, staking or collateral utility, transparent unlocks, and liquidity that can support realistic position sizing.
