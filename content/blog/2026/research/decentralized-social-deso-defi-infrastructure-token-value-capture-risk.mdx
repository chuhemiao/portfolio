...
| FDV | $21.58M |
| 24h volume | $6.78K |
| Circulating supply | 10.53M |
| Total supply | 10.81M |
| 7d price change | -29.64% |
| 30d price change | -40.41% |
...
| Liquidity | $6.78K 24h volume | Deeper CEX/DEX books and less fragmented contract liquidity |
| Supply quality | 10.53M circulating vs 10.81M total | Official unlock schedule and reconciled circulating methodology |
| Downside containment | Watchlist only | Transparent treasury, audits, risk controls, and stress-test history |

The strongest reason to add the report is not that Decentralized Social is obviously cheap. It is that the project is large or specific enough to track in the Research Map, and the current candidate backlog indicates it had not yet been covered locally.
...
The market intelligence layer has three parts: DeFi usage, market liquidity, and attention. For Decentralized Social, the DeFi-oriented backlog note is the first signal: Seeded 2026-07-06 from Surf market-ranking; rank 805, market cap $21,099,368, 24h volume $7,374. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.. Surf/CG data then adds market cap $21.02M, FDV $21.58M, 24h volume $6.78K, and price $2.0000.
...
| 24h volume | $6.78K | Position sizing and exit liquidity proxy |
| Market cap | $21.02M | Liquid valuation proxy |
| FDV | $21.58M | Dilution-aware valuation proxy |
| FDV / market cap spread | 1.03x | Higher spread means more supply risk |
| X followers | 70.75K | Attention proxy, not adoption proof |
...
| Accrual channel | Strength for Decentralized Social | Evidence needed |
|---|---|---|
...
| Staking / security | Depends on whether DESO is bonded or slashable | Staking contracts, validator docs, reward schedule |
...
The fifth frame is reflexivity. Many DeFi and infrastructure assets reprice in waves: first through TVL and listings, then through fee visibility, then through tokenomics cleanup, and finally through real cash-flow or strategic acquisition narratives. Decentralized Social currently needs to be monitored through that sequence. The available 90-day TVL series has 0 point(s), latest TVL not disclosed, and approximate change not disclosed. Market-price movement shows 7d -29.64% and 30d -40.41% when Surf or CoinGecko exposed the field. If TVL and price move together, the thesis may be simple beta. If TVL rises while price lags, the thesis becomes value-capture skepticism. If price rises while TVL falls, the thesis becomes momentum without fundamental confirmation.

The conservative conclusion is that Decentralized Social's product relevance may be ahead of its token value capture. That is common in this sector. The report should therefore watch for activation events: fee switch, staking redesign, revenue dashboard, cap increases, major integrations, or emissions reductions.
...
|---|---|---|---|
| 2021-09-21 | Undisclosed | $200.00M | Coinbase Ventures, Pantera Capital, Sequoia Capital, Arrington Capital, Polychain Capital, Andreessen Horowitz (a16z crypto), Distributed Global, Blockchain.com |

| Team member | Role | Link |
|---|---|---|
| Nader Al-Naji | Founder | [X](https://twitter.com/nadertheory) |
| Ed Moss | Head of Growth | not disclosed |
| Piotr Nojszewski | Head of Research | not disclosed |
...
Decentralized Social competes in the DeFi infrastructure bucket, where category peers vary by exact design. The memo uses functional competitors rather than only ticker competitors:
...
Weighted conclusion: Decentralized Social is important enough to track, but not clean enough to rank as a high-conviction token until economic capture is clearer.

## Bull / Base / Bear

| Scenario | Probability | Thesis | Monitoring signal |
|---|---:|---|---|
| Bull | 25% | Decentralized Social compounds usage, liquidity improves, and DESO gains measurable value capture through staking, fees, collateral, or governance-controlled economics. | TVL up, fees visible, volume deepens, supply overhang falls |
...
The strongest bearish critique is simple: this could be a useful protocol with an average token. If DESO does not capture fees or security demand, the market will eventually value it as governance optionality plus liquidity beta. The second critique is data inconsistency. CG, CMC, Surf, and official docs can disagree on circulating supply, FDV, and market cap. The third critique is reflexive TVL: deposits can leave quickly when incentives, yields, or narratives change.
...
| 24h volume | $6.78K | Weekly | Volume below position-size threshold |
...
1. Re-run Surf project-detail and project-defi-metrics if Decentralized Social announces a major integration, listing, tokenomics change, exploit, or governance proposal.
...
This report intentionally separates source availability from source quality. Decentralized Social has a visible market footprint, but a visible footprint is not the same as a reconciled investment record. The Research Map standard treats CoinGecko and CoinMarketCap as discovery and market-data surfaces, Surf as an aggregation and refresh layer, DefiLlama style records as a protocol-usage lens, and official docs as the final arbiter for product mechanics. When these sources disagree, the disagreement itself is part of the thesis. A token with unclear supply methodology, mismatched contract labels, stale app docs, or broken dashboard coverage is usually harder to underwrite even when the narrative looks attractive.

For Decentralized Social, the first reconciliation job is identity. The token symbol is DESO, the category is DeFi infrastructure, chains are not disclosed, exchanges are COINBASE, and tags are Creator Economy, Layer1, SocialFi. These fields should be checked against official docs, token contracts, exchange market tabs, and community channels before the report graduates from watchlist to allocation candidate. If DESO trades on multiple chains, each contract should be mapped to a canonical issuer statement. If the same symbol is reused by another asset, exchange tickers and contract addresses must be treated as separate facts rather than as interchangeable labels. This matters because a fuzzy ticker match can make a good memo wrong at the first line.

The second reconciliation job is market data. Market cap is $21.02M, FDV is $21.58M, 24h volume is $6.78K, FDV / market cap is 1.03x, 7d price change is -29.64%, and 30d price change is -40.41%. These numbers need a vendor-drift check. If CMC reports a different circulating supply from CoinGecko or Surf, the memo should prefer the official unlock and circulating-supply definition, then keep the aggregator spread as a risk note. If volume is dominated by one venue, the liquidity score should be lower than the headline volume implies. If FDV is not disclosed or total supply is missing, the base case should assume worse dilution until proven otherwise.
...
|---|---|---|
| Identity | Decentralized Social / DESO | Match official docs, CG, CMC, Surf, contracts |
...
For Decentralized Social, the current liquidity read is watchlist first. The market cap is $21.02M, FDV is $21.58M, reported 24h volume is $6.78K, and FDV / market cap is 1.03x. These values can support a research card, but they do not automatically support an investment. A cleaner setup would show stable volume across multiple venues, narrow spreads, less reliance on a single pair, and a supply schedule that does not create a near-term wall of unlock pressure.
...
| Peer comparison | Monthly | Decentralized Social gains share with better economics | Peers grow faster with cleaner capture |

## Evidence Ledger

| # | Source | Link | Why it matters |
|---:|---|---|---|
| 1 | Official website | [link](https://www.deso.org/) | Identity, market, social, contract, or discovery cross-check |
| 2 | CoinGecko search | [link](https://www.coingecko.com/en/search?query=Decentralized%20Social) | Identity, market, social, contract, or discovery cross-check |
| 3 | CoinMarketCap discovery | [link](https://coinmarketcap.com/search/?q=Decentralized%20Social) | Identity, market, social, contract, or discovery cross-check |
| 4 | DefiLlama protocol discovery | [link](https://defillama.com/search?query=Decentralized%20Social) | Identity, market, social, contract, or discovery cross-check |
| 5 | Token Terminal discovery | [link](https://tokenterminal.com/explorer?search=Decentralized%20Social) | Identity, market, social, contract, or discovery cross-check |
| 6 | Messari discovery | [link](https://messari.io/search?q=Decentralized%20Social) | Identity, market, social, contract, or discovery cross-check |
| 7 | X profile | [link](https://x.com/desoprotocol) | Identity, market, social, contract, or discovery cross-check |
| 8 | GitHub | [link](https://github.com/deso-protocol) | Identity, market, social, contract, or discovery cross-check |
| 9 | Discord | [link](https://discord.com/invite/JFHDRt4Cdm) | Identity, market, social, contract, or discovery cross-check |
| 10 | Decentralized Social Price Chart (DESO) - CoinGecko | [link](https://www.coingecko.com/en/coins/deso) | Identity, market, social, contract, or discovery cross-check |
| 11 | Decentralized Social price DESO #764 - CoinMarketCap | [link](https://coinmarketcap.com/currencies/deso/) | Identity, market, social, contract, or discovery cross-check |
| 12 | Current DESO Supply / DeSo • Decentralized Social Media Blockchain | [link](https://docs.deso.org/deso-tokenomics/current-deso-supply) | Identity, market, social, contract, or discovery cross-check |
| 13 | Top Decentralized Social Media (DeSOC) Coins by Market Cap | [link](https://www.coingecko.com/en/categories/decentralized-social-media-desoc) | Identity, market, social, contract, or discovery cross-check |
| 14 | DESO to BTC: Decentralized Social Price in Bitcoin / CoinGecko | [link](https://www.coingecko.com/en/coins/deso/btc) | Identity, market, social, contract, or discovery cross-check |
| 15 | Google project search | [link](https://www.google.com/search?q=Decentralized%20Social%20DESO%20crypto) | Identity, market, social, contract, or discovery cross-check |
| 16 | Google tokenomics search | [link](https://www.google.com/search?q=Decentralized%20Social%20DESO%20tokenomics) | Identity, market, social, contract, or discovery cross-check |
| 17 | Google docs search | [link](https://www.google.com/search?q=Decentralized%20Social%20docs) | Identity, market, social, contract, or discovery cross-check |
| 18 | Google governance search | [link](https://www.google.com/search?q=Decentralized%20Social%20governance%20proposal) | Identity, market, social, contract, or discovery cross-check |
| 19 | Google audit search | [link](https://www.google.com/search?q=Decentralized%20Social%20audit%20report) | Identity, market, social, contract, or discovery cross-check |
| 20 | CoinMarketCap what-is guess | [link](https://coinmarketcap.com/cmc-ai/decentralized-social/what-is/) | Identity, market, social, contract, or discovery cross-check |
| 21 | CoinMarketCap price analysis guess | [link](https://coinmarketcap.com/cmc-ai/decentralized-social/price-analysis/) | Identity, market, social, contract, or discovery cross-check |
| 22 | CoinMarketCap currency guess | [link](https://coinmarketcap.com/currencies/decentralized-social/) | Identity, market, social, contract, or discovery cross-check |
| 23 | Dune discovery | [link](https://dune.com/browse/dashboards?q=Decentralized%20Social) | Identity, market, social, contract, or discovery cross-check |
| 24 | Dune token query | [link](https://dune.com/browse/queries?q=Decentralized%20Social) | Identity, market, social, contract, or discovery cross-check |
| 25 | DeFiLlama fees discovery | [link](https://defillama.com/fees?chain=All&search=Decentralized%20Social) | Identity, market, social, contract, or discovery cross-check |
| 26 | DeFiLlama yield discovery | [link](https://defillama.com/yields?token=DESO) | Identity, market, social, contract, or discovery cross-check |
| 27 | TokenUnlocks search | [link](https://token.unlocks.app/?search=Decentralized%20Social) | Identity, market, social, contract, or discovery cross-check |
| 28 | CryptoRank search | [link](https://cryptorank.io/price/decentralized-social) | Identity, market, social, contract, or discovery cross-check |
| 29 | RootData search | [link](https://www.rootdata.com/search?kw=Decentralized%20Social) | Identity, market, social, contract, or discovery cross-check |
| 30 | CoinDesk search | [link](https://www.coindesk.com/search?s=Decentralized%20Social) | Identity, market, social, contract, or discovery cross-check |
| 31 | The Block search | [link](https://www.theblock.co/search?query=Decentralized%20Social) | Identity, market, social, contract, or discovery cross-check |
| 32 | GitHub search | [link](https://github.com/search?q=Decentralized%20Social&type=repositories) | Identity, market, social, contract, or discovery cross-check |
| 33 | Etherscan token search | [link](https://etherscan.io/search?f=0&q=DESO) | Identity, market, social, contract, or discovery cross-check |
| 34 | BscScan token search | [link](https://bscscan.com/search?f=0&q=DESO) | Identity, market, social, contract, or discovery cross-check |

Additional direct source list:

- [Official website](https://www.deso.org/)
- [CoinGecko search](https://www.coingecko.com/en/search?query=Decentralized%20Social)
- [CoinMarketCap discovery](https://coinmarketcap.com/search/?q=Decentralized%20Social)
- [DefiLlama protocol discovery](https://defillama.com/search?query=Decentralized%20Social)
- [Token Terminal discovery](https://tokenterminal.com/explorer?search=Decentralized%20Social)
- [Messari discovery](https://messari.io/search?q=Decentralized%20Social)
- [X profile](https://x.com/desoprotocol)
- [GitHub](https://github.com/deso-protocol)
- [Discord](https://discord.com/invite/JFHDRt4Cdm)
- [Decentralized Social Price Chart (DESO) - CoinGecko](https://www.coingecko.com/en/coins/deso)
- [Decentralized Social price DESO #764 - CoinMarketCap](https://coinmarketcap.com/currencies/deso/)
- [Current DESO Supply | DeSo • Decentralized Social Media Blockchain](https://docs.deso.org/deso-tokenomics/current-deso-supply)
- [Top Decentralized Social Media (DeSOC) Coins by Market Cap](https://www.coingecko.com/en/categories/decentralized-social-media-desoc)
- [DESO to BTC: Decentralized Social Price in Bitcoin | CoinGecko](https://www.coingecko.com/en/coins/deso/btc)
- [Google project search](https://www.google.com/search?q=Decentralized%20Social%20DESO%20crypto)
- [Google tokenomics search](https://www.google.com/search?q=Decentralized%20Social%20DESO%20tokenomics)
- [Google docs search](https://www.google.com/search?q=Decentralized%20Social%20docs)
- [Google governance search](https://www.google.com/search?q=Decentralized%20Social%20governance%20proposal)
- [Google audit search](https://www.google.com/search?q=Decentralized%20Social%20audit%20report)
- [CoinMarketCap what-is guess](https://coinmarketcap.com/cmc-ai/decentralized-social/what-is/)
- [CoinMarketCap price analysis guess](https://coinmarketcap.com/cmc-ai/decentralized-social/price-analysis/)
- [CoinMarketCap currency guess](https://coinmarketcap.com/currencies/decentralized-social/)
- [Dune discovery](https://dune.com/browse/dashboards?q=Decentralized%20Social)
- [Dune token query](https://dune.com/browse/queries?q=Decentralized%20Social)
