...
As of the June 23, 2026 market snapshot, PYUSD has roughly **$2.77B** in circulating supply and market value, trades near **$1.00**, ranks around **#28 on CoinMarketCap** and **#34 on CoinGecko**, and has about **$93M** in 24-hour spot volume on CoinGecko's live page. DefiLlama tracks about **$2.77B** circulating across 17 chains, led by Ethereum at about **$1.79B**, Solana at about **$678M**, Arbitrum at about **$216M**, Flow at about **$71M**, Polygon at about **$10M**, and Sei at about **$5M**. [CoinMarketCap](https://coinmarketcap.com/currencies/paypal-usd/) [CoinGecko](https://www.coingecko.com/en/coins/paypal-usd) [DefiLlama](https://defillama.com/stablecoin/paypal-usd)
...
| Current supply | About $2.75-2.77B |
...
A GoPlus token-security snapshot for the Ethereum PYUSD contract shows an open-source proxy token with roughly **88K** holders and **0%** buy/sell tax. That is consistent with a regulated issuer-controlled stablecoin: the tax and honeypot profile is clean, while proxy/admin control remains part of the intended model rather than a decentralization feature. [GoPlus](https://api.gopluslabs.io/api/v1/token_security/1?contract_addresses=0x6c3ea9036406852006290770bedfcaba0e23a0e8)
...
| --- | --- |
| CoinMarketCap rank | Around #28 |
| CoinGecko rank | Around #34 |
| Market cap / circulating value | About $2.77B |
| 24h volume | About $93M on CoinGecko's live page |
| DefiLlama chain count | 17 chains |
| 30d supply trend | Down from about $3.61B to $2.74B, roughly -24% |
...
DEX depth is better than many regulated challengers, but it is still concentrated. Dexscreener shows the largest visible Ethereum PYUSD pool as Curve **USDS/PYUSD** at roughly **$100M** liquidity and about **$22M** 24h volume, with a separate Curve **PYUSD/USDC** pool near **$45M** liquidity. On Solana, the main Orca **PYUSD/USDC** pool shows about **$20.9M** liquidity and roughly **$2.5M** 24h volume. That is meaningful depth for a non-USDT/USDC stablecoin, but PYUSD still depends more on issuer redemption, PayPal rails, and selected stable-swap pools than on broad long-tail DEX liquidity. [Dexscreener Ethereum](https://dexscreener.com/ethereum/0xa632d59b9b804a956bfaa9b48af3a1b74808fc1f) [Dexscreener Solana](https://dexscreener.com/solana/9txiurrw7kbejlhzxtxdxys2ree43uh2e7k1kocgdm9b)
...
| --- | ---: | --- | --- |
| Circulating value | ~$2.77B | Sustained return above $4B and then $6B | Below $2B after rewards/rollout |
...
- [GoPlus PYUSD token-security snapshot](https://api.gopluslabs.io/api/v1/token_security/1?contract_addresses=0x6c3ea9036406852006290770bedfcaba0e23a0e8)
