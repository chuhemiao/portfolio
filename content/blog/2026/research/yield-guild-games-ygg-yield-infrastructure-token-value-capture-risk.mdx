---
title: 'Yield Guild Games / YGG: yield infrastructure value capture, liquidity, and token risk'
publishedAt: '2026-07-06'
summary: 'Yield Guild Games is treated as a yield infrastructure watchlist candidate sourced from CoinGecko/CMC discovery and refreshed with Surf, with emphasis on product durability, token value capture, liquidity, supply, and execution risk.'
slug: 'yield-guild-games-ygg-yield-infrastructure-token-value-capture-risk'
category: 'research'
---

# Yield Guild Games / YGG: yield infrastructure value capture, liquidity, and token risk

## Pre-screen Decision

**Decision: add to Research Map as a full-depth watchlist report, not as an automatic accumulation call.** Yield Guild Games appears in the local CoinGecko/CMC-oriented candidate pool through market discovery and was refreshed with Surf on 2026-07-06. The project has enough protocol surface for a real memo: chain exposure is Abstract, Base, Binance Smart Chain, Ethereum, Harmony Shard 0, Polygon Pos, Ronin; exchange exposure is BINANCE, UPBIT, OKX, BITHUMB, BITGET; category tags are DAO, GameFi; current market cap is $18.94M; FDV is $23.77M; and 24h volume is $3.95M. That combination makes it worth researching, but not enough to override the main risks: token value capture may be indirect, liquidity can be fragile, supply methodology may differ across data vendors, and protocol usage can be incentive-sensitive.

The report uses a conservative watchlist standard. A pass means the project deserves monitoring and comparison against peers. It does not mean the token is cheap. A fail would require one of three red flags: no identifiable official/project surface, no meaningful market or DeFi data, or a high-confidence duplicate in the Research Map. Local duplicate checks did not flag Yield Guild Games before this file was created, and the existing candidate note says: Seeded 2026-07-06 from Surf market-ranking; rank 858, market cap $18,791,625, 24h volume $3,120,279. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.

## TL;DR / Executive Summary

Yield Guild Games is best understood as a **yield infrastructure** asset where the product thesis and the token thesis must be separated. The product thesis asks whether users, validators, LPs, borrowers, or asset issuers have a durable reason to use the protocol. The token thesis asks whether YGG captures that activity through fees, staking, collateral, governance, liquidity routing, protocol-owned assets, or emissions control. The available evidence supports a watchlist entry, especially because it has a visible data footprint across Surf, CoinGecko, CMC discovery, and DeFi-oriented candidate notes. The evidence does not yet support a high-conviction valuation without better fee/revenue, unlock, treasury, and user-retention disclosure.
...
| Chains | Abstract, Base, Binance Smart Chain, Ethereum, Harmony Shard 0, Polygon Pos, Ronin |
| Exchanges | BINANCE, UPBIT, OKX, BITHUMB, BITGET |
| Price | $0.0238 |
| Market cap | $18.94M |
| FDV | $23.77M |
| 24h volume | $3.95M |
| Circulating supply | 796.99M |
| Total supply | 1.00B |
...
Base case: Yield Guild Games remains a selective watchlist asset until token value capture is cleaner. Bull case: protocol usage and token mechanics converge, turning YGG into a security, collateral, or fee-routing asset with real demand. Bear case: the protocol remains useful but token holders absorb dilution, thin liquidity, governance optionality, or regulatory/technical tail risk.

## Project Overview

A DAO investing in play-to-earn (P2E) game NFTs, enabling income via blockchain games; token used for governance and voting on asset management

Surf's project profile maps Yield Guild Games to the following high-level surface:

| Area | Evidence |
|---|---|
| Website | [https://yieldguild.io/](https://yieldguild.io/) |
| X handle | [@YieldGuild](https://x.com/YieldGuild) |
| X followers | 233.81K |
| Tags | DAO, GameFi |
| Chains | Abstract, Base, Binance Smart Chain, Ethereum, Harmony Shard 0, Polygon Pos, Ronin |
| Exchanges | BINANCE, UPBIT, OKX, BITHUMB, BITGET |
...
| Liquidity | $3.95M 24h volume | Deeper CEX/DEX books and less fragmented contract liquidity |
| Supply quality | 796.99M circulating vs 1.00B total | Official unlock schedule and reconciled circulating methodology |
| Downside containment | Watchlist only | Transparent treasury, audits, risk controls, and stress-test history |

The strongest reason to add the report is not that Yield Guild Games is obviously cheap. It is that the project is large or specific enough to track in the Research Map, and the current candidate backlog indicates it had not yet been covered locally.

## Architecture / Mechanism

Yield Guild Games's architecture should be evaluated through the job it performs. For a yield infrastructure project, architecture is not merely code shape. It includes the contracts, governance process, integration path, oracle and risk dependencies, bridge or staking assumptions, collateral policies, and the way users enter and exit positions.
...
| Settlement layer | Chains and contracts that hold user value | Abstract, Base, Binance Smart Chain, Ethereum, Harmony Shard 0, Polygon Pos, Ronin |
...
|---|---|---|---|
| base | YGG | 0xaac78d1219c08aecc8e37e03858fe885f5ef1799 | [explorer](https://basescan.org/token/0xaac78d1219c08aecc8e37e03858fe885f5ef1799) |
| Ronin | YGG | 0x1c306872bc82525d72bf3562e8f0aa3f8f26e857 | not mapped |
| Abstract | YGG | 0xa9053dc939d74222f7aa0b3a2be407abbfd56c6a | not mapped |
| ethereum | YGG | 0x25f8087ead173b73d6e8b84329989a8eea16cf73 | [explorer](https://etherscan.io/token/0x25f8087ead173b73d6e8b84329989a8eea16cf73) |
| polygon | YGG | 0x82617aa52dddf5ed9bb7b370ed777b3182a30fd1 | [explorer](https://polygonscan.com/token/0x82617aa52dddf5ed9bb7b370ed777b3182a30fd1) |
| Harmony Shard 0 | YGG | 0x63cf309500d8be0b9fdb8f1fb66c821236c0438c | not mapped |
| bsc | YGG | 0x13ab6739368a4e4abf24695bf52959224367391f | [explorer](https://bscscan.com/token/0x13ab6739368a4e4abf24695bf52959224367391f) |
...
The market intelligence layer has three parts: DeFi usage, market liquidity, and attention. For Yield Guild Games, the DeFi-oriented backlog note is the first signal: Seeded 2026-07-06 from Surf market-ranking; rank 858, market cap $18,791,625, 24h volume $3,120,279. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.. Surf/CG data then adds market cap $18.94M, FDV $23.77M, 24h volume $3.95M, and price $0.0238.
...
| 24h volume | $3.95M | Position sizing and exit liquidity proxy |
| Market cap | $18.94M | Liquid valuation proxy |
| FDV | $23.77M | Dilution-aware valuation proxy |
| FDV / market cap spread | 1.25x | Higher spread means more supply risk |
| X followers | 233.81K | Attention proxy, not adoption proof |
...
| Accrual channel | Strength for Yield Guild Games | Evidence needed |
|---|---|---|
...
| Staking / security | Depends on whether YGG is bonded or slashable | Staking contracts, validator docs, reward schedule |
...
The first analytical frame is utility durability. Yield Guild Games should not be treated as investable only because it appears in CoinGecko or CoinMarketCap discovery. The useful question is whether the protocol controls a repeatable workflow: validators needing distributed operation, lenders needing collateralized liquidity, LPs needing routing, tokenized assets needing compliance rails, or depositors needing yield. In this memo the base assumption is that Yield Guild Games belongs to the yield infrastructure bucket. That means the token, if any, has to be judged by how directly it captures fees, security demand, collateral demand, risk-management demand, governance power, or distribution access. A high TVL number without fee conversion is weaker than a modest TVL base with sticky users, clear revenue, and controllable emissions.

The second frame is liquidity quality. Current tracked market data points to market cap $18.94M, FDV $23.77M, 24h volume $3.95M, price $0.0238, circulating supply 796.99M, and total supply 1.00B. These numbers are not a buy signal by themselves. They are a risk surface. When FDV materially exceeds market cap, the memo discounts upside because later unlocks can absorb demand. When volume is low relative to market cap, the memo discounts tradability because position sizing becomes difficult. When price performance is strong but project usage is flat, the memo treats the move as narrative beta rather than fundamental repricing. When usage is durable but price is weak, the memo treats the asset as a watchlist candidate rather than an immediate long.

The third frame is source triangulation. Surf project-detail gives an aggregated project view, CoinGecko provides a market-data and community-data surface, CoinMarketCap discovery is used to cross-check symbol identity, and DefiLlama style TVL notes provide a protocol-usage lens. For Yield Guild Games, the candidate backlog records Seeded 2026-07-06 from Surf market-ranking; rank 858, market cap $18,791,625, 24h volume $3,120,279. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.. Surf identifies chains as Abstract, Base, Binance Smart Chain, Ethereum, Harmony Shard 0, Polygon Pos, Ronin, exchanges as BINANCE, UPBIT, OKX, BITHUMB, BITGET, and tags as DAO, GameFi. If these labels diverge from official documentation, official documentation wins. If CMC, CG, and Surf disagree on supply or market cap, this memo treats the supply field as unresolved until a token contract, official tokenomics page, and exchange-circulating methodology can be reconciled.
...
The fifth frame is reflexivity. Many DeFi and infrastructure assets reprice in waves: first through TVL and listings, then through fee visibility, then through tokenomics cleanup, and finally through real cash-flow or strategic acquisition narratives. Yield Guild Games currently needs to be monitored through that sequence. The available 90-day TVL series has 0 point(s), latest TVL not disclosed, and approximate change not disclosed. Market-price movement shows 7d 5.06% and 30d -6.06% when Surf or CoinGecko exposed the field. If TVL and price move together, the thesis may be simple beta. If TVL rises while price lags, the thesis becomes value-capture skepticism. If price rises while TVL falls, the thesis becomes momentum without fundamental confirmation.

The conservative conclusion is that Yield Guild Games's product relevance may be ahead of its token value capture. That is common in this sector. The report should therefore watch for activation events: fee switch, staking redesign, revenue dashboard, cap increases, major integrations, or emissions reductions.
...
|---|---|---|---|
| 2025-02-13 | Strategic | not disclosed | Gam3Girl |
| 2024-04-08 | Strategic | not disclosed | Newman Capital |
| 2023-02-17 | Undisclosed | $13.80M | Andreessen Horowitz (a16z crypto), Galaxy Interactive, DWF Labs, Sanctor Capital, Sangha Capital, David Lee |
| 2021-08-19 | Undisclosed | $4.60M | Andreessen Horowitz (a16z crypto) |
| 2021-07-27 | Ido | $12.50M | not disclosed |
| 2021-06-16 | Series A | $4.00M | Fabric Ventures, Mechanism Capital, Animoca Brands, Bitscale Capital, SevenX Ventures, Ascensive Assets, Sfermion, IDEO CoLab Ventures |

| Team member | Role | Link |
|---|---|---|
| Gabby Dizon | Co-Founder | [X](https://twitter.com/gabusch) |
| Beryl Li | Co-Founder | [X](https://twitter.com/berylygg) |
| Christy Choi | Advisor | not disclosed |
| Anirudh Pai | Advisor | [X](https://twitter.com/ani_pai) |
...
Yield Guild Games competes in the yield infrastructure bucket, where category peers vary by exact design. The memo uses functional competitors rather than only ticker competitors:
...
The key competitive question is whether Yield Guild Games has a reason to exist beyond incentives. If switching costs are low and users are primarily chasing emissions, any valuation premium should be temporary. If the protocol controls a scarce integration point, compliance rail, validator layer, or liquidity venue, it can deserve a persistent watchlist premium.
...
Weighted conclusion: Yield Guild Games is important enough to track, but not clean enough to rank as a high-conviction token until economic capture is clearer.

## Bull / Base / Bear

| Scenario | Probability | Thesis | Monitoring signal |
|---|---:|---|---|
| Bull | 25% | Yield Guild Games compounds usage, liquidity improves, and YGG gains measurable value capture through staking, fees, collateral, or governance-controlled economics. | TVL up, fees visible, volume deepens, supply overhang falls |
...
The strongest bearish critique is simple: this could be a useful protocol with an average token. If YGG does not capture fees or security demand, the market will eventually value it as governance optionality plus liquidity beta. The second critique is data inconsistency. CG, CMC, Surf, and official docs can disagree on circulating supply, FDV, and market cap. The third critique is reflexive TVL: deposits can leave quickly when incentives, yields, or narratives change.
...
| 24h volume | $3.95M | Weekly | Volume below position-size threshold |
| FDV / market cap | 1.25x | Monthly | Rising dilution gap |
...
1. Re-run Surf project-detail and project-defi-metrics if Yield Guild Games announces a major integration, listing, tokenomics change, exploit, or governance proposal.
...
This report intentionally separates source availability from source quality. Yield Guild Games has a visible market footprint, but a visible footprint is not the same as a reconciled investment record. The Research Map standard treats CoinGecko and CoinMarketCap as discovery and market-data surfaces, Surf as an aggregation and refresh layer, DefiLlama style records as a protocol-usage lens, and official docs as the final arbiter for product mechanics. When these sources disagree, the disagreement itself is part of the thesis. A token with unclear supply methodology, mismatched contract labels, stale app docs, or broken dashboard coverage is usually harder to underwrite even when the narrative looks attractive.

For Yield Guild Games, the first reconciliation job is identity. The token symbol is YGG, the category is yield infrastructure, chains are Abstract, Base, Binance Smart Chain, Ethereum, Harmony Shard 0, Polygon Pos, Ronin, exchanges are BINANCE, UPBIT, OKX, BITHUMB, BITGET, and tags are DAO, GameFi. These fields should be checked against official docs, token contracts, exchange market tabs, and community channels before the report graduates from watchlist to allocation candidate. If YGG trades on multiple chains, each contract should be mapped to a canonical issuer statement. If the same symbol is reused by another asset, exchange tickers and contract addresses must be treated as separate facts rather than as interchangeable labels. This matters because a fuzzy ticker match can make a good memo wrong at the first line.

The second reconciliation job is market data. Market cap is $18.94M, FDV is $23.77M, 24h volume is $3.95M, FDV / market cap is 1.25x, 7d price change is 5.06%, and 30d price change is -6.06%. These numbers need a vendor-drift check. If CMC reports a different circulating supply from CoinGecko or Surf, the memo should prefer the official unlock and circulating-supply definition, then keep the aggregator spread as a risk note. If volume is dominated by one venue, the liquidity score should be lower than the headline volume implies. If FDV is not disclosed or total supply is missing, the base case should assume worse dilution until proven otherwise.
...
|---|---|---|
| Identity | Yield Guild Games / YGG | Match official docs, CG, CMC, Surf, contracts |
| Category | yield infrastructure | Confirm product mechanics and revenue model |
| Chains | Abstract, Base, Binance Smart Chain, Ethereum, Harmony Shard 0, Polygon Pos, Ronin | Confirm canonical deployments and bridge assumptions |
| Exchanges | BINANCE, UPBIT, OKX, BITHUMB, BITGET | Check live order books and inactive pairs |
| Market cap | $18.94M | Compare Surf, CG, CMC, exchange pages |
| FDV | $23.77M | Reconcile total supply and unlock schedule |
| Volume | $3.95M | Check exchange concentration and wash-trading risk |
| TVL | not disclosed | Confirm TVL meaning, source, and double-counting risk |

## Primary-source Diligence Work Plan

The next diligence pass should start from primary sources, not from the token chart. The first document to find is an official docs or whitepaper page that explains what Yield Guild Games does and where users interact with it. The second is tokenomics: allocation, emissions, unlocks, utility, fee routing, treasury policy, and governance rights. The third is security material: audits, bug bounty scope, incident post-mortems, admin-key disclosures, or upgrade timelocks. The fourth is usage evidence: live app metrics, dashboards, contract balances, fee dashboards, validator counts, loan books, LP depth, or stablecoin collateral reports. Without those four documents, any price target is mostly narrative.

For Yield Guild Games, the primary-source pass should answer a narrow sequence of questions. What user action creates protocol value? Who pays? Who receives the fee or spread? Does YGG sit inside that flow, or does it only vote on parameters? Can users exit without trusting a multisig, bridge, centralized custodian, or opaque off-chain book? What part of the system can be paused or upgraded? Which parameters would cause losses if changed incorrectly? If the project is young, which metrics prove organic adoption rather than incentives? If the project is mature, which metrics prove durability rather than slow decline?
...
For Yield Guild Games, the current liquidity read is watchlist first. The market cap is $18.94M, FDV is $23.77M, reported 24h volume is $3.95M, and FDV / market cap is 1.25x. These values can support a research card, but they do not automatically support an investment. A cleaner setup would show stable volume across multiple venues, narrow spreads, less reliance on a single pair, and a supply schedule that does not create a near-term wall of unlock pressure.
...
The failure-mode view is deliberately harsher than the base case. Yield Guild Games can fail for reasons that do not show up in a simple market-data table. Smart contracts can be exploited. Oracles can misprice collateral. Bridges can be paused. Staking systems can experience slashing or validator concentration. RWA systems can face issuer, custodian, or redemption risk. Stablecoin systems can lose pegs. Privacy systems can face sanctions, delistings, or legal restrictions. DEXs and yield systems can lose users when incentives rotate. A full-depth memo should make these risks visible before they become headlines.

For Yield Guild Games, the live monitoring stack should include contract events, TVL, volume, governance, documentation changes, social announcements, security disclosures, and exchange-market quality. A single metric is not enough. TVL may stay high while liquidity thins. Volume may rise because of volatility rather than adoption. Social attention may rise around controversy rather than progress. Governance may pass proposals that improve short-term price but add long-term risk. The strongest monitoring dashboard combines on-chain state, off-chain disclosure, and market quality.

Incident response matters because crypto risks are discontinuous. A protocol can look normal until a bridge halt, oracle issue, admin pause, market-maker withdrawal, regulatory action, or treasury sale changes the entire thesis. The Research Map should therefore attach explicit downgrade triggers. If Yield Guild Games suffers a material exploit, downgrade until a post-mortem, reimbursement plan, and contract patch are published. If supply expands faster than disclosed, downgrade tokenomics confidence. If the main app loses integrations or TVL without explanation, downgrade product durability. If market depth collapses while price holds, downgrade liquidity quality.
...
| Peer comparison | Monthly | Yield Guild Games gains share with better economics | Peers grow faster with cleaner capture |

## Evidence Ledger

| # | Source | Link | Why it matters |
|---:|---|---|---|
| 1 | Official website | [link](https://yieldguild.io/) | Identity, market, social, contract, or discovery cross-check |
| 2 | CoinGecko search | [link](https://www.coingecko.com/en/search?query=Yield%20Guild%20Games) | Identity, market, social, contract, or discovery cross-check |
| 3 | CoinMarketCap discovery | [link](https://coinmarketcap.com/search/?q=Yield%20Guild%20Games) | Identity, market, social, contract, or discovery cross-check |
| 4 | DefiLlama protocol discovery | [link](https://defillama.com/search?query=Yield%20Guild%20Games) | Identity, market, social, contract, or discovery cross-check |
| 5 | Token Terminal discovery | [link](https://tokenterminal.com/explorer?search=Yield%20Guild%20Games) | Identity, market, social, contract, or discovery cross-check |
| 6 | Messari discovery | [link](https://messari.io/search?q=Yield%20Guild%20Games) | Identity, market, social, contract, or discovery cross-check |
| 7 | X profile | [link](https://x.com/YieldGuild) | Identity, market, social, contract, or discovery cross-check |
| 8 | Telegram | [link](https://t.me/yieldguildgames) | Identity, market, social, contract, or discovery cross-check |
| 9 | Discord | [link](https://discord.com/invite/ygg) | Identity, market, social, contract, or discovery cross-check |
| 10 | Yield Guild Games Price Chart (YGG) - CoinGecko | [link](https://www.coingecko.com/en/coins/yield-guild-games) | Identity, market, social, contract, or discovery cross-check |
| 11 | What is Yield Guild Games (YGG)? - CoinMarketCap | [link](https://coinmarketcap.com/cmc-ai/yield-guild-games/what-is/) | Identity, market, social, contract, or discovery cross-check |
| 12 | YGG to BTC: Yield Guild Games Price in Bitcoin / CoinGecko | [link](https://www.coingecko.com/en/coins/yield-guild-games/btc) | Identity, market, social, contract, or discovery cross-check |
| 13 | Latest Yield Guild Games (YGG) Price Analysis - CoinMarketCap | [link](https://coinmarketcap.com/cmc-ai/yield-guild-games/price-analysis/) | Identity, market, social, contract, or discovery cross-check |
| 14 | YGG to DKK: Yield Guild Games Price in Danish Krone / CoinGecko | [link](https://www.coingecko.com/en/coins/yield-guild-games/dkk) | Identity, market, social, contract, or discovery cross-check |
| 15 | base YGG | [link](https://basescan.org/token/0xaac78d1219c08aecc8e37e03858fe885f5ef1799) | Identity, market, social, contract, or discovery cross-check |
| 16 | ethereum YGG | [link](https://etherscan.io/token/0x25f8087ead173b73d6e8b84329989a8eea16cf73) | Identity, market, social, contract, or discovery cross-check |
| 17 | polygon YGG | [link](https://polygonscan.com/token/0x82617aa52dddf5ed9bb7b370ed777b3182a30fd1) | Identity, market, social, contract, or discovery cross-check |
| 18 | bsc YGG | [link](https://bscscan.com/token/0x13ab6739368a4e4abf24695bf52959224367391f) | Identity, market, social, contract, or discovery cross-check |
| 19 | Google project search | [link](https://www.google.com/search?q=Yield%20Guild%20Games%20YGG%20crypto) | Identity, market, social, contract, or discovery cross-check |
| 20 | Google tokenomics search | [link](https://www.google.com/search?q=Yield%20Guild%20Games%20YGG%20tokenomics) | Identity, market, social, contract, or discovery cross-check |
| 21 | Google docs search | [link](https://www.google.com/search?q=Yield%20Guild%20Games%20docs) | Identity, market, social, contract, or discovery cross-check |
| 22 | Google governance search | [link](https://www.google.com/search?q=Yield%20Guild%20Games%20governance%20proposal) | Identity, market, social, contract, or discovery cross-check |
| 23 | Google audit search | [link](https://www.google.com/search?q=Yield%20Guild%20Games%20audit%20report) | Identity, market, social, contract, or discovery cross-check |
| 24 | CoinMarketCap currency guess | [link](https://coinmarketcap.com/currencies/yield-guild-games/) | Identity, market, social, contract, or discovery cross-check |
| 25 | Dune discovery | [link](https://dune.com/browse/dashboards?q=Yield%20Guild%20Games) | Identity, market, social, contract, or discovery cross-check |
| 26 | Dune token query | [link](https://dune.com/browse/queries?q=Yield%20Guild%20Games) | Identity, market, social, contract, or discovery cross-check |
| 27 | DeFiLlama fees discovery | [link](https://defillama.com/fees?chain=All&search=Yield%20Guild%20Games) | Identity, market, social, contract, or discovery cross-check |
| 28 | DeFiLlama yield discovery | [link](https://defillama.com/yields?token=YGG) | Identity, market, social, contract, or discovery cross-check |
| 29 | TokenUnlocks search | [link](https://token.unlocks.app/?search=Yield%20Guild%20Games) | Identity, market, social, contract, or discovery cross-check |
| 30 | CryptoRank search | [link](https://cryptorank.io/price/yield-guild-games) | Identity, market, social, contract, or discovery cross-check |
| 31 | RootData search | [link](https://www.rootdata.com/search?kw=Yield%20Guild%20Games) | Identity, market, social, contract, or discovery cross-check |
| 32 | CoinDesk search | [link](https://www.coindesk.com/search?s=Yield%20Guild%20Games) | Identity, market, social, contract, or discovery cross-check |
| 33 | The Block search | [link](https://www.theblock.co/search?query=Yield%20Guild%20Games) | Identity, market, social, contract, or discovery cross-check |
| 34 | GitHub search | [link](https://github.com/search?q=Yield%20Guild%20Games&type=repositories) | Identity, market, social, contract, or discovery cross-check |

Additional direct source list:

- [Official website](https://yieldguild.io/)
- [CoinGecko search](https://www.coingecko.com/en/search?query=Yield%20Guild%20Games)
- [CoinMarketCap discovery](https://coinmarketcap.com/search/?q=Yield%20Guild%20Games)
- [DefiLlama protocol discovery](https://defillama.com/search?query=Yield%20Guild%20Games)
- [Token Terminal discovery](https://tokenterminal.com/explorer?search=Yield%20Guild%20Games)
- [Messari discovery](https://messari.io/search?q=Yield%20Guild%20Games)
- [X profile](https://x.com/YieldGuild)
- [Telegram](https://t.me/yieldguildgames)
- [Discord](https://discord.com/invite/ygg)
- [Yield Guild Games Price Chart (YGG) - CoinGecko](https://www.coingecko.com/en/coins/yield-guild-games)
- [What is Yield Guild Games (YGG)? - CoinMarketCap](https://coinmarketcap.com/cmc-ai/yield-guild-games/what-is/)
- [YGG to BTC: Yield Guild Games Price in Bitcoin | CoinGecko](https://www.coingecko.com/en/coins/yield-guild-games/btc)
- [Latest Yield Guild Games (YGG) Price Analysis - CoinMarketCap](https://coinmarketcap.com/cmc-ai/yield-guild-games/price-analysis/)
- [YGG to DKK: Yield Guild Games Price in Danish Krone | CoinGecko](https://www.coingecko.com/en/coins/yield-guild-games/dkk)
- [base YGG](https://basescan.org/token/0xaac78d1219c08aecc8e37e03858fe885f5ef1799)
- [ethereum YGG](https://etherscan.io/token/0x25f8087ead173b73d6e8b84329989a8eea16cf73)
- [polygon YGG](https://polygonscan.com/token/0x82617aa52dddf5ed9bb7b370ed777b3182a30fd1)
- [bsc YGG](https://bscscan.com/token/0x13ab6739368a4e4abf24695bf52959224367391f)
- [Google project search](https://www.google.com/search?q=Yield%20Guild%20Games%20YGG%20crypto)
- [Google tokenomics search](https://www.google.com/search?q=Yield%20Guild%20Games%20YGG%20tokenomics)
- [Google docs search](https://www.google.com/search?q=Yield%20Guild%20Games%20docs)
- [Google governance search](https://www.google.com/search?q=Yield%20Guild%20Games%20governance%20proposal)
- [Google audit search](https://www.google.com/search?q=Yield%20Guild%20Games%20audit%20report)
- [CoinMarketCap currency guess](https://coinmarketcap.com/currencies/yield-guild-games/)

## Final Investment View

Yield Guild Games should be in the Research Map as a **watchlist / selective diligence** asset. The project has enough category relevance and data footprint to merit ongoing coverage, especially because it came from the CG/CMC-oriented candidate workflow and has no high-confidence local duplicate. The current evidence does not yet support a high-conviction allocation thesis. The next level of confidence requires cleaner token economics: fee capture, staking or collateral utility, transparent unlocks, and liquidity that can support realistic position sizing.
