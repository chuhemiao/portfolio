...
| FDV | $46.69M |
| 24h volume | $1.83M |
| Circulating supply | 591.96M |
| Total supply | 591.96M |
...
Base case: DUSK remains a selective watchlist asset until token value capture is cleaner. Bull case: protocol usage and token mechanics converge, turning DUSK into a security, collateral, or fee-routing asset with real demand. Bear case: the protocol remains useful but token holders absorb dilution, thin liquidity, governance optionality, or regulatory/technical tail risk.

## Project Overview

Million on Mars is a browser-based, mobile-friendly MMO city-builder set on Mars that combines resource management, professions, crafting and a persistent player-driven economy. Its in-game currency is Dusk (token DUSK) and the project uses NFTs/land deeds across WAX, Solana and Polygon; official site, docs and X account provide game and token details.

Surf's project profile maps DUSK to the following high-level surface:

| Area | Evidence |
|---|---|
| Website | [https://www.milliononmars.com/](https://www.milliononmars.com/) |
...
| Liquidity | $1.83M 24h volume | Deeper CEX/DEX books and less fragmented contract liquidity |
| Supply quality | 591.96M circulating vs 591.96M total | Official unlock schedule and reconciled circulating methodology |
| Downside containment | Watchlist only | Transparent treasury, audits, risk controls, and stress-test history |

The strongest reason to add the report is not that DUSK is obviously cheap. It is that the project is large or specific enough to track in the Research Map, and the current candidate backlog indicates it had not yet been covered locally.
...
|---|---|---|---|
| ethereum | DUSK | 0x940a2db1b7008b6c776d4faaca729d6d4a4aa551 | [explorer](https://etherscan.io/token/0x940a2db1b7008b6c776d4faaca729d6d4a4aa551) |
| bsc | DUSK | 0xb2bd0749dbe21f623d9baba856d3b0f0e1bfec9c | [explorer](https://bscscan.com/token/0xb2bd0749dbe21f623d9baba856d3b0f0e1bfec9c) |
...
The market intelligence layer has three parts: DeFi usage, market liquidity, and attention. For DUSK, the DeFi-oriented backlog note is the first signal: Seeded 2026-07-06 from Surf market-ranking; rank 471, market cap $46,097,288, 24h volume $4,281,438. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.. Surf/CG data then adds market cap $46.69M, FDV $46.69M, 24h volume $1.83M, and price $0.0789.
...
| 24h volume | $1.83M | Position sizing and exit liquidity proxy |
| Market cap | $46.69M | Liquid valuation proxy |
| FDV | $46.69M | Dilution-aware valuation proxy |
...
| Accrual channel | Strength for DUSK | Evidence needed |
|---|---|---|
...
| Staking / security | Depends on whether DUSK is bonded or slashable | Staking contracts, validator docs, reward schedule |
...
The fifth frame is reflexivity. Many DeFi and infrastructure assets reprice in waves: first through TVL and listings, then through fee visibility, then through tokenomics cleanup, and finally through real cash-flow or strategic acquisition narratives. DUSK currently needs to be monitored through that sequence. The available 90-day TVL series has 0 point(s), latest TVL not disclosed, and approximate change not disclosed. Market-price movement shows 7d 1.39% and 30d -14.53% when Surf or CoinGecko exposed the field. If TVL and price move together, the thesis may be simple beta. If TVL rises while price lags, the thesis becomes value-capture skepticism. If price rises while TVL falls, the thesis becomes momentum without fundamental confirmation.

The conservative conclusion is that DUSK's product relevance may be ahead of its token value capture. That is common in this sector. The report should therefore watch for activation events: fee switch, staking redesign, revenue dashboard, cap increases, major integrations, or emissions reductions.
...
|---|---|---|---|
| 2020-09-01 | Strategic | $1.00M | iFinex |

| Team member | Role | Link |
|---|---|---|
| Emanuele Francioni | Co-Founder, CEO | [X](https://twitter.com/Autholykos) |
| Fulvio Venturelli | Co-Founder, CIO | [X](https://twitter.com/@fulviuus) |
| Matteo Ferretti | CTO | not disclosed |
| Sabine de Witte | Chief of Staff | [X](https://twitter.com/sabinedewitte) |
| Bas Kortenhoff | Strategic Advisor | not disclosed |
| Aylon Morley | Strategic Advisor | not disclosed |
| Richard Sanders | Security Advisor | not disclosed |
| Patrick de Laive | Advisor | [X](https://twitter.com/patrick) |
...
DUSK competes in the DeFi infrastructure bucket, where category peers vary by exact design. The memo uses functional competitors rather than only ticker competitors:
...
The key competitive question is whether DUSK has a reason to exist beyond incentives. If switching costs are low and users are primarily chasing emissions, any valuation premium should be temporary. If the protocol controls a scarce integration point, compliance rail, validator layer, or liquidity venue, it can deserve a persistent watchlist premium.
...
Weighted conclusion: DUSK is important enough to track, but not clean enough to rank as a high-conviction token until economic capture is clearer.

## Bull / Base / Bear

| Scenario | Probability | Thesis | Monitoring signal |
|---|---:|---|---|
| Bull | 25% | DUSK compounds usage, liquidity improves, and DUSK gains measurable value capture through staking, fees, collateral, or governance-controlled economics. | TVL up, fees visible, volume deepens, supply overhang falls |
...
**Confidence: 6.2 / 10.** The score is above neutral because DUSK has enough source coverage and category relevance to justify a full report. It is below high conviction because several valuation-critical fields remain unresolved: durable fees, tokenholder capture, precise unlocks, and stress-tested liquidity.
...
The strongest bearish critique is simple: this could be a useful protocol with an average token. If DUSK does not capture fees or security demand, the market will eventually value it as governance optionality plus liquidity beta. The second critique is data inconsistency. CG, CMC, Surf, and official docs can disagree on circulating supply, FDV, and market cap. The third critique is reflexive TVL: deposits can leave quickly when incentives, yields, or narratives change.
...
| 24h volume | $1.83M | Weekly | Volume below position-size threshold |
...
1. Re-run Surf project-detail and project-defi-metrics if DUSK announces a major integration, listing, tokenomics change, exploit, or governance proposal.
...
This report intentionally separates source availability from source quality. DUSK has a visible market footprint, but a visible footprint is not the same as a reconciled investment record. The Research Map standard treats CoinGecko and CoinMarketCap as discovery and market-data surfaces, Surf as an aggregation and refresh layer, DefiLlama style records as a protocol-usage lens, and official docs as the final arbiter for product mechanics. When these sources disagree, the disagreement itself is part of the thesis. A token with unclear supply methodology, mismatched contract labels, stale app docs, or broken dashboard coverage is usually harder to underwrite even when the narrative looks attractive.

For DUSK, the first reconciliation job is identity. The token symbol is DUSK, the category is DeFi infrastructure, chains are Binance Smart Chain, Ethereum, exchanges are BINANCE, BITGET, and tags are GameFi, Metaverse. These fields should be checked against official docs, token contracts, exchange market tabs, and community channels before the report graduates from watchlist to allocation candidate. If DUSK trades on multiple chains, each contract should be mapped to a canonical issuer statement. If the same symbol is reused by another asset, exchange tickers and contract addresses must be treated as separate facts rather than as interchangeable labels. This matters because a fuzzy ticker match can make a good memo wrong at the first line.

The second reconciliation job is market data. Market cap is $46.69M, FDV is $46.69M, 24h volume is $1.83M, FDV / market cap is 1.00x, 7d price change is 1.39%, and 30d price change is -14.53%. These numbers need a vendor-drift check. If CMC reports a different circulating supply from CoinGecko or Surf, the memo should prefer the official unlock and circulating-supply definition, then keep the aggregator spread as a risk note. If volume is dominated by one venue, the liquidity score should be lower than the headline volume implies. If FDV is not disclosed or total supply is missing, the base case should assume worse dilution until proven otherwise.
...
|---|---|---|
| Identity | DUSK / DUSK | Match official docs, CG, CMC, Surf, contracts |
...
For DUSK, the current liquidity read is watchlist first. The market cap is $46.69M, FDV is $46.69M, reported 24h volume is $1.83M, and FDV / market cap is 1.00x. These values can support a research card, but they do not automatically support an investment. A cleaner setup would show stable volume across multiple venues, narrow spreads, less reliance on a single pair, and a supply schedule that does not create a near-term wall of unlock pressure.
...
| Peer comparison | Monthly | DUSK gains share with better economics | Peers grow faster with cleaner capture |

## Evidence Ledger

| # | Source | Link | Why it matters |
|---:|---|---|---|
| 1 | Official website | [link](https://www.milliononmars.com/) | Identity, market, social, contract, or discovery cross-check |
| 2 | CoinGecko search | [link](https://www.coingecko.com/en/search?query=DUSK) | Identity, market, social, contract, or discovery cross-check |
| 3 | CoinMarketCap discovery | [link](https://coinmarketcap.com/search/?q=DUSK) | Identity, market, social, contract, or discovery cross-check |
| 4 | DefiLlama protocol discovery | [link](https://defillama.com/search?query=DUSK) | Identity, market, social, contract, or discovery cross-check |
| 5 | Token Terminal discovery | [link](https://tokenterminal.com/explorer?search=DUSK) | Identity, market, social, contract, or discovery cross-check |
| 6 | Messari discovery | [link](https://messari.io/search?q=DUSK) | Identity, market, social, contract, or discovery cross-check |
| 7 | GitHub | [link](https://github.com/MillionOnMars) | Identity, market, social, contract, or discovery cross-check |
| 8 | Telegram | [link](https://t.me/DuskNetwork) | Identity, market, social, contract, or discovery cross-check |
| 9 | Discord | [link](https://discord.gg/milliononmars) | Identity, market, social, contract, or discovery cross-check |
| 10 | DUSK/USD Live Price Chart, Market Cap & News Today - CoinGecko | [link](https://www.coingecko.com/en/coins/dusk) | Identity, market, social, contract, or discovery cross-check |
| 11 | Tokenomics / DOCS - Dusk Network | [link](https://docs.dusk.network/learn/tokenomics/) | Identity, market, social, contract, or discovery cross-check |
| 12 | What Is Dusk (DUSK) And How Does It Work? - CoinMarketCap | [link](https://coinmarketcap.com/cmc-ai/dusk/what-is/) | Identity, market, social, contract, or discovery cross-check |
| 13 | DUSK Deep Research Report: Token Future Development and ... | [link](https://onekey.so/blog/ecosystem/dusk-deep-research-report-token-future-development-and-price-outlook/?srsltid=AfmBOor6rcq7uycU2ZuO4OSn51KWeO7BwVr2nEO9uSCOBxaq9yxPWM9-) | Identity, market, social, contract, or discovery cross-check |
| 14 | DUSK to BTC: DUSK Price in Bitcoin - CoinGecko | [link](https://www.coingecko.com/en/coins/dusk/btc) | Identity, market, social, contract, or discovery cross-check |
| 15 | ethereum DUSK | [link](https://etherscan.io/token/0x940a2db1b7008b6c776d4faaca729d6d4a4aa551) | Identity, market, social, contract, or discovery cross-check |
| 16 | bsc DUSK | [link](https://bscscan.com/token/0xb2bd0749dbe21f623d9baba856d3b0f0e1bfec9c) | Identity, market, social, contract, or discovery cross-check |
| 17 | Google project search | [link](https://www.google.com/search?q=DUSK%20DUSK%20crypto) | Identity, market, social, contract, or discovery cross-check |
| 18 | Google tokenomics search | [link](https://www.google.com/search?q=DUSK%20DUSK%20tokenomics) | Identity, market, social, contract, or discovery cross-check |
| 19 | Google docs search | [link](https://www.google.com/search?q=DUSK%20docs) | Identity, market, social, contract, or discovery cross-check |
| 20 | Google governance search | [link](https://www.google.com/search?q=DUSK%20governance%20proposal) | Identity, market, social, contract, or discovery cross-check |
| 21 | Google audit search | [link](https://www.google.com/search?q=DUSK%20audit%20report) | Identity, market, social, contract, or discovery cross-check |
| 22 | CoinMarketCap price analysis guess | [link](https://coinmarketcap.com/cmc-ai/dusk/price-analysis/) | Identity, market, social, contract, or discovery cross-check |
| 23 | CoinMarketCap currency guess | [link](https://coinmarketcap.com/currencies/dusk/) | Identity, market, social, contract, or discovery cross-check |
| 24 | Dune discovery | [link](https://dune.com/browse/dashboards?q=DUSK) | Identity, market, social, contract, or discovery cross-check |
| 25 | Dune token query | [link](https://dune.com/browse/queries?q=DUSK) | Identity, market, social, contract, or discovery cross-check |
| 26 | DeFiLlama fees discovery | [link](https://defillama.com/fees?chain=All&search=DUSK) | Identity, market, social, contract, or discovery cross-check |
| 27 | DeFiLlama yield discovery | [link](https://defillama.com/yields?token=DUSK) | Identity, market, social, contract, or discovery cross-check |
| 28 | TokenUnlocks search | [link](https://token.unlocks.app/?search=DUSK) | Identity, market, social, contract, or discovery cross-check |
| 29 | CryptoRank search | [link](https://cryptorank.io/price/dusk) | Identity, market, social, contract, or discovery cross-check |
| 30 | RootData search | [link](https://www.rootdata.com/search?kw=DUSK) | Identity, market, social, contract, or discovery cross-check |
| 31 | CoinDesk search | [link](https://www.coindesk.com/search?s=DUSK) | Identity, market, social, contract, or discovery cross-check |
| 32 | The Block search | [link](https://www.theblock.co/search?query=DUSK) | Identity, market, social, contract, or discovery cross-check |
| 33 | GitHub search | [link](https://github.com/search?q=DUSK&type=repositories) | Identity, market, social, contract, or discovery cross-check |
| 34 | Etherscan token search | [link](https://etherscan.io/search?f=0&q=DUSK) | Identity, market, social, contract, or discovery cross-check |

Additional direct source list:

- [Official website](https://www.milliononmars.com/)
- [CoinGecko search](https://www.coingecko.com/en/search?query=DUSK)
- [CoinMarketCap discovery](https://coinmarketcap.com/search/?q=DUSK)
- [DefiLlama protocol discovery](https://defillama.com/search?query=DUSK)
- [Token Terminal discovery](https://tokenterminal.com/explorer?search=DUSK)
- [Messari discovery](https://messari.io/search?q=DUSK)
- [GitHub](https://github.com/MillionOnMars)
- [Telegram](https://t.me/DuskNetwork)
- [Discord](https://discord.gg/milliononmars)
- [DUSK/USD Live Price Chart, Market Cap & News Today - CoinGecko](https://www.coingecko.com/en/coins/dusk)
- [Tokenomics | DOCS - Dusk Network](https://docs.dusk.network/learn/tokenomics/)
- [What Is Dusk (DUSK) And How Does It Work? - CoinMarketCap](https://coinmarketcap.com/cmc-ai/dusk/what-is/)
- [DUSK Deep Research Report: Token Future Development and ...](https://onekey.so/blog/ecosystem/dusk-deep-research-report-token-future-development-and-price-outlook/?srsltid=AfmBOor6rcq7uycU2ZuO4OSn51KWeO7BwVr2nEO9uSCOBxaq9yxPWM9-)
- [DUSK to BTC: DUSK Price in Bitcoin - CoinGecko](https://www.coingecko.com/en/coins/dusk/btc)
- [ethereum DUSK](https://etherscan.io/token/0x940a2db1b7008b6c776d4faaca729d6d4a4aa551)
- [bsc DUSK](https://bscscan.com/token/0xb2bd0749dbe21f623d9baba856d3b0f0e1bfec9c)
- [Google project search](https://www.google.com/search?q=DUSK%20DUSK%20crypto)
- [Google tokenomics search](https://www.google.com/search?q=DUSK%20DUSK%20tokenomics)
- [Google docs search](https://www.google.com/search?q=DUSK%20docs)
- [Google governance search](https://www.google.com/search?q=DUSK%20governance%20proposal)
- [Google audit search](https://www.google.com/search?q=DUSK%20audit%20report)
- [CoinMarketCap price analysis guess](https://coinmarketcap.com/cmc-ai/dusk/price-analysis/)
- [CoinMarketCap currency guess](https://coinmarketcap.com/currencies/dusk/)
- [Dune discovery](https://dune.com/browse/dashboards?q=DUSK)
