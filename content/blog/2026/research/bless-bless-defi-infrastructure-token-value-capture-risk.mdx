---
title: 'Bless / BLESS: DeFi infrastructure value capture, liquidity, and token risk'
publishedAt: '2026-07-06'
summary: 'Bless is treated as a DeFi infrastructure watchlist candidate sourced from CoinGecko/CMC discovery and refreshed with Surf, with emphasis on product durability, token value capture, liquidity, supply, and execution risk.'
slug: 'bless-bless-defi-infrastructure-token-value-capture-risk'
category: 'research'
---

# Bless / BLESS: DeFi infrastructure value capture, liquidity, and token risk

## Pre-screen Decision

**Decision: add to Research Map as a full-depth watchlist report, not as an automatic accumulation call.** Bless appears in the local CoinGecko/CMC-oriented candidate pool through market discovery and was refreshed with Surf on 2026-07-06. The project has enough protocol surface for a real memo: chain exposure is Binance Smart Chain, Solana; exchange exposure is BINANCE ALPHA, BITGET; category tags are DePIN (Physical Infra); current market cap is $15.91M; FDV is $86.37M; and 24h volume is $3.24M. That combination makes it worth researching, but not enough to override the main risks: token value capture may be indirect, liquidity can be fragile, supply methodology may differ across data vendors, and protocol usage can be incentive-sensitive.

The report uses a conservative watchlist standard. A pass means the project deserves monitoring and comparison against peers. It does not mean the token is cheap. A fail would require one of three red flags: no identifiable official/project surface, no meaningful market or DeFi data, or a high-confidence duplicate in the Research Map. Local duplicate checks did not flag Bless before this file was created, and the existing candidate note says: Seeded 2026-07-06 from Surf market-ranking; rank 929, market cap $16,283,502, 24h volume $3,243,961. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.

## TL;DR / Executive Summary

Bless is best understood as a **DeFi infrastructure** asset where the product thesis and the token thesis must be separated. The product thesis asks whether users, validators, LPs, borrowers, or asset issuers have a durable reason to use the protocol. The token thesis asks whether BLESS captures that activity through fees, staking, collateral, governance, liquidity routing, protocol-owned assets, or emissions control. The available evidence supports a watchlist entry, especially because it has a visible data footprint across Surf, CoinGecko, CMC discovery, and DeFi-oriented candidate notes. The evidence does not yet support a high-conviction valuation without better fee/revenue, unlock, treasury, and user-retention disclosure.
...
| FDV | $86.37M |
| 24h volume | $3.24M |
| Circulating supply | 1.84B |
| Total supply | 10.00B |
| 7d price change | 5.61% |
| 30d price change | 74.34% |
...
Base case: Bless remains a selective watchlist asset until token value capture is cleaner. Bull case: protocol usage and token mechanics converge, turning BLESS into a security, collateral, or fee-routing asset with real demand. Bear case: the protocol remains useful but token holders absorb dilution, thin liquidity, governance optionality, or regulatory/technical tail risk.

## Project Overview

Bless is a decentralized edge‑compute network that pools idle CPU/GPU from everyday devices to deliver low‑latency compute for AI, machine‑learning and web applications. Participants run nodes via the Bless extension/dashboard to contribute resources and earn rewards. The network’s native token, BLS, is required for node staking, used for payments within the platform, and a portion of proceeds are burned.

Surf's project profile maps Bless to the following high-level surface:

| Area | Evidence |
|---|---|
| Website | [https://bless.network/](https://bless.network/) |
| X handle | [@theblessnetwork](https://x.com/theblessnetwork) |
| X followers | 500.04K |
...
| Liquidity | $3.24M 24h volume | Deeper CEX/DEX books and less fragmented contract liquidity |
| Supply quality | 1.84B circulating vs 10.00B total | Official unlock schedule and reconciled circulating methodology |
| Downside containment | Watchlist only | Transparent treasury, audits, risk controls, and stress-test history |

The strongest reason to add the report is not that Bless is obviously cheap. It is that the project is large or specific enough to track in the Research Map, and the current candidate backlog indicates it had not yet been covered locally.
...
|---|---|---|---|
| solana | BLESS | A1t2UviBYwyfYZDJyKY2W6Td8ritgsCriUDuNaAQN49S | [explorer](https://solscan.io/token/A1t2UviBYwyfYZDJyKY2W6Td8ritgsCriUDuNaAQN49S) |
| bsc | BLESS | 0x7c8217517ed4711fe2deccdfeffe8d906b9ae11f | [explorer](https://bscscan.com/token/0x7c8217517ed4711fe2deccdfeffe8d906b9ae11f) |
...
The market intelligence layer has three parts: DeFi usage, market liquidity, and attention. For Bless, the DeFi-oriented backlog note is the first signal: Seeded 2026-07-06 from Surf market-ranking; rank 929, market cap $16,283,502, 24h volume $3,243,961. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.. Surf/CG data then adds market cap $15.91M, FDV $86.37M, 24h volume $3.24M, and price $0.0086.
...
| 24h volume | $3.24M | Position sizing and exit liquidity proxy |
| Market cap | $15.91M | Liquid valuation proxy |
| FDV | $86.37M | Dilution-aware valuation proxy |
| FDV / market cap spread | 5.43x | Higher spread means more supply risk |
| X followers | 500.04K | Attention proxy, not adoption proof |
...
| Accrual channel | Strength for Bless | Evidence needed |
|---|---|---|
...
| Staking / security | Depends on whether BLESS is bonded or slashable | Staking contracts, validator docs, reward schedule |
...
The fifth frame is reflexivity. Many DeFi and infrastructure assets reprice in waves: first through TVL and listings, then through fee visibility, then through tokenomics cleanup, and finally through real cash-flow or strategic acquisition narratives. Bless currently needs to be monitored through that sequence. The available 90-day TVL series has 0 point(s), latest TVL not disclosed, and approximate change not disclosed. Market-price movement shows 7d 5.61% and 30d 74.34% when Surf or CoinGecko exposed the field. If TVL and price move together, the thesis may be simple beta. If TVL rises while price lags, the thesis becomes value-capture skepticism. If price rises while TVL falls, the thesis becomes momentum without fundamental confirmation.

The conservative conclusion is that Bless's product relevance may be ahead of its token value capture. That is common in this sector. The report should therefore watch for activation events: fee switch, staking redesign, revenue dashboard, cap increases, major integrations, or emissions reductions.
...
|---|---|---|---|
| 2024-05-21 | Seed | $5.00M | M31 Capital, Marblex |
| 2022-03-01 | Pre Seed | $3.00M | NGC Ventures, MH Ventures, Plassa Capital, No Limit Holdings, Interop |

| Team member | Role | Link |
|---|---|---|
| Derek Anderson | Founder, CTO | [X](https://x.com/dmikeyanderson) |
| Michael Chen | Co-Founder, COO | [X](https://x.com/mchen8864) |
| Liam Zhang | Co-Founder, CPO | [X](https://x.com/velvety_cc) |
| Butian Li | Co-Founder | [X](https://x.com/blessbutian) |
...
Bless competes in the DeFi infrastructure bucket, where category peers vary by exact design. The memo uses functional competitors rather than only ticker competitors:
...
The key competitive question is whether Bless has a reason to exist beyond incentives. If switching costs are low and users are primarily chasing emissions, any valuation premium should be temporary. If the protocol controls a scarce integration point, compliance rail, validator layer, or liquidity venue, it can deserve a persistent watchlist premium.
...
Weighted conclusion: Bless is important enough to track, but not clean enough to rank as a high-conviction token until economic capture is clearer.

## Bull / Base / Bear

| Scenario | Probability | Thesis | Monitoring signal |
|---|---:|---|---|
| Bull | 25% | Bless compounds usage, liquidity improves, and BLESS gains measurable value capture through staking, fees, collateral, or governance-controlled economics. | TVL up, fees visible, volume deepens, supply overhang falls |
...
**Confidence: 6.2 / 10.** The score is above neutral because Bless has enough source coverage and category relevance to justify a full report. It is below high conviction because several valuation-critical fields remain unresolved: durable fees, tokenholder capture, precise unlocks, and stress-tested liquidity.
...
The strongest bearish critique is simple: this could be a useful protocol with an average token. If BLESS does not capture fees or security demand, the market will eventually value it as governance optionality plus liquidity beta. The second critique is data inconsistency. CG, CMC, Surf, and official docs can disagree on circulating supply, FDV, and market cap. The third critique is reflexive TVL: deposits can leave quickly when incentives, yields, or narratives change.
...
| 24h volume | $3.24M | Weekly | Volume below position-size threshold |
| FDV / market cap | 5.43x | Monthly | Rising dilution gap |
...
1. Re-run Surf project-detail and project-defi-metrics if Bless announces a major integration, listing, tokenomics change, exploit, or governance proposal.
...
|---|---|---|
| Identity | Bless / BLESS | Match official docs, CG, CMC, Surf, contracts |
...
For Bless, the current liquidity read is watchlist first. The market cap is $15.91M, FDV is $86.37M, reported 24h volume is $3.24M, and FDV / market cap is 5.43x. These values can support a research card, but they do not automatically support an investment. A cleaner setup would show stable volume across multiple venues, narrow spreads, less reliance on a single pair, and a supply schedule that does not create a near-term wall of unlock pressure.
...
| Peer comparison | Monthly | Bless gains share with better economics | Peers grow faster with cleaner capture |

## Evidence Ledger

| # | Source | Link | Why it matters |
|---:|---|---|---|
| 1 | Official website | [link](https://bless.network/) | Identity, market, social, contract, or discovery cross-check |
| 2 | CoinGecko search | [link](https://www.coingecko.com/en/search?query=Bless) | Identity, market, social, contract, or discovery cross-check |
| 3 | CoinMarketCap discovery | [link](https://coinmarketcap.com/search/?q=Bless) | Identity, market, social, contract, or discovery cross-check |
| 4 | DefiLlama protocol discovery | [link](https://defillama.com/search?query=Bless) | Identity, market, social, contract, or discovery cross-check |
| 5 | Token Terminal discovery | [link](https://tokenterminal.com/explorer?search=Bless) | Identity, market, social, contract, or discovery cross-check |
| 6 | Messari discovery | [link](https://messari.io/search?q=Bless) | Identity, market, social, contract, or discovery cross-check |
| 7 | X profile | [link](https://x.com/theblessnetwork) | Identity, market, social, contract, or discovery cross-check |
| 8 | GitHub | [link](https://github.com/blocklessnetwork) | Identity, market, social, contract, or discovery cross-check |
| 9 | Telegram | [link](https://t.me/blessnetofficial) | Identity, market, social, contract, or discovery cross-check |
| 10 | Discord | [link](https://discord.com/invite/blessnetwork) | Identity, market, social, contract, or discovery cross-check |
| 11 | BLESS/USD Live Price Chart, Market Cap & News Today - CoinGecko | [link](https://www.coingecko.com/en/coins/bless) | Identity, market, social, contract, or discovery cross-check |
| 12 | What Is Bless (BLESS) And How Does It Work? - CoinMarketCap | [link](https://coinmarketcap.com/cmc-ai/bless/what-is/) | Identity, market, social, contract, or discovery cross-check |
...
| 14 | Latest Bless (BLESS) Price Analysis - CoinMarketCap | [link](https://coinmarketcap.com/cmc-ai/bless/price-analysis/) | Identity, market, social, contract, or discovery cross-check |
| 15 | Bless (BLESS) Price Prediction For 2026 & Beyond - CoinMarketCap | [link](https://coinmarketcap.com/cmc-ai/bless/price-prediction/) | Identity, market, social, contract, or discovery cross-check |
| 16 | solana BLESS | [link](https://solscan.io/token/A1t2UviBYwyfYZDJyKY2W6Td8ritgsCriUDuNaAQN49S) | Identity, market, social, contract, or discovery cross-check |
| 17 | bsc BLESS | [link](https://bscscan.com/token/0x7c8217517ed4711fe2deccdfeffe8d906b9ae11f) | Identity, market, social, contract, or discovery cross-check |
| 18 | Google project search | [link](https://www.google.com/search?q=Bless%20BLESS%20crypto) | Identity, market, social, contract, or discovery cross-check |
| 19 | Google tokenomics search | [link](https://www.google.com/search?q=Bless%20BLESS%20tokenomics) | Identity, market, social, contract, or discovery cross-check |
| 20 | Google docs search | [link](https://www.google.com/search?q=Bless%20docs) | Identity, market, social, contract, or discovery cross-check |
| 21 | Google governance search | [link](https://www.google.com/search?q=Bless%20governance%20proposal) | Identity, market, social, contract, or discovery cross-check |
| 22 | Google audit search | [link](https://www.google.com/search?q=Bless%20audit%20report) | Identity, market, social, contract, or discovery cross-check |
| 23 | CoinMarketCap currency guess | [link](https://coinmarketcap.com/currencies/bless/) | Identity, market, social, contract, or discovery cross-check |
| 24 | Dune discovery | [link](https://dune.com/browse/dashboards?q=Bless) | Identity, market, social, contract, or discovery cross-check |
| 25 | Dune token query | [link](https://dune.com/browse/queries?q=Bless) | Identity, market, social, contract, or discovery cross-check |
| 26 | DeFiLlama fees discovery | [link](https://defillama.com/fees?chain=All&search=Bless) | Identity, market, social, contract, or discovery cross-check |
| 27 | DeFiLlama yield discovery | [link](https://defillama.com/yields?token=BLESS) | Identity, market, social, contract, or discovery cross-check |
| 28 | TokenUnlocks search | [link](https://token.unlocks.app/?search=Bless) | Identity, market, social, contract, or discovery cross-check |
| 29 | CryptoRank search | [link](https://cryptorank.io/price/bless) | Identity, market, social, contract, or discovery cross-check |
| 30 | RootData search | [link](https://www.rootdata.com/search?kw=Bless) | Identity, market, social, contract, or discovery cross-check |
| 31 | CoinDesk search | [link](https://www.coindesk.com/search?s=Bless) | Identity, market, social, contract, or discovery cross-check |
| 32 | The Block search | [link](https://www.theblock.co/search?query=Bless) | Identity, market, social, contract, or discovery cross-check |
| 33 | GitHub search | [link](https://github.com/search?q=Bless&type=repositories) | Identity, market, social, contract, or discovery cross-check |
| 34 | Etherscan token search | [link](https://etherscan.io/search?f=0&q=BLESS) | Identity, market, social, contract, or discovery cross-check |

Additional direct source list:

- [Official website](https://bless.network/)
- [CoinGecko search](https://www.coingecko.com/en/search?query=Bless)
- [CoinMarketCap discovery](https://coinmarketcap.com/search/?q=Bless)
- [DefiLlama protocol discovery](https://defillama.com/search?query=Bless)
- [Token Terminal discovery](https://tokenterminal.com/explorer?search=Bless)
- [Messari discovery](https://messari.io/search?q=Bless)
- [X profile](https://x.com/theblessnetwork)
- [GitHub](https://github.com/blocklessnetwork)
- [Telegram](https://t.me/blessnetofficial)
- [Discord](https://discord.com/invite/blessnetwork)
- [BLESS/USD Live Price Chart, Market Cap & News Today - CoinGecko](https://www.coingecko.com/en/coins/bless)
- [What Is Bless (BLESS) And How Does It Work? - CoinMarketCap](https://coinmarketcap.com/cmc-ai/bless/what-is/)
- [CoinGecko: Cryptocurrency Prices, Charts, and Crypto Market Cap](https://www.coingecko.com/)
- [Latest Bless (BLESS) Price Analysis - CoinMarketCap](https://coinmarketcap.com/cmc-ai/bless/price-analysis/)
- [Bless (BLESS) Price Prediction For 2026 & Beyond - CoinMarketCap](https://coinmarketcap.com/cmc-ai/bless/price-prediction/)
- [solana BLESS](https://solscan.io/token/A1t2UviBYwyfYZDJyKY2W6Td8ritgsCriUDuNaAQN49S)
- [bsc BLESS](https://bscscan.com/token/0x7c8217517ed4711fe2deccdfeffe8d906b9ae11f)
- [Google project search](https://www.google.com/search?q=Bless%20BLESS%20crypto)
- [Google tokenomics search](https://www.google.com/search?q=Bless%20BLESS%20tokenomics)
- [Google docs search](https://www.google.com/search?q=Bless%20docs)
- [Google governance search](https://www.google.com/search?q=Bless%20governance%20proposal)
- [Google audit search](https://www.google.com/search?q=Bless%20audit%20report)
- [CoinMarketCap currency guess](https://coinmarketcap.com/currencies/bless/)
- [Dune discovery](https://dune.com/browse/dashboards?q=Bless)

## Final Investment View

Bless should be in the Research Map as a **watchlist / selective diligence** asset. The project has enough category relevance and data footprint to merit ongoing coverage, especially because it came from the CG/CMC-oriented candidate workflow and has no high-confidence local duplicate. The current evidence does not yet support a high-conviction allocation thesis. The next level of confidence requires cleaner token economics: fee capture, staking or collateral utility, transparent unlocks, and liquidity that can support realistic position sizing.
