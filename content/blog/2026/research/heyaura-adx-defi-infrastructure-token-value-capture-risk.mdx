...
Base case: heyAura remains a selective watchlist asset until token value capture is cleaner. Bull case: protocol usage and token mechanics converge, turning ADX into a security, collateral, or fee-routing asset with real demand. Bear case: the protocol remains useful but token holders absorb dilution, thin liquidity, governance optionality, or regulatory/technical tail risk.

## Project Overview

heyAura (ADX) evolved from a decentralized ad platform into an AI infrastructure for Web3. It offers a personal AI agent that optimizes portfolios, identifies opportunities, and automates strategies. ADX enables staking, governance, and premium access.

Surf's project profile maps heyAura to the following high-level surface:

| Area | Evidence |
|---|---|
| Website | [https://www.heyaura.com/](https://www.heyaura.com/) |
| X handle | [@heyaura](https://x.com/heyaura) |
| X followers | 182.56K |
...
| Liquidity | $1.54M 24h volume | Deeper CEX/DEX books and less fragmented contract liquidity |
| Supply quality | 147.90M circulating vs 150.00M total | Official unlock schedule and reconciled circulating methodology |
| Downside containment | Watchlist only | Transparent treasury, audits, risk controls, and stress-test history |

The strongest reason to add the report is not that heyAura is obviously cheap. It is that the project is large or specific enough to track in the Research Map, and the current candidate backlog indicates it had not yet been covered locally.

## Architecture / Mechanism

heyAura's architecture should be evaluated through the job it performs. For a DeFi infrastructure project, architecture is not merely code shape. It includes the contracts, governance process, integration path, oracle and risk dependencies, bridge or staking assumptions, collateral policies, and the way users enter and exit positions.
...
|---|---|---|---|
| ethereum | ADX | 0xade00c28244d5ce17d72e40330b1c318cd12b7c3 | [explorer](https://etherscan.io/token/0xade00c28244d5ce17d72e40330b1c318cd12b7c3) |
| bsc | ADX | 0x6bff4fb161347ad7de4a625ae5aa3a1ca7077819 | [explorer](https://bscscan.com/token/0x6bff4fb161347ad7de4a625ae5aa3a1ca7077819) |
...
The market intelligence layer has three parts: DeFi usage, market liquidity, and attention. For heyAura, the DeFi-oriented backlog note is the first signal: Seeded 2026-07-06 from Surf market-ranking; rank 1267, market cap $8,373,299, 24h volume $1,520,700. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.. Surf/CG data then adds market cap $8.53M, FDV $8.65M, 24h volume $1.54M, and price $0.0577.
...
| 24h volume | $1.54M | Position sizing and exit liquidity proxy |
| Market cap | $8.53M | Liquid valuation proxy |
| FDV | $8.65M | Dilution-aware valuation proxy |
| FDV / market cap spread | 1.01x | Higher spread means more supply risk |
| X followers | 182.56K | Attention proxy, not adoption proof |
...
| Accrual channel | Strength for heyAura | Evidence needed |
|---|---|---|
...
| Staking / security | Depends on whether ADX is bonded or slashable | Staking contracts, validator docs, reward schedule |
...
The fifth frame is reflexivity. Many DeFi and infrastructure assets reprice in waves: first through TVL and listings, then through fee visibility, then through tokenomics cleanup, and finally through real cash-flow or strategic acquisition narratives. heyAura currently needs to be monitored through that sequence. The available 90-day TVL series has 0 point(s), latest TVL not disclosed, and approximate change not disclosed. Market-price movement shows 7d 2.98% and 30d 5.83% when Surf or CoinGecko exposed the field. If TVL and price move together, the thesis may be simple beta. If TVL rises while price lags, the thesis becomes value-capture skepticism. If price rises while TVL falls, the thesis becomes momentum without fundamental confirmation.

The conservative conclusion is that heyAura's product relevance may be ahead of its token value capture. That is common in this sector. The report should therefore watch for activation events: fee switch, staking redesign, revenue dashboard, cap increases, major integrations, or emissions reductions.
...
heyAura competes in the DeFi infrastructure bucket, where category peers vary by exact design. The memo uses functional competitors rather than only ticker competitors:
...
The key competitive question is whether heyAura has a reason to exist beyond incentives. If switching costs are low and users are primarily chasing emissions, any valuation premium should be temporary. If the protocol controls a scarce integration point, compliance rail, validator layer, or liquidity venue, it can deserve a persistent watchlist premium.
...
Weighted conclusion: heyAura is important enough to track, but not clean enough to rank as a high-conviction token until economic capture is clearer.

## Bull / Base / Bear

| Scenario | Probability | Thesis | Monitoring signal |
|---|---:|---|---|
| Bull | 25% | heyAura compounds usage, liquidity improves, and ADX gains measurable value capture through staking, fees, collateral, or governance-controlled economics. | TVL up, fees visible, volume deepens, supply overhang falls |
...
**Confidence: 6.2 / 10.** The score is above neutral because heyAura has enough source coverage and category relevance to justify a full report. It is below high conviction because several valuation-critical fields remain unresolved: durable fees, tokenholder capture, precise unlocks, and stress-tested liquidity.
...
The strongest bearish critique is simple: this could be a useful protocol with an average token. If ADX does not capture fees or security demand, the market will eventually value it as governance optionality plus liquidity beta. The second critique is data inconsistency. CG, CMC, Surf, and official docs can disagree on circulating supply, FDV, and market cap. The third critique is reflexive TVL: deposits can leave quickly when incentives, yields, or narratives change.
...
| 24h volume | $1.54M | Weekly | Volume below position-size threshold |
...
1. Re-run Surf project-detail and project-defi-metrics if heyAura announces a major integration, listing, tokenomics change, exploit, or governance proposal.
...
This report intentionally separates source availability from source quality. heyAura has a visible market footprint, but a visible footprint is not the same as a reconciled investment record. The Research Map standard treats CoinGecko and CoinMarketCap as discovery and market-data surfaces, Surf as an aggregation and refresh layer, DefiLlama style records as a protocol-usage lens, and official docs as the final arbiter for product mechanics. When these sources disagree, the disagreement itself is part of the thesis. A token with unclear supply methodology, mismatched contract labels, stale app docs, or broken dashboard coverage is usually harder to underwrite even when the narrative looks attractive.

For heyAura, the first reconciliation job is identity. The token symbol is ADX, the category is DeFi infrastructure, chains are Binance Smart Chain, Ethereum, exchanges are BINANCE, and tags are Web3 AI (Agent/AIGC). These fields should be checked against official docs, token contracts, exchange market tabs, and community channels before the report graduates from watchlist to allocation candidate. If ADX trades on multiple chains, each contract should be mapped to a canonical issuer statement. If the same symbol is reused by another asset, exchange tickers and contract addresses must be treated as separate facts rather than as interchangeable labels. This matters because a fuzzy ticker match can make a good memo wrong at the first line.

The second reconciliation job is market data. Market cap is $8.53M, FDV is $8.65M, 24h volume is $1.54M, FDV / market cap is 1.01x, 7d price change is 2.98%, and 30d price change is 5.83%. These numbers need a vendor-drift check. If CMC reports a different circulating supply from CoinGecko or Surf, the memo should prefer the official unlock and circulating-supply definition, then keep the aggregator spread as a risk note. If volume is dominated by one venue, the liquidity score should be lower than the headline volume implies. If FDV is not disclosed or total supply is missing, the base case should assume worse dilution until proven otherwise.
...
|---|---|---|
| Identity | heyAura / ADX | Match official docs, CG, CMC, Surf, contracts |
...
For heyAura, the current liquidity read is watchlist first. The market cap is $8.53M, FDV is $8.65M, reported 24h volume is $1.54M, and FDV / market cap is 1.01x. These values can support a research card, but they do not automatically support an investment. A cleaner setup would show stable volume across multiple venues, narrow spreads, less reliance on a single pair, and a supply schedule that does not create a near-term wall of unlock pressure.
...
| Peer comparison | Monthly | heyAura gains share with better economics | Peers grow faster with cleaner capture |

## Evidence Ledger

| # | Source | Link | Why it matters |
|---:|---|---|---|
| 1 | Official website | [link](https://www.heyaura.com/) | Identity, market, social, contract, or discovery cross-check |
| 2 | CoinGecko search | [link](https://www.coingecko.com/en/search?query=heyAura) | Identity, market, social, contract, or discovery cross-check |
| 3 | CoinMarketCap discovery | [link](https://coinmarketcap.com/search/?q=heyAura) | Identity, market, social, contract, or discovery cross-check |
| 4 | DefiLlama protocol discovery | [link](https://defillama.com/search?query=heyAura) | Identity, market, social, contract, or discovery cross-check |
| 5 | Token Terminal discovery | [link](https://tokenterminal.com/explorer?search=heyAura) | Identity, market, social, contract, or discovery cross-check |
| 6 | Messari discovery | [link](https://messari.io/search?q=heyAura) | Identity, market, social, contract, or discovery cross-check |
| 7 | X profile | [link](https://x.com/heyaura) | Identity, market, social, contract, or discovery cross-check |
| 8 | GitHub | [link](https://github.com/heyauradev/) | Identity, market, social, contract, or discovery cross-check |
| 9 | Telegram | [link](https://t.me/adex_community) | Identity, market, social, contract, or discovery cross-check |
| 10 | heyAura Price: ADX/USD Live Price Chart, Market Cap & News Today | [link](https://www.coingecko.com/en/coins/adex) | Identity, market, social, contract, or discovery cross-check |
| 11 | Latest heyAura (ADX) News Update - CoinMarketCap | [link](https://coinmarketcap.com/cmc-ai/adx-net/latest-updates/) | Identity, market, social, contract, or discovery cross-check |
| 12 | heyAura (ADX) Price Prediction For 2026 & Beyond - CoinMarketCap | [link](https://coinmarketcap.com/cmc-ai/adx-net/price-prediction/) | Identity, market, social, contract, or discovery cross-check |
| 13 | ADX to IDR: heyAura Price in Indonesian Rupiah / CoinGecko | [link](https://www.coingecko.com/en/coins/adex/idr) | Identity, market, social, contract, or discovery cross-check |
| 14 | ADX to ETH: heyAura Price in Ether - CoinGecko | [link](https://www.coingecko.com/en/coins/adex/eth) | Identity, market, social, contract, or discovery cross-check |
| 15 | ethereum ADX | [link](https://etherscan.io/token/0xade00c28244d5ce17d72e40330b1c318cd12b7c3) | Identity, market, social, contract, or discovery cross-check |
| 16 | bsc ADX | [link](https://bscscan.com/token/0x6bff4fb161347ad7de4a625ae5aa3a1ca7077819) | Identity, market, social, contract, or discovery cross-check |
| 17 | Google project search | [link](https://www.google.com/search?q=heyAura%20ADX%20crypto) | Identity, market, social, contract, or discovery cross-check |
| 18 | Google tokenomics search | [link](https://www.google.com/search?q=heyAura%20ADX%20tokenomics) | Identity, market, social, contract, or discovery cross-check |
| 19 | Google docs search | [link](https://www.google.com/search?q=heyAura%20docs) | Identity, market, social, contract, or discovery cross-check |
| 20 | Google governance search | [link](https://www.google.com/search?q=heyAura%20governance%20proposal) | Identity, market, social, contract, or discovery cross-check |
| 21 | Google audit search | [link](https://www.google.com/search?q=heyAura%20audit%20report) | Identity, market, social, contract, or discovery cross-check |
| 22 | CoinMarketCap what-is guess | [link](https://coinmarketcap.com/cmc-ai/heyaura/what-is/) | Identity, market, social, contract, or discovery cross-check |
| 23 | CoinMarketCap price analysis guess | [link](https://coinmarketcap.com/cmc-ai/heyaura/price-analysis/) | Identity, market, social, contract, or discovery cross-check |
| 24 | CoinMarketCap currency guess | [link](https://coinmarketcap.com/currencies/heyaura/) | Identity, market, social, contract, or discovery cross-check |
| 25 | Dune discovery | [link](https://dune.com/browse/dashboards?q=heyAura) | Identity, market, social, contract, or discovery cross-check |
| 26 | Dune token query | [link](https://dune.com/browse/queries?q=heyAura) | Identity, market, social, contract, or discovery cross-check |
| 27 | DeFiLlama fees discovery | [link](https://defillama.com/fees?chain=All&search=heyAura) | Identity, market, social, contract, or discovery cross-check |
| 28 | DeFiLlama yield discovery | [link](https://defillama.com/yields?token=ADX) | Identity, market, social, contract, or discovery cross-check |
| 29 | TokenUnlocks search | [link](https://token.unlocks.app/?search=heyAura) | Identity, market, social, contract, or discovery cross-check |
| 30 | CryptoRank search | [link](https://cryptorank.io/price/heyaura) | Identity, market, social, contract, or discovery cross-check |
| 31 | RootData search | [link](https://www.rootdata.com/search?kw=heyAura) | Identity, market, social, contract, or discovery cross-check |
| 32 | CoinDesk search | [link](https://www.coindesk.com/search?s=heyAura) | Identity, market, social, contract, or discovery cross-check |
| 33 | The Block search | [link](https://www.theblock.co/search?query=heyAura) | Identity, market, social, contract, or discovery cross-check |
| 34 | GitHub search | [link](https://github.com/search?q=heyAura&type=repositories) | Identity, market, social, contract, or discovery cross-check |

Additional direct source list:

- [Official website](https://www.heyaura.com/)
- [CoinGecko search](https://www.coingecko.com/en/search?query=heyAura)
- [CoinMarketCap discovery](https://coinmarketcap.com/search/?q=heyAura)
- [DefiLlama protocol discovery](https://defillama.com/search?query=heyAura)
- [Token Terminal discovery](https://tokenterminal.com/explorer?search=heyAura)
- [Messari discovery](https://messari.io/search?q=heyAura)
- [X profile](https://x.com/heyaura)
- [GitHub](https://github.com/heyauradev/)
- [Telegram](https://t.me/adex_community)
- [heyAura Price: ADX/USD Live Price Chart, Market Cap & News Today](https://www.coingecko.com/en/coins/adex)
- [Latest heyAura (ADX) News Update - CoinMarketCap](https://coinmarketcap.com/cmc-ai/adx-net/latest-updates/)
- [heyAura (ADX) Price Prediction For 2026 & Beyond - CoinMarketCap](https://coinmarketcap.com/cmc-ai/adx-net/price-prediction/)
- [ADX to IDR: heyAura Price in Indonesian Rupiah | CoinGecko](https://www.coingecko.com/en/coins/adex/idr)
- [ADX to ETH: heyAura Price in Ether - CoinGecko](https://www.coingecko.com/en/coins/adex/eth)
- [ethereum ADX](https://etherscan.io/token/0xade00c28244d5ce17d72e40330b1c318cd12b7c3)
- [bsc ADX](https://bscscan.com/token/0x6bff4fb161347ad7de4a625ae5aa3a1ca7077819)
- [Google project search](https://www.google.com/search?q=heyAura%20ADX%20crypto)
- [Google tokenomics search](https://www.google.com/search?q=heyAura%20ADX%20tokenomics)
- [Google docs search](https://www.google.com/search?q=heyAura%20docs)
- [Google governance search](https://www.google.com/search?q=heyAura%20governance%20proposal)
- [Google audit search](https://www.google.com/search?q=heyAura%20audit%20report)
- [CoinMarketCap what-is guess](https://coinmarketcap.com/cmc-ai/heyaura/what-is/)
- [CoinMarketCap price analysis guess](https://coinmarketcap.com/cmc-ai/heyaura/price-analysis/)
- [CoinMarketCap currency guess](https://coinmarketcap.com/currencies/heyaura/)

## Final Investment View

heyAura should be in the Research Map as a **watchlist / selective diligence** asset. The project has enough category relevance and data footprint to merit ongoing coverage, especially because it came from the CG/CMC-oriented candidate workflow and has no high-confidence local duplicate. The current evidence does not yet support a high-conviction allocation thesis. The next level of confidence requires cleaner token economics: fee capture, staking or collateral utility, transparent unlocks, and liquidity that can support realistic position sizing.
