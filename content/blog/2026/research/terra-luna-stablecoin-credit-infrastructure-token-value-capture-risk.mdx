---
title: 'Terra / LUNA: stablecoin / credit infrastructure value capture, liquidity, and token risk'
publishedAt: '2026-07-06'
summary: 'Terra is treated as a stablecoin / credit infrastructure watchlist candidate sourced from CoinGecko/CMC discovery and refreshed with Surf, with emphasis on product durability, token value capture, liquidity, supply, and execution risk.'
slug: 'terra-luna-stablecoin-credit-infrastructure-token-value-capture-risk'
category: 'research'
---

# Terra / LUNA: stablecoin / credit infrastructure value capture, liquidity, and token risk

## Pre-screen Decision

**Decision: add to Research Map as a full-depth watchlist report, not as an automatic accumulation call.** Terra appears in the local CoinGecko/CMC-oriented candidate pool through market discovery and was refreshed with Surf on 2026-07-06. The project has enough protocol surface for a real memo: chain exposure is Aurora, Binance Smart Chain, Ethereum, Fantom, Harmony Shard 0, Osmosis, Polygon Pos, SORA, Solana, Terra; exchange exposure is BINANCE, OKX, BYBIT, BITGET; category tags are Stablecoins; current market cap is $342.05M; FDV is $399.33M; and 24h volume is $12.59M. That combination makes it worth researching, but not enough to override the main risks: token value capture may be indirect, liquidity can be fragile, supply methodology may differ across data vendors, and protocol usage can be incentive-sensitive.

The report uses a conservative watchlist standard. A pass means the project deserves monitoring and comparison against peers. It does not mean the token is cheap. A fail would require one of three red flags: no identifiable official/project surface, no meaningful market or DeFi data, or a high-confidence duplicate in the Research Map. Local duplicate checks did not flag Terra before this file was created, and the existing candidate note says: Seeded 2026-07-06 from Surf market-ranking; rank 576, market cap $34,510,919, 24h volume $5,179,749. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.

## TL;DR / Executive Summary

Terra is best understood as a **stablecoin / credit infrastructure** asset where the product thesis and the token thesis must be separated. The product thesis asks whether users, validators, LPs, borrowers, or asset issuers have a durable reason to use the protocol. The token thesis asks whether LUNA captures that activity through fees, staking, collateral, governance, liquidity routing, protocol-owned assets, or emissions control. The available evidence supports a watchlist entry, especially because it has a visible data footprint across Surf, CoinGecko, CMC discovery, and DeFi-oriented candidate notes. The evidence does not yet support a high-conviction valuation without better fee/revenue, unlock, treasury, and user-retention disclosure.
...
| Chains | Aurora, Binance Smart Chain, Ethereum, Fantom, Harmony Shard 0, Osmosis, Polygon Pos, SORA, Solana, Terra |
| Exchanges | BINANCE, OKX, BYBIT, BITGET |
| Price | $0.0001 |
| Market cap | $342.05M |
| FDV | $399.33M |
| 24h volume | $12.59M |
| Circulating supply | 5528.75B |
| Total supply | 6454.53B |
...
Base case: Terra remains a selective watchlist asset until token value capture is cleaner. Bull case: protocol usage and token mechanics converge, turning LUNA into a security, collateral, or fee-routing asset with real demand. Bear case: the protocol remains useful but token holders absorb dilution, thin liquidity, governance optionality, or regulatory/technical tail risk.

## Project Overview

Terra Classic USD (USTC) is the rebranded TerraUSD on the Terra Classic blockchain. Originally an algorithmic stablecoin, its peg mechanism was halted post-2022 collapse. It now functions as a volatile token in DeFi pools and exchanges.

Surf's project profile maps Terra to the following high-level surface:

| Area | Evidence |
|---|---|
| Website | [https://www.terra-classic.money/](https://www.terra-classic.money/) |
| X handle | [@terra_money](https://x.com/terra_money) |
| X followers | 954.24K |
| Tags | Stablecoins |
| Chains | Aurora, Binance Smart Chain, Ethereum, Fantom, Harmony Shard 0, Osmosis, Polygon Pos, SORA, Solana, Terra |
| Exchanges | BINANCE, OKX, BYBIT, BITGET |
...
| Liquidity | $12.59M 24h volume | Deeper CEX/DEX books and less fragmented contract liquidity |
| Supply quality | 5528.75B circulating vs 6454.53B total | Official unlock schedule and reconciled circulating methodology |
| Downside containment | Watchlist only | Transparent treasury, audits, risk controls, and stress-test history |

The strongest reason to add the report is not that Terra is obviously cheap. It is that the project is large or specific enough to track in the Research Map, and the current candidate backlog indicates it had not yet been covered locally.
...
| Settlement layer | Chains and contracts that hold user value | Aurora, Binance Smart Chain, Ethereum, Fantom, Harmony Shard 0, Osmosis, Polygon Pos, SORA, Solana, Terra |
...
|---|---|---|---|
| Aurora | LUNC | 0xc4bdd27c33ec7daa6fcfd8532ddb524bf4038096 | not mapped |
| ethereum | LUNC | 0xd2877702675e6ceb975b4a1dff9fb7baf4c91ea9 | [explorer](https://etherscan.io/token/0xd2877702675e6ceb975b4a1dff9fb7baf4c91ea9) |
| polygon | LUNC | 0x24834bbec7e39ef42f4a75eaf8e5b6486d3f0e57 | [explorer](https://polygonscan.com/token/0x24834bbec7e39ef42f4a75eaf8e5b6486d3f0e57) |
| Aurora | USTC | 0x5ce9f0b6afb36135b5ddbf11705ceb65e634a9dc | not mapped |
| fantom | USTC | 0xe2d27f06f63d98b8e11b38b5b08a75d0c8dd62b9 | not mapped |
| solana | USTC | CXLBjMMcwkc17GfJtBos6rQCo1ypeH6eDbB82Kby4MRm | [explorer](https://solscan.io/token/CXLBjMMcwkc17GfJtBos6rQCo1ypeH6eDbB82Kby4MRm) |
| ethereum | USTC | 0xa47c8bf37f92abed4a126bda807a7b7498661acd | [explorer](https://etherscan.io/token/0xa47c8bf37f92abed4a126bda807a7b7498661acd) |
| polygon | USTC | 0x692597b009d13c4049a947cab2239b7d6517875f | [explorer](https://polygonscan.com/token/0x692597b009d13c4049a947cab2239b7d6517875f) |
...
The market intelligence layer has three parts: DeFi usage, market liquidity, and attention. For Terra, the DeFi-oriented backlog note is the first signal: Seeded 2026-07-06 from Surf market-ranking; rank 576, market cap $34,510,919, 24h volume $5,179,749. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.. Surf/CG data then adds market cap $342.05M, FDV $399.33M, 24h volume $12.59M, and price $0.0001.
...
| 24h volume | $12.59M | Position sizing and exit liquidity proxy |
| Market cap | $342.05M | Liquid valuation proxy |
| FDV | $399.33M | Dilution-aware valuation proxy |
| FDV / market cap spread | 1.17x | Higher spread means more supply risk |
| X followers | 954.24K | Attention proxy, not adoption proof |
...
| Accrual channel | Strength for Terra | Evidence needed |
|---|---|---|
...
| Staking / security | Depends on whether LUNA is bonded or slashable | Staking contracts, validator docs, reward schedule |
...
The fifth frame is reflexivity. Many DeFi and infrastructure assets reprice in waves: first through TVL and listings, then through fee visibility, then through tokenomics cleanup, and finally through real cash-flow or strategic acquisition narratives. Terra currently needs to be monitored through that sequence. The available 90-day TVL series has 0 point(s), latest TVL not disclosed, and approximate change not disclosed. Market-price movement shows 7d 0.37% and 30d 4.39% when Surf or CoinGecko exposed the field. If TVL and price move together, the thesis may be simple beta. If TVL rises while price lags, the thesis becomes value-capture skepticism. If price rises while TVL falls, the thesis becomes momentum without fundamental confirmation.

The conservative conclusion is that Terra's product relevance may be ahead of its token value capture. That is common in this sector. The report should therefore watch for activation events: fee switch, staking redesign, revenue dashboard, cap increases, major integrations, or emissions reductions.
...
|---|---|---|---|
| 2022-02-22 | Treasury Diversification | $1.00B | Three Arrows Capital, DeFiance Capital, Republic, Tribe Capital, Jump Crypto, GSR Ventures |
| 2021-01-26 | Strategic | $25.00M | Coinbase Ventures, Pantera Capital, Galaxy |
| 2019-01-30 | Ico | $62.00M | not disclosed |
| 2018-08-29 | Undisclosed | $32.00M | Kenetic Capital, HTX Ventures, Hashed, Arrington Capital, YZi Labs (Prev. Binance Labs), Polychain Capital, FBG Capital, 1kx |
| not disclosed | Private | $48.00M | not disclosed |
| not disclosed | Seed | $23.00M | not disclosed |

| Team member | Role | Link |
|---|---|---|
| Do Kwon | Co-Founder | [X](https://twitter.com/stablekwon) |
| Daniel Shin | Co-Founder | not disclosed |
| Chris Amani | CEO | [X](https://twitter.com/fleece_cannon) |
| Eduardo Alves | Chief Architect | [X](https://twitter.com/eduamdsa) |
...
Terra competes in the stablecoin / credit infrastructure bucket, where category peers vary by exact design. The memo uses functional competitors rather than only ticker competitors:
...
The key competitive question is whether Terra has a reason to exist beyond incentives. If switching costs are low and users are primarily chasing emissions, any valuation premium should be temporary. If the protocol controls a scarce integration point, compliance rail, validator layer, or liquidity venue, it can deserve a persistent watchlist premium.
...
Weighted conclusion: Terra is important enough to track, but not clean enough to rank as a high-conviction token until economic capture is clearer.

## Bull / Base / Bear

| Scenario | Probability | Thesis | Monitoring signal |
|---|---:|---|---|
| Bull | 25% | Terra compounds usage, liquidity improves, and LUNA gains measurable value capture through staking, fees, collateral, or governance-controlled economics. | TVL up, fees visible, volume deepens, supply overhang falls |
...
**Confidence: 6.2 / 10.** The score is above neutral because Terra has enough source coverage and category relevance to justify a full report. It is below high conviction because several valuation-critical fields remain unresolved: durable fees, tokenholder capture, precise unlocks, and stress-tested liquidity.
...
The strongest bearish critique is simple: this could be a useful protocol with an average token. If LUNA does not capture fees or security demand, the market will eventually value it as governance optionality plus liquidity beta. The second critique is data inconsistency. CG, CMC, Surf, and official docs can disagree on circulating supply, FDV, and market cap. The third critique is reflexive TVL: deposits can leave quickly when incentives, yields, or narratives change.
...
| 24h volume | $12.59M | Weekly | Volume below position-size threshold |
...
1. Re-run Surf project-detail and project-defi-metrics if Terra announces a major integration, listing, tokenomics change, exploit, or governance proposal.
...
This report intentionally separates source availability from source quality. Terra has a visible market footprint, but a visible footprint is not the same as a reconciled investment record. The Research Map standard treats CoinGecko and CoinMarketCap as discovery and market-data surfaces, Surf as an aggregation and refresh layer, DefiLlama style records as a protocol-usage lens, and official docs as the final arbiter for product mechanics. When these sources disagree, the disagreement itself is part of the thesis. A token with unclear supply methodology, mismatched contract labels, stale app docs, or broken dashboard coverage is usually harder to underwrite even when the narrative looks attractive.

For Terra, the first reconciliation job is identity. The token symbol is LUNA, the category is stablecoin / credit infrastructure, chains are Aurora, Binance Smart Chain, Ethereum, Fantom, Harmony Shard 0, Osmosis, Polygon Pos, SORA, Solana, Terra, exchanges are BINANCE, OKX, BYBIT, BITGET, and tags are Stablecoins. These fields should be checked against official docs, token contracts, exchange market tabs, and community channels before the report graduates from watchlist to allocation candidate. If LUNA trades on multiple chains, each contract should be mapped to a canonical issuer statement. If the same symbol is reused by another asset, exchange tickers and contract addresses must be treated as separate facts rather than as interchangeable labels. This matters because a fuzzy ticker match can make a good memo wrong at the first line.

The second reconciliation job is market data. Market cap is $342.05M, FDV is $399.33M, 24h volume is $12.59M, FDV / market cap is 1.17x, 7d price change is 0.37%, and 30d price change is 4.39%. These numbers need a vendor-drift check. If CMC reports a different circulating supply from CoinGecko or Surf, the memo should prefer the official unlock and circulating-supply definition, then keep the aggregator spread as a risk note. If volume is dominated by one venue, the liquidity score should be lower than the headline volume implies. If FDV is not disclosed or total supply is missing, the base case should assume worse dilution until proven otherwise.
...
For Terra, the current liquidity read is watchlist first. The market cap is $342.05M, FDV is $399.33M, reported 24h volume is $12.59M, and FDV / market cap is 1.17x. These values can support a research card, but they do not automatically support an investment. A cleaner setup would show stable volume across multiple venues, narrow spreads, less reliance on a single pair, and a supply schedule that does not create a near-term wall of unlock pressure.
...
| Peer comparison | Monthly | Terra gains share with better economics | Peers grow faster with cleaner capture |

## Evidence Ledger

| # | Source | Link | Why it matters |
|---:|---|---|---|
| 1 | Official website | [link](https://www.terra-classic.money/) | Identity, market, social, contract, or discovery cross-check |
| 2 | CoinGecko search | [link](https://www.coingecko.com/en/search?query=Terra) | Identity, market, social, contract, or discovery cross-check |
| 3 | CoinMarketCap discovery | [link](https://coinmarketcap.com/search/?q=Terra) | Identity, market, social, contract, or discovery cross-check |
| 4 | DefiLlama protocol discovery | [link](https://defillama.com/search?query=Terra) | Identity, market, social, contract, or discovery cross-check |
| 5 | Token Terminal discovery | [link](https://tokenterminal.com/explorer?search=Terra) | Identity, market, social, contract, or discovery cross-check |
| 6 | Messari discovery | [link](https://messari.io/search?q=Terra) | Identity, market, social, contract, or discovery cross-check |
| 7 | X profile | [link](https://x.com/terra_money) | Identity, market, social, contract, or discovery cross-check |
| 8 | GitHub | [link](https://github.com/classic-terra) | Identity, market, social, contract, or discovery cross-check |
| 9 | Telegram | [link](https://t.me/TerraLunaChat) | Identity, market, social, contract, or discovery cross-check |
| 10 | Discord | [link](https://discord.com/invite/5NnXWgK6WD) | Identity, market, social, contract, or discovery cross-check |
| 11 | Terra Luna Classic Price Chart (LUNC) | [link](https://www.coingecko.com/en/coins/terra-luna-classic) | Identity, market, social, contract, or discovery cross-check |
| 12 | Terra Price: LUNA/USD Live Price Chart, Market Cap ... | [link](https://www.coingecko.com/en/coins/terra) | Identity, market, social, contract, or discovery cross-check |
| 13 | What Is Terra (LUNA)? Features, Tokenomics and Price ... | [link](https://coinmarketcap.com/academy/article/what-is-luna-features-tokenomics-and-price-prediction) | Identity, market, social, contract, or discovery cross-check |
| 14 | Top Terra Ecosystem Coins by Market Cap | [link](https://www.coingecko.com/en/categories/terra-ecosystem) | Identity, market, social, contract, or discovery cross-check |
| 15 | Terra Luna Classic (LUNC) Tokenomics: Supply, Burns, Utility | [link](https://www.findas.org/tokenomics-review/coins/the-tokenomics-of-terra-luna-classic-lunc/r/YR2RxNd6ExKBBYkza6LnQ2) | Identity, market, social, contract, or discovery cross-check |
| 16 | ethereum LUNC | [link](https://etherscan.io/token/0xd2877702675e6ceb975b4a1dff9fb7baf4c91ea9) | Identity, market, social, contract, or discovery cross-check |
| 17 | polygon LUNC | [link](https://polygonscan.com/token/0x24834bbec7e39ef42f4a75eaf8e5b6486d3f0e57) | Identity, market, social, contract, or discovery cross-check |
| 18 | solana USTC | [link](https://solscan.io/token/CXLBjMMcwkc17GfJtBos6rQCo1ypeH6eDbB82Kby4MRm) | Identity, market, social, contract, or discovery cross-check |
| 19 | ethereum USTC | [link](https://etherscan.io/token/0xa47c8bf37f92abed4a126bda807a7b7498661acd) | Identity, market, social, contract, or discovery cross-check |
| 20 | polygon USTC | [link](https://polygonscan.com/token/0x692597b009d13c4049a947cab2239b7d6517875f) | Identity, market, social, contract, or discovery cross-check |
| 21 | bsc USTC | [link](https://bscscan.com/token/0x23396cf899ca06c4472205fc903bdb4de249d6fc) | Identity, market, social, contract, or discovery cross-check |
| 22 | Google project search | [link](https://www.google.com/search?q=Terra%20LUNA%20crypto) | Identity, market, social, contract, or discovery cross-check |
| 23 | Google tokenomics search | [link](https://www.google.com/search?q=Terra%20LUNA%20tokenomics) | Identity, market, social, contract, or discovery cross-check |
| 24 | Google docs search | [link](https://www.google.com/search?q=Terra%20docs) | Identity, market, social, contract, or discovery cross-check |
| 25 | Google governance search | [link](https://www.google.com/search?q=Terra%20governance%20proposal) | Identity, market, social, contract, or discovery cross-check |
| 26 | Google audit search | [link](https://www.google.com/search?q=Terra%20audit%20report) | Identity, market, social, contract, or discovery cross-check |
| 27 | CoinMarketCap what-is guess | [link](https://coinmarketcap.com/cmc-ai/terra/what-is/) | Identity, market, social, contract, or discovery cross-check |
| 28 | CoinMarketCap price analysis guess | [link](https://coinmarketcap.com/cmc-ai/terra/price-analysis/) | Identity, market, social, contract, or discovery cross-check |
| 29 | CoinMarketCap currency guess | [link](https://coinmarketcap.com/currencies/terra/) | Identity, market, social, contract, or discovery cross-check |
| 30 | Dune discovery | [link](https://dune.com/browse/dashboards?q=Terra) | Identity, market, social, contract, or discovery cross-check |
| 31 | Dune token query | [link](https://dune.com/browse/queries?q=Terra) | Identity, market, social, contract, or discovery cross-check |
| 32 | DeFiLlama fees discovery | [link](https://defillama.com/fees?chain=All&search=Terra) | Identity, market, social, contract, or discovery cross-check |
| 33 | DeFiLlama yield discovery | [link](https://defillama.com/yields?token=LUNA) | Identity, market, social, contract, or discovery cross-check |
| 34 | TokenUnlocks search | [link](https://token.unlocks.app/?search=Terra) | Identity, market, social, contract, or discovery cross-check |

Additional direct source list:

- [Official website](https://www.terra-classic.money/)
- [CoinGecko search](https://www.coingecko.com/en/search?query=Terra)
- [CoinMarketCap discovery](https://coinmarketcap.com/search/?q=Terra)
- [DefiLlama protocol discovery](https://defillama.com/search?query=Terra)
- [Token Terminal discovery](https://tokenterminal.com/explorer?search=Terra)
- [Messari discovery](https://messari.io/search?q=Terra)
- [X profile](https://x.com/terra_money)
- [GitHub](https://github.com/classic-terra)
- [Telegram](https://t.me/TerraLunaChat)
- [Discord](https://discord.com/invite/5NnXWgK6WD)
- [Terra Luna Classic Price Chart (LUNC)](https://www.coingecko.com/en/coins/terra-luna-classic)
- [Terra Price: LUNA/USD Live Price Chart, Market Cap ...](https://www.coingecko.com/en/coins/terra)
- [What Is Terra (LUNA)? Features, Tokenomics and Price ...](https://coinmarketcap.com/academy/article/what-is-luna-features-tokenomics-and-price-prediction)
- [Top Terra Ecosystem Coins by Market Cap](https://www.coingecko.com/en/categories/terra-ecosystem)
- [Terra Luna Classic (LUNC) Tokenomics: Supply, Burns, Utility](https://www.findas.org/tokenomics-review/coins/the-tokenomics-of-terra-luna-classic-lunc/r/YR2RxNd6ExKBBYkza6LnQ2)
- [ethereum LUNC](https://etherscan.io/token/0xd2877702675e6ceb975b4a1dff9fb7baf4c91ea9)
- [polygon LUNC](https://polygonscan.com/token/0x24834bbec7e39ef42f4a75eaf8e5b6486d3f0e57)
- [solana USTC](https://solscan.io/token/CXLBjMMcwkc17GfJtBos6rQCo1ypeH6eDbB82Kby4MRm)
- [ethereum USTC](https://etherscan.io/token/0xa47c8bf37f92abed4a126bda807a7b7498661acd)
- [polygon USTC](https://polygonscan.com/token/0x692597b009d13c4049a947cab2239b7d6517875f)
- [bsc USTC](https://bscscan.com/token/0x23396cf899ca06c4472205fc903bdb4de249d6fc)
- [Google project search](https://www.google.com/search?q=Terra%20LUNA%20crypto)
- [Google tokenomics search](https://www.google.com/search?q=Terra%20LUNA%20tokenomics)
- [Google docs search](https://www.google.com/search?q=Terra%20docs)

## Final Investment View

Terra should be in the Research Map as a **watchlist / selective diligence** asset. The project has enough category relevance and data footprint to merit ongoing coverage, especially because it came from the CG/CMC-oriented candidate workflow and has no high-confidence local duplicate. The current evidence does not yet support a high-conviction allocation thesis. The next level of confidence requires cleaner token economics: fee capture, staking or collateral utility, transparent unlocks, and liquidity that can support realistic position sizing.
