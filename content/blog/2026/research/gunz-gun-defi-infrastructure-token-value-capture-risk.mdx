---
title: 'Gunz / GUN: DeFi infrastructure value capture, liquidity, and token risk'
publishedAt: '2026-07-06'
summary: 'Gunz is treated as a DeFi infrastructure watchlist candidate sourced from CoinGecko/CMC discovery and refreshed with Surf, with emphasis on product durability, token value capture, liquidity, supply, and execution risk.'
slug: 'gunz-gun-defi-infrastructure-token-value-capture-risk'
category: 'research'
---

# Gunz / GUN: DeFi infrastructure value capture, liquidity, and token risk

## Pre-screen Decision

**Decision: add to Research Map as a full-depth watchlist report, not as an automatic accumulation call.** Gunz appears in the local CoinGecko/CMC-oriented candidate pool through market discovery and was refreshed with Surf on 2026-07-06. The project has enough protocol surface for a real memo: chain exposure is Avalanche, Solana; exchange exposure is BINANCE, BITGET; category tags are Gaming Infra, Layer1; current market cap is $11.00M; FDV is $42.55M; and 24h volume is $6.06M. That combination makes it worth researching, but not enough to override the main risks: token value capture may be indirect, liquidity can be fragile, supply methodology may differ across data vendors, and protocol usage can be incentive-sensitive.

The report uses a conservative watchlist standard. A pass means the project deserves monitoring and comparison against peers. It does not mean the token is cheap. A fail would require one of three red flags: no identifiable official/project surface, no meaningful market or DeFi data, or a high-confidence duplicate in the Research Map. Local duplicate checks did not flag Gunz before this file was created, and the existing candidate note says: Seeded 2026-07-06 from Surf market-ranking; rank 1114, market cap $11,106,554, 24h volume $6,125,169. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.

## TL;DR / Executive Summary

Gunz is best understood as a **DeFi infrastructure** asset where the product thesis and the token thesis must be separated. The product thesis asks whether users, validators, LPs, borrowers, or asset issuers have a durable reason to use the protocol. The token thesis asks whether GUN captures that activity through fees, staking, collateral, governance, liquidity routing, protocol-owned assets, or emissions control. The available evidence supports a watchlist entry, especially because it has a visible data footprint across Surf, CoinGecko, CMC discovery, and DeFi-oriented candidate notes. The evidence does not yet support a high-conviction valuation without better fee/revenue, unlock, treasury, and user-retention disclosure.
...
Base case: Gunz remains a selective watchlist asset until token value capture is cleaner. Bull case: protocol usage and token mechanics converge, turning GUN into a security, collateral, or fee-routing asset with real demand. Bear case: the protocol remains useful but token holders absorb dilution, thin liquidity, governance optionality, or regulatory/technical tail risk.

## Project Overview

GUNZ is a Layer‑1 blockchain platform developed by Gunzilla Games to power AAA Web3 gaming economies. Its native token GUN serves as the in‑game currency and marketplace medium, enabling optional NFTization and trading of loot across titles like Off The Grid and Technocore. GUNZ runs as an Avalanche subnet (permissioned L1) with max supply 10 billion GUN.

Surf's project profile maps Gunz to the following high-level surface:

| Area | Evidence |
|---|---|
| Website | [https://gunbygunz.com/](https://gunbygunz.com/) |
| X handle | [@GUNbyGUNZ](https://x.com/GUNbyGUNZ) |
| X followers | 126.23K |
| Tags | Gaming Infra, Layer1 |
| Chains | Avalanche, Solana |
| Exchanges | BINANCE, BITGET |
| TGE status | post |
| CoinGecko ID | not disclosed |

The main product question is whether Gunz is a standalone protocol with defensible demand or a token wrapper riding a larger ecosystem wave. For DeFi infrastructure projects, the strongest evidence is usually not the token chart. It is repeated usage across cycles, measurable TVL or volume, sticky integrations, credible counterparties, and a token design that matters even after incentive budgets normalize.

## Research Question / Investment Relevance

The core research question is: **does Gunz convert protocol relevance into tokenholder relevance?** This is the gap that breaks many DeFi, infrastructure, and RWA tokens. A protocol can have meaningful TVL, a strong founder story, integrations, and real users while the token remains a weak claim on that value. Conversely, a token can appreciate because of listings or narrative momentum while the underlying protocol economics are not yet strong enough to justify the move.
...
| Liquidity | $6.06M 24h volume | Deeper CEX/DEX books and less fragmented contract liquidity |
| Supply quality | 2.59B circulating vs 10.00B total | Official unlock schedule and reconciled circulating methodology |
| Downside containment | Watchlist only | Transparent treasury, audits, risk controls, and stress-test history |

The strongest reason to add the report is not that Gunz is obviously cheap. It is that the project is large or specific enough to track in the Research Map, and the current candidate backlog indicates it had not yet been covered locally.
...
| Settlement layer | Chains and contracts that hold user value | Avalanche, Solana |
...
|---|---|---|---|
| solana | GUN | 3jUf2RTyXp867piSB2dt8uUcNiLDW58asjGtXkRAkBbe | [explorer](https://solscan.io/token/3jUf2RTyXp867piSB2dt8uUcNiLDW58asjGtXkRAkBbe) |
| avalanche | GUN | 0x26debd39d5ed069770406fca10a0e4f8d2c743eb | [explorer](https://snowtrace.io/token/0x26debd39d5ed069770406fca10a0e4f8d2c743eb) |
...
The market intelligence layer has three parts: DeFi usage, market liquidity, and attention. For Gunz, the DeFi-oriented backlog note is the first signal: Seeded 2026-07-06 from Surf market-ranking; rank 1114, market cap $11,106,554, 24h volume $6,125,169. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.. Surf/CG data then adds market cap $11.00M, FDV $42.55M, 24h volume $6.06M, and price $0.0043.
...
| 24h volume | $6.06M | Position sizing and exit liquidity proxy |
| Market cap | $11.00M | Liquid valuation proxy |
| FDV | $42.55M | Dilution-aware valuation proxy |
| FDV / market cap spread | 3.87x | Higher spread means more supply risk |
| X followers | 126.23K | Attention proxy, not adoption proof |
...
| Accrual channel | Strength for Gunz | Evidence needed |
|---|---|---|
...
| Staking / security | Depends on whether GUN is bonded or slashable | Staking contracts, validator docs, reward schedule |
...
The fifth frame is reflexivity. Many DeFi and infrastructure assets reprice in waves: first through TVL and listings, then through fee visibility, then through tokenomics cleanup, and finally through real cash-flow or strategic acquisition narratives. Gunz currently needs to be monitored through that sequence. The available 90-day TVL series has 0 point(s), latest TVL not disclosed, and approximate change not disclosed. Market-price movement shows 7d 0.82% and 30d -31.52% when Surf or CoinGecko exposed the field. If TVL and price move together, the thesis may be simple beta. If TVL rises while price lags, the thesis becomes value-capture skepticism. If price rises while TVL falls, the thesis becomes momentum without fundamental confirmation.

The conservative conclusion is that Gunz's product relevance may be ahead of its token value capture. That is common in this sector. The report should therefore watch for activation events: fee switch, staking redesign, revenue dashboard, cap increases, major integrations, or emissions reductions.
...
|---|---|---|---|
| 2025-04-10 | Strategic | not disclosed | 1kx |
| 2024-11-21 | Undisclosed | not disclosed | Coinbase Ventures |
| 2024-11-01 | Undisclosed | not disclosed | VanEck |
| 2024-09-18 | Undisclosed | $6.00M | Delphi Ventures |
| 2024-03-26 | Undisclosed | $30.00M | Morningstar Ventures, CoinFund, Blizzard Fund, Republic Capital |
| 2022-08-10 | Undisclosed | $46.00M | Morningstar Ventures, HTX Ventures, Animoca Brands, The Spartan Group, Raptor Capital, CoinFund, Shima Capital, Blizzard Fund |

| Team member | Role | Link |
|---|---|---|
| Vlad Korolev | Co-Founder, CEO | not disclosed |
| Alexander Zoll | Co-Founder, CSO | not disclosed |
| Neill Blomkamp | Co-Founder, CCO | [X](https://x.com/NeillBlomkamp) |
| Timur Davidenko | CTO | not disclosed |
...
Gunz competes in the DeFi infrastructure bucket, where category peers vary by exact design. The memo uses functional competitors rather than only ticker competitors:
...
Weighted conclusion: Gunz is important enough to track, but not clean enough to rank as a high-conviction token until economic capture is clearer.

## Bull / Base / Bear

| Scenario | Probability | Thesis | Monitoring signal |
|---|---:|---|---|
| Bull | 25% | Gunz compounds usage, liquidity improves, and GUN gains measurable value capture through staking, fees, collateral, or governance-controlled economics. | TVL up, fees visible, volume deepens, supply overhang falls |
...
**Confidence: 6.2 / 10.** The score is above neutral because Gunz has enough source coverage and category relevance to justify a full report. It is below high conviction because several valuation-critical fields remain unresolved: durable fees, tokenholder capture, precise unlocks, and stress-tested liquidity.
...
| 24h volume | $6.06M | Weekly | Volume below position-size threshold |
| FDV / market cap | 3.87x | Monthly | Rising dilution gap |
...
1. Re-run Surf project-detail and project-defi-metrics if Gunz announces a major integration, listing, tokenomics change, exploit, or governance proposal.
...
For Gunz, the current liquidity read is watchlist first. The market cap is $11.00M, FDV is $42.55M, reported 24h volume is $6.06M, and FDV / market cap is 3.87x. These values can support a research card, but they do not automatically support an investment. A cleaner setup would show stable volume across multiple venues, narrow spreads, less reliance on a single pair, and a supply schedule that does not create a near-term wall of unlock pressure.
...
| Peer comparison | Monthly | Gunz gains share with better economics | Peers grow faster with cleaner capture |

## Evidence Ledger

| # | Source | Link | Why it matters |
|---:|---|---|---|
| 1 | Official website | [link](https://gunbygunz.com/) | Identity, market, social, contract, or discovery cross-check |
| 2 | CoinGecko search | [link](https://www.coingecko.com/en/search?query=Gunz) | Identity, market, social, contract, or discovery cross-check |
| 3 | CoinMarketCap discovery | [link](https://coinmarketcap.com/search/?q=Gunz) | Identity, market, social, contract, or discovery cross-check |
| 4 | DefiLlama protocol discovery | [link](https://defillama.com/search?query=Gunz) | Identity, market, social, contract, or discovery cross-check |
| 5 | Token Terminal discovery | [link](https://tokenterminal.com/explorer?search=Gunz) | Identity, market, social, contract, or discovery cross-check |
| 6 | Messari discovery | [link](https://messari.io/search?q=Gunz) | Identity, market, social, contract, or discovery cross-check |
| 7 | X profile | [link](https://x.com/GUNbyGUNZ) | Identity, market, social, contract, or discovery cross-check |
| 8 | Discord | [link](https://discord.com/invite/gunbygunz) | Identity, market, social, contract, or discovery cross-check |
| 9 | Gunz Price: GUN/USD Live Price Chart, Market Cap ... | [link](https://www.coingecko.com/en/coins/gunz) | Identity, market, social, contract, or discovery cross-check |
| 10 | GUNZ price today, GUN to USD live price, marketcap ... | [link](https://coinmarketcap.com/currencies/gunz/) | Identity, market, social, contract, or discovery cross-check |
| 11 | Top GUNZ Ecosystem Coins by Market Cap | [link](https://www.coingecko.com/en/categories/gunz-ecosystem) | Identity, market, social, contract, or discovery cross-check |
| 12 | Latest GUNZ (GUN) Price Analysis | [link](https://coinmarketcap.com/cmc-ai/gunz/price-analysis/) | Identity, market, social, contract, or discovery cross-check |
| 13 | Gunz (GUN) / Tokenomics & Vesting Schedule | [link](https://tokenomist.ai/gunz) | Identity, market, social, contract, or discovery cross-check |
| 14 | solana GUN | [link](https://solscan.io/token/3jUf2RTyXp867piSB2dt8uUcNiLDW58asjGtXkRAkBbe) | Identity, market, social, contract, or discovery cross-check |
| 15 | avalanche GUN | [link](https://snowtrace.io/token/0x26debd39d5ed069770406fca10a0e4f8d2c743eb) | Identity, market, social, contract, or discovery cross-check |
| 16 | Google project search | [link](https://www.google.com/search?q=Gunz%20GUN%20crypto) | Identity, market, social, contract, or discovery cross-check |
| 17 | Google tokenomics search | [link](https://www.google.com/search?q=Gunz%20GUN%20tokenomics) | Identity, market, social, contract, or discovery cross-check |
| 18 | Google docs search | [link](https://www.google.com/search?q=Gunz%20docs) | Identity, market, social, contract, or discovery cross-check |
| 19 | Google governance search | [link](https://www.google.com/search?q=Gunz%20governance%20proposal) | Identity, market, social, contract, or discovery cross-check |
| 20 | Google audit search | [link](https://www.google.com/search?q=Gunz%20audit%20report) | Identity, market, social, contract, or discovery cross-check |
| 21 | CoinMarketCap what-is guess | [link](https://coinmarketcap.com/cmc-ai/gunz/what-is/) | Identity, market, social, contract, or discovery cross-check |
| 22 | Dune discovery | [link](https://dune.com/browse/dashboards?q=Gunz) | Identity, market, social, contract, or discovery cross-check |
| 23 | Dune token query | [link](https://dune.com/browse/queries?q=Gunz) | Identity, market, social, contract, or discovery cross-check |
| 24 | DeFiLlama fees discovery | [link](https://defillama.com/fees?chain=All&search=Gunz) | Identity, market, social, contract, or discovery cross-check |
| 25 | DeFiLlama yield discovery | [link](https://defillama.com/yields?token=GUN) | Identity, market, social, contract, or discovery cross-check |
| 26 | TokenUnlocks search | [link](https://token.unlocks.app/?search=Gunz) | Identity, market, social, contract, or discovery cross-check |
| 27 | CryptoRank search | [link](https://cryptorank.io/price/gunz) | Identity, market, social, contract, or discovery cross-check |
| 28 | RootData search | [link](https://www.rootdata.com/search?kw=Gunz) | Identity, market, social, contract, or discovery cross-check |
| 29 | CoinDesk search | [link](https://www.coindesk.com/search?s=Gunz) | Identity, market, social, contract, or discovery cross-check |
| 30 | The Block search | [link](https://www.theblock.co/search?query=Gunz) | Identity, market, social, contract, or discovery cross-check |
| 31 | GitHub search | [link](https://github.com/search?q=Gunz&type=repositories) | Identity, market, social, contract, or discovery cross-check |
| 32 | Etherscan token search | [link](https://etherscan.io/search?f=0&q=GUN) | Identity, market, social, contract, or discovery cross-check |
| 33 | BscScan token search | [link](https://bscscan.com/search?f=0&q=GUN) | Identity, market, social, contract, or discovery cross-check |
| 34 | Arbiscan token search | [link](https://arbiscan.io/search?f=0&q=GUN) | Identity, market, social, contract, or discovery cross-check |

Additional direct source list:

- [Official website](https://gunbygunz.com/)
- [CoinGecko search](https://www.coingecko.com/en/search?query=Gunz)
- [CoinMarketCap discovery](https://coinmarketcap.com/search/?q=Gunz)
- [DefiLlama protocol discovery](https://defillama.com/search?query=Gunz)
- [Token Terminal discovery](https://tokenterminal.com/explorer?search=Gunz)
- [Messari discovery](https://messari.io/search?q=Gunz)
- [X profile](https://x.com/GUNbyGUNZ)
- [Discord](https://discord.com/invite/gunbygunz)
- [Gunz Price: GUN/USD Live Price Chart, Market Cap ...](https://www.coingecko.com/en/coins/gunz)
- [GUNZ price today, GUN to USD live price, marketcap ...](https://coinmarketcap.com/currencies/gunz/)
- [Top GUNZ Ecosystem Coins by Market Cap](https://www.coingecko.com/en/categories/gunz-ecosystem)
- [Latest GUNZ (GUN) Price Analysis](https://coinmarketcap.com/cmc-ai/gunz/price-analysis/)
- [Gunz (GUN) | Tokenomics & Vesting Schedule](https://tokenomist.ai/gunz)
- [solana GUN](https://solscan.io/token/3jUf2RTyXp867piSB2dt8uUcNiLDW58asjGtXkRAkBbe)
- [avalanche GUN](https://snowtrace.io/token/0x26debd39d5ed069770406fca10a0e4f8d2c743eb)
- [Google project search](https://www.google.com/search?q=Gunz%20GUN%20crypto)
- [Google tokenomics search](https://www.google.com/search?q=Gunz%20GUN%20tokenomics)
- [Google docs search](https://www.google.com/search?q=Gunz%20docs)
- [Google governance search](https://www.google.com/search?q=Gunz%20governance%20proposal)
- [Google audit search](https://www.google.com/search?q=Gunz%20audit%20report)
- [CoinMarketCap what-is guess](https://coinmarketcap.com/cmc-ai/gunz/what-is/)
- [Dune discovery](https://dune.com/browse/dashboards?q=Gunz)
- [Dune token query](https://dune.com/browse/queries?q=Gunz)
- [DeFiLlama fees discovery](https://defillama.com/fees?chain=All&search=Gunz)

## Final Investment View

Gunz should be in the Research Map as a **watchlist / selective diligence** asset. The project has enough category relevance and data footprint to merit ongoing coverage, especially because it came from the CG/CMC-oriented candidate workflow and has no high-confidence local duplicate. The current evidence does not yet support a high-conviction allocation thesis. The next level of confidence requires cleaner token economics: fee capture, staking or collateral utility, transparent unlocks, and liquidity that can support realistic position sizing.
