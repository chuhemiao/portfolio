---
title: 'Caldera / ERA: bridge / cross-chain infrastructure value capture, liquidity, and token risk'
publishedAt: '2026-07-06'
summary: 'Caldera is treated as a bridge / cross-chain infrastructure watchlist candidate sourced from CoinGecko/CMC discovery and refreshed with Surf, with emphasis on product durability, token value capture, liquidity, supply, and execution risk.'
slug: 'caldera-era-bridge-cross-chain-infrastructure-token-value-capture-risk'
category: 'research'
---

# Caldera / ERA: bridge / cross-chain infrastructure value capture, liquidity, and token risk

## Pre-screen Decision

**Decision: add to Research Map as a full-depth watchlist report, not as an automatic accumulation call.** Caldera appears in the local CoinGecko/CMC-oriented candidate pool through market discovery and was refreshed with Surf on 2026-07-06. The project has enough protocol surface for a real memo: chain exposure is Arbitrum One, Base, Binance Smart Chain, Ethereum; exchange exposure is BINANCE, UPBIT, COINBASE, BITHUMB, BYBIT, BITGET; category tags are Cross-Chain & Bridge, Layer2 & Scaling, Modular & DA; current market cap is $15.02M; FDV is $85.95M; and 24h volume is $3.48M. That combination makes it worth researching, but not enough to override the main risks: token value capture may be indirect, liquidity can be fragile, supply methodology may differ across data vendors, and protocol usage can be incentive-sensitive.

The report uses a conservative watchlist standard. A pass means the project deserves monitoring and comparison against peers. It does not mean the token is cheap. A fail would require one of three red flags: no identifiable official/project surface, no meaningful market or DeFi data, or a high-confidence duplicate in the Research Map. Local duplicate checks did not flag Caldera before this file was created, and the existing candidate note says: Seeded 2026-07-06 from Surf market-ranking; rank 973, market cap $14,943,864, 24h volume $1,679,300. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.

## TL;DR / Executive Summary

Caldera is best understood as a **bridge / cross-chain infrastructure** asset where the product thesis and the token thesis must be separated. The product thesis asks whether users, validators, LPs, borrowers, or asset issuers have a durable reason to use the protocol. The token thesis asks whether ERA captures that activity through fees, staking, collateral, governance, liquidity routing, protocol-owned assets, or emissions control. The available evidence supports a watchlist entry, especially because it has a visible data footprint across Surf, CoinGecko, CMC discovery, and DeFi-oriented candidate notes. The evidence does not yet support a high-conviction valuation without better fee/revenue, unlock, treasury, and user-retention disclosure.
...
| Chains | Arbitrum One, Base, Binance Smart Chain, Ethereum |
| Exchanges | BINANCE, UPBIT, COINBASE, BITHUMB, BYBIT, BITGET |
| Price | $0.0859 |
| Market cap | $15.02M |
| FDV | $85.95M |
| 24h volume | $3.48M |
| Circulating supply | 174.75M |
| Total supply | 1.00B |
...
Base case: Caldera remains a selective watchlist asset until token value capture is cleaner. Bull case: protocol usage and token mechanics converge, turning ERA into a security, collateral, or fee-routing asset with real demand. Bear case: the protocol remains useful but token holders absorb dilution, thin liquidity, governance optionality, or regulatory/technical tail risk.

## Project Overview

Caldera (ERA) builds the Metalayer: a cross-chain interoperability framework and rollup launch platform that enables teams to deploy customizable EVM rollups with unified liquidity and low-latency message passing. ERA is the network’s native token for protocol utility, staking and governance.

Surf's project profile maps Caldera to the following high-level surface:

| Area | Evidence |
|---|---|
| Website | [https://caldera.xyz/](https://caldera.xyz/) |
| X handle | [@Calderaxyz](https://x.com/Calderaxyz) |
| X followers | 353.27K |
...
| Liquidity | $3.48M 24h volume | Deeper CEX/DEX books and less fragmented contract liquidity |
| Supply quality | 174.75M circulating vs 1.00B total | Official unlock schedule and reconciled circulating methodology |
| Downside containment | Watchlist only | Transparent treasury, audits, risk controls, and stress-test history |

The strongest reason to add the report is not that Caldera is obviously cheap. It is that the project is large or specific enough to track in the Research Map, and the current candidate backlog indicates it had not yet been covered locally.
...
| Settlement layer | Chains and contracts that hold user value | Arbitrum One, Base, Binance Smart Chain, Ethereum |
...
|---|---|---|---|
| ethereum | ERA | 0xe2ad0bf751834f2fbdc62a41014f84d67ca1de2a | [explorer](https://etherscan.io/token/0xe2ad0bf751834f2fbdc62a41014f84d67ca1de2a) |
| arbitrum | ERA | 0x00312400303d02c323295f6e8b7309bc30fb6bce | [explorer](https://arbiscan.io/token/0x00312400303d02c323295f6e8b7309bc30fb6bce) |
| base | ERA | 0x00312400303d02c323295f6e8b7309bc30fb6bce | [explorer](https://basescan.org/token/0x00312400303d02c323295f6e8b7309bc30fb6bce) |
| bsc | ERA | 0x00312400303d02c323295f6e8b7309bc30fb6bce | [explorer](https://bscscan.com/token/0x00312400303d02c323295f6e8b7309bc30fb6bce) |
...
The market intelligence layer has three parts: DeFi usage, market liquidity, and attention. For Caldera, the DeFi-oriented backlog note is the first signal: Seeded 2026-07-06 from Surf market-ranking; rank 973, market cap $14,943,864, 24h volume $1,679,300. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.. Surf/CG data then adds market cap $15.02M, FDV $85.95M, 24h volume $3.48M, and price $0.0859.
...
| 24h volume | $3.48M | Position sizing and exit liquidity proxy |
| Market cap | $15.02M | Liquid valuation proxy |
| FDV | $85.95M | Dilution-aware valuation proxy |
| FDV / market cap spread | 5.72x | Higher spread means more supply risk |
| X followers | 353.27K | Attention proxy, not adoption proof |
...
| Accrual channel | Strength for Caldera | Evidence needed |
|---|---|---|
...
| Staking / security | Depends on whether ERA is bonded or slashable | Staking contracts, validator docs, reward schedule |
...
The fifth frame is reflexivity. Many DeFi and infrastructure assets reprice in waves: first through TVL and listings, then through fee visibility, then through tokenomics cleanup, and finally through real cash-flow or strategic acquisition narratives. Caldera currently needs to be monitored through that sequence. The available 90-day TVL series has 0 point(s), latest TVL not disclosed, and approximate change not disclosed. Market-price movement shows 7d 5.36% and 30d -12.03% when Surf or CoinGecko exposed the field. If TVL and price move together, the thesis may be simple beta. If TVL rises while price lags, the thesis becomes value-capture skepticism. If price rises while TVL falls, the thesis becomes momentum without fundamental confirmation.

The conservative conclusion is that Caldera's product relevance may be ahead of its token value capture. That is common in this sector. The report should therefore watch for activation events: fee switch, staking redesign, revenue dashboard, cap increases, major integrations, or emissions reductions.
...
|---|---|---|---|
| 2024-07-24 | Series A | $15.00M | Sequoia Capital, Dragonfly, Lattice, ArkStream Capital, MH Ventures, Founders Fund, TrueBridge Capital |
| 2023-02-13 | Undisclosed | $9.00M | Sequoia Capital, Dragonfly, 1kx, Ethereal Ventures, Neo |

| Team member | Role | Link |
|---|---|---|
| Matthew Katz | Co-Founder, CEO | [X](https://twitter.com/0xkatz) |
| Parker Jou | Co-Founder, CTO | [X](https://twitter.com/theappletucker) |
| Abhi Raheja | Head of Marketing | [X](https://twitter.com/abhihereandnow) |
| Jake Nyquist | Head of Protocol | [X](https://x.com/Jake_Nyquist) |
...
Caldera competes in the bridge / cross-chain infrastructure bucket, where category peers vary by exact design. The memo uses functional competitors rather than only ticker competitors:
...
The key competitive question is whether Caldera has a reason to exist beyond incentives. If switching costs are low and users are primarily chasing emissions, any valuation premium should be temporary. If the protocol controls a scarce integration point, compliance rail, validator layer, or liquidity venue, it can deserve a persistent watchlist premium.
...
Weighted conclusion: Caldera is important enough to track, but not clean enough to rank as a high-conviction token until economic capture is clearer.

## Bull / Base / Bear

| Scenario | Probability | Thesis | Monitoring signal |
|---|---:|---|---|
| Bull | 25% | Caldera compounds usage, liquidity improves, and ERA gains measurable value capture through staking, fees, collateral, or governance-controlled economics. | TVL up, fees visible, volume deepens, supply overhang falls |
...
**Confidence: 6.2 / 10.** The score is above neutral because Caldera has enough source coverage and category relevance to justify a full report. It is below high conviction because several valuation-critical fields remain unresolved: durable fees, tokenholder capture, precise unlocks, and stress-tested liquidity.
...
The strongest bearish critique is simple: this could be a useful protocol with an average token. If ERA does not capture fees or security demand, the market will eventually value it as governance optionality plus liquidity beta. The second critique is data inconsistency. CG, CMC, Surf, and official docs can disagree on circulating supply, FDV, and market cap. The third critique is reflexive TVL: deposits can leave quickly when incentives, yields, or narratives change.
...
| 24h volume | $3.48M | Weekly | Volume below position-size threshold |
| FDV / market cap | 5.72x | Monthly | Rising dilution gap |
...
1. Re-run Surf project-detail and project-defi-metrics if Caldera announces a major integration, listing, tokenomics change, exploit, or governance proposal.
...
This report intentionally separates source availability from source quality. Caldera has a visible market footprint, but a visible footprint is not the same as a reconciled investment record. The Research Map standard treats CoinGecko and CoinMarketCap as discovery and market-data surfaces, Surf as an aggregation and refresh layer, DefiLlama style records as a protocol-usage lens, and official docs as the final arbiter for product mechanics. When these sources disagree, the disagreement itself is part of the thesis. A token with unclear supply methodology, mismatched contract labels, stale app docs, or broken dashboard coverage is usually harder to underwrite even when the narrative looks attractive.

For Caldera, the first reconciliation job is identity. The token symbol is ERA, the category is bridge / cross-chain infrastructure, chains are Arbitrum One, Base, Binance Smart Chain, Ethereum, exchanges are BINANCE, UPBIT, COINBASE, BITHUMB, BYBIT, BITGET, and tags are Cross-Chain & Bridge, Layer2 & Scaling, Modular & DA. These fields should be checked against official docs, token contracts, exchange market tabs, and community channels before the report graduates from watchlist to allocation candidate. If ERA trades on multiple chains, each contract should be mapped to a canonical issuer statement. If the same symbol is reused by another asset, exchange tickers and contract addresses must be treated as separate facts rather than as interchangeable labels. This matters because a fuzzy ticker match can make a good memo wrong at the first line.

The second reconciliation job is market data. Market cap is $15.02M, FDV is $85.95M, 24h volume is $3.48M, FDV / market cap is 5.72x, 7d price change is 5.36%, and 30d price change is -12.03%. These numbers need a vendor-drift check. If CMC reports a different circulating supply from CoinGecko or Surf, the memo should prefer the official unlock and circulating-supply definition, then keep the aggregator spread as a risk note. If volume is dominated by one venue, the liquidity score should be lower than the headline volume implies. If FDV is not disclosed or total supply is missing, the base case should assume worse dilution until proven otherwise.
...
For Caldera, the current liquidity read is watchlist first. The market cap is $15.02M, FDV is $85.95M, reported 24h volume is $3.48M, and FDV / market cap is 5.72x. These values can support a research card, but they do not automatically support an investment. A cleaner setup would show stable volume across multiple venues, narrow spreads, less reliance on a single pair, and a supply schedule that does not create a near-term wall of unlock pressure.
...
| Peer comparison | Monthly | Caldera gains share with better economics | Peers grow faster with cleaner capture |

## Evidence Ledger

| # | Source | Link | Why it matters |
|---:|---|---|---|
| 1 | Official website | [link](https://caldera.xyz/) | Identity, market, social, contract, or discovery cross-check |
| 2 | CoinGecko search | [link](https://www.coingecko.com/en/search?query=Caldera) | Identity, market, social, contract, or discovery cross-check |
| 3 | CoinMarketCap discovery | [link](https://coinmarketcap.com/search/?q=Caldera) | Identity, market, social, contract, or discovery cross-check |
| 4 | DefiLlama protocol discovery | [link](https://defillama.com/search?query=Caldera) | Identity, market, social, contract, or discovery cross-check |
| 5 | Token Terminal discovery | [link](https://tokenterminal.com/explorer?search=Caldera) | Identity, market, social, contract, or discovery cross-check |
| 6 | Messari discovery | [link](https://messari.io/search?q=Caldera) | Identity, market, social, contract, or discovery cross-check |
| 7 | X profile | [link](https://x.com/Calderaxyz) | Identity, market, social, contract, or discovery cross-check |
| 8 | Telegram | [link](https://t.me/s/calderaofficial) | Identity, market, social, contract, or discovery cross-check |
| 9 | Discord | [link](https://discord.gg/caldera) | Identity, market, social, contract, or discovery cross-check |
| 10 | Caldera Price: ERA/USD Live Price Chart, Market Cap & News Today | [link](https://www.coingecko.com/en/coins/caldera) | Identity, market, social, contract, or discovery cross-check |
| 11 | Caldera (ERA) Price Prediction For 2026 & Beyond - CoinMarketCap | [link](https://coinmarketcap.com/cmc-ai/caldera/price-prediction/) | Identity, market, social, contract, or discovery cross-check |
| 12 | ERA to TRY: Caldera Price in Turkish Lira - CoinGecko | [link](https://www.coingecko.com/en/coins/caldera/try) | Identity, market, social, contract, or discovery cross-check |
| 13 | What Is Caldera (ERA) And How Does It Work? - CoinMarketCap | [link](https://coinmarketcap.com/cmc-ai/caldera/what-is/) | Identity, market, social, contract, or discovery cross-check |
| 14 | ERA to INR: Caldera Price in Indian Rupee - CoinGecko | [link](https://www.coingecko.com/en/coins/caldera/inr) | Identity, market, social, contract, or discovery cross-check |
| 15 | ethereum ERA | [link](https://etherscan.io/token/0xe2ad0bf751834f2fbdc62a41014f84d67ca1de2a) | Identity, market, social, contract, or discovery cross-check |
| 16 | arbitrum ERA | [link](https://arbiscan.io/token/0x00312400303d02c323295f6e8b7309bc30fb6bce) | Identity, market, social, contract, or discovery cross-check |
| 17 | base ERA | [link](https://basescan.org/token/0x00312400303d02c323295f6e8b7309bc30fb6bce) | Identity, market, social, contract, or discovery cross-check |
| 18 | bsc ERA | [link](https://bscscan.com/token/0x00312400303d02c323295f6e8b7309bc30fb6bce) | Identity, market, social, contract, or discovery cross-check |
| 19 | Google project search | [link](https://www.google.com/search?q=Caldera%20ERA%20crypto) | Identity, market, social, contract, or discovery cross-check |
| 20 | Google tokenomics search | [link](https://www.google.com/search?q=Caldera%20ERA%20tokenomics) | Identity, market, social, contract, or discovery cross-check |
| 21 | Google docs search | [link](https://www.google.com/search?q=Caldera%20docs) | Identity, market, social, contract, or discovery cross-check |
| 22 | Google governance search | [link](https://www.google.com/search?q=Caldera%20governance%20proposal) | Identity, market, social, contract, or discovery cross-check |
| 23 | Google audit search | [link](https://www.google.com/search?q=Caldera%20audit%20report) | Identity, market, social, contract, or discovery cross-check |
| 24 | CoinMarketCap price analysis guess | [link](https://coinmarketcap.com/cmc-ai/caldera/price-analysis/) | Identity, market, social, contract, or discovery cross-check |
| 25 | CoinMarketCap currency guess | [link](https://coinmarketcap.com/currencies/caldera/) | Identity, market, social, contract, or discovery cross-check |
| 26 | Dune discovery | [link](https://dune.com/browse/dashboards?q=Caldera) | Identity, market, social, contract, or discovery cross-check |
| 27 | Dune token query | [link](https://dune.com/browse/queries?q=Caldera) | Identity, market, social, contract, or discovery cross-check |
| 28 | DeFiLlama fees discovery | [link](https://defillama.com/fees?chain=All&search=Caldera) | Identity, market, social, contract, or discovery cross-check |
| 29 | DeFiLlama yield discovery | [link](https://defillama.com/yields?token=ERA) | Identity, market, social, contract, or discovery cross-check |
| 30 | TokenUnlocks search | [link](https://token.unlocks.app/?search=Caldera) | Identity, market, social, contract, or discovery cross-check |
| 31 | CryptoRank search | [link](https://cryptorank.io/price/caldera) | Identity, market, social, contract, or discovery cross-check |
| 32 | RootData search | [link](https://www.rootdata.com/search?kw=Caldera) | Identity, market, social, contract, or discovery cross-check |
| 33 | CoinDesk search | [link](https://www.coindesk.com/search?s=Caldera) | Identity, market, social, contract, or discovery cross-check |
| 34 | The Block search | [link](https://www.theblock.co/search?query=Caldera) | Identity, market, social, contract, or discovery cross-check |

Additional direct source list:

- [Official website](https://caldera.xyz/)
- [CoinGecko search](https://www.coingecko.com/en/search?query=Caldera)
- [CoinMarketCap discovery](https://coinmarketcap.com/search/?q=Caldera)
- [DefiLlama protocol discovery](https://defillama.com/search?query=Caldera)
- [Token Terminal discovery](https://tokenterminal.com/explorer?search=Caldera)
- [Messari discovery](https://messari.io/search?q=Caldera)
- [X profile](https://x.com/Calderaxyz)
- [Telegram](https://t.me/s/calderaofficial)
- [Discord](https://discord.gg/caldera)
- [Caldera Price: ERA/USD Live Price Chart, Market Cap & News Today](https://www.coingecko.com/en/coins/caldera)
- [Caldera (ERA) Price Prediction For 2026 & Beyond - CoinMarketCap](https://coinmarketcap.com/cmc-ai/caldera/price-prediction/)
- [ERA to TRY: Caldera Price in Turkish Lira - CoinGecko](https://www.coingecko.com/en/coins/caldera/try)
- [What Is Caldera (ERA) And How Does It Work? - CoinMarketCap](https://coinmarketcap.com/cmc-ai/caldera/what-is/)
- [ERA to INR: Caldera Price in Indian Rupee - CoinGecko](https://www.coingecko.com/en/coins/caldera/inr)
- [ethereum ERA](https://etherscan.io/token/0xe2ad0bf751834f2fbdc62a41014f84d67ca1de2a)
- [arbitrum ERA](https://arbiscan.io/token/0x00312400303d02c323295f6e8b7309bc30fb6bce)
- [base ERA](https://basescan.org/token/0x00312400303d02c323295f6e8b7309bc30fb6bce)
- [bsc ERA](https://bscscan.com/token/0x00312400303d02c323295f6e8b7309bc30fb6bce)
- [Google project search](https://www.google.com/search?q=Caldera%20ERA%20crypto)
- [Google tokenomics search](https://www.google.com/search?q=Caldera%20ERA%20tokenomics)
- [Google docs search](https://www.google.com/search?q=Caldera%20docs)
- [Google governance search](https://www.google.com/search?q=Caldera%20governance%20proposal)
- [Google audit search](https://www.google.com/search?q=Caldera%20audit%20report)
- [CoinMarketCap price analysis guess](https://coinmarketcap.com/cmc-ai/caldera/price-analysis/)

## Final Investment View

Caldera should be in the Research Map as a **watchlist / selective diligence** asset. The project has enough category relevance and data footprint to merit ongoing coverage, especially because it came from the CG/CMC-oriented candidate workflow and has no high-confidence local duplicate. The current evidence does not yet support a high-conviction allocation thesis. The next level of confidence requires cleaner token economics: fee capture, staking or collateral utility, transparent unlocks, and liquidity that can support realistic position sizing.
