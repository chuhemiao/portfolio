---
title: 'Everscale / EVER: bridge / cross-chain infrastructure value capture, liquidity, and token risk'
publishedAt: '2026-07-06'
summary: 'Everscale is treated as a bridge / cross-chain infrastructure watchlist candidate sourced from CoinGecko/CMC discovery and refreshed with Surf, with emphasis on product durability, token value capture, liquidity, supply, and execution risk.'
slug: 'everscale-ever-bridge-cross-chain-infrastructure-token-value-capture-risk'
category: 'research'
---

# Everscale / EVER: bridge / cross-chain infrastructure value capture, liquidity, and token risk

## Pre-screen Decision

**Decision: add to Research Map as a full-depth watchlist report, not as an automatic accumulation call.** Everscale appears in the local CoinGecko/CMC-oriented candidate pool through market discovery and was refreshed with Surf on 2026-07-06. The project has enough protocol surface for a real memo: chain exposure is Ethereum, Everscale; exchange exposure is BYBIT; category tags are Cross-Chain & Bridge, Layer1; current market cap is $10.29M; FDV is $10.98M; and 24h volume is $15.91K. That combination makes it worth researching, but not enough to override the main risks: token value capture may be indirect, liquidity can be fragile, supply methodology may differ across data vendors, and protocol usage can be incentive-sensitive.

The report uses a conservative watchlist standard. A pass means the project deserves monitoring and comparison against peers. It does not mean the token is cheap. A fail would require one of three red flags: no identifiable official/project surface, no meaningful market or DeFi data, or a high-confidence duplicate in the Research Map. Local duplicate checks did not flag Everscale before this file was created, and the existing candidate note says: Seeded 2026-07-06 from Surf market-ranking; rank 1150, market cap $10,434,258, 24h volume $16,703. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.

## TL;DR / Executive Summary

Everscale is best understood as a **bridge / cross-chain infrastructure** asset where the product thesis and the token thesis must be separated. The product thesis asks whether users, validators, LPs, borrowers, or asset issuers have a durable reason to use the protocol. The token thesis asks whether EVER captures that activity through fees, staking, collateral, governance, liquidity routing, protocol-owned assets, or emissions control. The available evidence supports a watchlist entry, especially because it has a visible data footprint across Surf, CoinGecko, CMC discovery, and DeFi-oriented candidate notes. The evidence does not yet support a high-conviction valuation without better fee/revenue, unlock, treasury, and user-retention disclosure.
...
Base case: Everscale remains a selective watchlist asset until token value capture is cleaner. Bull case: protocol usage and token mechanics converge, turning EVER into a security, collateral, or fee-routing asset with real demand. Bear case: the protocol remains useful but token holders absorb dilution, thin liquidity, governance optionality, or regulatory/technical tail risk.

## Project Overview

Everscale is a TVM-based, fifth-generation blockchain (TON-derived) engineered for high throughput and near-zero fees using infinite sharding, instant routing, and a TVM-compatible smart-contract stack (T-Sol/TIP-3). Its native token EVER powers payments, staking/validation and on-chain governance, and the project provides developer docs, tools, and an expanding dApp ecosystem.

Surf's project profile maps Everscale to the following high-level surface:

| Area | Evidence |
|---|---|
| Website | [https://everscale.network/](https://everscale.network/) |
| X handle | [@Everscale_net](https://x.com/Everscale_net) |
| X followers | 47.84K |
...
| Liquidity | $15.91K 24h volume | Deeper CEX/DEX books and less fragmented contract liquidity |
| Supply quality | 1.99B circulating vs 2.12B total | Official unlock schedule and reconciled circulating methodology |
| Downside containment | Watchlist only | Transparent treasury, audits, risk controls, and stress-test history |

The strongest reason to add the report is not that Everscale is obviously cheap. It is that the project is large or specific enough to track in the Research Map, and the current candidate backlog indicates it had not yet been covered locally.
...
| Settlement layer | Chains and contracts that hold user value | Ethereum, Everscale |
...
|---|---|---|---|
| ethereum | EVER | 0x1ffefd8036409cb6d652bd610de465933b226917 | [explorer](https://etherscan.io/token/0x1ffefd8036409cb6d652bd610de465933b226917) |
| Everscale | WEVER | 0x29d578cec46b50fa5c88a99c6a4b70184c062953 | not mapped |
...
The market intelligence layer has three parts: DeFi usage, market liquidity, and attention. For Everscale, the DeFi-oriented backlog note is the first signal: Seeded 2026-07-06 from Surf market-ranking; rank 1150, market cap $10,434,258, 24h volume $16,703. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.. Surf/CG data then adds market cap $10.29M, FDV $10.98M, 24h volume $15.91K, and price $0.0052.
...
| 24h volume | $15.91K | Position sizing and exit liquidity proxy |
| Market cap | $10.29M | Liquid valuation proxy |
| FDV | $10.98M | Dilution-aware valuation proxy |
| FDV / market cap spread | 1.07x | Higher spread means more supply risk |
| X followers | 47.84K | Attention proxy, not adoption proof |
...
| Accrual channel | Strength for Everscale | Evidence needed |
|---|---|---|
...
| Staking / security | Depends on whether EVER is bonded or slashable | Staking contracts, validator docs, reward schedule |
...
The fifth frame is reflexivity. Many DeFi and infrastructure assets reprice in waves: first through TVL and listings, then through fee visibility, then through tokenomics cleanup, and finally through real cash-flow or strategic acquisition narratives. Everscale currently needs to be monitored through that sequence. The available 90-day TVL series has 0 point(s), latest TVL not disclosed, and approximate change not disclosed. Market-price movement shows 7d -4.14% and 30d 6.81% when Surf or CoinGecko exposed the field. If TVL and price move together, the thesis may be simple beta. If TVL rises while price lags, the thesis becomes value-capture skepticism. If price rises while TVL falls, the thesis becomes momentum without fundamental confirmation.

The conservative conclusion is that Everscale's product relevance may be ahead of its token value capture. That is common in this sector. The report should therefore watch for activation events: fee switch, staking redesign, revenue dashboard, cap increases, major integrations, or emissions reductions.
...
|---|---|---|---|
| 2025-09-22 | Undisclosed | $1.00M | FD LABS |
| 2023-01-31 | Strategic | $5.00M | Venom Ventures |
...
Everscale competes in the bridge / cross-chain infrastructure bucket, where category peers vary by exact design. The memo uses functional competitors rather than only ticker competitors:
...
The key competitive question is whether Everscale has a reason to exist beyond incentives. If switching costs are low and users are primarily chasing emissions, any valuation premium should be temporary. If the protocol controls a scarce integration point, compliance rail, validator layer, or liquidity venue, it can deserve a persistent watchlist premium.
...
Weighted conclusion: Everscale is important enough to track, but not clean enough to rank as a high-conviction token until economic capture is clearer.

## Bull / Base / Bear

| Scenario | Probability | Thesis | Monitoring signal |
|---|---:|---|---|
| Bull | 25% | Everscale compounds usage, liquidity improves, and EVER gains measurable value capture through staking, fees, collateral, or governance-controlled economics. | TVL up, fees visible, volume deepens, supply overhang falls |
...
| 24h volume | $15.91K | Weekly | Volume below position-size threshold |
...
1. Re-run Surf project-detail and project-defi-metrics if Everscale announces a major integration, listing, tokenomics change, exploit, or governance proposal.
...
For Everscale, the current liquidity read is watchlist first. The market cap is $10.29M, FDV is $10.98M, reported 24h volume is $15.91K, and FDV / market cap is 1.07x. These values can support a research card, but they do not automatically support an investment. A cleaner setup would show stable volume across multiple venues, narrow spreads, less reliance on a single pair, and a supply schedule that does not create a near-term wall of unlock pressure.
...
The failure-mode view is deliberately harsher than the base case. Everscale can fail for reasons that do not show up in a simple market-data table. Smart contracts can be exploited. Oracles can misprice collateral. Bridges can be paused. Staking systems can experience slashing or validator concentration. RWA systems can face issuer, custodian, or redemption risk. Stablecoin systems can lose pegs. Privacy systems can face sanctions, delistings, or legal restrictions. DEXs and yield systems can lose users when incentives rotate. A full-depth memo should make these risks visible before they become headlines.

For Everscale, the live monitoring stack should include contract events, TVL, volume, governance, documentation changes, social announcements, security disclosures, and exchange-market quality. A single metric is not enough. TVL may stay high while liquidity thins. Volume may rise because of volatility rather than adoption. Social attention may rise around controversy rather than progress. Governance may pass proposals that improve short-term price but add long-term risk. The strongest monitoring dashboard combines on-chain state, off-chain disclosure, and market quality.

Incident response matters because crypto risks are discontinuous. A protocol can look normal until a bridge halt, oracle issue, admin pause, market-maker withdrawal, regulatory action, or treasury sale changes the entire thesis. The Research Map should therefore attach explicit downgrade triggers. If Everscale suffers a material exploit, downgrade until a post-mortem, reimbursement plan, and contract patch are published. If supply expands faster than disclosed, downgrade tokenomics confidence. If the main app loses integrations or TVL without explanation, downgrade product durability. If market depth collapses while price holds, downgrade liquidity quality.
...
| Peer comparison | Monthly | Everscale gains share with better economics | Peers grow faster with cleaner capture |

## Evidence Ledger

| # | Source | Link | Why it matters |
|---:|---|---|---|
| 1 | Official website | [link](https://everscale.network/) | Identity, market, social, contract, or discovery cross-check |
| 2 | CoinGecko search | [link](https://www.coingecko.com/en/search?query=Everscale) | Identity, market, social, contract, or discovery cross-check |
| 3 | CoinMarketCap discovery | [link](https://coinmarketcap.com/search/?q=Everscale) | Identity, market, social, contract, or discovery cross-check |
| 4 | DefiLlama protocol discovery | [link](https://defillama.com/search?query=Everscale) | Identity, market, social, contract, or discovery cross-check |
| 5 | Token Terminal discovery | [link](https://tokenterminal.com/explorer?search=Everscale) | Identity, market, social, contract, or discovery cross-check |
| 6 | Messari discovery | [link](https://messari.io/search?q=Everscale) | Identity, market, social, contract, or discovery cross-check |
| 7 | X profile | [link](https://x.com/Everscale_net) | Identity, market, social, contract, or discovery cross-check |
| 8 | GitHub | [link](https://github.com/tonlabs/ton-labs-node) | Identity, market, social, contract, or discovery cross-check |
| 9 | Telegram | [link](https://t.me/everscale) | Identity, market, social, contract, or discovery cross-check |
| 10 | Discord | [link](https://discord.gg/everscale) | Identity, market, social, contract, or discovery cross-check |
| 11 | What Is Everscale? Features and Tokenomics - CoinMarketCap | [link](https://coinmarketcap.com/academy/article/what-is-everscale-features-and-tokenomics) | Identity, market, social, contract, or discovery cross-check |
| 12 | Everscale Price Chart (EVER) - CoinGecko | [link](https://www.coingecko.com/en/coins/everscale) | Identity, market, social, contract, or discovery cross-check |
| 13 | Everscale price today, EVER to USD live price, marketcap and chart | [link](https://coinmarketcap.com/currencies/everscale/) | Identity, market, social, contract, or discovery cross-check |
| 14 | What Is Tokenomics? A Complete Guide to Crypto Token Economics | [link](https://www.coingecko.com/learn/what-is-tokenomics-understanding-crypto-fundamentals) | Identity, market, social, contract, or discovery cross-check |
| 15 | Everscale Price History: Download EVER Historical Data / CoinGecko | [link](https://www.coingecko.com/en/coins/everscale/historical_data) | Identity, market, social, contract, or discovery cross-check |
| 16 | ethereum EVER | [link](https://etherscan.io/token/0x1ffefd8036409cb6d652bd610de465933b226917) | Identity, market, social, contract, or discovery cross-check |
| 17 | Google project search | [link](https://www.google.com/search?q=Everscale%20EVER%20crypto) | Identity, market, social, contract, or discovery cross-check |
| 18 | Google tokenomics search | [link](https://www.google.com/search?q=Everscale%20EVER%20tokenomics) | Identity, market, social, contract, or discovery cross-check |
| 19 | Google docs search | [link](https://www.google.com/search?q=Everscale%20docs) | Identity, market, social, contract, or discovery cross-check |
| 20 | Google governance search | [link](https://www.google.com/search?q=Everscale%20governance%20proposal) | Identity, market, social, contract, or discovery cross-check |
| 21 | Google audit search | [link](https://www.google.com/search?q=Everscale%20audit%20report) | Identity, market, social, contract, or discovery cross-check |
| 22 | CoinMarketCap what-is guess | [link](https://coinmarketcap.com/cmc-ai/everscale/what-is/) | Identity, market, social, contract, or discovery cross-check |
| 23 | CoinMarketCap price analysis guess | [link](https://coinmarketcap.com/cmc-ai/everscale/price-analysis/) | Identity, market, social, contract, or discovery cross-check |
| 24 | Dune discovery | [link](https://dune.com/browse/dashboards?q=Everscale) | Identity, market, social, contract, or discovery cross-check |
| 25 | Dune token query | [link](https://dune.com/browse/queries?q=Everscale) | Identity, market, social, contract, or discovery cross-check |
| 26 | DeFiLlama fees discovery | [link](https://defillama.com/fees?chain=All&search=Everscale) | Identity, market, social, contract, or discovery cross-check |
| 27 | DeFiLlama yield discovery | [link](https://defillama.com/yields?token=EVER) | Identity, market, social, contract, or discovery cross-check |
| 28 | TokenUnlocks search | [link](https://token.unlocks.app/?search=Everscale) | Identity, market, social, contract, or discovery cross-check |
| 29 | CryptoRank search | [link](https://cryptorank.io/price/everscale) | Identity, market, social, contract, or discovery cross-check |
| 30 | RootData search | [link](https://www.rootdata.com/search?kw=Everscale) | Identity, market, social, contract, or discovery cross-check |
| 31 | CoinDesk search | [link](https://www.coindesk.com/search?s=Everscale) | Identity, market, social, contract, or discovery cross-check |
| 32 | The Block search | [link](https://www.theblock.co/search?query=Everscale) | Identity, market, social, contract, or discovery cross-check |
| 33 | GitHub search | [link](https://github.com/search?q=Everscale&type=repositories) | Identity, market, social, contract, or discovery cross-check |
| 34 | Etherscan token search | [link](https://etherscan.io/search?f=0&q=EVER) | Identity, market, social, contract, or discovery cross-check |

Additional direct source list:

- [Official website](https://everscale.network/)
- [CoinGecko search](https://www.coingecko.com/en/search?query=Everscale)
- [CoinMarketCap discovery](https://coinmarketcap.com/search/?q=Everscale)
- [DefiLlama protocol discovery](https://defillama.com/search?query=Everscale)
- [Token Terminal discovery](https://tokenterminal.com/explorer?search=Everscale)
- [Messari discovery](https://messari.io/search?q=Everscale)
- [X profile](https://x.com/Everscale_net)
- [GitHub](https://github.com/tonlabs/ton-labs-node)
- [Telegram](https://t.me/everscale)
- [Discord](https://discord.gg/everscale)
- [What Is Everscale? Features and Tokenomics - CoinMarketCap](https://coinmarketcap.com/academy/article/what-is-everscale-features-and-tokenomics)
- [Everscale Price Chart (EVER) - CoinGecko](https://www.coingecko.com/en/coins/everscale)
- [Everscale price today, EVER to USD live price, marketcap and chart](https://coinmarketcap.com/currencies/everscale/)
- [What Is Tokenomics? A Complete Guide to Crypto Token Economics](https://www.coingecko.com/learn/what-is-tokenomics-understanding-crypto-fundamentals)
- [Everscale Price History: Download EVER Historical Data | CoinGecko](https://www.coingecko.com/en/coins/everscale/historical_data)
- [ethereum EVER](https://etherscan.io/token/0x1ffefd8036409cb6d652bd610de465933b226917)
- [Google project search](https://www.google.com/search?q=Everscale%20EVER%20crypto)
- [Google tokenomics search](https://www.google.com/search?q=Everscale%20EVER%20tokenomics)
- [Google docs search](https://www.google.com/search?q=Everscale%20docs)
- [Google governance search](https://www.google.com/search?q=Everscale%20governance%20proposal)
- [Google audit search](https://www.google.com/search?q=Everscale%20audit%20report)
- [CoinMarketCap what-is guess](https://coinmarketcap.com/cmc-ai/everscale/what-is/)
- [CoinMarketCap price analysis guess](https://coinmarketcap.com/cmc-ai/everscale/price-analysis/)
- [Dune discovery](https://dune.com/browse/dashboards?q=Everscale)
