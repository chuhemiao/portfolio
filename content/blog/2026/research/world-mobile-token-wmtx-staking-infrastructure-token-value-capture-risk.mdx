---
title: 'World Mobile Token / WMTX: staking infrastructure value capture, liquidity, and token risk'
publishedAt: '2026-07-06'
summary: 'World Mobile Token is treated as a staking infrastructure watchlist candidate sourced from CoinGecko/CMC discovery and refreshed with Surf, with emphasis on product durability, token value capture, liquidity, supply, and execution risk.'
slug: 'world-mobile-token-wmtx-staking-infrastructure-token-value-capture-risk'
category: 'research'
---

# World Mobile Token / WMTX: staking infrastructure value capture, liquidity, and token risk

## Pre-screen Decision

**Decision: add to Research Map as a full-depth watchlist report, not as an automatic accumulation call.** World Mobile Token appears in the local CoinGecko/CMC-oriented candidate pool through market discovery and was refreshed with Surf on 2026-07-06. The project has enough protocol surface for a real memo: chain exposure is Arbitrum One, Base, Binance Smart Chain, Cardano, Ethereum, Solana; exchange exposure is COINBASE, BINANCE ALPHA; category tags are DePIN (Physical Infra), DID & Identity, Node & Validator; current market cap is $29.85M; FDV is $70.07M; and 24h volume is $1.76M. That combination makes it worth researching, but not enough to override the main risks: token value capture may be indirect, liquidity can be fragile, supply methodology may differ across data vendors, and protocol usage can be incentive-sensitive.

The report uses a conservative watchlist standard. A pass means the project deserves monitoring and comparison against peers. It does not mean the token is cheap. A fail would require one of three red flags: no identifiable official/project surface, no meaningful market or DeFi data, or a high-confidence duplicate in the Research Map. Local duplicate checks did not flag World Mobile Token before this file was created, and the existing candidate note says: Seeded 2026-07-06 from Surf market-ranking; rank 639, market cap $29,887,994, 24h volume $1,647,816. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.

## TL;DR / Executive Summary

World Mobile Token is best understood as a **staking infrastructure** asset where the product thesis and the token thesis must be separated. The product thesis asks whether users, validators, LPs, borrowers, or asset issuers have a durable reason to use the protocol. The token thesis asks whether WMTX captures that activity through fees, staking, collateral, governance, liquidity routing, protocol-owned assets, or emissions control. The available evidence supports a watchlist entry, especially because it has a visible data footprint across Surf, CoinGecko, CMC discovery, and DeFi-oriented candidate notes. The evidence does not yet support a high-conviction valuation without better fee/revenue, unlock, treasury, and user-retention disclosure.
...
| Chains | Arbitrum One, Base, Binance Smart Chain, Cardano, Ethereum, Solana |
| Exchanges | COINBASE, BINANCE ALPHA |
| Price | $0.0350 |
| Market cap | $29.85M |
| FDV | $70.07M |
| 24h volume | $1.76M |
| Circulating supply | 851.87M |
| Total supply | 2.00B |
| 7d price change | -12.58% |
...
| Liquidity | $1.76M 24h volume | Deeper CEX/DEX books and less fragmented contract liquidity |
| Supply quality | 851.87M circulating vs 2.00B total | Official unlock schedule and reconciled circulating methodology |
| Downside containment | Watchlist only | Transparent treasury, audits, risk controls, and stress-test history |

The strongest reason to add the report is not that World Mobile Token is obviously cheap. It is that the project is large or specific enough to track in the Research Map, and the current candidate backlog indicates it had not yet been covered locally.

## Architecture / Mechanism

World Mobile Token's architecture should be evaluated through the job it performs. For a staking infrastructure project, architecture is not merely code shape. It includes the contracts, governance process, integration path, oracle and risk dependencies, bridge or staking assumptions, collateral policies, and the way users enter and exit positions.
...
| Settlement layer | Chains and contracts that hold user value | Arbitrum One, Base, Binance Smart Chain, Cardano, Ethereum, Solana |
...
|---|---|---|---|
| arbitrum | WMTX | 0xdbb5cf12408a3ac17d668037ce289f9ea75439d7 | [explorer](https://arbiscan.io/token/0xdbb5cf12408a3ac17d668037ce289f9ea75439d7) |
| base | WMTX | 0x3e31966d4f81c72d2a55310a6365a56a4393e98d | [explorer](https://basescan.org/token/0x3e31966d4f81c72d2a55310a6365a56a4393e98d) |
| solana | WMTX | WMTXyYKUMTG3VuZA5beXuHVRLpyTwwaoP7h2i8YpuRH | [explorer](https://solscan.io/token/WMTXyYKUMTG3VuZA5beXuHVRLpyTwwaoP7h2i8YpuRH) |
| Cardano | WMTX | e5a42a1a1d3d1da71b0449663c32798725888d2eb0843c4dabeca05a576f726c644d6f62696c65546f6b656e58 | not mapped |
| ethereum | WMTX | 0xdbb5cf12408a3ac17d668037ce289f9ea75439d7 | [explorer](https://etherscan.io/token/0xdbb5cf12408a3ac17d668037ce289f9ea75439d7) |
| bsc | WMTX | 0xdbb5cf12408a3ac17d668037ce289f9ea75439d7 | [explorer](https://bscscan.com/token/0xdbb5cf12408a3ac17d668037ce289f9ea75439d7) |
...
The market intelligence layer has three parts: DeFi usage, market liquidity, and attention. For World Mobile Token, the DeFi-oriented backlog note is the first signal: Seeded 2026-07-06 from Surf market-ranking; rank 639, market cap $29,887,994, 24h volume $1,647,816. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.. Surf/CG data then adds market cap $29.85M, FDV $70.07M, 24h volume $1.76M, and price $0.0350.
...
| 24h volume | $1.76M | Position sizing and exit liquidity proxy |
| Market cap | $29.85M | Liquid valuation proxy |
| FDV | $70.07M | Dilution-aware valuation proxy |
| FDV / market cap spread | 2.35x | Higher spread means more supply risk |
...
| Accrual channel | Strength for World Mobile Token | Evidence needed |
|---|---|---|
...
| Staking / security | Depends on whether WMTX is bonded or slashable | Staking contracts, validator docs, reward schedule |
...
The first analytical frame is utility durability. World Mobile Token should not be treated as investable only because it appears in CoinGecko or CoinMarketCap discovery. The useful question is whether the protocol controls a repeatable workflow: validators needing distributed operation, lenders needing collateralized liquidity, LPs needing routing, tokenized assets needing compliance rails, or depositors needing yield. In this memo the base assumption is that World Mobile Token belongs to the staking infrastructure bucket. That means the token, if any, has to be judged by how directly it captures fees, security demand, collateral demand, risk-management demand, governance power, or distribution access. A high TVL number without fee conversion is weaker than a modest TVL base with sticky users, clear revenue, and controllable emissions.

The second frame is liquidity quality. Current tracked market data points to market cap $29.85M, FDV $70.07M, 24h volume $1.76M, price $0.0350, circulating supply 851.87M, and total supply 2.00B. These numbers are not a buy signal by themselves. They are a risk surface. When FDV materially exceeds market cap, the memo discounts upside because later unlocks can absorb demand. When volume is low relative to market cap, the memo discounts tradability because position sizing becomes difficult. When price performance is strong but project usage is flat, the memo treats the move as narrative beta rather than fundamental repricing. When usage is durable but price is weak, the memo treats the asset as a watchlist candidate rather than an immediate long.

The third frame is source triangulation. Surf project-detail gives an aggregated project view, CoinGecko provides a market-data and community-data surface, CoinMarketCap discovery is used to cross-check symbol identity, and DefiLlama style TVL notes provide a protocol-usage lens. For World Mobile Token, the candidate backlog records Seeded 2026-07-06 from Surf market-ranking; rank 639, market cap $29,887,994, 24h volume $1,647,816. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.. Surf identifies chains as Arbitrum One, Base, Binance Smart Chain, Cardano, Ethereum, Solana, exchanges as COINBASE, BINANCE ALPHA, and tags as DePIN (Physical Infra), DID & Identity, Node & Validator. If these labels diverge from official documentation, official documentation wins. If CMC, CG, and Surf disagree on supply or market cap, this memo treats the supply field as unresolved until a token contract, official tokenomics page, and exchange-circulating methodology can be reconciled.
...
The fifth frame is reflexivity. Many DeFi and infrastructure assets reprice in waves: first through TVL and listings, then through fee visibility, then through tokenomics cleanup, and finally through real cash-flow or strategic acquisition narratives. World Mobile Token currently needs to be monitored through that sequence. The available 90-day TVL series has 0 point(s), latest TVL not disclosed, and approximate change not disclosed. Market-price movement shows 7d -12.58% and 30d -11.98% when Surf or CoinGecko exposed the field. If TVL and price move together, the thesis may be simple beta. If TVL rises while price lags, the thesis becomes value-capture skepticism. If price rises while TVL falls, the thesis becomes momentum without fundamental confirmation.

The conservative conclusion is that World Mobile Token's product relevance may be ahead of its token value capture. That is common in this sector. The report should therefore watch for activation events: fee switch, staking redesign, revenue dashboard, cap increases, major integrations, or emissions reductions.
...
|---|---|---|
| Micky Watkins | Founder, CEO | not disclosed |
| Charles Barnett | Co-Founder, CBO | not disclosed |
| Emmanuel Gratch | Co-Founder, CIO | not disclosed |
| RJ Katunda | Co-Founder, CXO | not disclosed |
| Nicholas Soper | Co-Founder, VP, Support | [X](https://x.com/nicksoper) |
| Antonio Hernández | Co-Founder | [X](https://x.com/DonAntonioHS) |
| James Bartlett | CTO | not disclosed |
| Alan Omnet | COO | not disclosed |
...
World Mobile Token competes in the staking infrastructure bucket, where category peers vary by exact design. The memo uses functional competitors rather than only ticker competitors:
...
The key competitive question is whether World Mobile Token has a reason to exist beyond incentives. If switching costs are low and users are primarily chasing emissions, any valuation premium should be temporary. If the protocol controls a scarce integration point, compliance rail, validator layer, or liquidity venue, it can deserve a persistent watchlist premium.
...
Weighted conclusion: World Mobile Token is important enough to track, but not clean enough to rank as a high-conviction token until economic capture is clearer.

## Bull / Base / Bear

| Scenario | Probability | Thesis | Monitoring signal |
|---|---:|---|---|
| Bull | 25% | World Mobile Token compounds usage, liquidity improves, and WMTX gains measurable value capture through staking, fees, collateral, or governance-controlled economics. | TVL up, fees visible, volume deepens, supply overhang falls |
...
The strongest bearish critique is simple: this could be a useful protocol with an average token. If WMTX does not capture fees or security demand, the market will eventually value it as governance optionality plus liquidity beta. The second critique is data inconsistency. CG, CMC, Surf, and official docs can disagree on circulating supply, FDV, and market cap. The third critique is reflexive TVL: deposits can leave quickly when incentives, yields, or narratives change.
...
| 24h volume | $1.76M | Weekly | Volume below position-size threshold |
| FDV / market cap | 2.35x | Monthly | Rising dilution gap |
...
1. Re-run Surf project-detail and project-defi-metrics if World Mobile Token announces a major integration, listing, tokenomics change, exploit, or governance proposal.
...
This report intentionally separates source availability from source quality. World Mobile Token has a visible market footprint, but a visible footprint is not the same as a reconciled investment record. The Research Map standard treats CoinGecko and CoinMarketCap as discovery and market-data surfaces, Surf as an aggregation and refresh layer, DefiLlama style records as a protocol-usage lens, and official docs as the final arbiter for product mechanics. When these sources disagree, the disagreement itself is part of the thesis. A token with unclear supply methodology, mismatched contract labels, stale app docs, or broken dashboard coverage is usually harder to underwrite even when the narrative looks attractive.

For World Mobile Token, the first reconciliation job is identity. The token symbol is WMTX, the category is staking infrastructure, chains are Arbitrum One, Base, Binance Smart Chain, Cardano, Ethereum, Solana, exchanges are COINBASE, BINANCE ALPHA, and tags are DePIN (Physical Infra), DID & Identity, Node & Validator. These fields should be checked against official docs, token contracts, exchange market tabs, and community channels before the report graduates from watchlist to allocation candidate. If WMTX trades on multiple chains, each contract should be mapped to a canonical issuer statement. If the same symbol is reused by another asset, exchange tickers and contract addresses must be treated as separate facts rather than as interchangeable labels. This matters because a fuzzy ticker match can make a good memo wrong at the first line.

The second reconciliation job is market data. Market cap is $29.85M, FDV is $70.07M, 24h volume is $1.76M, FDV / market cap is 2.35x, 7d price change is -12.58%, and 30d price change is -11.98%. These numbers need a vendor-drift check. If CMC reports a different circulating supply from CoinGecko or Surf, the memo should prefer the official unlock and circulating-supply definition, then keep the aggregator spread as a risk note. If volume is dominated by one venue, the liquidity score should be lower than the headline volume implies. If FDV is not disclosed or total supply is missing, the base case should assume worse dilution until proven otherwise.
...
|---|---|---|
| Identity | World Mobile Token / WMTX | Match official docs, CG, CMC, Surf, contracts |
| Category | staking infrastructure | Confirm product mechanics and revenue model |
| Chains | Arbitrum One, Base, Binance Smart Chain, Cardano, Ethereum, Solana | Confirm canonical deployments and bridge assumptions |
| Exchanges | COINBASE, BINANCE ALPHA | Check live order books and inactive pairs |
| Market cap | $29.85M | Compare Surf, CG, CMC, exchange pages |
| FDV | $70.07M | Reconcile total supply and unlock schedule |
| Volume | $1.76M | Check exchange concentration and wash-trading risk |
| TVL | not disclosed | Confirm TVL meaning, source, and double-counting risk |

## Primary-source Diligence Work Plan

The next diligence pass should start from primary sources, not from the token chart. The first document to find is an official docs or whitepaper page that explains what World Mobile Token does and where users interact with it. The second is tokenomics: allocation, emissions, unlocks, utility, fee routing, treasury policy, and governance rights. The third is security material: audits, bug bounty scope, incident post-mortems, admin-key disclosures, or upgrade timelocks. The fourth is usage evidence: live app metrics, dashboards, contract balances, fee dashboards, validator counts, loan books, LP depth, or stablecoin collateral reports. Without those four documents, any price target is mostly narrative.

For World Mobile Token, the primary-source pass should answer a narrow sequence of questions. What user action creates protocol value? Who pays? Who receives the fee or spread? Does WMTX sit inside that flow, or does it only vote on parameters? Can users exit without trusting a multisig, bridge, centralized custodian, or opaque off-chain book? What part of the system can be paused or upgraded? Which parameters would cause losses if changed incorrectly? If the project is young, which metrics prove organic adoption rather than incentives? If the project is mature, which metrics prove durability rather than slow decline?
...
For World Mobile Token, the current liquidity read is watchlist first. The market cap is $29.85M, FDV is $70.07M, reported 24h volume is $1.76M, and FDV / market cap is 2.35x. These values can support a research card, but they do not automatically support an investment. A cleaner setup would show stable volume across multiple venues, narrow spreads, less reliance on a single pair, and a supply schedule that does not create a near-term wall of unlock pressure.
...
The failure-mode view is deliberately harsher than the base case. World Mobile Token can fail for reasons that do not show up in a simple market-data table. Smart contracts can be exploited. Oracles can misprice collateral. Bridges can be paused. Staking systems can experience slashing or validator concentration. RWA systems can face issuer, custodian, or redemption risk. Stablecoin systems can lose pegs. Privacy systems can face sanctions, delistings, or legal restrictions. DEXs and yield systems can lose users when incentives rotate. A full-depth memo should make these risks visible before they become headlines.

For World Mobile Token, the live monitoring stack should include contract events, TVL, volume, governance, documentation changes, social announcements, security disclosures, and exchange-market quality. A single metric is not enough. TVL may stay high while liquidity thins. Volume may rise because of volatility rather than adoption. Social attention may rise around controversy rather than progress. Governance may pass proposals that improve short-term price but add long-term risk. The strongest monitoring dashboard combines on-chain state, off-chain disclosure, and market quality.

Incident response matters because crypto risks are discontinuous. A protocol can look normal until a bridge halt, oracle issue, admin pause, market-maker withdrawal, regulatory action, or treasury sale changes the entire thesis. The Research Map should therefore attach explicit downgrade triggers. If World Mobile Token suffers a material exploit, downgrade until a post-mortem, reimbursement plan, and contract patch are published. If supply expands faster than disclosed, downgrade tokenomics confidence. If the main app loses integrations or TVL without explanation, downgrade product durability. If market depth collapses while price holds, downgrade liquidity quality.
...
| Peer comparison | Monthly | World Mobile Token gains share with better economics | Peers grow faster with cleaner capture |

## Evidence Ledger

| # | Source | Link | Why it matters |
|---:|---|---|---|
| 1 | Official website | [link](https://worldmobile.io/) | Identity, market, social, contract, or discovery cross-check |
| 2 | CoinGecko search | [link](https://www.coingecko.com/en/search?query=World%20Mobile%20Token) | Identity, market, social, contract, or discovery cross-check |
| 3 | CoinMarketCap discovery | [link](https://coinmarketcap.com/search/?q=World%20Mobile%20Token) | Identity, market, social, contract, or discovery cross-check |
| 4 | DefiLlama protocol discovery | [link](https://defillama.com/search?query=World%20Mobile%20Token) | Identity, market, social, contract, or discovery cross-check |
| 5 | Token Terminal discovery | [link](https://tokenterminal.com/explorer?search=World%20Mobile%20Token) | Identity, market, social, contract, or discovery cross-check |
| 6 | Messari discovery | [link](https://messari.io/search?q=World%20Mobile%20Token) | Identity, market, social, contract, or discovery cross-check |
| 7 | Telegram | [link](https://t.me/WorldMobileTeam) | Identity, market, social, contract, or discovery cross-check |
| 8 | Discord | [link](https://discord.com/invite/worldmobile) | Identity, market, social, contract, or discovery cross-check |
| 9 | World Mobile Token Price Chart (WMTX) | [link](https://www.coingecko.com/en/coins/world-mobile-token) | Identity, market, social, contract, or discovery cross-check |
| 10 | What Is World Mobile Token (WMTX) And How Does It Work? | [link](https://coinmarketcap.com/cmc-ai/world-mobile-token/what-is/) | Identity, market, social, contract, or discovery cross-check |
| 11 | WMTX to BTC: World Mobile Token Price in Bitcoin | [link](https://www.coingecko.com/en/coins/world-mobile-token/btc) | Identity, market, social, contract, or discovery cross-check |
| 12 | World Mobile Token (WMTX) Price Prediction | [link](https://coinmarketcap.com/cmc-ai/world-mobile-token/price-prediction/) | Identity, market, social, contract, or discovery cross-check |
| 13 | World Mobile Token WMTX / UAH | [link](https://www.coingecko.com/en/coins/world-mobile-token/uah) | Identity, market, social, contract, or discovery cross-check |
| 14 | arbitrum WMTX | [link](https://arbiscan.io/token/0xdbb5cf12408a3ac17d668037ce289f9ea75439d7) | Identity, market, social, contract, or discovery cross-check |
| 15 | base WMTX | [link](https://basescan.org/token/0x3e31966d4f81c72d2a55310a6365a56a4393e98d) | Identity, market, social, contract, or discovery cross-check |
| 16 | solana WMTX | [link](https://solscan.io/token/WMTXyYKUMTG3VuZA5beXuHVRLpyTwwaoP7h2i8YpuRH) | Identity, market, social, contract, or discovery cross-check |
| 17 | ethereum WMTX | [link](https://etherscan.io/token/0xdbb5cf12408a3ac17d668037ce289f9ea75439d7) | Identity, market, social, contract, or discovery cross-check |
| 18 | bsc WMTX | [link](https://bscscan.com/token/0xdbb5cf12408a3ac17d668037ce289f9ea75439d7) | Identity, market, social, contract, or discovery cross-check |
| 19 | Google project search | [link](https://www.google.com/search?q=World%20Mobile%20Token%20WMTX%20crypto) | Identity, market, social, contract, or discovery cross-check |
| 20 | Google tokenomics search | [link](https://www.google.com/search?q=World%20Mobile%20Token%20WMTX%20tokenomics) | Identity, market, social, contract, or discovery cross-check |
| 21 | Google docs search | [link](https://www.google.com/search?q=World%20Mobile%20Token%20docs) | Identity, market, social, contract, or discovery cross-check |
| 22 | Google governance search | [link](https://www.google.com/search?q=World%20Mobile%20Token%20governance%20proposal) | Identity, market, social, contract, or discovery cross-check |
| 23 | Google audit search | [link](https://www.google.com/search?q=World%20Mobile%20Token%20audit%20report) | Identity, market, social, contract, or discovery cross-check |
| 24 | CoinMarketCap price analysis guess | [link](https://coinmarketcap.com/cmc-ai/world-mobile-token/price-analysis/) | Identity, market, social, contract, or discovery cross-check |
| 25 | CoinMarketCap currency guess | [link](https://coinmarketcap.com/currencies/world-mobile-token/) | Identity, market, social, contract, or discovery cross-check |
| 26 | Dune discovery | [link](https://dune.com/browse/dashboards?q=World%20Mobile%20Token) | Identity, market, social, contract, or discovery cross-check |
| 27 | Dune token query | [link](https://dune.com/browse/queries?q=World%20Mobile%20Token) | Identity, market, social, contract, or discovery cross-check |
| 28 | DeFiLlama fees discovery | [link](https://defillama.com/fees?chain=All&search=World%20Mobile%20Token) | Identity, market, social, contract, or discovery cross-check |
| 29 | DeFiLlama yield discovery | [link](https://defillama.com/yields?token=WMTX) | Identity, market, social, contract, or discovery cross-check |
| 30 | TokenUnlocks search | [link](https://token.unlocks.app/?search=World%20Mobile%20Token) | Identity, market, social, contract, or discovery cross-check |
| 31 | CryptoRank search | [link](https://cryptorank.io/price/world-mobile-token) | Identity, market, social, contract, or discovery cross-check |
| 32 | RootData search | [link](https://www.rootdata.com/search?kw=World%20Mobile%20Token) | Identity, market, social, contract, or discovery cross-check |
| 33 | CoinDesk search | [link](https://www.coindesk.com/search?s=World%20Mobile%20Token) | Identity, market, social, contract, or discovery cross-check |
| 34 | The Block search | [link](https://www.theblock.co/search?query=World%20Mobile%20Token) | Identity, market, social, contract, or discovery cross-check |

Additional direct source list:

- [Official website](https://worldmobile.io/)
- [CoinGecko search](https://www.coingecko.com/en/search?query=World%20Mobile%20Token)
- [CoinMarketCap discovery](https://coinmarketcap.com/search/?q=World%20Mobile%20Token)
- [DefiLlama protocol discovery](https://defillama.com/search?query=World%20Mobile%20Token)
- [Token Terminal discovery](https://tokenterminal.com/explorer?search=World%20Mobile%20Token)
- [Messari discovery](https://messari.io/search?q=World%20Mobile%20Token)
- [Telegram](https://t.me/WorldMobileTeam)
- [Discord](https://discord.com/invite/worldmobile)
- [World Mobile Token Price Chart (WMTX)](https://www.coingecko.com/en/coins/world-mobile-token)
- [What Is World Mobile Token (WMTX) And How Does It Work?](https://coinmarketcap.com/cmc-ai/world-mobile-token/what-is/)
- [WMTX to BTC: World Mobile Token Price in Bitcoin](https://www.coingecko.com/en/coins/world-mobile-token/btc)
- [World Mobile Token (WMTX) Price Prediction](https://coinmarketcap.com/cmc-ai/world-mobile-token/price-prediction/)
- [World Mobile Token WMTX / UAH](https://www.coingecko.com/en/coins/world-mobile-token/uah)
- [arbitrum WMTX](https://arbiscan.io/token/0xdbb5cf12408a3ac17d668037ce289f9ea75439d7)
- [base WMTX](https://basescan.org/token/0x3e31966d4f81c72d2a55310a6365a56a4393e98d)
- [solana WMTX](https://solscan.io/token/WMTXyYKUMTG3VuZA5beXuHVRLpyTwwaoP7h2i8YpuRH)
- [ethereum WMTX](https://etherscan.io/token/0xdbb5cf12408a3ac17d668037ce289f9ea75439d7)
- [bsc WMTX](https://bscscan.com/token/0xdbb5cf12408a3ac17d668037ce289f9ea75439d7)
- [Google project search](https://www.google.com/search?q=World%20Mobile%20Token%20WMTX%20crypto)
- [Google tokenomics search](https://www.google.com/search?q=World%20Mobile%20Token%20WMTX%20tokenomics)
- [Google docs search](https://www.google.com/search?q=World%20Mobile%20Token%20docs)
- [Google governance search](https://www.google.com/search?q=World%20Mobile%20Token%20governance%20proposal)
- [Google audit search](https://www.google.com/search?q=World%20Mobile%20Token%20audit%20report)
- [CoinMarketCap price analysis guess](https://coinmarketcap.com/cmc-ai/world-mobile-token/price-analysis/)

## Final Investment View

World Mobile Token should be in the Research Map as a **watchlist / selective diligence** asset. The project has enough category relevance and data footprint to merit ongoing coverage, especially because it came from the CG/CMC-oriented candidate workflow and has no high-confidence local duplicate. The current evidence does not yet support a high-conviction allocation thesis. The next level of confidence requires cleaner token economics: fee capture, staking or collateral utility, transparent unlocks, and liquidity that can support realistic position sizing.
