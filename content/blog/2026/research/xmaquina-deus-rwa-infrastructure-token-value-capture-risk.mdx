---
title: 'XMAQUINA / DEUS: RWA infrastructure value capture, liquidity, and token risk'
publishedAt: '2026-07-06'
summary: 'XMAQUINA is treated as a RWA infrastructure watchlist candidate sourced from CoinGecko/CMC discovery and refreshed with Surf, with emphasis on product durability, token value capture, liquidity, supply, and execution risk.'
slug: 'xmaquina-deus-rwa-infrastructure-token-value-capture-risk'
category: 'research'
---

# XMAQUINA / DEUS: RWA infrastructure value capture, liquidity, and token risk

## Pre-screen Decision

**Decision: add to Research Map as a full-depth watchlist report, not as an automatic accumulation call.** XMAQUINA appears in the local CoinGecko/CMC-oriented candidate pool through market discovery and was refreshed with Surf on 2026-07-06. The project has enough protocol surface for a real memo: chain exposure is Base, peaq; exchange exposure is AERODROME; category tags are DAO, DePIN (Physical Infra), RWA (Real World Assets); current market cap is $14.36M; FDV is $27.82M; and 24h volume is $167.75K. That combination makes it worth researching, but not enough to override the main risks: token value capture may be indirect, liquidity can be fragile, supply methodology may differ across data vendors, and protocol usage can be incentive-sensitive.

The report uses a conservative watchlist standard. A pass means the project deserves monitoring and comparison against peers. It does not mean the token is cheap. A fail would require one of three red flags: no identifiable official/project surface, no meaningful market or DeFi data, or a high-confidence duplicate in the Research Map. Local duplicate checks did not flag XMAQUINA before this file was created, and the existing candidate note says: Seeded 2026-07-06 from Surf market-ranking; rank 999, market cap $14,099,041, 24h volume $160,094. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.

## TL;DR / Executive Summary

XMAQUINA is best understood as a **RWA infrastructure** asset where the product thesis and the token thesis must be separated. The product thesis asks whether users, validators, LPs, borrowers, or asset issuers have a durable reason to use the protocol. The token thesis asks whether DEUS captures that activity through fees, staking, collateral, governance, liquidity routing, protocol-owned assets, or emissions control. The available evidence supports a watchlist entry, especially because it has a visible data footprint across Surf, CoinGecko, CMC discovery, and DeFi-oriented candidate notes. The evidence does not yet support a high-conviction valuation without better fee/revenue, unlock, treasury, and user-retention disclosure.
...
| FDV | $27.82M |
| 24h volume | $167.75K |
| Circulating supply | 516.07M |
| Total supply | 1.00B |
| 7d price change | -9.11% |
| 30d price change | -0.86% |
...
| Liquidity | $167.75K 24h volume | Deeper CEX/DEX books and less fragmented contract liquidity |
| Supply quality | 516.07M circulating vs 1.00B total | Official unlock schedule and reconciled circulating methodology |
| Downside containment | Watchlist only | Transparent treasury, audits, risk controls, and stress-test history |

The strongest reason to add the report is not that XMAQUINA is obviously cheap. It is that the project is large or specific enough to track in the Research Map, and the current candidate backlog indicates it had not yet been covered locally.
...
| Settlement layer | Chains and contracts that hold user value | Base, peaq |
...
|---|---|---|---|
| base | DEUS | 0x940a319b75861014a220d9c6c144d108552b089b | [explorer](https://basescan.org/token/0x940a319b75861014a220d9c6c144d108552b089b) |
| peaq | DEUS | 0x940a319b75861014a220d9c6c144d108552b089b | not mapped |
...
The market intelligence layer has three parts: DeFi usage, market liquidity, and attention. For XMAQUINA, the DeFi-oriented backlog note is the first signal: Seeded 2026-07-06 from Surf market-ranking; rank 999, market cap $14,099,041, 24h volume $160,094. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.. Surf/CG data then adds market cap $14.36M, FDV $27.82M, 24h volume $167.75K, and price $0.0278.
...
| 24h volume | $167.75K | Position sizing and exit liquidity proxy |
| Market cap | $14.36M | Liquid valuation proxy |
| FDV | $27.82M | Dilution-aware valuation proxy |
| FDV / market cap spread | 1.94x | Higher spread means more supply risk |
| X followers | 95.68K | Attention proxy, not adoption proof |
...
| Accrual channel | Strength for XMAQUINA | Evidence needed |
|---|---|---|
...
| Staking / security | Depends on whether DEUS is bonded or slashable | Staking contracts, validator docs, reward schedule |
...
The fifth frame is reflexivity. Many DeFi and infrastructure assets reprice in waves: first through TVL and listings, then through fee visibility, then through tokenomics cleanup, and finally through real cash-flow or strategic acquisition narratives. XMAQUINA currently needs to be monitored through that sequence. The available 90-day TVL series has 0 point(s), latest TVL not disclosed, and approximate change not disclosed. Market-price movement shows 7d -9.11% and 30d -0.86% when Surf or CoinGecko exposed the field. If TVL and price move together, the thesis may be simple beta. If TVL rises while price lags, the thesis becomes value-capture skepticism. If price rises while TVL falls, the thesis becomes momentum without fundamental confirmation.

The conservative conclusion is that XMAQUINA's product relevance may be ahead of its token value capture. That is common in this sector. The report should therefore watch for activation events: fee switch, staking redesign, revenue dashboard, cap increases, major integrations, or emissions reductions.
...
|---|---|---|---|
| 2026-01-13 | Undisclosed | $10.00M | Fundamental Labs, Waterdrip Capital, Advanced Blockchain, Borderless Capital, Moonrock Capital, MH Ventures, coinIX, Mulana Capital |
| 2026-01-08 | Ido | $2.00M | not disclosed |
| 2025-12-01 | Strategic | not disclosed | Waterdrip Capital, Borderless Capital, vVv, Clairvoyant Labs |
| 2025-10-01 | Ido | $2.00M | not disclosed |
| 2025-08-14 | Ido | $65.46K | not disclosed |
| 2025-06-24 | Ido | $2.00M | not disclosed |

| Team member | Role | Link |
|---|---|---|
| Mauricio Zolliker | Founder, CEO | not disclosed |
| Ruben Portela | Advisor | not disclosed |
| Simon Dedic | Advisor | [X](https://x.com/sjdedic) |
| Martin El-Khouri | Advisor | [X](https://x.com/MartinElKhouri) |
| Michael Ganser | Advisor | [X](https://x.com/MichaelGanser) |
| Lex Sokolin | Advisor | [X](https://x.com/LexSokolin) |
| Max Thake | Advisor | [X](https://x.com/MaxThake) |
| Alvaro Gracia | Advisor | [X](https://x.com/alvarogracia) |
...
XMAQUINA competes in the RWA infrastructure bucket, where category peers vary by exact design. The memo uses functional competitors rather than only ticker competitors:
...
The key competitive question is whether XMAQUINA has a reason to exist beyond incentives. If switching costs are low and users are primarily chasing emissions, any valuation premium should be temporary. If the protocol controls a scarce integration point, compliance rail, validator layer, or liquidity venue, it can deserve a persistent watchlist premium.
...
Weighted conclusion: XMAQUINA is important enough to track, but not clean enough to rank as a high-conviction token until economic capture is clearer.

## Bull / Base / Bear

| Scenario | Probability | Thesis | Monitoring signal |
|---|---:|---|---|
| Bull | 25% | XMAQUINA compounds usage, liquidity improves, and DEUS gains measurable value capture through staking, fees, collateral, or governance-controlled economics. | TVL up, fees visible, volume deepens, supply overhang falls |
...
The strongest bearish critique is simple: this could be a useful protocol with an average token. If DEUS does not capture fees or security demand, the market will eventually value it as governance optionality plus liquidity beta. The second critique is data inconsistency. CG, CMC, Surf, and official docs can disagree on circulating supply, FDV, and market cap. The third critique is reflexive TVL: deposits can leave quickly when incentives, yields, or narratives change.
...
| 24h volume | $167.75K | Weekly | Volume below position-size threshold |
| FDV / market cap | 1.94x | Monthly | Rising dilution gap |
...
1. Re-run Surf project-detail and project-defi-metrics if XMAQUINA announces a major integration, listing, tokenomics change, exploit, or governance proposal.
...
This report intentionally separates source availability from source quality. XMAQUINA has a visible market footprint, but a visible footprint is not the same as a reconciled investment record. The Research Map standard treats CoinGecko and CoinMarketCap as discovery and market-data surfaces, Surf as an aggregation and refresh layer, DefiLlama style records as a protocol-usage lens, and official docs as the final arbiter for product mechanics. When these sources disagree, the disagreement itself is part of the thesis. A token with unclear supply methodology, mismatched contract labels, stale app docs, or broken dashboard coverage is usually harder to underwrite even when the narrative looks attractive.

For XMAQUINA, the first reconciliation job is identity. The token symbol is DEUS, the category is RWA infrastructure, chains are Base, peaq, exchanges are AERODROME, and tags are DAO, DePIN (Physical Infra), RWA (Real World Assets). These fields should be checked against official docs, token contracts, exchange market tabs, and community channels before the report graduates from watchlist to allocation candidate. If DEUS trades on multiple chains, each contract should be mapped to a canonical issuer statement. If the same symbol is reused by another asset, exchange tickers and contract addresses must be treated as separate facts rather than as interchangeable labels. This matters because a fuzzy ticker match can make a good memo wrong at the first line.

The second reconciliation job is market data. Market cap is $14.36M, FDV is $27.82M, 24h volume is $167.75K, FDV / market cap is 1.94x, 7d price change is -9.11%, and 30d price change is -0.86%. These numbers need a vendor-drift check. If CMC reports a different circulating supply from CoinGecko or Surf, the memo should prefer the official unlock and circulating-supply definition, then keep the aggregator spread as a risk note. If volume is dominated by one venue, the liquidity score should be lower than the headline volume implies. If FDV is not disclosed or total supply is missing, the base case should assume worse dilution until proven otherwise.
...
|---|---|---|
| Identity | XMAQUINA / DEUS | Match official docs, CG, CMC, Surf, contracts |
| Category | RWA infrastructure | Confirm product mechanics and revenue model |
| Chains | Base, peaq | Confirm canonical deployments and bridge assumptions |
| Exchanges | AERODROME | Check live order books and inactive pairs |
| Market cap | $14.36M | Compare Surf, CG, CMC, exchange pages |
| FDV | $27.82M | Reconcile total supply and unlock schedule |
| Volume | $167.75K | Check exchange concentration and wash-trading risk |
| TVL | not disclosed | Confirm TVL meaning, source, and double-counting risk |

## Primary-source Diligence Work Plan

The next diligence pass should start from primary sources, not from the token chart. The first document to find is an official docs or whitepaper page that explains what XMAQUINA does and where users interact with it. The second is tokenomics: allocation, emissions, unlocks, utility, fee routing, treasury policy, and governance rights. The third is security material: audits, bug bounty scope, incident post-mortems, admin-key disclosures, or upgrade timelocks. The fourth is usage evidence: live app metrics, dashboards, contract balances, fee dashboards, validator counts, loan books, LP depth, or stablecoin collateral reports. Without those four documents, any price target is mostly narrative.

For XMAQUINA, the primary-source pass should answer a narrow sequence of questions. What user action creates protocol value? Who pays? Who receives the fee or spread? Does DEUS sit inside that flow, or does it only vote on parameters? Can users exit without trusting a multisig, bridge, centralized custodian, or opaque off-chain book? What part of the system can be paused or upgraded? Which parameters would cause losses if changed incorrectly? If the project is young, which metrics prove organic adoption rather than incentives? If the project is mature, which metrics prove durability rather than slow decline?
...
For XMAQUINA, the current liquidity read is watchlist first. The market cap is $14.36M, FDV is $27.82M, reported 24h volume is $167.75K, and FDV / market cap is 1.94x. These values can support a research card, but they do not automatically support an investment. A cleaner setup would show stable volume across multiple venues, narrow spreads, less reliance on a single pair, and a supply schedule that does not create a near-term wall of unlock pressure.
...
| Peer comparison | Monthly | XMAQUINA gains share with better economics | Peers grow faster with cleaner capture |

## Evidence Ledger

| # | Source | Link | Why it matters |
|---:|---|---|---|
| 1 | Official website | [link](https://www.xmaquina.io/) | Identity, market, social, contract, or discovery cross-check |
| 2 | CoinGecko search | [link](https://www.coingecko.com/en/search?query=XMAQUINA) | Identity, market, social, contract, or discovery cross-check |
| 3 | CoinMarketCap discovery | [link](https://coinmarketcap.com/search/?q=XMAQUINA) | Identity, market, social, contract, or discovery cross-check |
| 4 | DefiLlama protocol discovery | [link](https://defillama.com/search?query=XMAQUINA) | Identity, market, social, contract, or discovery cross-check |
| 5 | Token Terminal discovery | [link](https://tokenterminal.com/explorer?search=XMAQUINA) | Identity, market, social, contract, or discovery cross-check |
| 6 | Messari discovery | [link](https://messari.io/search?q=XMAQUINA) | Identity, market, social, contract, or discovery cross-check |
| 7 | X profile | [link](https://x.com/xmaquina) | Identity, market, social, contract, or discovery cross-check |
| 8 | Telegram | [link](https://t.me/xmaquinaofficial) | Identity, market, social, contract, or discovery cross-check |
| 9 | Discord | [link](https://discord.com/invite/xmaquina) | Identity, market, social, contract, or discovery cross-check |
| 10 | XMAQUINA Price Chart (DEUS) | [link](https://www.coingecko.com/en/coins/xmaquina) | Identity, market, social, contract, or discovery cross-check |
| 11 | XMAQUINA price today, DEUS to USD live ... | [link](https://coinmarketcap.com/currencies/deus-token/) | Identity, market, social, contract, or discovery cross-check |
| 12 | XMAQUINA Price, DEUS Price, Live Charts, and Marketcap | [link](https://www.coinbase.com/en-in/price/xmaquina) | Identity, market, social, contract, or discovery cross-check |
| 13 | What Is XMAQUINA (DEUS) And How Does It Work? | [link](https://coinmarketcap.com/cmc-ai/deus-token/what-is/) | Identity, market, social, contract, or discovery cross-check |
| 14 | XMAQUINA Price History: Download DEUS Historical Data | [link](https://www.coingecko.com/en/coins/xmaquina/historical_data) | Identity, market, social, contract, or discovery cross-check |
| 15 | base DEUS | [link](https://basescan.org/token/0x940a319b75861014a220d9c6c144d108552b089b) | Identity, market, social, contract, or discovery cross-check |
| 16 | Google project search | [link](https://www.google.com/search?q=XMAQUINA%20DEUS%20crypto) | Identity, market, social, contract, or discovery cross-check |
| 17 | Google tokenomics search | [link](https://www.google.com/search?q=XMAQUINA%20DEUS%20tokenomics) | Identity, market, social, contract, or discovery cross-check |
| 18 | Google docs search | [link](https://www.google.com/search?q=XMAQUINA%20docs) | Identity, market, social, contract, or discovery cross-check |
| 19 | Google governance search | [link](https://www.google.com/search?q=XMAQUINA%20governance%20proposal) | Identity, market, social, contract, or discovery cross-check |
| 20 | Google audit search | [link](https://www.google.com/search?q=XMAQUINA%20audit%20report) | Identity, market, social, contract, or discovery cross-check |
| 21 | CoinMarketCap what-is guess | [link](https://coinmarketcap.com/cmc-ai/xmaquina/what-is/) | Identity, market, social, contract, or discovery cross-check |
| 22 | CoinMarketCap price analysis guess | [link](https://coinmarketcap.com/cmc-ai/xmaquina/price-analysis/) | Identity, market, social, contract, or discovery cross-check |
| 23 | CoinMarketCap currency guess | [link](https://coinmarketcap.com/currencies/xmaquina/) | Identity, market, social, contract, or discovery cross-check |
| 24 | Dune discovery | [link](https://dune.com/browse/dashboards?q=XMAQUINA) | Identity, market, social, contract, or discovery cross-check |
| 25 | Dune token query | [link](https://dune.com/browse/queries?q=XMAQUINA) | Identity, market, social, contract, or discovery cross-check |
| 26 | DeFiLlama fees discovery | [link](https://defillama.com/fees?chain=All&search=XMAQUINA) | Identity, market, social, contract, or discovery cross-check |
| 27 | DeFiLlama yield discovery | [link](https://defillama.com/yields?token=DEUS) | Identity, market, social, contract, or discovery cross-check |
| 28 | TokenUnlocks search | [link](https://token.unlocks.app/?search=XMAQUINA) | Identity, market, social, contract, or discovery cross-check |
| 29 | CryptoRank search | [link](https://cryptorank.io/price/xmaquina) | Identity, market, social, contract, or discovery cross-check |
| 30 | RootData search | [link](https://www.rootdata.com/search?kw=XMAQUINA) | Identity, market, social, contract, or discovery cross-check |
| 31 | CoinDesk search | [link](https://www.coindesk.com/search?s=XMAQUINA) | Identity, market, social, contract, or discovery cross-check |
| 32 | The Block search | [link](https://www.theblock.co/search?query=XMAQUINA) | Identity, market, social, contract, or discovery cross-check |
| 33 | GitHub search | [link](https://github.com/search?q=XMAQUINA&type=repositories) | Identity, market, social, contract, or discovery cross-check |
| 34 | Etherscan token search | [link](https://etherscan.io/search?f=0&q=DEUS) | Identity, market, social, contract, or discovery cross-check |

Additional direct source list:

- [Official website](https://www.xmaquina.io/)
- [CoinGecko search](https://www.coingecko.com/en/search?query=XMAQUINA)
- [CoinMarketCap discovery](https://coinmarketcap.com/search/?q=XMAQUINA)
- [DefiLlama protocol discovery](https://defillama.com/search?query=XMAQUINA)
- [Token Terminal discovery](https://tokenterminal.com/explorer?search=XMAQUINA)
- [Messari discovery](https://messari.io/search?q=XMAQUINA)
- [X profile](https://x.com/xmaquina)
- [Telegram](https://t.me/xmaquinaofficial)
- [Discord](https://discord.com/invite/xmaquina)
- [XMAQUINA Price Chart (DEUS)](https://www.coingecko.com/en/coins/xmaquina)
- [XMAQUINA price today, DEUS to USD live ...](https://coinmarketcap.com/currencies/deus-token/)
- [XMAQUINA Price, DEUS Price, Live Charts, and Marketcap](https://www.coinbase.com/en-in/price/xmaquina)
- [What Is XMAQUINA (DEUS) And How Does It Work?](https://coinmarketcap.com/cmc-ai/deus-token/what-is/)
- [XMAQUINA Price History: Download DEUS Historical Data](https://www.coingecko.com/en/coins/xmaquina/historical_data)
- [base DEUS](https://basescan.org/token/0x940a319b75861014a220d9c6c144d108552b089b)
- [Google project search](https://www.google.com/search?q=XMAQUINA%20DEUS%20crypto)
- [Google tokenomics search](https://www.google.com/search?q=XMAQUINA%20DEUS%20tokenomics)
- [Google docs search](https://www.google.com/search?q=XMAQUINA%20docs)
- [Google governance search](https://www.google.com/search?q=XMAQUINA%20governance%20proposal)
- [Google audit search](https://www.google.com/search?q=XMAQUINA%20audit%20report)
- [CoinMarketCap what-is guess](https://coinmarketcap.com/cmc-ai/xmaquina/what-is/)
- [CoinMarketCap price analysis guess](https://coinmarketcap.com/cmc-ai/xmaquina/price-analysis/)
- [CoinMarketCap currency guess](https://coinmarketcap.com/currencies/xmaquina/)
- [Dune discovery](https://dune.com/browse/dashboards?q=XMAQUINA)
