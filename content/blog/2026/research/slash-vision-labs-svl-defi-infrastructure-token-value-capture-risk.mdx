...
| FDV | $104.08M |
| 24h volume | $336.26K |
| Circulating supply | 1.65B |
| Total supply | 10.00B |
| 7d price change | 31.40% |
| 30d price change | 39.96% |
...
Base case: Slash Vision Labs remains a selective watchlist asset until token value capture is cleaner. Bull case: protocol usage and token mechanics converge, turning SVL into a security, collateral, or fee-routing asset with real demand. Bear case: the protocol remains useful but token holders absorb dilution, thin liquidity, governance optionality, or regulatory/technical tail risk.

## Project Overview

Slash Vision Labs (SVL) is a payments-focused Web3 ecosystem on the Mantle network offering a non-custodial merchant gateway (Slash Payment) and crypto-backed card products (Slash Card). The SVL token powers protocol fee redistribution to token stakers and supports merchant settlement and product incentives, with technical details and a whitepaper available in the project docs.

Surf's project profile maps Slash Vision Labs to the following high-level surface:

| Area | Evidence |
|---|---|
| Website | [https://slash.vision/](https://slash.vision/) |
| X handle | [@SlashWeb3](https://x.com/SlashWeb3) |
| X followers | 47.47K |
...
| Liquidity | $336.26K 24h volume | Deeper CEX/DEX books and less fragmented contract liquidity |
| Supply quality | 1.65B circulating vs 10.00B total | Official unlock schedule and reconciled circulating methodology |
| Downside containment | Watchlist only | Transparent treasury, audits, risk controls, and stress-test history |

The strongest reason to add the report is not that Slash Vision Labs is obviously cheap. It is that the project is large or specific enough to track in the Research Map, and the current candidate backlog indicates it had not yet been covered locally.
...
| Settlement layer | Chains and contracts that hold user value | Mantle |
...
|---|---|---|---|
| Mantle | SVL | 0xabbeed1d173541e0546b38b1c0394975be200000 | not mapped |
...
The market intelligence layer has three parts: DeFi usage, market liquidity, and attention. For Slash Vision Labs, the DeFi-oriented backlog note is the first signal: Seeded 2026-07-06 from Surf market-ranking; rank 911, market cap $17,044,671, 24h volume $343,853. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.. Surf/CG data then adds market cap $17.17M, FDV $104.08M, 24h volume $336.26K, and price $0.0104.
...
| 24h volume | $336.26K | Position sizing and exit liquidity proxy |
| Market cap | $17.17M | Liquid valuation proxy |
| FDV | $104.08M | Dilution-aware valuation proxy |
| FDV / market cap spread | 6.06x | Higher spread means more supply risk |
| X followers | 47.47K | Attention proxy, not adoption proof |
...
| Accrual channel | Strength for Slash Vision Labs | Evidence needed |
|---|---|---|
...
| Staking / security | Depends on whether SVL is bonded or slashable | Staking contracts, validator docs, reward schedule |
...
The fifth frame is reflexivity. Many DeFi and infrastructure assets reprice in waves: first through TVL and listings, then through fee visibility, then through tokenomics cleanup, and finally through real cash-flow or strategic acquisition narratives. Slash Vision Labs currently needs to be monitored through that sequence. The available 90-day TVL series has 0 point(s), latest TVL not disclosed, and approximate change not disclosed. Market-price movement shows 7d 31.40% and 30d 39.96% when Surf or CoinGecko exposed the field. If TVL and price move together, the thesis may be simple beta. If TVL rises while price lags, the thesis becomes value-capture skepticism. If price rises while TVL falls, the thesis becomes momentum without fundamental confirmation.

The conservative conclusion is that Slash Vision Labs's product relevance may be ahead of its token value capture. That is common in this sector. The report should therefore watch for activation events: fee switch, staking redesign, revenue dashboard, cap increases, major integrations, or emissions reductions.
...
|---|---|---|---|
| 2024-08-23 | Strategic | not disclosed | 071labs |
| 2024-04-22 | Ieo | $50.00K | not disclosed |

| Team member | Role | Link |
|---|---|---|
| SHIN | Founder | [X](https://x.com/0xShin0310) |
| Tokio | COO | [X](https://x.com/tokio_slash) |
...
Slash Vision Labs competes in the DeFi infrastructure bucket, where category peers vary by exact design. The memo uses functional competitors rather than only ticker competitors:
...
Weighted conclusion: Slash Vision Labs is important enough to track, but not clean enough to rank as a high-conviction token until economic capture is clearer.

## Bull / Base / Bear

| Scenario | Probability | Thesis | Monitoring signal |
|---|---:|---|---|
| Bull | 25% | Slash Vision Labs compounds usage, liquidity improves, and SVL gains measurable value capture through staking, fees, collateral, or governance-controlled economics. | TVL up, fees visible, volume deepens, supply overhang falls |
...
The strongest bearish critique is simple: this could be a useful protocol with an average token. If SVL does not capture fees or security demand, the market will eventually value it as governance optionality plus liquidity beta. The second critique is data inconsistency. CG, CMC, Surf, and official docs can disagree on circulating supply, FDV, and market cap. The third critique is reflexive TVL: deposits can leave quickly when incentives, yields, or narratives change.
...
| 24h volume | $336.26K | Weekly | Volume below position-size threshold |
| FDV / market cap | 6.06x | Monthly | Rising dilution gap |
...
1. Re-run Surf project-detail and project-defi-metrics if Slash Vision Labs announces a major integration, listing, tokenomics change, exploit, or governance proposal.
...
For Slash Vision Labs, the current liquidity read is watchlist first. The market cap is $17.17M, FDV is $104.08M, reported 24h volume is $336.26K, and FDV / market cap is 6.06x. These values can support a research card, but they do not automatically support an investment. A cleaner setup would show stable volume across multiple venues, narrow spreads, less reliance on a single pair, and a supply schedule that does not create a near-term wall of unlock pressure.
...
| Peer comparison | Monthly | Slash Vision Labs gains share with better economics | Peers grow faster with cleaner capture |

## Evidence Ledger

| # | Source | Link | Why it matters |
|---:|---|---|---|
| 1 | Official website | [link](https://slash.vision/) | Identity, market, social, contract, or discovery cross-check |
| 2 | CoinGecko search | [link](https://www.coingecko.com/en/search?query=Slash%20Vision%20Labs) | Identity, market, social, contract, or discovery cross-check |
| 3 | CoinMarketCap discovery | [link](https://coinmarketcap.com/search/?q=Slash%20Vision%20Labs) | Identity, market, social, contract, or discovery cross-check |
| 4 | DefiLlama protocol discovery | [link](https://defillama.com/search?query=Slash%20Vision%20Labs) | Identity, market, social, contract, or discovery cross-check |
| 5 | Token Terminal discovery | [link](https://tokenterminal.com/explorer?search=Slash%20Vision%20Labs) | Identity, market, social, contract, or discovery cross-check |
| 6 | Messari discovery | [link](https://messari.io/search?q=Slash%20Vision%20Labs) | Identity, market, social, contract, or discovery cross-check |
| 7 | X profile | [link](https://x.com/SlashWeb3) | Identity, market, social, contract, or discovery cross-check |
| 8 | Slash Vision Labs Price Chart (SVL) - CoinGecko | [link](https://www.coingecko.com/en/coins/slash-vision-labs) | Identity, market, social, contract, or discovery cross-check |
| 9 | Slash Vision Labs (SVL) / Tokenomics & Vesting Schedule | [link](https://tokenomist.ai/slash-vision-labs) | Identity, market, social, contract, or discovery cross-check |
| 10 | SVL to PHP: Slash Vision Labs Price in Philippine Peso - CoinGecko | [link](https://www.coingecko.com/en/coins/slash-vision-labs/php) | Identity, market, social, contract, or discovery cross-check |
| 11 | Slash Vision Labs (SVL) IEO Funding Rounds, Token ... - CryptoRank | [link](https://cryptorank.io/ico/slash-vision-labs) | Identity, market, social, contract, or discovery cross-check |
| 12 | Slash Vision Labs price SVL #3968 - CoinMarketCap | [link](https://coinmarketcap.com/currencies/slash-vision-labs/) | Identity, market, social, contract, or discovery cross-check |
| 13 | Google project search | [link](https://www.google.com/search?q=Slash%20Vision%20Labs%20SVL%20crypto) | Identity, market, social, contract, or discovery cross-check |
| 14 | Google tokenomics search | [link](https://www.google.com/search?q=Slash%20Vision%20Labs%20SVL%20tokenomics) | Identity, market, social, contract, or discovery cross-check |
| 15 | Google docs search | [link](https://www.google.com/search?q=Slash%20Vision%20Labs%20docs) | Identity, market, social, contract, or discovery cross-check |
| 16 | Google governance search | [link](https://www.google.com/search?q=Slash%20Vision%20Labs%20governance%20proposal) | Identity, market, social, contract, or discovery cross-check |
| 17 | Google audit search | [link](https://www.google.com/search?q=Slash%20Vision%20Labs%20audit%20report) | Identity, market, social, contract, or discovery cross-check |
| 18 | CoinMarketCap what-is guess | [link](https://coinmarketcap.com/cmc-ai/slash-vision-labs/what-is/) | Identity, market, social, contract, or discovery cross-check |
| 19 | CoinMarketCap price analysis guess | [link](https://coinmarketcap.com/cmc-ai/slash-vision-labs/price-analysis/) | Identity, market, social, contract, or discovery cross-check |
| 20 | Dune discovery | [link](https://dune.com/browse/dashboards?q=Slash%20Vision%20Labs) | Identity, market, social, contract, or discovery cross-check |
| 21 | Dune token query | [link](https://dune.com/browse/queries?q=Slash%20Vision%20Labs) | Identity, market, social, contract, or discovery cross-check |
| 22 | DeFiLlama fees discovery | [link](https://defillama.com/fees?chain=All&search=Slash%20Vision%20Labs) | Identity, market, social, contract, or discovery cross-check |
| 23 | DeFiLlama yield discovery | [link](https://defillama.com/yields?token=SVL) | Identity, market, social, contract, or discovery cross-check |
| 24 | TokenUnlocks search | [link](https://token.unlocks.app/?search=Slash%20Vision%20Labs) | Identity, market, social, contract, or discovery cross-check |
| 25 | CryptoRank search | [link](https://cryptorank.io/price/slash-vision-labs) | Identity, market, social, contract, or discovery cross-check |
| 26 | RootData search | [link](https://www.rootdata.com/search?kw=Slash%20Vision%20Labs) | Identity, market, social, contract, or discovery cross-check |
| 27 | CoinDesk search | [link](https://www.coindesk.com/search?s=Slash%20Vision%20Labs) | Identity, market, social, contract, or discovery cross-check |
| 28 | The Block search | [link](https://www.theblock.co/search?query=Slash%20Vision%20Labs) | Identity, market, social, contract, or discovery cross-check |
| 29 | GitHub search | [link](https://github.com/search?q=Slash%20Vision%20Labs&type=repositories) | Identity, market, social, contract, or discovery cross-check |
| 30 | Etherscan token search | [link](https://etherscan.io/search?f=0&q=SVL) | Identity, market, social, contract, or discovery cross-check |
| 31 | BscScan token search | [link](https://bscscan.com/search?f=0&q=SVL) | Identity, market, social, contract, or discovery cross-check |
| 32 | Arbiscan token search | [link](https://arbiscan.io/search?f=0&q=SVL) | Identity, market, social, contract, or discovery cross-check |
| 33 | BaseScan token search | [link](https://basescan.org/search?f=0&q=SVL) | Identity, market, social, contract, or discovery cross-check |
| 34 | RWA.xyz search | [link](https://app.rwa.xyz/search?query=Slash%20Vision%20Labs) | Identity, market, social, contract, or discovery cross-check |

Additional direct source list:

- [Official website](https://slash.vision/)
- [CoinGecko search](https://www.coingecko.com/en/search?query=Slash%20Vision%20Labs)
- [CoinMarketCap discovery](https://coinmarketcap.com/search/?q=Slash%20Vision%20Labs)
- [DefiLlama protocol discovery](https://defillama.com/search?query=Slash%20Vision%20Labs)
- [Token Terminal discovery](https://tokenterminal.com/explorer?search=Slash%20Vision%20Labs)
- [Messari discovery](https://messari.io/search?q=Slash%20Vision%20Labs)
- [X profile](https://x.com/SlashWeb3)
- [Slash Vision Labs Price Chart (SVL) - CoinGecko](https://www.coingecko.com/en/coins/slash-vision-labs)
- [Slash Vision Labs (SVL) | Tokenomics & Vesting Schedule](https://tokenomist.ai/slash-vision-labs)
- [SVL to PHP: Slash Vision Labs Price in Philippine Peso - CoinGecko](https://www.coingecko.com/en/coins/slash-vision-labs/php)
- [Slash Vision Labs (SVL) IEO Funding Rounds, Token ... - CryptoRank](https://cryptorank.io/ico/slash-vision-labs)
- [Slash Vision Labs price SVL #3968 - CoinMarketCap](https://coinmarketcap.com/currencies/slash-vision-labs/)
- [Google project search](https://www.google.com/search?q=Slash%20Vision%20Labs%20SVL%20crypto)
- [Google tokenomics search](https://www.google.com/search?q=Slash%20Vision%20Labs%20SVL%20tokenomics)
- [Google docs search](https://www.google.com/search?q=Slash%20Vision%20Labs%20docs)
- [Google governance search](https://www.google.com/search?q=Slash%20Vision%20Labs%20governance%20proposal)
- [Google audit search](https://www.google.com/search?q=Slash%20Vision%20Labs%20audit%20report)
- [CoinMarketCap what-is guess](https://coinmarketcap.com/cmc-ai/slash-vision-labs/what-is/)
- [CoinMarketCap price analysis guess](https://coinmarketcap.com/cmc-ai/slash-vision-labs/price-analysis/)
- [Dune discovery](https://dune.com/browse/dashboards?q=Slash%20Vision%20Labs)
- [Dune token query](https://dune.com/browse/queries?q=Slash%20Vision%20Labs)
- [DeFiLlama fees discovery](https://defillama.com/fees?chain=All&search=Slash%20Vision%20Labs)
- [DeFiLlama yield discovery](https://defillama.com/yields?token=SVL)
- [TokenUnlocks search](https://token.unlocks.app/?search=Slash%20Vision%20Labs)
