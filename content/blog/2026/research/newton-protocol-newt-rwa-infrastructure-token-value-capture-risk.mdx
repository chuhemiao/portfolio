...
Base case: Newton Protocol remains a selective watchlist asset until token value capture is cleaner. Bull case: protocol usage and token mechanics converge, turning NEWT into a security, collateral, or fee-routing asset with real demand. Bear case: the protocol remains useful but token holders absorb dilution, thin liquidity, governance optionality, or regulatory/technical tail risk.

## Project Overview

Newton (Newton Protocol) is a decentralized “Policy Protocol” that provides a verifiable on‑chain automation layer and secure agent authorization for agentic AI, stablecoins, and tokenized real‑world assets. The NEWT ERC‑20 token powers staking, permissions, and incentive mechanisms that secure, govern, and align participants within the protocol.

Surf's project profile maps Newton Protocol to the following high-level surface:

| Area | Evidence |
|---|---|
| Website | [https://newton.xyz/](https://newton.xyz/) |
| X handle | [@newton_xyz](https://x.com/newton_xyz) |
| X followers | 534.27K |
...
| Liquidity | $6.03M 24h volume | Deeper CEX/DEX books and less fragmented contract liquidity |
| Supply quality | 215.00M circulating vs 1.00B total | Official unlock schedule and reconciled circulating methodology |
| Downside containment | Watchlist only | Transparent treasury, audits, risk controls, and stress-test history |

The strongest reason to add the report is not that Newton Protocol is obviously cheap. It is that the project is large or specific enough to track in the Research Map, and the current candidate backlog indicates it had not yet been covered locally.
...
|---|---|---|---|
| ethereum | NEWT | 0xd0ec028a3d21533fdd200838f39c85b03679285d | [explorer](https://etherscan.io/token/0xd0ec028a3d21533fdd200838f39c85b03679285d) |
| bsc | NEWT | 0xb8a677e6d805c8d743e6f14c8bc9c19305b5defc | [explorer](https://bscscan.com/token/0xb8a677e6d805c8d743e6f14c8bc9c19305b5defc) |
...
The market intelligence layer has three parts: DeFi usage, market liquidity, and attention. For Newton Protocol, the DeFi-oriented backlog note is the first signal: Seeded 2026-07-06 from Surf market-ranking; rank 1129, market cap $10,783,557, 24h volume $5,599,897. Local registry duplicate check passed; refresh CG/CMC/Surf and primary sources before writing.. Surf/CG data then adds market cap $10.87M, FDV $50.57M, 24h volume $6.03M, and price $0.0506.
...
| 24h volume | $6.03M | Position sizing and exit liquidity proxy |
| Market cap | $10.87M | Liquid valuation proxy |
| FDV | $50.57M | Dilution-aware valuation proxy |
| FDV / market cap spread | 4.65x | Higher spread means more supply risk |
| X followers | 534.27K | Attention proxy, not adoption proof |
...
| Accrual channel | Strength for Newton Protocol | Evidence needed |
|---|---|---|
...
| Staking / security | Depends on whether NEWT is bonded or slashable | Staking contracts, validator docs, reward schedule |
...
The fifth frame is reflexivity. Many DeFi and infrastructure assets reprice in waves: first through TVL and listings, then through fee visibility, then through tokenomics cleanup, and finally through real cash-flow or strategic acquisition narratives. Newton Protocol currently needs to be monitored through that sequence. The available 90-day TVL series has 0 point(s), latest TVL not disclosed, and approximate change not disclosed. Market-price movement shows 7d 3.17% and 30d -3.82% when Surf or CoinGecko exposed the field. If TVL and price move together, the thesis may be simple beta. If TVL rises while price lags, the thesis becomes value-capture skepticism. If price rises while TVL falls, the thesis becomes momentum without fundamental confirmation.

The conservative conclusion is that Newton Protocol's product relevance may be ahead of its token value capture. That is common in this sector. The report should therefore watch for activation events: fee switch, staking redesign, revenue dashboard, cap increases, major integrations, or emissions reductions.
...
|---|---|---|---|
| 2022-02-10 | Series B | $20.00M | Anthony Pompliano, DV Chain, CI Financial Corp., Singh Capital Partners, Tiny Capital, Snowdevil Capital, Gowri Narayanan |
| 2018-08-30 | Undisclosed | $15.00M | DV Group, Independent Trading Group |

| Team member | Role | Link |
|---|---|---|
| Sean Li | Co-Founder, CEO | [X](https://x.com/_seanli) |
| Jaemin Jin | Co-Founder, CPO | [X](https://x.com/jaemin0x) |
| Arthur Jen | Co-Founder | [X](https://x.com/f_y_jen) |
...
Newton Protocol competes in the RWA infrastructure bucket, where category peers vary by exact design. The memo uses functional competitors rather than only ticker competitors:
...
Weighted conclusion: Newton Protocol is important enough to track, but not clean enough to rank as a high-conviction token until economic capture is clearer.

## Bull / Base / Bear

| Scenario | Probability | Thesis | Monitoring signal |
|---|---:|---|---|
| Bull | 25% | Newton Protocol compounds usage, liquidity improves, and NEWT gains measurable value capture through staking, fees, collateral, or governance-controlled economics. | TVL up, fees visible, volume deepens, supply overhang falls |
...
The strongest bearish critique is simple: this could be a useful protocol with an average token. If NEWT does not capture fees or security demand, the market will eventually value it as governance optionality plus liquidity beta. The second critique is data inconsistency. CG, CMC, Surf, and official docs can disagree on circulating supply, FDV, and market cap. The third critique is reflexive TVL: deposits can leave quickly when incentives, yields, or narratives change.
...
| 24h volume | $6.03M | Weekly | Volume below position-size threshold |
| FDV / market cap | 4.65x | Monthly | Rising dilution gap |
...
1. Re-run Surf project-detail and project-defi-metrics if Newton Protocol announces a major integration, listing, tokenomics change, exploit, or governance proposal.
...
This report intentionally separates source availability from source quality. Newton Protocol has a visible market footprint, but a visible footprint is not the same as a reconciled investment record. The Research Map standard treats CoinGecko and CoinMarketCap as discovery and market-data surfaces, Surf as an aggregation and refresh layer, DefiLlama style records as a protocol-usage lens, and official docs as the final arbiter for product mechanics. When these sources disagree, the disagreement itself is part of the thesis. A token with unclear supply methodology, mismatched contract labels, stale app docs, or broken dashboard coverage is usually harder to underwrite even when the narrative looks attractive.

For Newton Protocol, the first reconciliation job is identity. The token symbol is NEWT, the category is RWA infrastructure, chains are Binance Smart Chain, Ethereum, exchanges are BINANCE, UPBIT, COINBASE, BITHUMB, BYBIT, BITGET, and tags are Compliance & RegTech, RWA (Real World Assets). These fields should be checked against official docs, token contracts, exchange market tabs, and community channels before the report graduates from watchlist to allocation candidate. If NEWT trades on multiple chains, each contract should be mapped to a canonical issuer statement. If the same symbol is reused by another asset, exchange tickers and contract addresses must be treated as separate facts rather than as interchangeable labels. This matters because a fuzzy ticker match can make a good memo wrong at the first line.

The second reconciliation job is market data. Market cap is $10.87M, FDV is $50.57M, 24h volume is $6.03M, FDV / market cap is 4.65x, 7d price change is 3.17%, and 30d price change is -3.82%. These numbers need a vendor-drift check. If CMC reports a different circulating supply from CoinGecko or Surf, the memo should prefer the official unlock and circulating-supply definition, then keep the aggregator spread as a risk note. If volume is dominated by one venue, the liquidity score should be lower than the headline volume implies. If FDV is not disclosed or total supply is missing, the base case should assume worse dilution until proven otherwise.
...
|---|---|---|
| Identity | Newton Protocol / NEWT | Match official docs, CG, CMC, Surf, contracts |
...
For Newton Protocol, the current liquidity read is watchlist first. The market cap is $10.87M, FDV is $50.57M, reported 24h volume is $6.03M, and FDV / market cap is 4.65x. These values can support a research card, but they do not automatically support an investment. A cleaner setup would show stable volume across multiple venues, narrow spreads, less reliance on a single pair, and a supply schedule that does not create a near-term wall of unlock pressure.
...
| Peer comparison | Monthly | Newton Protocol gains share with better economics | Peers grow faster with cleaner capture |

## Evidence Ledger

| # | Source | Link | Why it matters |
|---:|---|---|---|
| 1 | Official website | [link](https://newton.xyz/) | Identity, market, social, contract, or discovery cross-check |
| 2 | CoinGecko search | [link](https://www.coingecko.com/en/search?query=Newton%20Protocol) | Identity, market, social, contract, or discovery cross-check |
| 3 | CoinMarketCap discovery | [link](https://coinmarketcap.com/search/?q=Newton%20Protocol) | Identity, market, social, contract, or discovery cross-check |
| 4 | DefiLlama protocol discovery | [link](https://defillama.com/search?query=Newton%20Protocol) | Identity, market, social, contract, or discovery cross-check |
| 5 | Token Terminal discovery | [link](https://tokenterminal.com/explorer?search=Newton%20Protocol) | Identity, market, social, contract, or discovery cross-check |
| 6 | Messari discovery | [link](https://messari.io/search?q=Newton%20Protocol) | Identity, market, social, contract, or discovery cross-check |
| 7 | X profile | [link](https://x.com/newton_xyz) | Identity, market, social, contract, or discovery cross-check |
| 8 | Discord | [link](https://discord.com/invite/magicnewton) | Identity, market, social, contract, or discovery cross-check |
| 9 | Newton Protocol NEWT Price - CoinGecko | [link](https://www.coingecko.com/en/coins/newton-protocol) | Identity, market, social, contract, or discovery cross-check |
| 10 | NEWT to TRY: Newton Protocol Price in Turkish Lira - CoinGecko | [link](https://www.coingecko.com/en/coins/newton-protocol/try) | Identity, market, social, contract, or discovery cross-check |
| 11 | NEWT to THB: Newton Protocol Price in Thai Baht - CoinGecko | [link](https://www.coingecko.com/en/coins/newton-protocol/thb) | Identity, market, social, contract, or discovery cross-check |
| 12 | Latest Newton Protocol (NEWT) Price Analysis - CoinMarketCap | [link](https://coinmarketcap.com/cmc-ai/newton-protocol/price-analysis/) | Identity, market, social, contract, or discovery cross-check |
| 13 | Newton Protocol (NEWT) / Tokenomics & Vesting Schedule | [link](https://tokenomist.ai/newton-protocol) | Identity, market, social, contract, or discovery cross-check |
| 14 | ethereum NEWT | [link](https://etherscan.io/token/0xd0ec028a3d21533fdd200838f39c85b03679285d) | Identity, market, social, contract, or discovery cross-check |
| 15 | bsc NEWT | [link](https://bscscan.com/token/0xb8a677e6d805c8d743e6f14c8bc9c19305b5defc) | Identity, market, social, contract, or discovery cross-check |
| 16 | Google project search | [link](https://www.google.com/search?q=Newton%20Protocol%20NEWT%20crypto) | Identity, market, social, contract, or discovery cross-check |
| 17 | Google tokenomics search | [link](https://www.google.com/search?q=Newton%20Protocol%20NEWT%20tokenomics) | Identity, market, social, contract, or discovery cross-check |
| 18 | Google docs search | [link](https://www.google.com/search?q=Newton%20Protocol%20docs) | Identity, market, social, contract, or discovery cross-check |
| 19 | Google governance search | [link](https://www.google.com/search?q=Newton%20Protocol%20governance%20proposal) | Identity, market, social, contract, or discovery cross-check |
| 20 | Google audit search | [link](https://www.google.com/search?q=Newton%20Protocol%20audit%20report) | Identity, market, social, contract, or discovery cross-check |
| 21 | CoinMarketCap what-is guess | [link](https://coinmarketcap.com/cmc-ai/newton-protocol/what-is/) | Identity, market, social, contract, or discovery cross-check |
| 22 | CoinMarketCap currency guess | [link](https://coinmarketcap.com/currencies/newton-protocol/) | Identity, market, social, contract, or discovery cross-check |
| 23 | Dune discovery | [link](https://dune.com/browse/dashboards?q=Newton%20Protocol) | Identity, market, social, contract, or discovery cross-check |
| 24 | Dune token query | [link](https://dune.com/browse/queries?q=Newton%20Protocol) | Identity, market, social, contract, or discovery cross-check |
| 25 | DeFiLlama fees discovery | [link](https://defillama.com/fees?chain=All&search=Newton%20Protocol) | Identity, market, social, contract, or discovery cross-check |
| 26 | DeFiLlama yield discovery | [link](https://defillama.com/yields?token=NEWT) | Identity, market, social, contract, or discovery cross-check |
| 27 | TokenUnlocks search | [link](https://token.unlocks.app/?search=Newton%20Protocol) | Identity, market, social, contract, or discovery cross-check |
| 28 | CryptoRank search | [link](https://cryptorank.io/price/newton-protocol) | Identity, market, social, contract, or discovery cross-check |
| 29 | RootData search | [link](https://www.rootdata.com/search?kw=Newton%20Protocol) | Identity, market, social, contract, or discovery cross-check |
| 30 | CoinDesk search | [link](https://www.coindesk.com/search?s=Newton%20Protocol) | Identity, market, social, contract, or discovery cross-check |
| 31 | The Block search | [link](https://www.theblock.co/search?query=Newton%20Protocol) | Identity, market, social, contract, or discovery cross-check |
| 32 | GitHub search | [link](https://github.com/search?q=Newton%20Protocol&type=repositories) | Identity, market, social, contract, or discovery cross-check |
| 33 | Etherscan token search | [link](https://etherscan.io/search?f=0&q=NEWT) | Identity, market, social, contract, or discovery cross-check |
| 34 | BscScan token search | [link](https://bscscan.com/search?f=0&q=NEWT) | Identity, market, social, contract, or discovery cross-check |

Additional direct source list:

- [Official website](https://newton.xyz/)
- [CoinGecko search](https://www.coingecko.com/en/search?query=Newton%20Protocol)
- [CoinMarketCap discovery](https://coinmarketcap.com/search/?q=Newton%20Protocol)
- [DefiLlama protocol discovery](https://defillama.com/search?query=Newton%20Protocol)
- [Token Terminal discovery](https://tokenterminal.com/explorer?search=Newton%20Protocol)
- [Messari discovery](https://messari.io/search?q=Newton%20Protocol)
- [X profile](https://x.com/newton_xyz)
- [Discord](https://discord.com/invite/magicnewton)
- [Newton Protocol NEWT Price - CoinGecko](https://www.coingecko.com/en/coins/newton-protocol)
- [NEWT to TRY: Newton Protocol Price in Turkish Lira - CoinGecko](https://www.coingecko.com/en/coins/newton-protocol/try)
- [NEWT to THB: Newton Protocol Price in Thai Baht - CoinGecko](https://www.coingecko.com/en/coins/newton-protocol/thb)
- [Latest Newton Protocol (NEWT) Price Analysis - CoinMarketCap](https://coinmarketcap.com/cmc-ai/newton-protocol/price-analysis/)
- [Newton Protocol (NEWT) | Tokenomics & Vesting Schedule](https://tokenomist.ai/newton-protocol)
- [ethereum NEWT](https://etherscan.io/token/0xd0ec028a3d21533fdd200838f39c85b03679285d)
- [bsc NEWT](https://bscscan.com/token/0xb8a677e6d805c8d743e6f14c8bc9c19305b5defc)
- [Google project search](https://www.google.com/search?q=Newton%20Protocol%20NEWT%20crypto)
- [Google tokenomics search](https://www.google.com/search?q=Newton%20Protocol%20NEWT%20tokenomics)
- [Google docs search](https://www.google.com/search?q=Newton%20Protocol%20docs)
- [Google governance search](https://www.google.com/search?q=Newton%20Protocol%20governance%20proposal)
- [Google audit search](https://www.google.com/search?q=Newton%20Protocol%20audit%20report)
- [CoinMarketCap what-is guess](https://coinmarketcap.com/cmc-ai/newton-protocol/what-is/)
- [CoinMarketCap currency guess](https://coinmarketcap.com/currencies/newton-protocol/)
- [Dune discovery](https://dune.com/browse/dashboards?q=Newton%20Protocol)
- [Dune token query](https://dune.com/browse/queries?q=Newton%20Protocol)

## Final Investment View

Newton Protocol should be in the Research Map as a **watchlist / selective diligence** asset. The project has enough category relevance and data footprint to merit ongoing coverage, especially because it came from the CG/CMC-oriented candidate workflow and has no high-confidence local duplicate. The current evidence does not yet support a high-conviction allocation thesis. The next level of confidence requires cleaner token economics: fee capture, staking or collateral utility, transparent unlocks, and liquidity that can support realistic position sizing.
