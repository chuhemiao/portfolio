...
export default async function OscillatorPage() {
  const jsonLd = {
    ...
    '@type': 'WebApplication',
    name: 'kkdemian Oscillator — Altcoin Strength Monitor',
    description: 'Altcoin strength monitor using ALT/BTC oscillator thesis. Research watchlist, market breadth table, and BTC market heat index.',
    url: 'https://kkdemian.com/oscillator',
  ...
  return (
    <div className='relative left-1/2 min-h-[100dvh] w-screen -translate-x-1/2 overflow-x-clip'>
      ...
      <div className='relative mx-auto w-full max-w-[1150px] px-4 pb-dock-safe pt-6 sm:px-6 sm:pb-dock-safe-lg sm:pt-10 lg:px-8'>
