...
const PROJECTS: ResearchProject[] = [
  ...
  },
  {
    ...
    color: '#059669',
    initial: 'MM',
    logoUrl: "/research-logos/mantle-mnt-treasury-backed-modular-l2-platform-or-execution-sensitive.svg",
  },
  {
    name: 'MemeCore (M)',
    description:
    ...
    color: '#7C3AED',
    initial: 'MM',
    logoUrl: "/research-logos/memecore-m-meme-2.svg",
  },
  {
    ...
    color: '#0891B2',
    initial: 'NP',
    logoUrl: "/research-logos/naoris-protocol-naoris-post-quantum-sub-zero-layer-security-infrastructure.svg",
  },
  {
    name: 'NEAR Protocol',
    description:
    ...
    color: '#EF4444',
    initial: 'NP',
    logoUrl: "/research-logos/near-protocol-chain-abstraction-leader-in-the-agentic-economy-institutional.svg",
  },
  {
    name: 'OpenGradient',
    description:
    ...
    color: '#059669',
    initial: 'OPEN',
    logoUrl: "/research-logos/opengradient-verifiable-ai-infrastructure-or-decentralized-ai-narrative-proxy.svg",
  },
  {
    name: 'PEPE',
    description:
    ...
    color: '#0284C7',
    initial: 'PEPE',
    logoUrl: "/research-logos/pepe-meme-benchmark-or-cyclical-beta.svg",
  },
  {
    name: 'Polkadot (DOT)',
    description:
    ...
    color: '#F59E0B',
    initial: 'PD',
    logoUrl: "/research-logos/polkadot-dot-shared-security-coordination-layer-in-a-modular-world.svg",
  },
  {
    name: 'Shiba Inu (SHIB)',
    description:
    ...
    color: '#0891B2',
    initial: 'SI',
    logoUrl: "/research-logos/shiba-inu-shib-beyond-meme-cycles-ecosystem-durability-and-institutional.svg",
  },
  {
    ...
    color: '#0284C7',
    initial: 'ZP',
    logoUrl: "/research-logos/zama-privacy-upgrade-will-it-boost-shib-ecosystem-security.svg",
  },
  {
    name: 'Zcash (ZEC)',
    description:
    ...
    color: '#0EA5E9',
    initial: 'ZZ',
    logoUrl: "/research-logos/zcash-zec-selectively-private-money-in-a-surveillance-economy-zk.svg",
  },
  {
    name: 'Cronos',
    description:
    ...
    color: '#F59E0B',
    initial: 'CRON',
    logoUrl: "/research-logos/cronos-crypto-loyalty-cro.svg",
  },
  {
    ...
    color: '#D97706',
    initial: 'IC',
    logoUrl: "/research-logos/internet-computer-icp-institutional-venture-memo-on-full-stack-on.svg",
  },
  {
    name: 'OKB',
    description:
    ...
    color: '#0284C7',
    initial: 'OKB',
    logoUrl: "/research-logos/okb-exchange-utility-token-in-a-post-scarcity-era-capturing.svg",
  },
  {
    name: 'Pharos Network',
    description:
    ...
    color: '#0284C7',
    initial: 'PN',
    logoUrl: "/research-logos/pharos-network-pre-tge-rwa-l1-venture-investment-memo-t.svg",
  },
  {
    name: 'Toncoin (TON)',
    description:
    ...
    color: '#EC4899',
    initial: 'TT',
    logoUrl: "/research-logos/toncoin-ton-telegram-distribution-moat-and-the-quest-for-consumer.svg",
  },
  {
    name: 'Beldex (BDX)',
    description:
    ...
    color: '#D97706',
    initial: 'BB',
    logoUrl: "/research-logos/beldex-bdx-privacy-infrastructure-ecosystem-technical-economic-and-investment-analysis.svg",
  },
  {
    name: 'Dash',
    description:
    ...
    color: '#F59E0B',
    initial: 'DASH',
    logoUrl: "/research-logos/dash-legacy-digital-cash-or-resilient-dao.svg",
  },
  {
    ...
    color: '#4F46E5',
    initial: 'DX',
    logoUrl: "/research-logos/decoding-xdc-network-xdpos-consensus-enterprise-architecture-and-token-value.svg",
  },
  {
    name: 'DeXe Protocol',
    description:
    ...
    color: '#7C3AED',
    initial: 'DP',
    logoUrl: "/research-logos/dexe-protocol-institutional-analysis-of-dao-infrastructure-governance-and-dexe.svg",
  },
  {
    name: 'FILCOIN',
    description:
    ...
    color: '#EC4899',
    initial: 'FILC',
    logoUrl: "/research-logos/filcoin-fil-decentralized-storage-moat-and-token-capture-assessment.svg",
  },
  {
    name: 'Kaspa (KAS)',
    description:
    ...
    color: '#EF4444',
    initial: 'KK',
    logoUrl: "/research-logos/kaspa-kas-institutional-grade-blockdag-pow-analysis-technical-innovation-vs.svg",
  },
  {
    ...
    color: '#4F46E5',
    initial: 'NI',
    logoUrl: "/research-logos/nexo-investment-research-report-in-depth-analysis-of-cefi-wealth.svg",
  },
  {
    name: 'Quant (QNT)',
    description:
    ...
    color: '#0EA5E9',
    initial: 'QQ',
    logoUrl: "/research-logos/quant-qnt-enterprise-interoperability-middleware-architecture-adoption-reality-and-token.svg",
  },
  {
    ...
    color: '#EC4899',
    initial: 'SI',
    logoUrl: "/research-logos/siren-investment-memorandum-bubble-at-b-mc-to-collapse-alert.svg",
  },
  {
    ...
    color: '#0EA5E9',
    initial: 'TP',
    logoUrl: "/research-logos/the-pump.svg",
  },
  {
    name: 'Wingbits',
    description:
  ...
  },
  {
    ...
    color: '#0891B2',
    initial: 'BINA',
    logoUrl: "/research-logos/binance-life-cz-free-money-life.svg",
  },
  {
    ...
    color: '#D97706',
    initial: 'Q',
    logoUrl: "/research-logos/coinbase-q-day-ryan-babbush-bitcoin.svg",
  },
  {
    ...
    color: '#0284C7',
    initial: 'EE',
    logoUrl: "/research-logos/ether-fi-ecosystem-and-ethfi-token-full-spectrum-analysis.svg",
  },
  {
  ...
  },
  {
    ...
    color: '#0891B2',
    initial: 'IP',
    logoUrl: "/research-logos/worldcoin-is-proof-of-humanity-a-bubble-or-the-ai-era.svg",
  },
  {
    name: 'Venice AI',
    ...
    color: '#6366F1',
    initial: 'VA',
    logoUrl: "/research-logos/venice-ai-private-inference-and-vvv-tokenomics-deep-dive.svg",
  },
  {
    ...
    color: '#DC2626',
    initial: 'BU',
    logoUrl: "/research-logos/beldex-unmasked-privacy-empire-or-masternode-mirage.svg",
  },
  {
    name: 'Celestia (TIA)',
    ...
    color: '#F59E0B',
    initial: 'CT',
    logoUrl: "/research-logos/celestia-tia-da-as-the-new-digital-oil-the-hidden.svg",
  },
  {
    ...
    color: '#0284C7',
    initial: 'EI',
    logoUrl: "/research-logos/ethgas-investment-research-memo-realtime-ethereum-open-gas-and-the.svg",
  },
  {
    name: 'Kaia (KAIA)',
    ...
    color: '#D97706',
    initial: 'KK',
    logoUrl: "/research-logos/kaia-kaia-vc-thesis-on-asia-line-powered-l1-for.svg",
  },
  {
    name: 'MegaPot',
    ...
    color: '#0EA5E9',
    initial: 'MEGA',
    logoUrl: "/research-logos/megapot-investment-memo-global-lottery-infrastructure-for-the-internet-era.svg",
  },
  {
    ...
    color: '#059669',
    initial: 'SI',
    logoUrl: "/research-logos/stabledev-investment-thesis-from-single-sky-exposure-to-stablecoin-platform.svg",
  },
  {
    name: 'xMoney / XMN',
  ...
  },
  {
    ...
    color: '#EF4444',
    initial: 'ONYX',
    logoUrl: "/research-logos/onyx-modular-financial-l3-architecture-promise-vs.svg",
  },
  {
    ...
    color: '#EF4444',
    initial: 'SR',
    logoUrl: "/research-logos/surf-research-memo-crypto-native-copilot-or-prompt-wrapper.svg",
  },
  {
    name: 'Re Protocol',
  ...
  },
  {
    ...
    color: '#0284C7',
    initial: 'BN',
    logoUrl: "/research-logos/billions-network-institutional-grade-identity-and-trust-infrastructure-analysis.svg",
  },
  {
  ...
  },
  {
    ...
    color: '#2563EB',
    initial: 'CI',
    logoUrl: "/research-logos/citrea-vc-grade-investment-memo.svg",
  },
  {
    name: 'KAIO',
    ...
    color: '#DC2626',
    initial: 'KAIO',
    logoUrl: "/research-logos/kaio-the-shadow-banker-of-tokenized-finance-plumbing-tradfi-into.svg",
  },
  {
    name: 'Liquid Trading',
    ...
    color: '#2563EB',
    initial: 'LT',
    logoUrl: "/research-logos/liquid-trading-the-all-in-one-mobile-superapp-for-crypto.svg",
  },
  {
    name: 'PayPal USD',
    ...
    color: '#003087',
    initial: 'PY',
    logoUrl: "/research-logos/paypal-usd-pyusd-payfi-stablecoin.svg",
  },
  {
    name: 'Variational',
  ...
  },
  {
    ...
    color: '#C8A24A',
    initial: 'XAU',
    logoUrl: "/research-logos/tether-gold-xaut-tokenized-gold-rwa.svg",
  },
  {
    name: 'PAX Gold',
    ...
    color: '#D4AF37',
    initial: 'PAXG',
    logoUrl: "/research-logos/pax-gold-paxg-regulated-tokenized-gold.svg",
  },
  {
    name: 'USDD',
    ...
    color: '#2563EB',
    initial: 'USDD',
    logoUrl: "/research-logos/usdd-crypto-backed-stablecoin-tron-reserve.svg",
  },
  {
    name: 'Ripple USD',
    ...
    color: '#111827',
    initial: 'RL',
    logoUrl: "/research-logos/ripple-usd-rlusd-enterprise-stablecoin.svg",
  },
  {
    name: 'Ondo USDY',
    ...
    color: '#2563EB',
    initial: 'USDY',
    logoUrl: "/research-logos/ondo-us-dollar-yield-usdy-tokenized-treasury-note.svg",
  },
  {
    name: 'Bitget Token',
    ...
    color: '#0EA5E9',
    initial: 'BGB',
    logoUrl: "/research-logos/bitget-token-bgb-morph-exchange-utility-token.svg",
  },
  {
    name: 'Sky USDS',
    ...
    color: '#6366F1',
    initial: 'USDS',
    logoUrl: "/research-logos/sky-usds-susds-defi-native-stablecoin-yield.svg",
  },
  {
    name: 'Circle USYC',
    ...
    color: '#2563EB',
    initial: 'USYC',
    logoUrl: "/research-logos/circle-usyc-tokenized-money-market-fund-collateral.svg",
  },
  {
  ...
  },
  {
    ...
    color: '#EF4444',
    initial: 'WBT',
    logoUrl: "/research-logos/whitebit-coin-wbt-exchange-utility-token-supply-premium.svg",
  },
  {
    name: 'KuCoin Token',
    ...
    color: '#0EA5E9',
    initial: 'KCS',
    logoUrl: "/research-logos/kucoin-token-kcs-exchange-utility-kcc-trust-rebuild.svg",
  },
  {
    ...
    color: '#328332',
    initial: 'ETC',
    logoUrl: "/research-logos/ethereum-classic-etc-pow-immutability-app-layer-gap.svg",
  },
  {
    name: 'Cosmos Hub',
  ...
  },
  {
    ...
    color: '#FF3B1F',
    initial: 'RENDER',
    logoUrl: "/research-logos/render-network-render-gpu-rendering-ai-compute-depin.svg",
  },
  {
    name: 'Arbitrum',
    ...
    color: '#28A0F0',
    initial: 'ARB',
    logoUrl: "/research-logos/arbitrum-arb-l2-governance-token-value-capture-gap.svg",
  },
  {
    name: 'Optimism',
    ...
    color: '#FF0420',
    initial: 'OP',
    logoUrl: "/research-logos/optimism-op-superchain-platform-economics-buyback-test.svg",
  },
  {
    name: 'Starknet',
    ...
    color: '#EC796B',
    initial: 'STRK',
    logoUrl: "/research-logos/starknet-strk-zk-rollup-account-abstraction-value-capture.svg",
  },
  {
    name: 'Ondo Finance',
    ...
    color: '#2563EB',
    initial: 'ONDO',
    logoUrl: "/research-logos/ondo-finance-ondo-rwa-platform-token-value-capture.svg",
  },
  {
    name: 'Pi Network',
    ...
    color: '#F4B544',
    initial: 'PI',
    logoUrl: "/research-logos/pi-network-pi-mobile-mining-kyc-utility-reality-check.svg",
  },
  {
    name: 'HTX DAO',
  ...
  },
  {
    ...
    color: '#111827',
    initial: 'ALGO',
    logoUrl: "/research-logos/algorand-algo-finality-quantum-roadmap-app-demand-gap.svg",
  },
];
